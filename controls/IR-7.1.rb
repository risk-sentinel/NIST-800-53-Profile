control 'IR-7 (1)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      IR-07(01) the availability of incident response information and support is increased using #{input('ir_07_01_odp')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control IR-7 (1)' do
