control 'AC-4 (11)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      AC-04(11)[01] capability is provided for privileged administrators to configure #{input('ac_04_11_odp_01')} to support different security or privacy policies;
      AC-04(11)[02] capability is provided for privileged administrators to configure #{input('ac_04_11_odp_02')} to support different security or privacy policies.
  ...
  tag baseline: %w{}
  tag odp: %w{ac_04_11_odp_01 ac_04_11_odp_02 ac_4_11_prm_1}

  describe 'NIST SP 800-53 Rev 5 control AC-4 (11)' do
