control 'AC-6 (8)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      AC-06(08) #{input('ac_06_08_odp')} is prevented from executing at higher privilege levels than users executing the software.
  ...
  describe 'NIST SP 800-53 Rev 5 control AC-6 (8)' do
