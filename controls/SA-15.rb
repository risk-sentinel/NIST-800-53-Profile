control 'SA-15' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      ...
      SA-15b.
        SA-15b.[01] the developer of the system, system component, or system service is required to follow a documented development process in which the development process, standards, tools, tool options, and tool configurations are reviewed #{input('sa_15_odp_01')} to determine that the process, standards, tools, tool options, and tool configurations selected and employed satisfy #{input('sa_15_odp_02')};
        SA-15b.[02] the developer of the system, system component, or system service is required to follow a documented development process in which the development process, standards, tools, tool options, and tool configurations are reviewed #{input('sa_15_odp_01')} to determine that the process, standards, tools, tool options, and tool configurations selected and employed satisfy #{input('sa_15_odp_03')}.
  ...
  tag odp: %w{sa_15_odp_01 sa_15_odp_02 sa_15_odp_03 sa_15_prm_2}

  describe 'NIST SP 800-53 Rev 5 control SA-15' do
