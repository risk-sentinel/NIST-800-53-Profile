control 'SI-18 (1)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SI-18(01) #{input('si_18_01_odp')} are used to correct or delete personally identifiable information that is inaccurate, outdated, incorrectly determined regarding impact, or incorrectly de-identified.
  ...
  describe 'NIST SP 800-53 Rev 5 control SI-18 (1)' do
