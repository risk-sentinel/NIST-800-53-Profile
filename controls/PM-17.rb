control 'PM-17' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      ...
      PM-17b.
        PM-17b.[01] policy is reviewed and updated #{input('pm_17_odp_01')};
        PM-17b.[02] procedures are reviewed and updated #{input('pm_17_odp_02')}
  ...
  tag odp: %w{pm_17_odp_01 pm_17_odp_02 pm_17_prm_1}

  describe 'NIST SP 800-53 Rev 5 control PM-17' do
