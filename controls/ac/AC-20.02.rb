control 'AC-20(02)' do
  impact 0.5
  title "the use of organization-controlled portable storage devices by authorized individuals is restricted on external systems using #{input('ac_20_02_odp')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the use of organization-controlled portable storage devices by authorized individuals is restricted on external systems using #{input('ac_20_02_odp')}.
  ...
  tag nist: ['AC-20 (2)']
  tag control: 'AC-20 (2)'
  tag objective: 'AC-20(02)'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{MODERATE HIGH}
  tag baseline_moderate: true
  tag baseline_high: true
  tag control_ac_20_2: true
  tag odp: %w{ac_20_02_odp}

  describe 'NIST SP 800-53A Rev 5 objective AC-20(02)' do
