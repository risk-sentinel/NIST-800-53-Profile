control 'AC-22d.[02]' do
  impact 0.5
  title "non-public information is removed from the publicly accessible system, if discovered."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-22d.[02]' do
