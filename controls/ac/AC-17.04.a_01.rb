control 'AC-17(04)(a)[01]' do
  impact 0.5
  title "the execution of privileged commands via remote access is authorized only in a format that provides assessable evidence;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-17(04)(a)[01]' do
