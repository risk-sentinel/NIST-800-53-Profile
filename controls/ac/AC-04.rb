control 'AC-04' do
  impact 0.5
  title "approved authorizations are enforced for controlling the flow of information within the system and between connected systems based on #{input('ac_04_odp')}."
  desc <<~DESC
    Enforce approved authorizations for controlling the flow of information within the system and between connected systems based on #{input('ac_04_odp')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      approved authorizations are enforced for controlling the flow of information within the system and between connected systems based on #{input('ac_04_odp')}.
  ...
  tag control_ac_4: true
  tag odp: %w{ac_04_odp}

  describe 'NIST SP 800-53A Rev 5 objective AC-04' do
