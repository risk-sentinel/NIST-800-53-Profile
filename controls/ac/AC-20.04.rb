control 'AC-20(04)' do
  impact 0.5
  title "the use of #{input('ac_20_04_odp')} is prohibited in external systems."
  desc <<~DESC
    Prohibit the use of #{input('ac_20_04_odp')} in external systems.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      the use of #{input('ac_20_04_odp')} is prohibited in external systems.
  ...
  tag nist: ['AC-20 (4)']
  tag control: 'AC-20 (4)'
  tag objective: 'AC-20(04)'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{}
  tag control_ac_20_4: true
  tag odp: %w{ac_20_04_odp}

  describe 'NIST SP 800-53A Rev 5 objective AC-20(04)' do
