control 'AC-04(31)' do
  impact 0.5
  title "when transferring information between different security domains, the transfer of failed content to the receiving domain is prevented."
  desc <<~DESC
  ...
  tag nist: ['AC-4 (31)']
  tag control: 'AC-4 (31)'
  tag objective: 'AC-04(31)'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{}
  tag control_ac_4_31: true

  describe 'NIST SP 800-53A Rev 5 objective AC-04(31)' do
