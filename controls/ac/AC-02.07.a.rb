control 'AC-02(07)(a)' do
  impact 0.5
  title "privileged user accounts are established and administered in accordance with #{input('ac_02_07_odp')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      privileged user accounts are established and administered in accordance with #{input('ac_02_07_odp')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-02(07)(a)' do
