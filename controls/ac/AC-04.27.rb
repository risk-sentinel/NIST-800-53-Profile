control 'AC-04(27)' do
  impact 0.5
  title "when transferring information between security domains, implemented content filtering solutions provide redundant and independent filtering mechanisms for each data type."
  desc <<~DESC
  ...
  tag nist: ['AC-4 (27)']
  tag control: 'AC-4 (27)'
  tag objective: 'AC-04(27)'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{}
  tag control_ac_4_27: true

  describe 'NIST SP 800-53A Rev 5 objective AC-04(27)' do
