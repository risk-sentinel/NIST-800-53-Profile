control 'AC-04(26)[02]' do
  impact 0.5
  title "when transferring information between different security domains, results for the information being filtered are recorded and audited."
  desc <<~DESC
  ...
  tag nist: ['AC-4 (26)']
  tag control: 'AC-4 (26)'
  tag objective: 'AC-04(26)[02]'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{}
  tag control_ac_4_26: true

  describe 'NIST SP 800-53A Rev 5 objective AC-04(26)[02]' do
