control 'AC-12(01)' do
  impact 0.5
  title "a logout capability is provided for user-initiated communications sessions whenever authentication is used to gain access to #{input('ac_12_01_odp')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      a logout capability is provided for user-initiated communications sessions whenever authentication is used to gain access to #{input('ac_12_01_odp')}.
  ...
  tag nist: ['AC-12 (1)']
  tag control: 'AC-12 (1)'
  tag objective: 'AC-12(01)'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{}
  tag control_ac_12_1: true
  tag odp: %w{ac_12_01_odp}

  describe 'NIST SP 800-53A Rev 5 objective AC-12(01)' do
