control 'AC-02j.' do
  impact 0.5
  title "accounts are reviewed for compliance with account management requirements #{input('ac_02_odp_10')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      accounts are reviewed for compliance with account management requirements #{input('ac_02_odp_10')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-02j.' do
