control 'AC-19a.[03]' do
  impact 0.5
  title "implementation guidance is established for organization-controlled mobile devices, including when such devices are outside of the controlled area;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-19a.[03]' do
