control 'AC-24(02)[02]' do
  impact 0.5
  title "access control decisions are enforced based on #{input('ac_24_02_odp_02')} that do not include the identity of the user or process acting on behalf of the user (if selected)."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      access control decisions are enforced based on #{input('ac_24_02_odp_02')} that do not include the identity of the user or process acting on behalf of the user (if selected).
  ...
  tag nist: ['AC-24 (2)']
  tag control: 'AC-24 (2)'
  tag objective: 'AC-24(02)[02]'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{}
  tag control_ac_24_2: true
  tag odp: %w{ac_24_02_odp_02 ac_24_2_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective AC-24(02)[02]' do
