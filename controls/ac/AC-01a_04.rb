control 'AC-01a.[04]' do
  impact 0.5
  title "the access control procedures are disseminated to #{input('ac_01_odp_02')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the access control procedures are disseminated to #{input('ac_01_odp_02')};
  ...
  tag odp: %w{ac_01_odp_02 ac_01_odp_03 ac_01_odp_04 ac_01_odp_05 ac_01_odp_06 ac_01_odp_07 ac_01_odp_08 ac_1_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective AC-01a.[04]' do
