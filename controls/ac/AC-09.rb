control 'AC-09' do
  impact 0.5
  title "the user is notified, upon successful logon to the system, of the date and time of the last logon."
  desc <<~DESC
  ...
  tag baseline: %w{}
  tag control_ac_9: true

  describe 'NIST SP 800-53A Rev 5 objective AC-09' do
