control 'AC-02k.[01]' do
  impact 0.5
  title "a process is established for changing shared or group account authenticators (if deployed) when individuals are removed from the group;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-02k.[01]' do
