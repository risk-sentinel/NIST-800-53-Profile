control 'AC-02d.03[02]' do
  impact 0.5
  title "#{input('ac_02_odp_02')} are specified for each account;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('ac_02_odp_02')} are specified for each account;
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-02d.03[02]' do
