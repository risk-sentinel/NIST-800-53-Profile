control 'AC-17(04)(b)' do
  impact 0.5
  title "the rationale for remote access is documented in the security plan for the system."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-17(04)(b)' do
