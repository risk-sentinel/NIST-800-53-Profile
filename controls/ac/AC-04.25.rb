control 'AC-04(25)' do
  impact 0.5
  title "when transferring information between different security domains, data is sanitized to minimize #{input('ac_04_25_odp_01')} in accordance with #{input('ac_04_25_odp_02')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      when transferring information between different security domains, data is sanitized to minimize #{input('ac_04_25_odp_01')} in accordance with #{input('ac_04_25_odp_02')}.
  ...
  tag nist: ['AC-4 (25)']
  tag control: 'AC-4 (25)'
  tag objective: 'AC-04(25)'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{}
  tag control_ac_4_25: true
  tag odp: %w{ac_04_25_odp_01 ac_04_25_odp_02}

  describe 'NIST SP 800-53A Rev 5 objective AC-04(25)' do
