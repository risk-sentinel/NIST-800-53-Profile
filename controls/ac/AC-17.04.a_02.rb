control 'AC-17(04)(a)[02]' do
  impact 0.5
  title "access to security-relevant information via remote access is authorized only in a format that provides assessable evidence;"
  desc <<~DESC
  ...
  tag odp: %w{ac_17_4_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective AC-17(04)(a)[02]' do
