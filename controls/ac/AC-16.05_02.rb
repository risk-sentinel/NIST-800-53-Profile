control 'AC-16(05)[02]' do
  impact 0.5
  title "privacy attributes are displayed in human-readable form on each object that the system transmits to output devices to identify #{input('ac_16_05_odp_01')} using #{input('ac_16_05_odp_02')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      privacy attributes are displayed in human-readable form on each object that the system transmits to output devices to identify #{input('ac_16_05_odp_01')} using #{input('ac_16_05_odp_02')}.
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-16(05)[02]' do
