control 'AC-03(04)(a)' do
  impact 0.5
  title "#{input('ac_03_04_odp_01')} and #{input('ac_03_04_odp_02')} are enforced where the policy specifies that a subject that has been granted access to information can pass the information to any other subjects or objects;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('ac_03_04_odp_01')} and #{input('ac_03_04_odp_02')} are enforced where the policy specifies that a subject that has been granted access to information can pass the information to any other subjects or objects;
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-03(04)(a)' do
