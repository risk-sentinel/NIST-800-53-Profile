control 'AC-06(07)(a)' do
  impact 0.5
  title "privileges assigned to #{input('ac_06_07_odp_02')} are reviewed #{input('ac_06_07_odp_01')} to validate the need for such privileges;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      privileges assigned to #{input('ac_06_07_odp_02')} are reviewed #{input('ac_06_07_odp_01')} to validate the need for such privileges;
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-06(07)(a)' do
