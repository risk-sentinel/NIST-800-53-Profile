control 'AC-19a.[02]' do
  impact 0.5
  title "connection requirements are established for organization-controlled mobile devices, including when such devices are outside of the controlled area;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-19a.[02]' do
