control 'AC-02i.03' do
  impact 0.5
  title "access to the system is authorized based on #{input('ac_02_odp_09')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      access to the system is authorized based on #{input('ac_02_odp_09')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-02i.03' do
