control 'AC-02(07)(b)' do
  impact 0.5
  title "privileged role or attribute assignments are monitored;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-02(07)(b)' do
