control 'AC-04(04)' do
  impact 0.5
  title "encrypted information is prevented from bypassing #{input('ac_04_04_odp_01')} by #{input('ac_04_04_odp_02')}."
  desc <<~DESC
    Prevent encrypted information from bypassing #{input('ac_04_04_odp_01')} by #{input('ac_04_04_odp_02')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      encrypted information is prevented from bypassing #{input('ac_04_04_odp_01')} by #{input('ac_04_04_odp_02')}.
  ...
  tag nist: ['AC-4 (4)']
  tag control: 'AC-4 (4)'
  tag objective: 'AC-04(04)'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{HIGH}
  tag baseline_high: true
  tag control_ac_4_4: true
  tag odp: %w{ac_04_04_odp_01 ac_04_04_odp_02}

  describe 'NIST SP 800-53A Rev 5 objective AC-04(04)' do
