control 'AC-14b.[01]' do
  impact 0.5
  title "user actions not requiring identification or authentication are documented in the security plan for the system;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-14b.[01]' do
