control 'AC-02(02)' do
  impact 0.5
  title "temporary and emergency accounts are automatically #{input('ac_02_02_odp_01')} after #{input('ac_02_02_odp_02')}."
  desc <<~DESC
    Automatically #{input('ac_02_02_odp_01')} temporary and emergency accounts after #{input('ac_02_02_odp_02')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      temporary and emergency accounts are automatically #{input('ac_02_02_odp_01')} after #{input('ac_02_02_odp_02')}.
  ...
  tag nist: ['AC-2 (2)']
  tag control: 'AC-2 (2)'
  tag objective: 'AC-02(02)'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{MODERATE HIGH}
  tag baseline_moderate: true
  tag baseline_high: true
  tag control_ac_2_2: true
  tag odp: %w{ac_02_02_odp_01 ac_02_02_odp_02}

  describe 'NIST SP 800-53A Rev 5 objective AC-02(02)' do
