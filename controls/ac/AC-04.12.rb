control 'AC-04(12)' do
  impact 0.5
  title "when transferring information between different security domains, #{input('ac_04_12_odp')} are used to validate data essential for information flow decisions."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      when transferring information between different security domains, #{input('ac_04_12_odp')} are used to validate data essential for information flow decisions.
  ...
  tag nist: ['AC-4 (12)']
  tag control: 'AC-4 (12)'
  tag objective: 'AC-04(12)'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{}
  tag control_ac_4_12: true
  tag odp: %w{ac_04_12_odp}

  describe 'NIST SP 800-53A Rev 5 objective AC-04(12)' do
