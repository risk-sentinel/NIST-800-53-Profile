control 'AC-16(04)[02]' do
  impact 0.5
  title "authorized individuals (or processes acting on behalf of individuals) are provided with the capability to associate #{input('ac_16_04_odp_02')} with #{input('ac_16_04_odp_06')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      authorized individuals (or processes acting on behalf of individuals) are provided with the capability to associate #{input('ac_16_04_odp_02')} with #{input('ac_16_04_odp_06')};
  ...
  tag nist: ['AC-16 (4)']
  tag control: 'AC-16 (4)'
  tag objective: 'AC-16(04)[02]'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{}
  tag control_ac_16_4: true
  tag odp: %w{ac_16_04_odp_02 ac_16_04_odp_06 ac_16_4_prm_1 ac_16_4_prm_2}

  describe 'NIST SP 800-53A Rev 5 objective AC-16(04)[02]' do
