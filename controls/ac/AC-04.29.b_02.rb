control 'AC-04(29)(b)[02]' do
  impact 0.5
  title "when transferring information between security domains, content filter orchestration engines are employed to ensure that content-filtering actions comply with #{input('ac_04_29_odp')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      when transferring information between security domains, content filter orchestration engines are employed to ensure that content-filtering actions comply with #{input('ac_04_29_odp')}.
  ...
  tag nist: ['AC-4 (29)']
  tag control: 'AC-4 (29)'
  tag objective: 'AC-04(29)(b)[02]'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{}
  tag control_ac_4_29: true
  tag odp: %w{ac_04_29_odp}

  describe 'NIST SP 800-53A Rev 5 objective AC-04(29)(b)[02]' do
