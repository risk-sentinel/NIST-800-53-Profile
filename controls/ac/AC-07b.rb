control 'AC-07b.' do
  impact 0.5
  title "automatically #{input('ac_07_odp_03')} when the maximum number of unsuccessful attempts is exceeded."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      automatically #{input('ac_07_odp_03')} when the maximum number of unsuccessful attempts is exceeded.
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-07b.' do
