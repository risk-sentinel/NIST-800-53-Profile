control 'AC-16(10)[02]' do
  impact 0.5
  title "authorized individuals are provided with the capability to define or change the type and value of privacy attributes available for association with subjects and objects."
  desc <<~DESC
  ...
  tag objective: 'AC-16(10)[02]'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{}
  tag control_ac_16_10: true

  describe 'NIST SP 800-53A Rev 5 objective AC-16(10)[02]' do
