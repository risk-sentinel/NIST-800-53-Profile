control 'AC-02i.01' do
  impact 0.5
  title "access to the system is authorized based on a valid access authorization;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-02i.01' do
