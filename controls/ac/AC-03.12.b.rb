control 'AC-03(12)(b)' do
  impact 0.5
  title "an enforcement mechanism to prevent unauthorized access is provided;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-03(12)(b)' do
