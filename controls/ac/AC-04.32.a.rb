control 'AC-04(32)(a)' do
  impact 0.5
  title "when transferring information between different security domains, the process that transfers information between filter pipelines does not filter message content;"
  desc <<~DESC
  ...
  tag nist: ['AC-4 (32)']
  tag control: 'AC-4 (32)'
  tag objective: 'AC-04(32)(a)'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{}
  tag control_ac_4_32: true

  describe 'NIST SP 800-53A Rev 5 objective AC-04(32)(a)' do
