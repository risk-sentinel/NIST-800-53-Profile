control 'AC-03(07)[02]' do
  impact 0.5
  title "a role-based access control policy is enforced over defined objects;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-03(07)[02]' do
