control 'AC-03(07)[01]' do
  impact 0.5
  title "a role-based access control policy is enforced over defined subjects;"
  desc <<~DESC
  ...
  tag nist: ['AC-3 (7)']
  tag control: 'AC-3 (7)'
  tag objective: 'AC-03(07)[01]'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{}
  tag control_ac_3_7: true
  tag odp: %w{ac_3_7_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective AC-03(07)[01]' do
