control 'AC-01c.02[01]' do
  impact 0.5
  title "the current access control procedures are reviewed and updated #{input('ac_01_odp_07')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the current access control procedures are reviewed and updated #{input('ac_01_odp_07')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-01c.02[01]' do
