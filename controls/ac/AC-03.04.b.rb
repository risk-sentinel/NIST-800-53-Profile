control 'AC-03(04)(b)' do
  impact 0.5
  title "#{input('ac_03_04_odp_01')} and #{input('ac_03_04_odp_02')} are enforced where the policy specifies that a subject that has been granted access to information can grant its privileges to other subjects;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('ac_03_04_odp_01')} and #{input('ac_03_04_odp_02')} are enforced where the policy specifies that a subject that has been granted access to information can grant its privileges to other subjects;
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-03(04)(b)' do
