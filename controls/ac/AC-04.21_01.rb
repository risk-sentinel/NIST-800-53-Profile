control 'AC-04(21)[01]' do
  impact 0.5
  title "information flows are separated logically using #{input('ac_04_21_odp_01')} to accomplish #{input('ac_04_21_odp_03')};"
  desc <<~DESC
    Separate information flows logically or physically using #{input('ac_4_21_prm_1')} to accomplish #{input('ac_04_21_odp_03')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      information flows are separated logically using #{input('ac_04_21_odp_01')} to accomplish #{input('ac_04_21_odp_03')};
  ...
  tag nist: ['AC-4 (21)']
  tag control: 'AC-4 (21)'
  tag objective: 'AC-04(21)[01]'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{}
  tag control_ac_4_21: true
  tag odp: %w{ac_04_21_odp_01 ac_04_21_odp_03 ac_4_21_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective AC-04(21)[01]' do
