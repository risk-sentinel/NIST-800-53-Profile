control 'AC-01a.01(b)' do
  impact 0.5
  title "the #{input('ac_01_odp_03')} access control policy is consistent with applicable laws, Executive Orders, directives, regulations, policies, standards, and guidelines;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the #{input('ac_01_odp_03')} access control policy is consistent with applicable laws, Executive Orders, directives, regulations, policies, standards, and guidelines;
  ...
  tag odp: %w{ac_01_odp_03 ac_01_odp_04 ac_01_odp_05 ac_01_odp_06 ac_01_odp_07 ac_01_odp_08 ac_1_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective AC-01a.01(b)' do
