control 'AC-04(07)' do
  impact 0.5
  title "one-way information flows are enforced through hardware-based flow control mechanisms."
  desc <<~DESC
  ...
  tag nist: ['AC-4 (7)']
  tag control: 'AC-4 (7)'
  tag objective: 'AC-04(07)'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{}
  tag control_ac_4_7: true

  describe 'NIST SP 800-53A Rev 5 objective AC-04(07)' do
