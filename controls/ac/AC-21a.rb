control 'AC-21a.' do
  impact 0.5
  title "authorized users are enabled to determine whether access authorizations assigned to a sharing partner match the information’s access and use restrictions for #{input('ac_21_odp_01')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      authorized users are enabled to determine whether access authorizations assigned to a sharing partner match the information’s access and use restrictions for #{input('ac_21_odp_01')};
  ...
  tag nist: ['AC-21']
  tag control: 'AC-21'
  tag objective: 'AC-21a.'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{MODERATE HIGH}
  tag baseline_moderate: true
  tag baseline_high: true
  tag control_ac_21: true
  tag odp: %w{ac_21_odp_01 ac_21_odp_02}

  describe 'NIST SP 800-53A Rev 5 objective AC-21a.' do
