control 'AC-16f.[01]' do
  impact 0.5
  title "#{input('ac_16_odp_07')} are reviewed for applicability #{input('ac_16_odp_10')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('ac_16_odp_07')} are reviewed for applicability #{input('ac_16_odp_10')};
  ...
  tag nist: ['AC-16']
  tag control: 'AC-16'
  tag objective: 'AC-16f.[01]'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{}
  tag control_ac_16: true
  tag odp: %w{ac_16_odp_07 ac_16_odp_09 ac_16_odp_10 ac_16_prm_1 ac_16_prm_2 ac_16_prm_3 ac_16_prm_4 ac_16_prm_6 ac_16_prm_7}

  describe 'NIST SP 800-53A Rev 5 objective AC-16f.[01]' do
