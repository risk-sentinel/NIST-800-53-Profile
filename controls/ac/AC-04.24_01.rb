control 'AC-04(24)[01]' do
  impact 0.5
  title "when transferring information between different security domains, incoming data is parsed into an internal, normalized format;"
  desc <<~DESC
  ...
  tag nist: ['AC-4 (24)']
  tag control: 'AC-4 (24)'
  tag objective: 'AC-04(24)[01]'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{}
  tag control_ac_4_24: true

  describe 'NIST SP 800-53A Rev 5 objective AC-04(24)[01]' do
