control 'AC-16(03)[02]' do
  impact 0.5
  title "the association and integrity of #{input('ac_16_03_odp_01')} to #{input('ac_16_03_odp_04')} is maintained."
  desc <<~DESC
    Maintain the association and integrity of #{input('ac_16_3_prm_1')} to #{input('ac_16_3_prm_2')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      the association and integrity of #{input('ac_16_03_odp_01')} to #{input('ac_16_03_odp_04')} is maintained.
  ...
  tag nist: ['AC-16 (3)']
  tag control: 'AC-16 (3)'
  tag objective: 'AC-16(03)[02]'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{}
  tag control_ac_16_3: true
  tag odp: %w{ac_16_03_odp_01 ac_16_03_odp_04 ac_16_3_prm_1 ac_16_3_prm_2}

  describe 'NIST SP 800-53A Rev 5 objective AC-16(03)[02]' do
