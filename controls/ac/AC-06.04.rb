control 'AC-06(04)' do
  impact 0.5
  title "separate processing domains are provided to enable finer-grain allocation of user privileges."
  desc <<~DESC
  ...
  tag nist: ['AC-6 (4)']
  tag control: 'AC-6 (4)'
  tag objective: 'AC-06(04)'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{}
  tag control_ac_6_4: true

  describe 'NIST SP 800-53A Rev 5 objective AC-06(04)' do
