control 'AC-02(11)' do
  impact 0.5
  title "#{input('ac_02_11_odp_01')} for #{input('ac_02_11_odp_02')} are enforced."
  desc <<~DESC
    Enforce #{input('ac_02_11_odp_01')} for #{input('ac_02_11_odp_02')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      #{input('ac_02_11_odp_01')} for #{input('ac_02_11_odp_02')} are enforced.
  ...
  tag nist: ['AC-2 (11)']
  tag control: 'AC-2 (11)'
  tag objective: 'AC-02(11)'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{HIGH}
  tag baseline_high: true
  tag control_ac_2_11: true
  tag odp: %w{ac_02_11_odp_01 ac_02_11_odp_02}

  describe 'NIST SP 800-53A Rev 5 objective AC-02(11)' do
