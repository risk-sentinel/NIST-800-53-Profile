control 'AC-03(14)' do
  impact 0.5
  title "#{input('ac_03_14_odp_01')} are provided to enable individuals to have access to #{input('ac_03_14_odp_02')} of their personally identifiable information."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('ac_03_14_odp_01')} are provided to enable individuals to have access to #{input('ac_03_14_odp_02')} of their personally identifiable information.
  ...
  tag nist: ['AC-3 (14)']
  tag control: 'AC-3 (14)'
  tag objective: 'AC-03(14)'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{PRIVACY}
  tag baseline_privacy: true
  tag control_ac_3_14: true
  tag odp: %w{ac_03_14_odp_01 ac_03_14_odp_02}

  describe 'NIST SP 800-53A Rev 5 objective AC-03(14)' do
