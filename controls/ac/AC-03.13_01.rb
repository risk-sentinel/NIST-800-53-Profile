control 'AC-03(13)[01]' do
  impact 0.5
  title "the attribute-based access control policy is enforced over defined subjects;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-03(13)[01]' do
