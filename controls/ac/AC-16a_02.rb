control 'AC-16a.[02]' do
  impact 0.5
  title "the means to associate #{input('ac_16_odp_02')} with #{input('ac_16_odp_04')} for information in storage, in process, and/or in transmission are provided;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the means to associate #{input('ac_16_odp_02')} with #{input('ac_16_odp_04')} for information in storage, in process, and/or in transmission are provided;
  ...
  tag nist: ['AC-16']
  tag control: 'AC-16'
  tag objective: 'AC-16a.[02]'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{}
  tag control_ac_16: true
  tag odp: %w{ac_16_odp_02 ac_16_odp_04 ac_16_odp_09 ac_16_prm_1 ac_16_prm_2 ac_16_prm_3 ac_16_prm_4 ac_16_prm_6 ac_16_prm_7}

  describe 'NIST SP 800-53A Rev 5 objective AC-16a.[02]' do
