control 'AC-02(12)(a)' do
  impact 0.5
  title "system accounts are monitored for #{input('ac_02_12_odp_01')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      system accounts are monitored for #{input('ac_02_12_odp_01')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-02(12)(a)' do
