control 'AC-07a.' do
  impact 0.5
  title "a limit of #{input('ac_07_odp_01')} consecutive invalid logon attempts by a user during #{input('ac_07_odp_02')} is enforced;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      a limit of #{input('ac_07_odp_01')} consecutive invalid logon attempts by a user during #{input('ac_07_odp_02')} is enforced;
  ...
  tag control_ac_7: true
  tag odp: %w{ac_07_odp_01 ac_07_odp_02 ac_07_odp_03}

  describe 'NIST SP 800-53A Rev 5 objective AC-07a.' do
