control 'AC-06(09)' do
  impact 0.5
  title "the execution of privileged functions is logged."
  desc <<~DESC
  ...
  tag nist: ['AC-6 (9)']
  tag control: 'AC-6 (9)'
  tag objective: 'AC-06(09)'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{MODERATE HIGH}
  tag baseline_moderate: true
  tag baseline_high: true
  tag control_ac_6_9: true

  describe 'NIST SP 800-53A Rev 5 objective AC-06(09)' do
