control 'AC-04(14)[01]' do
  impact 0.5
  title "when transferring information between different security domains, implemented #{input('ac_04_14_odp_01')} require fully enumerated formats that restrict data structure and content;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      when transferring information between different security domains, implemented #{input('ac_04_14_odp_01')} require fully enumerated formats that restrict data structure and content;
  ...
  tag nist: ['AC-4 (14)']
  tag control: 'AC-4 (14)'
  tag objective: 'AC-04(14)[01]'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{}
  tag control_ac_4_14: true
  tag odp: %w{ac_04_14_odp_01 ac_4_14_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective AC-04(14)[01]' do
