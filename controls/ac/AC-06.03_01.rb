control 'AC-06(03)[01]' do
  impact 0.5
  title "network access to #{input('ac_06_03_odp_01')} is authorized only for #{input('ac_06_03_odp_02')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      network access to #{input('ac_06_03_odp_01')} is authorized only for #{input('ac_06_03_odp_02')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-06(03)[01]' do
