control 'AC-17(01)[02]' do
  impact 0.5
  title "automated mechanisms are employed to control remote access methods."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-17(01)[02]' do
