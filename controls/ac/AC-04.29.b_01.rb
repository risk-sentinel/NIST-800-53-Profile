control 'AC-04(29)(b)[01]' do
  impact 0.5
  title "when transferring information between security domains, content filter orchestration engines are employed to ensure that content-filtering actions occur in the correct order;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-04(29)(b)[01]' do
