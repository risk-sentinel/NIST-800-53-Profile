control 'AC-19(04)(a)' do
  impact 0.5
  title "the use of unclassified mobile devices in facilities containing systems processing, storing, or transmitting classified information is prohibited unless specifically permitted by the authorizing official;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-19(04)(a)' do
