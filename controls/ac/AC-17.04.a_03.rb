control 'AC-17(04)(a)[03]' do
  impact 0.5
  title "the execution of privileged commands via remote access is authorized only for the following needs: #{input('ac_17_04_odp_01')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the execution of privileged commands via remote access is authorized only for the following needs: #{input('ac_17_04_odp_01')};
  ...
  tag odp: %w{ac_17_04_odp_01 ac_17_4_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective AC-17(04)(a)[03]' do
