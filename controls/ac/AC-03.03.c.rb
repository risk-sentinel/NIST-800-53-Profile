control 'AC-03(03)(c)' do
  impact 0.5
  title "#{input('ac_03_03_odp_01')} and #{input('ac_03_03_odp_02')} specifying that #{input('ac_03_03_odp_03')} may explicitly be granted #{input('ac_03_03_odp_04')} such that they are not limited by any defined subset (or all) of the above constraints are enforced."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('ac_03_03_odp_01')} and #{input('ac_03_03_odp_02')} specifying that #{input('ac_03_03_odp_03')} may explicitly be granted #{input('ac_03_03_odp_04')} such that they are not limited by any defined subset (or all) of the above constraints are enforced.
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-03(03)(c)' do
