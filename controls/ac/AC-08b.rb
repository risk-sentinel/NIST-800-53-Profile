control 'AC-08b.' do
  impact 0.5
  title "the notification message or banner is retained on the screen until users acknowledge the usage conditions and take explicit actions to log on to or further access the system;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-08b.' do
