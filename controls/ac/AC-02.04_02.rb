control 'AC-02(04)[02]' do
  impact 0.5
  title "account modification is automatically audited;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-02(04)[02]' do
