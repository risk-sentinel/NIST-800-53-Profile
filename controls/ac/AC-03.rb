control 'AC-03' do
  impact 0.5
  title "approved authorizations for logical access to information and system resources are enforced in accordance with applicable access control policies."
  desc <<~DESC
  ...
  tag control_ac_3: true

  describe 'NIST SP 800-53A Rev 5 objective AC-03' do
