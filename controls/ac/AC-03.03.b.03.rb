control 'AC-03(03)(b)(03)' do
  impact 0.5
  title "#{input('ac_03_03_odp_01')} and #{input('ac_03_03_odp_02')} specifying that a subject that has been granted access to information is constrained from changing one of more security attributes (specified by the policy) on subjects, objects, the system, or system components are enforced;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('ac_03_03_odp_01')} and #{input('ac_03_03_odp_02')} specifying that a subject that has been granted access to information is constrained from changing one of more security attributes (specified by the policy) on subjects, objects, the system, or system components are enforced;
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-03(03)(b)(03)' do
