control 'AC-14b.[02]' do
  impact 0.5
  title "a rationale for user actions not requiring identification or authentication is provided in the security plan for the system."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-14b.[02]' do
