control 'AC-18b.' do
  impact 0.5
  title "each type of wireless access to the system is authorized prior to allowing such connections."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-18b.' do
