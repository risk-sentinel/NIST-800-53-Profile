control 'AC-16c.[01]' do
  impact 0.5
  title "the following permitted security attributes are established from the attributes defined in AC-16_ODP[01] for #{input('ac_16_odp_05')}: #{input('ac_16_odp_07')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the following permitted security attributes are established from the attributes defined in AC-16_ODP[01] for #{input('ac_16_odp_05')}: #{input('ac_16_odp_07')};
  ...
  tag nist: ['AC-16']
  tag control: 'AC-16'
  tag objective: 'AC-16c.[01]'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{}
  tag control_ac_16: true
  tag odp: %w{ac_16_odp_05 ac_16_odp_07 ac_16_odp_09 ac_16_prm_1 ac_16_prm_2 ac_16_prm_3 ac_16_prm_4 ac_16_prm_6 ac_16_prm_7}

  describe 'NIST SP 800-53A Rev 5 objective AC-16c.[01]' do
