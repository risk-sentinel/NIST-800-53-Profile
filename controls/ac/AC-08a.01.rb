control 'AC-08a.01' do
  impact 0.5
  title "the system use notification states that users are accessing a U.S. Government system;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-08a.01' do
