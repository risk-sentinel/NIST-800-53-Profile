control 'AC-02d.03[01]' do
  impact 0.5
  title "access authorizations (i.e., privileges) are specified for each account;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-02d.03[01]' do
