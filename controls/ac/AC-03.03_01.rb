control 'AC-03(03)[01]' do
  impact 0.5
  title "#{input('ac_03_03_odp_01')} is enforced over the set of covered subjects specified in the policy;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('ac_03_03_odp_01')} is enforced over the set of covered subjects specified in the policy;
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-03(03)[01]' do
