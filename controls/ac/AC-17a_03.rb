control 'AC-17a.[03]' do
  impact 0.5
  title "implementation guidance is established and documented for each type of remote access allowed;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-17a.[03]' do
