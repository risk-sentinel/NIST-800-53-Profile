control 'AC-04(15)[01]' do
  impact 0.5
  title "when transferring information between different security domains, information is examined for the presence of #{input('ac_04_15_odp_01')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      when transferring information between different security domains, information is examined for the presence of #{input('ac_04_15_odp_01')};
  ...
  tag nist: ['AC-4 (15)']
  tag control: 'AC-4 (15)'
  tag objective: 'AC-04(15)[01]'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{}
  tag control_ac_4_15: true
  tag odp: %w{ac_04_15_odp_01 ac_4_15_prm_2}

  describe 'NIST SP 800-53A Rev 5 objective AC-04(15)[01]' do
