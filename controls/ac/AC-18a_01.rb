control 'AC-18a.[01]' do
  impact 0.5
  title "configuration requirements are established for each type of wireless access;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-18a.[01]' do
