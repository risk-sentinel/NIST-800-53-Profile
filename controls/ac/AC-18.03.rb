control 'AC-18(03)' do
  impact 0.5
  title "when not intended for use, wireless networking capabilities embedded within system components are disabled prior to issuance and deployment."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    ...
    Assessment methods and objects:
      ...
      TEST: Mechanisms managing the disabling of wireless networking capabilities internally embedded within system components
  CHECK
  desc 'fix', <<~FIX
  ...
  tag nist: ['AC-18 (3)']
  tag control: 'AC-18 (3)'
  tag objective: 'AC-18(03)'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{MODERATE HIGH}
  tag baseline_moderate: true
  tag baseline_high: true
  tag control_ac_18_3: true

  describe 'NIST SP 800-53A Rev 5 objective AC-18(03)' do
