control 'AC-02(13)' do
  impact 0.5
  title "accounts of individuals are disabled within #{input('ac_02_13_odp_01')} of discovery of #{input('ac_02_13_odp_02')}."
  desc <<~DESC
    Disable accounts of individuals within #{input('ac_02_13_odp_01')} of discovery of #{input('ac_02_13_odp_02')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      accounts of individuals are disabled within #{input('ac_02_13_odp_01')} of discovery of #{input('ac_02_13_odp_02')}.
  ...
  tag nist: ['AC-2 (13)']
  tag control: 'AC-2 (13)'
  tag objective: 'AC-02(13)'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{MODERATE HIGH}
  tag baseline_moderate: true
  tag baseline_high: true
  tag control_ac_2_13: true
  tag odp: %w{ac_02_13_odp_01 ac_02_13_odp_02}

  describe 'NIST SP 800-53A Rev 5 objective AC-02(13)' do
