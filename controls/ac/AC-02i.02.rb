control 'AC-02i.02' do
  impact 0.5
  title "access to the system is authorized based on intended system usage;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-02i.02' do
