control 'AC-22d.[01]' do
  impact 0.5
  title "the content on the publicly accessible system is reviewed for non-public information #{input('ac_22_odp')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the content on the publicly accessible system is reviewed for non-public information #{input('ac_22_odp')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-22d.[01]' do
