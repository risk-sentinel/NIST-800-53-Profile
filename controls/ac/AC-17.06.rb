control 'AC-17(06)' do
  impact 0.5
  title "information about remote access mechanisms is protected from unauthorized use and disclosure."
  desc <<~DESC
  ...
  tag nist: ['AC-17 (6)']
  tag control: 'AC-17 (6)'
  tag objective: 'AC-17(06)'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{}
  tag control_ac_17_6: true

  describe 'NIST SP 800-53A Rev 5 objective AC-17(06)' do
