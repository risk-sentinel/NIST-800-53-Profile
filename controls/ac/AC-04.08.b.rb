control 'AC-04(08)(b)' do
  impact 0.5
  title "#{input('ac_04_08_odp_05')} data after a filter processing failure in accordance with #{input('ac_04_08_odp_06')}; #{input('ac_04_08_odp_05')} data after a filter processing failure in accordance with #{input('ac_04_08_odp_07')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('ac_04_08_odp_05')} data after a filter processing failure in accordance with #{input('ac_04_08_odp_06')};
  ...
  tag nist: ['AC-4 (8)']
  tag control: 'AC-4 (8)'
  tag objective: 'AC-04(08)(b)'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{}
  tag control_ac_4_8: true
  tag odp: %w{ac_04_08_odp_05 ac_04_08_odp_06 ac_04_08_odp_07 ac_4_8_prm_1 ac_4_8_prm_2 ac_4_8_prm_4}

  describe 'NIST SP 800-53A Rev 5 objective AC-04(08)(b)' do
