control 'AC-19a.[01]' do
  impact 0.5
  title "configuration requirements are established for organization-controlled mobile devices, including when such devices are outside of the controlled area;"
  desc <<~DESC
  ...
  tag control_ac_19: true

  describe 'NIST SP 800-53A Rev 5 objective AC-19a.[01]' do
