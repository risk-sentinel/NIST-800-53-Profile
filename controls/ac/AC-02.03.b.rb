control 'AC-02(03)(b)' do
  impact 0.5
  title "accounts are disabled within #{input('ac_02_03_odp_01')} when the accounts are no longer associated with a user or individual;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      accounts are disabled within #{input('ac_02_03_odp_01')} when the accounts are no longer associated with a user or individual;
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-02(03)(b)' do
