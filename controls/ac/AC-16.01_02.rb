control 'AC-16(01)[02]' do
  impact 0.5
  title "security attributes are dynamically associated with #{input('ac_16_01_odp_02')} in accordance with the following security policies as information is created and combined: #{input('ac_16_01_odp_05')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      security attributes are dynamically associated with #{input('ac_16_01_odp_02')} in accordance with the following security policies as information is created and combined: #{input('ac_16_01_odp_05')};
  ...
  tag nist: ['AC-16 (1)']
  tag control: 'AC-16 (1)'
  tag objective: 'AC-16(01)[02]'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{}
  tag control_ac_16_1: true
  tag odp: %w{ac_16_01_odp_02 ac_16_01_odp_05 ac_16_1_prm_1 ac_16_1_prm_2}

  describe 'NIST SP 800-53A Rev 5 objective AC-16(01)[02]' do
