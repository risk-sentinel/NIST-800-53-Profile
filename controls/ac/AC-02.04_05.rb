control 'AC-02(04)[05]' do
  impact 0.5
  title "account removal actions are automatically audited."
  desc <<~DESC
  ...
  tag nist: ['AC-2 (4)']
  tag control: 'AC-2 (4)'
  tag objective: 'AC-02(04)[05]'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{MODERATE HIGH}
  tag baseline_moderate: true
  tag baseline_high: true
  tag control_ac_2_4: true

  describe 'NIST SP 800-53A Rev 5 objective AC-02(04)[05]' do
