control 'AC-04(08)(a)[01]' do
  impact 0.5
  title "information flow control is enforced using #{input('ac_04_08_odp_01')} as a basis for flow control decisions for #{input('ac_04_08_odp_03')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      information flow control is enforced using #{input('ac_04_08_odp_01')} as a basis for flow control decisions for #{input('ac_04_08_odp_03')};
  ...
  tag nist: ['AC-4 (8)']
  tag control: 'AC-4 (8)'
  tag objective: 'AC-04(08)(a)[01]'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{}
  tag control_ac_4_8: true
  tag odp: %w{ac_04_08_odp_01 ac_04_08_odp_03 ac_04_08_odp_05 ac_4_8_prm_1 ac_4_8_prm_2 ac_4_8_prm_4}

  describe 'NIST SP 800-53A Rev 5 objective AC-04(08)(a)[01]' do
