control 'AC-04(22)' do
  impact 0.5
  title "access is provided from a single device to computing platforms, applications, or data that reside in multiple different security domains while preventing information flow between the different security domains."
  desc <<~DESC
  ...
  tag nist: ['AC-4 (22)']
  tag control: 'AC-4 (22)'
  tag objective: 'AC-04(22)'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{}
  tag control_ac_4_22: true

  describe 'NIST SP 800-53A Rev 5 objective AC-04(22)' do
