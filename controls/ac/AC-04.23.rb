control 'AC-04(23)' do
  impact 0.5
  title "when transferring information between security domains, non-releasable information is modified by implementing #{input('ac_04_23_odp')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      when transferring information between security domains, non-releasable information is modified by implementing #{input('ac_04_23_odp')}.
  ...
  tag nist: ['AC-4 (23)']
  tag control: 'AC-4 (23)'
  tag objective: 'AC-04(23)'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{}
  tag control_ac_4_23: true
  tag odp: %w{ac_04_23_odp}

  describe 'NIST SP 800-53A Rev 5 objective AC-04(23)' do
