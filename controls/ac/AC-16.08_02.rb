control 'AC-16(08)[02]' do
  impact 0.5
  title "#{input('ac_16_08_odp_02')} are implemented in associating privacy attributes to information."
  desc <<~DESC
    Implement #{input('ac_16_8_prm_1')} in associating security and privacy attributes to information.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      #{input('ac_16_08_odp_02')} are implemented in associating privacy attributes to information.
  ...
  tag nist: ['AC-16 (8)']
  tag control: 'AC-16 (8)'
  tag objective: 'AC-16(08)[02]'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{}
  tag control_ac_16_8: true
  tag odp: %w{ac_16_08_odp_02 ac_16_8_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective AC-16(08)[02]' do
