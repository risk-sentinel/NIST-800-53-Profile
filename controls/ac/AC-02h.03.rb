control 'AC-02h.03' do
  impact 0.5
  title "account managers and #{input('ac_02_odp_05')} are notified within #{input('ac_02_odp_08')} when system usage or the need to know changes for an individual;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      account managers and #{input('ac_02_odp_05')} are notified within #{input('ac_02_odp_08')} when system usage or the need to know changes for an individual;
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-02h.03' do
