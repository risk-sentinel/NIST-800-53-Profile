control 'AC-18(05)[01]' do
  impact 0.5
  title "radio antennas are selected to reduce the probability that signals from wireless access points can be received outside of organization-controlled boundaries;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-18(05)[01]' do
