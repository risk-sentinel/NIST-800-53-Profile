control 'AC-04(11)[01]' do
  impact 0.5
  title "capability is provided for privileged administrators to configure #{input('ac_04_11_odp_01')} to support different security or privacy policies;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      capability is provided for privileged administrators to configure #{input('ac_04_11_odp_01')} to support different security or privacy policies;
  ...
  tag nist: ['AC-4 (11)']
  tag control: 'AC-4 (11)'
  tag objective: 'AC-04(11)[01]'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{}
  tag control_ac_4_11: true
  tag odp: %w{ac_04_11_odp_01 ac_4_11_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective AC-04(11)[01]' do
