control 'AC-16(07)[01]' do
  impact 0.5
  title "a consistent interpretation of security attributes transmitted between distributed system components is provided;"
  desc <<~DESC
  ...
  tag nist: ['AC-16 (7)']
  tag control: 'AC-16 (7)'
  tag objective: 'AC-16(07)[01]'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{}
  tag control_ac_16_7: true

  describe 'NIST SP 800-53A Rev 5 objective AC-16(07)[01]' do
