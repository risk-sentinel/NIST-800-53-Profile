control 'AC-06(01)(a)[02]' do
  impact 0.5
  title "access is authorized for #{input('ac_06_01_odp_01')} to #{input('ac_06_01_odp_03')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      access is authorized for #{input('ac_06_01_odp_01')} to #{input('ac_06_01_odp_03')};
  ...
  tag odp: %w{ac_06_01_odp_01 ac_06_01_odp_03 ac_06_01_odp_05 ac_6_1_prm_2}

  describe 'NIST SP 800-53A Rev 5 objective AC-06(01)(a)[02]' do
