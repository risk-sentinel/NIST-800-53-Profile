control 'AC-02e.' do
  impact 0.5
  title "approvals are required by #{input('ac_02_odp_03')} for requests to create accounts;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      approvals are required by #{input('ac_02_odp_03')} for requests to create accounts;
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-02e.' do
