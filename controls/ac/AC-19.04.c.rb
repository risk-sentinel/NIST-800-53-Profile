control 'AC-19(04)(c)' do
  impact 0.5
  title "the connection of classified mobile devices to classified systems is restricted in accordance with #{input('ac_19_04_odp_02')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the connection of classified mobile devices to classified systems is restricted in accordance with #{input('ac_19_04_odp_02')}.
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-19(04)(c)' do
