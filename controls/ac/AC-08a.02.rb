control 'AC-08a.02' do
  impact 0.5
  title "the system use notification states that system usage may be monitored, recorded, and subject to audit;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-08a.02' do
