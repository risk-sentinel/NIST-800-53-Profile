control 'AC-19(04)(b)(04)[02]' do
  impact 0.5
  title "following of the incident handling policy is enforced if classified information is found during a random review and inspection of unclassified mobile devices;"
  desc <<~DESC
  ...
  tag nist: ['AC-19 (4)']
  tag control: 'AC-19 (4)'
  tag objective: 'AC-19(04)(b)(04)[02]'
  tag rev: 'Rev_5'
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-19(04)(b)(04)[02]' do
