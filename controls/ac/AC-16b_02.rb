control 'AC-16b.[02]' do
  impact 0.5
  title "attribute associations are retained with the information;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-16b.[02]' do
