control 'AC-16(02)[02]' do
  impact 0.5
  title "authorized individuals (or processes acting on behalf of individuals) are provided with the capability to define or change the value of associated privacy attributes."
  desc <<~DESC
  ...
  tag nist: ['AC-16 (2)']
  tag control: 'AC-16 (2)'
  tag objective: 'AC-16(02)[02]'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{}
  tag control_ac_16_2: true

  describe 'NIST SP 800-53A Rev 5 objective AC-16(02)[02]' do
