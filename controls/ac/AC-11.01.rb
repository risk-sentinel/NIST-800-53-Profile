control 'AC-11(01)' do
  impact 0.5
  title "information previously visible on the display is concealed, via device lock, with a publicly viewable image."
  desc <<~DESC
  ...
  tag nist: ['AC-11 (1)']
  tag control: 'AC-11 (1)'
  tag objective: 'AC-11(01)'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{MODERATE HIGH}
  tag baseline_moderate: true
  tag baseline_high: true
  tag control_ac_11_1: true

  describe 'NIST SP 800-53A Rev 5 objective AC-11(01)' do
