control 'AC-06(06)' do
  impact 0.5
  title "privileged access to the system by non-organizational users is prohibited."
  desc <<~DESC
  ...
  tag nist: ['AC-6 (6)']
  tag control: 'AC-6 (6)'
  tag objective: 'AC-06(06)'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{}
  tag control_ac_6_6: true

  describe 'NIST SP 800-53A Rev 5 objective AC-06(06)' do
