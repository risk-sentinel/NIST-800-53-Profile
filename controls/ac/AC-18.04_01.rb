control 'AC-18(04)[01]' do
  impact 0.5
  title "users allowed to independently configure wireless networking capabilities are identified;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-18(04)[01]' do
