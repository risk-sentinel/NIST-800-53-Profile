control 'AC-01a.01(a)[01]' do
  impact 0.5
  title "the #{input('ac_01_odp_03')} access control policy addresses purpose;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the #{input('ac_01_odp_03')} access control policy addresses purpose;
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-01a.01(a)[01]' do
