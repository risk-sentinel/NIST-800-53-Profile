control 'AC-03(09)(b)' do
  impact 0.5
  title "information is released outside of the system only if #{input('ac_03_09_odp_03')} are used to validate the appropriateness of the information designated for release."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      information is released outside of the system only if #{input('ac_03_09_odp_03')} are used to validate the appropriateness of the information designated for release.
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-03(09)(b)' do
