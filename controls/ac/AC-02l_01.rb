control 'AC-02l.[01]' do
  impact 0.5
  title "account management processes are aligned with personnel termination processes;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-02l.[01]' do
