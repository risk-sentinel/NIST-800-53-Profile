control 'AC-02h.01' do
  impact 0.5
  title "account managers and #{input('ac_02_odp_05')} are notified within #{input('ac_02_odp_06')} when accounts are no longer required;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      account managers and #{input('ac_02_odp_05')} are notified within #{input('ac_02_odp_06')} when accounts are no longer required;
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-02h.01' do
