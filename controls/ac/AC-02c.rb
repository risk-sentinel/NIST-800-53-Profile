control 'AC-02c.' do
  impact 0.5
  title "#{input('ac_02_odp_01')} for group and role membership are required;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('ac_02_odp_01')} for group and role membership are required;
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-02c.' do
