control 'AC-04(17)' do
  impact 0.5
  title "source and destination points are uniquely identified and authenticated by #{input('ac_04_17_odp')} for information transfer."
  desc <<~DESC
    Uniquely identify and authenticate source and destination points by #{input('ac_04_17_odp')} for information transfer.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      source and destination points are uniquely identified and authenticated by #{input('ac_04_17_odp')} for information transfer.
  ...
  tag nist: ['AC-4 (17)']
  tag control: 'AC-4 (17)'
  tag objective: 'AC-04(17)'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{}
  tag control_ac_4_17: true
  tag odp: %w{ac_04_17_odp}

  describe 'NIST SP 800-53A Rev 5 objective AC-04(17)' do
