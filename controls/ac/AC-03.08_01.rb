control 'AC-03(08)[01]' do
  impact 0.5
  title "revocation of access authorizations is enforced, resulting from changes to the security attributes of subjects based on #{input('ac_03_08_odp')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      revocation of access authorizations is enforced, resulting from changes to the security attributes of subjects based on #{input('ac_03_08_odp')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-03(08)[01]' do
