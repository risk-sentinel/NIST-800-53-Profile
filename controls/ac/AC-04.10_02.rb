control 'AC-04(10)[02]' do
  impact 0.5
  title "capability is provided for privileged administrators to enable and disable #{input('ac_04_10_odp_02')} under #{input('ac_04_10_odp_04')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      capability is provided for privileged administrators to enable and disable #{input('ac_04_10_odp_02')} under #{input('ac_04_10_odp_04')}.
  ...
  tag nist: ['AC-4 (10)']
  tag control: 'AC-4 (10)'
  tag objective: 'AC-04(10)[02]'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{}
  tag control_ac_4_10: true
  tag odp: %w{ac_04_10_odp_02 ac_04_10_odp_04 ac_4_10_prm_1 ac_4_10_prm_2}

  describe 'NIST SP 800-53A Rev 5 objective AC-04(10)[02]' do
