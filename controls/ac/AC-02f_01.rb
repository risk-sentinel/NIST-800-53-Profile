control 'AC-02f.[01]' do
  impact 0.5
  title "accounts are created in accordance with #{input('ac_02_odp_04')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      accounts are created in accordance with #{input('ac_02_odp_04')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-02f.[01]' do
