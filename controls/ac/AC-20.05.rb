control 'AC-20(05)' do
  impact 0.5
  title "the use of organization-controlled portable storage devices by authorized individuals is prohibited on external systems."
  desc <<~DESC
  ...
  tag nist: ['AC-20 (5)']
  tag control: 'AC-20 (5)'
  tag objective: 'AC-20(05)'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{}
  tag control_ac_20_5: true

  describe 'NIST SP 800-53A Rev 5 objective AC-20(05)' do
