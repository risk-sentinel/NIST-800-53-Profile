control 'AC-21b.' do
  impact 0.5
  title "#{input('ac_21_odp_02')} are employed to assist users in making information-sharing and collaboration decisions."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('ac_21_odp_02')} are employed to assist users in making information-sharing and collaboration decisions.
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-21b.' do
