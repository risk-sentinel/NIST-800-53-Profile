control 'AC-12(02)' do
  impact 0.5
  title "an explicit logout message is displayed to users indicating the termination of authenticated communication sessions."
  desc <<~DESC
  ...
  tag nist: ['AC-12 (2)']
  tag control: 'AC-12 (2)'
  tag objective: 'AC-12(02)'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{}
  tag control_ac_12_2: true

  describe 'NIST SP 800-53A Rev 5 objective AC-12(02)' do
