control 'AC-08a.03' do
  impact 0.5
  title "the system use notification states that unauthorized use of the system is prohibited and subject to criminal and civil penalties; and"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-08a.03' do
