control 'AC-04(15)[02]' do
  impact 0.5
  title "when transferring information between different security domains, transfer of #{input('ac_04_15_odp_01')} is prohibited in accordance with the #{input('ac_04_15_odp_02')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      when transferring information between different security domains, transfer of #{input('ac_04_15_odp_01')} is prohibited in accordance with the #{input('ac_04_15_odp_02')};
  ...
  tag nist: ['AC-4 (15)']
  tag control: 'AC-4 (15)'
  tag objective: 'AC-04(15)[02]'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{}
  tag control_ac_4_15: true
  tag odp: %w{ac_04_15_odp_01 ac_04_15_odp_02 ac_4_15_prm_2}

  describe 'NIST SP 800-53A Rev 5 objective AC-04(15)[02]' do
