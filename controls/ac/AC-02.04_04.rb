control 'AC-02(04)[04]' do
  impact 0.5
  title "account disabling is automatically audited;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-02(04)[04]' do
