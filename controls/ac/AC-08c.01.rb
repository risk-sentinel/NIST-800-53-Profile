control 'AC-08c.01' do
  impact 0.5
  title "for publicly accessible systems, system use information #{input('ac_08_odp_02')} is displayed before granting further access to the publicly accessible system;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      for publicly accessible systems, system use information #{input('ac_08_odp_02')} is displayed before granting further access to the publicly accessible system;
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-08c.01' do
