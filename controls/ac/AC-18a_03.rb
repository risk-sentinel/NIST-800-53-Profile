control 'AC-18a.[03]' do
  impact 0.5
  title "implementation guidance is established for each type of wireless access;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-18a.[03]' do
