control 'AC-02(08)[03]' do
  impact 0.5
  title "#{input('ac_02_08_odp')} are managed dynamically;"
  desc <<~DESC
    Create, activate, manage, and deactivate #{input('ac_02_08_odp')} dynamically.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      #{input('ac_02_08_odp')} are managed dynamically;
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-02(08)[03]' do
