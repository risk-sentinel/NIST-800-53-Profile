control 'AC-19(04)(b)(03)' do
  impact 0.5
  title "prohibition of the use of internal or external modems or wireless interfaces within unclassified mobile devices is enforced on individuals permitted by an authorizing official to use unclassified mobile devices in facilities containing systems processing, storing, or transmitting classified information;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-19(04)(b)(03)' do
