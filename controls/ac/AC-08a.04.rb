control 'AC-08a.04' do
  impact 0.5
  title "the system use notification states that use of the system indicates consent to monitoring and recording;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-08a.04' do
