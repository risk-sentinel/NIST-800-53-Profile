control 'AC-03(15)(b)[02]' do
  impact 0.5
  title "#{input('ac_03_15_odp_04')} is enforced over the set of covered objects specified in the policy."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('ac_03_15_odp_04')} is enforced over the set of covered objects specified in the policy.
  ...
  tag nist: ['AC-3 (15)']
  tag control: 'AC-3 (15)'
  tag objective: 'AC-03(15)(b)[02]'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{}
  tag control_ac_3_15: true
  tag odp: %w{ac_03_15_odp_04 ac_3_15_prm_1 ac_3_15_prm_2}

  describe 'NIST SP 800-53A Rev 5 objective AC-03(15)(b)[02]' do
