control 'AC-07(04)(a)' do
  impact 0.5
  title "#{input('ac_07_04_odp_01')} that are different from the primary authentication factors are allowed to be used after the number of organization-defined consecutive invalid logon attempts have been exceeded;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('ac_07_04_odp_01')} that are different from the primary authentication factors are allowed to be used after the number of organization-defined consecutive invalid logon attempts have been exceeded;
  ...
  tag nist: ['AC-7 (4)']
  tag control: 'AC-7 (4)'
  tag objective: 'AC-07(04)(a)'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{}
  tag control_ac_7_4: true
  tag odp: %w{ac_07_04_odp_01 ac_07_04_odp_02 ac_07_04_odp_03}

  describe 'NIST SP 800-53A Rev 5 objective AC-07(04)(a)' do
