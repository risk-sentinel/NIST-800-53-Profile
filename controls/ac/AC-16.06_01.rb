control 'AC-16(06)[01]' do
  impact 0.5
  title "personnel are required to associate and maintain the association of #{input('ac_16_06_odp_01')} with #{input('ac_16_06_odp_05')} in accordance with #{input('ac_16_06_odp_09')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      personnel are required to associate and maintain the association of #{input('ac_16_06_odp_01')} with #{input('ac_16_06_odp_05')} in accordance with #{input('ac_16_06_odp_09')};
  ...
  tag nist: ['AC-16 (6)']
  tag control: 'AC-16 (6)'
  tag objective: 'AC-16(06)[01]'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{}
  tag control_ac_16_6: true
  tag odp: %w{ac_16_06_odp_01 ac_16_06_odp_05 ac_16_06_odp_09 ac_16_6_prm_1 ac_16_6_prm_2 ac_16_6_prm_3}

  describe 'NIST SP 800-53A Rev 5 objective AC-16(06)[01]' do
