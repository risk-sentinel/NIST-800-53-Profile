control 'AC-02a.[02]' do
  impact 0.5
  title "account types specifically prohibited for use within the system are defined and documented;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-02a.[02]' do
