control 'AC-17(10)' do
  impact 0.5
  title "#{input('ac_17_10_odp_01')} are implemented to authenticate #{input('ac_17_10_odp_02')}."
  desc <<~DESC
    Implement #{input('ac_17_10_odp_01')} to authenticate #{input('ac_17_10_odp_02')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      #{input('ac_17_10_odp_01')} are implemented to authenticate #{input('ac_17_10_odp_02')}.
  ...
  GUIDANCE
  tag nist: ['AC-17 (10)']
  tag control: 'AC-17 (10)'
  tag objective: 'AC-17(10)'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{}
  tag control_ac_17_10: true
  tag odp: %w{ac_17_10_odp_01 ac_17_10_odp_02}

  describe 'NIST SP 800-53A Rev 5 objective AC-17(10)' do
