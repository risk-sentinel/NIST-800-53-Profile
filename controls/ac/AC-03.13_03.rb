control 'AC-03(13)[03]' do
  impact 0.5
  title "access is controlled based on #{input('ac_03_13_odp')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      access is controlled based on #{input('ac_03_13_odp')}.
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-03(13)[03]' do
