control 'AC-22a.' do
  impact 0.5
  title "designated individuals are authorized to make information publicly accessible;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-22a.' do
