control 'AC-19(04)(b)(04)[01]' do
  impact 0.5
  title "random review and inspection of unclassified mobile devices and the information stored on those devices by #{input('ac_19_04_odp_01')} are enforced;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      random review and inspection of unclassified mobile devices and the information stored on those devices by #{input('ac_19_04_odp_01')} are enforced;
  ...
  tag nist: ['AC-19 (4)']
  tag control: 'AC-19 (4)'
  tag objective: 'AC-19(04)(b)(04)[01]'
  tag rev: 'Rev_5'
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-19(04)(b)(04)[01]' do
