control 'AC-03(03)(a)[01]' do
  impact 0.5
  title "#{input('ac_03_03_odp_01')} is uniformly enforced across the covered subjects within the system;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('ac_03_03_odp_01')} is uniformly enforced across the covered subjects within the system;
  ...
  tag nist: ['AC-3 (3)']
  tag control: 'AC-3 (3)'
  tag objective: 'AC-03(03)(a)[01]'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{}
  tag control_ac_3_3: true
  tag odp: %w{ac_03_03_odp_01 ac_03_03_odp_03 ac_03_03_odp_04 ac_3_3_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective AC-03(03)(a)[01]' do
