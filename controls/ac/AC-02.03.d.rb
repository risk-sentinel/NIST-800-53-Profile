control 'AC-02(03)(d)' do
  impact 0.5
  title "accounts are disabled within #{input('ac_02_03_odp_01')} when the accounts have been inactive for #{input('ac_02_03_odp_02')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      accounts are disabled within #{input('ac_02_03_odp_01')} when the accounts have been inactive for #{input('ac_02_03_odp_02')}.
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-02(03)(d)' do
