control 'AC-03(04)[01]' do
  impact 0.5
  title "#{input('ac_03_04_odp_01')} is enforced over the set of covered subjects specified in the policy;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('ac_03_04_odp_01')} is enforced over the set of covered subjects specified in the policy;
  ...
  tag nist: ['AC-3 (4)']
  tag control: 'AC-3 (4)'
  tag objective: 'AC-03(04)[01]'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{}
  tag control_ac_3_4: true
  tag odp: %w{ac_03_04_odp_01 ac_3_4_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective AC-03(04)[01]' do
