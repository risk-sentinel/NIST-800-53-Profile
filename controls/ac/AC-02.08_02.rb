control 'AC-02(08)[02]' do
  impact 0.5
  title "#{input('ac_02_08_odp')} are activated dynamically;"
  desc <<~DESC
    Create, activate, manage, and deactivate #{input('ac_02_08_odp')} dynamically.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      #{input('ac_02_08_odp')} are activated dynamically;
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-02(08)[02]' do
