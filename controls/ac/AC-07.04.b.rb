control 'AC-07(04)(b)' do
  impact 0.5
  title "a limit of #{input('ac_07_04_odp_02')} consecutive invalid logon attempts through the use of the alternative factors by the user during a #{input('ac_07_04_odp_03')} is enforced."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      a limit of #{input('ac_07_04_odp_02')} consecutive invalid logon attempts through the use of the alternative factors by the user during a #{input('ac_07_04_odp_03')} is enforced.
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-07(04)(b)' do
