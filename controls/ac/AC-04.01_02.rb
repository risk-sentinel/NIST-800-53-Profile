control 'AC-04(01)[02]' do
  impact 0.5
  title "#{input('ac_04_01_odp_02')} associated with #{input('ac_04_01_odp_04')}, #{input('ac_04_01_odp_06')} , and #{input('ac_04_01_odp_08')} are used to enforce #{input('ac_04_01_odp_09')} as a basis for flow control decisions."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('ac_04_01_odp_02')} associated with #{input('ac_04_01_odp_04')}, #{input('ac_04_01_odp_06')} , and #{input('ac_04_01_odp_08')} are used to enforce #{input('ac_04_01_odp_09')} as a basis for flow control decisions.
  ...
  tag nist: ['AC-4 (1)']
  tag control: 'AC-4 (1)'
  tag objective: 'AC-04(01)[02]'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{}
  tag control_ac_4_1: true
  tag odp: %w{ac_04_01_odp_02 ac_04_01_odp_04 ac_04_01_odp_06 ac_04_01_odp_08 ac_04_01_odp_09 ac_4_1_prm_1 ac_4_1_prm_2}

  describe 'NIST SP 800-53A Rev 5 objective AC-04(01)[02]' do
