control 'AC-03(12)(c)' do
  impact 0.5
  title "access changes after initial installation of the application are approved."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-03(12)(c)' do
