control 'AC-22c.' do
  impact 0.5
  title "the proposed content of information is reviewed prior to posting onto the publicly accessible system to ensure that non-public information is not included;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-22c.' do
