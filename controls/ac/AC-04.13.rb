control 'AC-04(13)' do
  impact 0.5
  title "when transferring information between different security domains, information is decomposed into #{input('ac_04_13_odp')} for submission to policy enforcement mechanisms."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      when transferring information between different security domains, information is decomposed into #{input('ac_04_13_odp')} for submission to policy enforcement mechanisms.
  ...
  tag nist: ['AC-4 (13)']
  tag control: 'AC-4 (13)'
  tag objective: 'AC-04(13)'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{}
  tag control_ac_4_13: true
  tag odp: %w{ac_04_13_odp}

  describe 'NIST SP 800-53A Rev 5 objective AC-04(13)' do
