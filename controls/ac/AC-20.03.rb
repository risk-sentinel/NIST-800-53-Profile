control 'AC-20(03)' do
  impact 0.5
  title "the use of non-organizationally owned systems or system components to process, store, or transmit organizational information is restricted using #{input('ac_20_03_odp')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the use of non-organizationally owned systems or system components to process, store, or transmit organizational information is restricted using #{input('ac_20_03_odp')}.
  ...
  tag nist: ['AC-20 (3)']
  tag control: 'AC-20 (3)'
  tag objective: 'AC-20(03)'
  tag rev: 'Rev_5'
  tag family: 'Access Control'
  tag baseline: %w{}
  tag control_ac_20_3: true
  tag odp: %w{ac_20_03_odp}

  describe 'NIST SP 800-53A Rev 5 objective AC-20(03)' do
