control 'AC-08c.03' do
  impact 0.5
  title "for publicly accessible systems, a description of the authorized uses of the system is included."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective AC-08c.03' do
