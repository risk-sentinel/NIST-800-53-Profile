control 'IA-3 (3)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      IA-03(03)(a)
        IA-03(03)(a)[01] dynamic address allocation lease information assigned to devices where addresses are allocated dynamically are standardized in accordance with #{input('ia_03_03_odp_01')};
        IA-03(03)(a)[02] dynamic address allocation lease duration assigned to devices where addresses are allocated dynamically are standardized in accordance with #{input('ia_03_03_odp_02')};
  ...
  tag baseline: %w{}
  tag odp: %w{ia_03_03_odp_01 ia_03_03_odp_02 ia_3_3_prm_1}

  describe 'NIST SP 800-53 Rev 5 control IA-3 (3)' do
