control 'SR-3 (1)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SR-03(01)[01] a diverse set of sources is employed for #{input('sr_03_01_odp_01')};
      SR-03(01)[02] a diverse set of sources is employed for #{input('sr_03_01_odp_02')}.
  ...
  tag baseline: %w{}
  tag odp: %w{sr_03_01_odp_01 sr_03_01_odp_02 sr_3_1_prm_1}

  describe 'NIST SP 800-53 Rev 5 control SR-3 (1)' do
