control 'PM-30' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      ...
      PM-30c. the supply chain risk management strategy is reviewed and updated #{input('pm_30_odp')} or as required to address organizational changes.
  ...
  describe 'NIST SP 800-53 Rev 5 control PM-30' do
