control 'AC-20' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      AC-20a.
        AC-20a.01 #{input('ac_20_odp_01')} is/are consistent with the trust relationships established with other organizations owning, operating, and/or maintaining external systems, allowing authorized individuals to access the system from external systems (if applicable);
        AC-20a.02 #{input('ac_20_odp_01')} is/are consistent with the trust relationships established with other organizations owning, operating, and/or maintaining external systems, allowing authorized individuals to process, store, or transmit organization-controlled information using external systems (if applicable);
      AC-20b. the use of #{input('ac_20_odp_04')} is prohibited (if applicable).
  ...
  describe 'NIST SP 800-53 Rev 5 control AC-20' do
