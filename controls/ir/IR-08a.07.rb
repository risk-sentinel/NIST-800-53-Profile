control 'IR-08a.07' do
  impact 0.5
  title "an incident response plan is developed that defines the resources and management support needed to effectively maintain and mature an incident response capability;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective IR-08a.07' do
