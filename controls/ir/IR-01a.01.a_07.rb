control 'IR-01a.01(a)[07]' do
  impact 0.5
  title "the #{input('ir_01_odp_03')} incident response policy addresses compliance;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the #{input('ir_01_odp_03')} incident response policy addresses compliance;
  ...
  describe 'NIST SP 800-53A Rev 5 objective IR-01a.01(a)[07]' do
