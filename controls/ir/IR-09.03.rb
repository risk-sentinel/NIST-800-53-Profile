control 'IR-09(03)' do
  impact 0.5
  title "#{input('ir_09_03_odp')} are implemented to ensure that organizational personnel impacted by information spills can continue to carry out assigned tasks while contaminated systems are undergoing corrective actions."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('ir_09_03_odp')} are implemented to ensure that organizational personnel impacted by information spills can continue to carry out assigned tasks while contaminated systems are undergoing corrective actions.
  ...
  tag nist: ['IR-9 (3)']
  tag control: 'IR-9 (3)'
  tag objective: 'IR-09(03)'
  tag rev: 'Rev_5'
  tag family: 'Incident Response'
  tag baseline: %w{}
  tag control_ir_9_3: true
  tag odp: %w{ir_09_03_odp}

  describe 'NIST SP 800-53A Rev 5 objective IR-09(03)' do
