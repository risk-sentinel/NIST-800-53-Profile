control 'IR-08(01)(a)' do
  impact 0.5
  title "the incident response plan for breaches involving personally identifiable information includes a process to determine if notice to individuals or other organizations, including oversight organizations, is needed;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective IR-08(01)(a)' do
