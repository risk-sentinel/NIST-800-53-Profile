control 'IR-04(04)' do
  impact 0.5
  title "incident information and individual incident responses are correlated to achieve an organization-wide perspective on incident awareness and response."
  desc <<~DESC
  ...
  tag nist: ['IR-4 (4)']
  tag control: 'IR-4 (4)'
  tag objective: 'IR-04(04)'
  tag rev: 'Rev_5'
  tag family: 'Incident Response'
  tag baseline: %w{HIGH}
  tag baseline_high: true
  tag control_ir_4_4: true

  describe 'NIST SP 800-53A Rev 5 objective IR-04(04)' do
