control 'IR-04b.' do
  impact 0.5
  title "incident handling activities are coordinated with contingency planning activities;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective IR-04b.' do
