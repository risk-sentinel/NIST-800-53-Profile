control 'IR-08a.09' do
  impact 0.5
  title "an incident response plan is developed that is reviewed and approved by #{input('ir_08_odp_01')} #{input('ir_08_odp_02')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      an incident response plan is developed that is reviewed and approved by #{input('ir_08_odp_01')} #{input('ir_08_odp_02')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective IR-08a.09' do
