control 'IR-08a.08' do
  impact 0.5
  title "an incident response plan is developed that addresses the sharing of incident information;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective IR-08a.08' do
