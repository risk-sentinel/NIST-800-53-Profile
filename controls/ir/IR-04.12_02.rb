control 'IR-04(12)[02]' do
  impact 0.5
  title "other residual artifacts remaining in the system (if any) are analyzed after the incident."
  desc <<~DESC
  ...
  tag nist: ['IR-4 (12)']
  tag control: 'IR-4 (12)'
  tag objective: 'IR-04(12)[02]'
  tag rev: 'Rev_5'
  tag family: 'Incident Response'
  tag baseline: %w{}
  tag control_ir_4_12: true

  describe 'NIST SP 800-53A Rev 5 objective IR-04(12)[02]' do
