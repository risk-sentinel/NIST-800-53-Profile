control 'IR-02(03)[01]' do
  impact 0.5
  title "incident response training on how to identify and respond to a breach is provided;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective IR-02(03)[01]' do
