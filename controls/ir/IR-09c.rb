control 'IR-09c.' do
  impact 0.5
  title "#{input('ir_09_odp_02')} is/are alerted of the information spill using a method of communication not associated with the spill;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('ir_09_odp_02')} is/are alerted of the information spill using a method of communication not associated with the spill;
  ...
  describe 'NIST SP 800-53A Rev 5 objective IR-09c.' do
