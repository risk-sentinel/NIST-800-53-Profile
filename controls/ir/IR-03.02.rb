control 'IR-03(02)' do
  impact 0.5
  title "incident response testing is coordinated with organizational elements responsible for related plans."
  desc <<~DESC
  ...
  tag nist: ['IR-3 (2)']
  tag control: 'IR-3 (2)'
  tag objective: 'IR-03(02)'
  tag rev: 'Rev_5'
  tag family: 'Incident Response'
  tag baseline: %w{MODERATE HIGH}
  tag baseline_moderate: true
  tag baseline_high: true
  tag control_ir_3_2: true

  describe 'NIST SP 800-53A Rev 5 objective IR-03(02)' do
