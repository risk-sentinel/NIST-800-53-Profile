control 'IR-04(11)[02]' do
  impact 0.5
  title "the integrated incident response team can be deployed to any location identified by the organization in #{input('ir_04_11_odp')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the integrated incident response team can be deployed to any location identified by the organization in #{input('ir_04_11_odp')}.
  ...
  describe 'NIST SP 800-53A Rev 5 objective IR-04(11)[02]' do
