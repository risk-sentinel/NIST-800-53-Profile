control 'IR-08a.10' do
  impact 0.5
  title "an incident response plan is developed that explicitly designates responsibility for incident response to #{input('ir_08_odp_03')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      an incident response plan is developed that explicitly designates responsibility for incident response to #{input('ir_08_odp_03')}.
  ...
  describe 'NIST SP 800-53A Rev 5 objective IR-08a.10' do
