control 'IR-02a.01' do
  impact 0.5
  title "incident response training is provided to system users consistent with assigned roles and responsibilities within #{input('ir_02_odp_01')} of assuming an incident response role or responsibility or acquiring system access;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      incident response training is provided to system users consistent with assigned roles and responsibilities within #{input('ir_02_odp_01')} of assuming an incident response role or responsibility or acquiring system access;
  ...
  describe 'NIST SP 800-53A Rev 5 objective IR-02a.01' do
