control 'IR-07(02)(a)' do
  impact 0.5
  title "a direct, cooperative relationship is established between its incident response capability and external providers of the system protection capability;"
  desc <<~DESC
  ...
  tag nist: ['IR-7 (2)']
  tag control: 'IR-7 (2)'
  tag objective: 'IR-07(02)(a)'
  tag rev: 'Rev_5'
  tag family: 'Incident Response'
  tag baseline: %w{}
  tag control_ir_7_2: true

  describe 'NIST SP 800-53A Rev 5 objective IR-07(02)(a)' do
