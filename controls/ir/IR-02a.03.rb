control 'IR-02a.03' do
  impact 0.5
  title "incident response training is provided to system users consistent with assigned roles and responsibilities #{input('ir_02_odp_02')} thereafter;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      incident response training is provided to system users consistent with assigned roles and responsibilities #{input('ir_02_odp_02')} thereafter;
  ...
  describe 'NIST SP 800-53A Rev 5 objective IR-02a.03' do
