control 'IR-01a.[04]' do
  impact 0.5
  title "the incident response procedures are disseminated to #{input('ir_01_odp_02')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the incident response procedures are disseminated to #{input('ir_01_odp_02')};
  ...
  tag odp: %w{ir_01_odp_02 ir_01_odp_03 ir_01_odp_04 ir_01_odp_05 ir_01_odp_06 ir_01_odp_07 ir_01_odp_08 ir_1_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective IR-01a.[04]' do
