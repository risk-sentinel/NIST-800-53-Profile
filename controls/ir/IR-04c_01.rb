control 'IR-04c.[01]' do
  impact 0.5
  title "lessons learned from ongoing incident handling activities are incorporated into incident response procedures, training, and testing;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective IR-04c.[01]' do
