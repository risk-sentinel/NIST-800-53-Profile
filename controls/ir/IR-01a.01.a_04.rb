control 'IR-01a.01(a)[04]' do
  impact 0.5
  title "the #{input('ir_01_odp_03')} incident response policy addresses responsibilities;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the #{input('ir_01_odp_03')} incident response policy addresses responsibilities;
  ...
  describe 'NIST SP 800-53A Rev 5 objective IR-01a.01(a)[04]' do
