control 'IR-04d.[03]' do
  impact 0.5
  title "the scope of incident handling activities is comparable and predictable across the organization;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective IR-04d.[03]' do
