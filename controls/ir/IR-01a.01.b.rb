control 'IR-01a.01(b)' do
  impact 0.5
  title "the #{input('ir_01_odp_03')} incident response policy is consistent with applicable laws, Executive Orders, directives, regulations, policies, standards, and guidelines;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the #{input('ir_01_odp_03')} incident response policy is consistent with applicable laws, Executive Orders, directives, regulations, policies, standards, and guidelines;
  ...
  describe 'NIST SP 800-53A Rev 5 objective IR-01a.01(b)' do
