control 'IR-09b.' do
  impact 0.5
  title "the specific information involved in the system contamination is identified in response to information spills;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective IR-09b.' do
