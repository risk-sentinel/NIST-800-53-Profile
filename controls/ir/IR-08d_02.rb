control 'IR-08d.[02]' do
  impact 0.5
  title "incident response plan changes are communicated to #{input('ir_08_odp_07')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      incident response plan changes are communicated to #{input('ir_08_odp_07')};
  ...
  tag odp: %w{ir_08_odp_01 ir_08_odp_02 ir_08_odp_03 ir_08_odp_04 ir_08_odp_07 ir_8_prm_5}

  describe 'NIST SP 800-53A Rev 5 objective IR-08d.[02]' do
