control 'IR-09d.' do
  impact 0.5
  title "the contaminated system or system component is isolated in response to information spills;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective IR-09d.' do
