control 'IR-04(03)[01]' do
  impact 0.5
  title "#{input('ir_04_03_odp_01')} are identified;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('ir_04_03_odp_01')} are identified;
  ...
  describe 'NIST SP 800-53A Rev 5 objective IR-04(03)[01]' do
