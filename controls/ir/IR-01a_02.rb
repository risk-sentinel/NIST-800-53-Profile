control 'IR-01a.[02]' do
  impact 0.5
  title "the incident response policy is disseminated to #{input('ir_01_odp_01')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the incident response policy is disseminated to #{input('ir_01_odp_01')};
  ...
  tag odp: %w{ir_01_odp_01 ir_01_odp_03 ir_01_odp_04 ir_01_odp_05 ir_01_odp_06 ir_01_odp_07 ir_01_odp_08 ir_1_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective IR-01a.[02]' do
