control 'IR-06b.' do
  impact 0.5
  title "incident information is reported to #{input('ir_06_odp_02')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      incident information is reported to #{input('ir_06_odp_02')}.
  ...
  describe 'NIST SP 800-53A Rev 5 objective IR-06b.' do
