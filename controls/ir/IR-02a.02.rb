control 'IR-02a.02' do
  impact 0.5
  title "incident response training is provided to system users consistent with assigned roles and responsibilities when required by system changes;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective IR-02a.02' do
