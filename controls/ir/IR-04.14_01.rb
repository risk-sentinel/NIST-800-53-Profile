control 'IR-04(14)[01]' do
  impact 0.5
  title "a security operations center is established;"
  desc <<~DESC
  ...
  tag nist: ['IR-4 (14)']
  tag control: 'IR-4 (14)'
  tag objective: 'IR-04(14)[01]'
  tag rev: 'Rev_5'
  tag family: 'Incident Response'
  tag baseline: %w{}
  tag control_ir_4_14: true

  describe 'NIST SP 800-53A Rev 5 objective IR-04(14)[01]' do
