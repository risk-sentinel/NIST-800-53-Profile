control 'IR-04d.[04]' do
  impact 0.5
  title "the results of incident handling activities are comparable and predictable across the organization."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective IR-04d.[04]' do
