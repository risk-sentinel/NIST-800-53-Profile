control 'IR-04(02)' do
  impact 0.5
  title "#{input('ir_04_02_odp_01')} for #{input('ir_04_02_odp_02')} are included as part of the incident response capability."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('ir_04_02_odp_01')} for #{input('ir_04_02_odp_02')} are included as part of the incident response capability.
  ...
  tag nist: ['IR-4 (2)']
  tag control: 'IR-4 (2)'
  tag objective: 'IR-04(02)'
  tag rev: 'Rev_5'
  tag family: 'Incident Response'
  tag baseline: %w{}
  tag control_ir_4_2: true
  tag odp: %w{ir_04_02_odp_01 ir_04_02_odp_02}

  describe 'NIST SP 800-53A Rev 5 objective IR-04(02)' do
