control 'IR-01c.02[02]' do
  impact 0.5
  title "the current incident response procedures are reviewed and updated following #{input('ir_01_odp_08')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the current incident response procedures are reviewed and updated following #{input('ir_01_odp_08')}.
  ...
  describe 'NIST SP 800-53A Rev 5 objective IR-01c.02[02]' do
