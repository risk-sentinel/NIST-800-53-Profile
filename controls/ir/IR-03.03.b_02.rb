control 'IR-03(03)(b)[02]' do
  impact 0.5
  title "quantitative data from testing are used to continuously improve incident response processes;"
  desc <<~DESC
  ...
  tag nist: ['IR-3 (3)']
  tag control: 'IR-3 (3)'
  tag objective: 'IR-03(03)(b)[02]'
  tag rev: 'Rev_5'
  tag family: 'Incident Response'
  tag baseline: %w{}
  tag control_ir_3_3: true

  describe 'NIST SP 800-53A Rev 5 objective IR-03(03)(b)[02]' do
