control 'IR-09f.' do
  impact 0.5
  title "other systems or system components that may have been subsequently contaminated are identified in response to information spills;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective IR-09f.' do
