control 'IR-09g.' do
  impact 0.5
  title "#{input('ir_09_odp_03')} are performed in response to information spills."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('ir_09_odp_03')} are performed in response to information spills.
  ...
  describe 'NIST SP 800-53A Rev 5 objective IR-09g.' do
