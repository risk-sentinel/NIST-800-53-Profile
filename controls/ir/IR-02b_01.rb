control 'IR-02b.[01]' do
  impact 0.5
  title "incident response training content is reviewed and updated #{input('ir_02_odp_03')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      incident response training content is reviewed and updated #{input('ir_02_odp_03')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective IR-02b.[01]' do
