control 'IR-04(07)[02]' do
  impact 0.5
  title "the coordinated incident handling capability includes #{input('ir_04_07_odp')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the coordinated incident handling capability includes #{input('ir_04_07_odp')}.
  ...
  describe 'NIST SP 800-53A Rev 5 objective IR-04(07)[02]' do
