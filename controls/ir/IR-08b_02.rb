control 'IR-08b.[02]' do
  impact 0.5
  title "copies of the incident response plan are distributed to #{input('ir_08_odp_05')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      copies of the incident response plan are distributed to #{input('ir_08_odp_05')};
  ...
  tag odp: %w{ir_08_odp_01 ir_08_odp_02 ir_08_odp_03 ir_08_odp_04 ir_08_odp_05 ir_8_prm_5}

  describe 'NIST SP 800-53A Rev 5 objective IR-08b.[02]' do
