control 'IR-08a.05' do
  impact 0.5
  title "an incident response plan is developed that defines reportable incidents;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective IR-08a.05' do
