control 'IR-04(15)(a)' do
  impact 0.5
  title "public relations associated with an incident are managed;"
  desc <<~DESC
  ...
  tag nist: ['IR-4 (15)']
  tag control: 'IR-4 (15)'
  tag objective: 'IR-04(15)(a)'
  tag rev: 'Rev_5'
  tag family: 'Incident Response'
  tag baseline: %w{}
  tag control_ir_4_15: true

  describe 'NIST SP 800-53A Rev 5 objective IR-04(15)(a)' do
