control 'IR-04a.[06]' do
  impact 0.5
  title "the incident handling capability for incidents includes recovery;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective IR-04a.[06]' do
