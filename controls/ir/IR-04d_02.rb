control 'IR-04d.[02]' do
  impact 0.5
  title "the intensity of incident handling activities is comparable and predictable across the organization;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective IR-04d.[02]' do
