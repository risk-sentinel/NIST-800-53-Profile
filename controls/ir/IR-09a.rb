control 'IR-09a.' do
  impact 0.5
  title "#{input('ir_09_odp_01')} is/are assigned the responsibility to respond to information spills;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('ir_09_odp_01')} is/are assigned the responsibility to respond to information spills;
  ...
  describe 'NIST SP 800-53A Rev 5 objective IR-09a.' do
