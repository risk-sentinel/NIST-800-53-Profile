control 'IR-04a.[01]' do
  impact 0.5
  title "an incident handling capability for incidents is implemented that is consistent with the incident response plan;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective IR-04a.[01]' do
