control 'IR-03' do
  impact 0.5
  title "the effectiveness of the incident response capability for the system is tested #{input('ir_03_odp_01')} using #{input('ir_03_odp_02')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the effectiveness of the incident response capability for the system is tested #{input('ir_03_odp_01')} using #{input('ir_03_odp_02')}.
  ...
  tag control_ir_3: true
  tag odp: %w{ir_03_odp_01 ir_03_odp_02}

  describe 'NIST SP 800-53A Rev 5 objective IR-03' do
