control 'IR-08e.[02]' do
  impact 0.5
  title "the incident response plan is protected from unauthorized modification."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective IR-08e.[02]' do
