control 'IR-08a.04' do
  impact 0.5
  title "an incident response plan is developed that meets the unique requirements of the organization with regard to mission, size, structure, and functions;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective IR-08a.04' do
