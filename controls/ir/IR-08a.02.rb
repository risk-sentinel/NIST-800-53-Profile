control 'IR-08a.02' do
  impact 0.5
  title "an incident response plan is developed that describes the structure and organization of the incident response capability;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective IR-08a.02' do
