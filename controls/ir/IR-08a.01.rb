control 'IR-08a.01' do
  impact 0.5
  title "an incident response plan is developed that provides the organization with a roadmap for implementing its incident response capability;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective IR-08a.01' do
