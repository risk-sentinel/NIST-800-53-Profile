control 'IR-08c.' do
  impact 0.5
  title "the incident response plan is updated to address system and organizational changes or problems encountered during plan implementation, execution, or testing;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective IR-08c.' do
