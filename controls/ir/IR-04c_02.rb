control 'IR-04c.[02]' do
  impact 0.5
  title "the changes resulting from the incorporated lessons learned are implemented accordingly;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective IR-04c.[02]' do
