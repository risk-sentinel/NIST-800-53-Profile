control 'PT-5 (1)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      PT-05(01) a notice of personally identifiable information processing is presented to individuals at a time and location where the individual provides personally identifiable information, in conjunction with a data action, or #{input('pt_05_01_odp')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control PT-5 (1)' do
