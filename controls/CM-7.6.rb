control 'CM-7 (6)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      CM-07(06) #{input('cm_07_06_odp')} is required to be executed in a confined physical or virtual machine environment with limited privileges.
  ...
  describe 'NIST SP 800-53 Rev 5 control CM-7 (6)' do
