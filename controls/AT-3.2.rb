control 'AT-3 (2)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      AT-03(02) #{input('at_03_02_odp_01')} is/are provided with initial and refresher training #{input('at_03_02_odp_02')} in the employment and operation of physical security controls.
  ...
  describe 'NIST SP 800-53 Rev 5 control AT-3 (2)' do
