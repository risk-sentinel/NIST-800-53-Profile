control 'PT-6 (2)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      PT-06(02)[01] all Privacy Act exemptions claimed for the system of records are reviewed #{input('pt_06_02_odp')} to ensure that they remain appropriate and necessary in accordance with law;
      PT-06(02)[02] all Privacy Act exemptions claimed for the system of records are reviewed #{input('pt_06_02_odp')} to ensure that they have been promulgated as regulations;
      PT-06(02)[03] all Privacy Act exemptions claimed for the system of records are reviewed #{input('pt_06_02_odp')} to ensure that they are accurately described in the system of records notice.
  ...
  describe 'NIST SP 800-53 Rev 5 control PT-6 (2)' do
