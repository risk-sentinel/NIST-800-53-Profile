control 'CP-8 (4)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      ...
      CP-08(04)(c)
        CP-08(04)(c)[01] evidence of contingency testing by providers is obtained #{input('cp_08_04_odp_01')}.
        CP-08(04)(c)[02] evidence of contingency training by providers is obtained #{input('cp_08_04_odp_02')}.
  ...
  tag odp: %w{cp_08_04_odp_01 cp_08_04_odp_02 cp_8_4_prm_1}

  describe 'NIST SP 800-53 Rev 5 control CP-8 (4)' do
