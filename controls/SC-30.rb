control 'SC-30' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SC-30 #{input('sc_30_odp_01')} are employed for #{input('sc_30_odp_02')} for #{input('sc_30_odp_03')} to confuse and mislead adversaries.
  ...
  describe 'NIST SP 800-53 Rev 5 control SC-30' do
