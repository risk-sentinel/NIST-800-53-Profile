control 'SI-4 (12)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SI-04(12) #{input('si_04_12_odp_01')} is/are alerted using #{input('si_04_12_odp_02')} when #{input('si_04_12_odp_03')} indicate inappropriate or unusual activities with security or privacy implications.
  ...
  describe 'NIST SP 800-53 Rev 5 control SI-4 (12)' do
