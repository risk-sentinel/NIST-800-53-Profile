control 'CA-2' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      ...
      CA-02d.
        CA-02d.[01] controls are assessed in the system and its environment of operation #{input('ca_02_odp_01')} to determine the extent to which the controls are implemented correctly, operating as intended, and producing the desired outcome with respect to meeting established security requirements;
        CA-02d.[02] controls are assessed in the system and its environment of operation #{input('ca_02_odp_01')} to determine the extent to which the controls are implemented correctly, operating as intended, and producing the desired outcome with respect to meeting established privacy requirements;
      CA-02e. a control assessment report is produced that documents the results of the assessment;
      CA-02f. the results of the control assessment are provided to #{input('ca_02_odp_02')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control CA-2' do
