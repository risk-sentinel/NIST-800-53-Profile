control 'IA-10' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      IA-10 individuals accessing the system are required to employ #{input('ia_10_odp_01')} under specific #{input('ia_10_odp_02')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control IA-10' do
