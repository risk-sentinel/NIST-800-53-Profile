control 'SR-11 (2)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SR-11(02)[01] configuration control over #{input('sr_11_02_odp')} awaiting service or repair is maintained;
      SR-11(02)[02] configuration control over serviced or repaired #{input('sr_11_02_odp')} awaiting return to service is maintained.
  ...
  describe 'NIST SP 800-53 Rev 5 control SR-11 (2)' do
