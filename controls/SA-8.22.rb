control 'SA-8 (22)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SA-08(22)[01] #{input('sa_08_22_odp_01')} implement the security design principle of accountability;
      SA-08(22)[02] #{input('sa_08_22_odp_02')} implement the security design principle of traceability.
  ...
  tag baseline: %w{}
  tag odp: %w{sa_08_22_odp_01 sa_08_22_odp_02 sa_8_22_prm_1}

  describe 'NIST SP 800-53 Rev 5 control SA-8 (22)' do
