control 'SI-4 (22)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SI-04(22)(a) network services that have not been authorized or approved by #{input('si_04_22_odp_01')} are detected;
      SI-04(22)(b) #{input('si_04_22_odp_02')} is/are initiated when network services that have not been authorized or approved by authorization or approval processes are detected.
  ...
  describe 'NIST SP 800-53 Rev 5 control SI-4 (22)' do
