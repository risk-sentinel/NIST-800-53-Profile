control 'AC-4 (8)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      AC-04(08)(a)
        AC-04(08)(a)[01] information flow control is enforced using #{input('ac_04_08_odp_01')} as a basis for flow control decisions for #{input('ac_04_08_odp_03')};
        AC-04(08)(a)[02] information flow control is enforced using #{input('ac_04_08_odp_02')} as a basis for flow control decisions for #{input('ac_04_08_odp_04')};
      AC-04(08)(b) #{input('ac_04_08_odp_05')} data after a filter processing failure in accordance with #{input('ac_04_08_odp_06')};

    #{input('ac_04_08_odp_05')} data after a filter processing failure in accordance with #{input('ac_04_08_odp_07')}.
  ...
  tag baseline: %w{}
  tag odp: %w{ac_04_08_odp_01 ac_04_08_odp_02 ac_04_08_odp_03 ac_04_08_odp_04 ac_04_08_odp_05 ac_04_08_odp_06 ac_04_08_odp_07 ac_4_8_prm_1 ac_4_8_prm_2 ac_4_8_prm_4}

  describe 'NIST SP 800-53 Rev 5 control AC-4 (8)' do
