control 'PS-03(02)' do
  impact 0.5
  title "individuals accessing a system processing, storing, or transmitting types of classified information that require formal indoctrination are formally indoctrinated for all of the relevant types of information to which they have access on the system."
  desc <<~DESC
  ...
  tag nist: ['PS-3 (2)']
  tag control: 'PS-3 (2)'
  tag objective: 'PS-03(02)'
  tag rev: 'Rev_5'
  tag family: 'Personnel Security'
  tag baseline: %w{}
  tag control_ps_3_2: true

  describe 'NIST SP 800-53A Rev 5 objective PS-03(02)' do
