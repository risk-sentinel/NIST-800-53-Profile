control 'PS-03(04)' do
  impact 0.5
  title "individuals accessing a system processing, storing, or transmitting #{input('ps_03_04_odp_01')} meet #{input('ps_03_04_odp_02')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      individuals accessing a system processing, storing, or transmitting #{input('ps_03_04_odp_01')} meet #{input('ps_03_04_odp_02')}.
  ...
  tag nist: ['PS-3 (4)']
  tag control: 'PS-3 (4)'
  tag objective: 'PS-03(04)'
  tag rev: 'Rev_5'
  tag family: 'Personnel Security'
  tag baseline: %w{}
  tag control_ps_3_4: true
  tag odp: %w{ps_03_04_odp_01 ps_03_04_odp_02}

  describe 'NIST SP 800-53A Rev 5 objective PS-03(04)' do
