control 'PS-01c.02[02]' do
  impact 0.5
  title "the current personnel security procedures are reviewed and updated following #{input('ps_01_odp_08')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the current personnel security procedures are reviewed and updated following #{input('ps_01_odp_08')}.
  ...
  describe 'NIST SP 800-53A Rev 5 objective PS-01c.02[02]' do
