control 'PS-03(03)(a)' do
  impact 0.5
  title "individuals accessing a system processing, storing, or transmitting information requiring special protection have valid access authorizations that are demonstrated by assigned official government duties;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PS-03(03)(a)' do
