control 'PS-02b.' do
  impact 0.5
  title "screening criteria are established for individuals filling organizational positions;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PS-02b.' do
