control 'PS-06(02)(b)' do
  impact 0.5
  title "access to classified information requiring special protection is granted only to individuals who satisfy associated personnel security criteria;"
  desc <<~DESC
  ...
  tag nist: ['PS-6 (2)']
  tag control: 'PS-6 (2)'
  tag objective: 'PS-06(02)(b)'
  tag rev: 'Rev_5'
  tag family: 'Personnel Security'
  tag baseline: %w{}
  tag control_ps_6_2: true

  describe 'NIST SP 800-53A Rev 5 objective PS-06(02)(b)' do
