control 'PS-05b.' do
  impact 0.5
  title "#{input('ps_05_odp_01')} are initiated within #{input('ps_05_odp_02')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('ps_05_odp_01')} are initiated within #{input('ps_05_odp_02')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective PS-05b.' do
