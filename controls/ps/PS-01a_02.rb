control 'PS-01a.[02]' do
  impact 0.5
  title "the personnel security policy is disseminated to #{input('ps_01_odp_01')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the personnel security policy is disseminated to #{input('ps_01_odp_01')};
  ...
  tag odp: %w{ps_01_odp_01 ps_01_odp_03 ps_01_odp_04 ps_01_odp_05 ps_01_odp_06 ps_01_odp_07 ps_01_odp_08 ps_1_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective PS-01a.[02]' do
