control 'PS-01a.[04]' do
  impact 0.5
  title "the personnel security procedures are disseminated to #{input('ps_01_odp_02')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the personnel security procedures are disseminated to #{input('ps_01_odp_02')};
  ...
  tag odp: %w{ps_01_odp_02 ps_01_odp_03 ps_01_odp_04 ps_01_odp_05 ps_01_odp_06 ps_01_odp_07 ps_01_odp_08 ps_1_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective PS-01a.[04]' do
