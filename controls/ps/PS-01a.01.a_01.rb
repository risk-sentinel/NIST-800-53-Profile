control 'PS-01a.01(a)[01]' do
  impact 0.5
  title "the #{input('ps_01_odp_03')} personnel security policy addresses purpose;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the #{input('ps_01_odp_03')} personnel security policy addresses purpose;
  ...
  describe 'NIST SP 800-53A Rev 5 objective PS-01a.01(a)[01]' do
