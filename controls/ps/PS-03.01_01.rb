control 'PS-03(01)[01]' do
  impact 0.5
  title "individuals accessing a system processing, storing, or transmitting classified information are cleared;"
  desc <<~DESC
  ...
  tag nist: ['PS-3 (1)']
  tag control: 'PS-3 (1)'
  tag objective: 'PS-03(01)[01]'
  tag rev: 'Rev_5'
  tag family: 'Personnel Security'
  tag baseline: %w{}
  tag control_ps_3_1: true

  describe 'NIST SP 800-53A Rev 5 objective PS-03(01)[01]' do
