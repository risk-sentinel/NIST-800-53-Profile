control 'PS-06(03)(b)' do
  impact 0.5
  title "individuals are required to sign an acknowledgement of applicable, legally binding post-employment requirements as part of being granted initial access to covered information."
  desc <<~DESC
  ...
  tag nist: ['PS-6 (3)']
  tag control: 'PS-6 (3)'
  tag objective: 'PS-06(03)(b)'
  tag rev: 'Rev_5'
  tag family: 'Personnel Security'
  tag baseline: %w{}
  tag control_ps_6_3: true

  describe 'NIST SP 800-53A Rev 5 objective PS-06(03)(b)' do
