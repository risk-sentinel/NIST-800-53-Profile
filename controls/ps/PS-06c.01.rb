control 'PS-06c.01' do
  impact 0.5
  title "individuals requiring access to organizational information and systems sign appropriate access agreements prior to being granted access;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PS-06c.01' do
