control 'PS-08b.' do
  impact 0.5
  title "#{input('ps_08_odp_01')} is/are notified within #{input('ps_08_odp_02')} when a formal employee sanctions process is initiated, identifying the individual sanctioned and the reason for the sanction."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('ps_08_odp_01')} is/are notified within #{input('ps_08_odp_02')} when a formal employee sanctions process is initiated, identifying the individual sanctioned and the reason for the sanction.
  ...
  tag control_ps_8: true
  tag odp: %w{ps_08_odp_01 ps_08_odp_02}

  describe 'NIST SP 800-53A Rev 5 objective PS-08b.' do
