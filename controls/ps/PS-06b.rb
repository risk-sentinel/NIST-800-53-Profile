control 'PS-06b.' do
  impact 0.5
  title "the access agreements are reviewed and updated #{input('ps_06_odp_01')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the access agreements are reviewed and updated #{input('ps_06_odp_01')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective PS-06b.' do
