control 'PS-09[02]' do
  impact 0.5
  title "privacy roles and responsibilities are incorporated into organizational position descriptions."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PS-09[02]' do
