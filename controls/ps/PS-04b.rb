control 'PS-04b.' do
  impact 0.5
  title "upon termination of individual employment, any authenticators and credentials are terminated or revoked;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PS-04b.' do
