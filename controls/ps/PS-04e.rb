control 'PS-04e.' do
  impact 0.5
  title "upon termination of individual employment, access to organizational information and systems formerly controlled by the terminated individual are retained."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PS-04e.' do
