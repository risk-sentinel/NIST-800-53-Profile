control 'PS-04a.' do
  impact 0.5
  title "upon termination of individual employment, system access is disabled within #{input('ps_04_odp_01')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      upon termination of individual employment, system access is disabled within #{input('ps_04_odp_01')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective PS-04a.' do
