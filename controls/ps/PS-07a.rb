control 'PS-07a.' do
  impact 0.5
  title "personnel security requirements are established, including security roles and responsibilities for external providers;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PS-07a.' do
