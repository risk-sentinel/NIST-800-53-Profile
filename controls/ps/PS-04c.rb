control 'PS-04c.' do
  impact 0.5
  title "upon termination of individual employment, exit interviews that include a discussion of #{input('ps_04_odp_02')} are conducted;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      upon termination of individual employment, exit interviews that include a discussion of #{input('ps_04_odp_02')} are conducted;
  ...
  describe 'NIST SP 800-53A Rev 5 objective PS-04c.' do
