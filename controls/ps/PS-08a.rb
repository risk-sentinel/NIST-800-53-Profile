control 'PS-08a.' do
  impact 0.5
  title "a formal sanctions process is employed for individuals failing to comply with established information security and privacy policies and procedures;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PS-08a.' do
