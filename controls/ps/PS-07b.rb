control 'PS-07b.' do
  impact 0.5
  title "external providers are required to comply with personnel security policies and procedures established by the organization;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PS-07b.' do
