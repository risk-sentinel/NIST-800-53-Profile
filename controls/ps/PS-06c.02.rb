control 'PS-06c.02' do
  impact 0.5
  title "individuals requiring access to organizational information and systems re-sign access agreements to maintain access to organizational systems when access agreements have been updated or #{input('ps_06_odp_02')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      individuals requiring access to organizational information and systems re-sign access agreements to maintain access to organizational systems when access agreements have been updated or #{input('ps_06_odp_02')}.
  ...
  tag control_ps_6: true
  tag odp: %w{ps_06_odp_01 ps_06_odp_02}

  describe 'NIST SP 800-53A Rev 5 objective PS-06c.02' do
