control 'PS-04(02)' do
  impact 0.5
  title "#{input('ps_04_02_odp_01')} are used to #{input('ps_04_02_odp_02')}."
  desc <<~DESC
    Use #{input('ps_04_02_odp_01')} to #{input('ps_04_02_odp_02')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      #{input('ps_04_02_odp_01')} are used to #{input('ps_04_02_odp_02')}.
  ...
  tag nist: ['PS-4 (2)']
  tag control: 'PS-4 (2)'
  tag objective: 'PS-04(02)'
  tag rev: 'Rev_5'
  tag family: 'Personnel Security'
  tag baseline: %w{HIGH}
  tag baseline_high: true
  tag control_ps_4_2: true
  tag odp: %w{ps_04_02_odp_01 ps_04_02_odp_02}

  describe 'NIST SP 800-53A Rev 5 objective PS-04(02)' do
