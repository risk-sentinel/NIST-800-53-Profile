control 'PS-05d.' do
  impact 0.5
  title "#{input('ps_05_odp_03')} are notified within #{input('ps_05_odp_04')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('ps_05_odp_03')} are notified within #{input('ps_05_odp_04')}.
  ...
  describe 'NIST SP 800-53A Rev 5 objective PS-05d.' do
