control 'PS-04(01)(b)' do
  impact 0.5
  title "terminated individuals are required to sign an acknowledgement of post-employment requirements as part of the organizational termination process."
  desc <<~DESC
  ...
  tag nist: ['PS-4 (1)']
  tag control: 'PS-4 (1)'
  tag objective: 'PS-04(01)(b)'
  tag rev: 'Rev_5'
  tag family: 'Personnel Security'
  tag baseline: %w{}
  tag control_ps_4_1: true

  describe 'NIST SP 800-53A Rev 5 objective PS-04(01)(b)' do
