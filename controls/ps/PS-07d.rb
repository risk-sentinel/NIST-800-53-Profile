control 'PS-07d.' do
  impact 0.5
  title "external providers are required to notify #{input('ps_07_odp_01')} of any personnel transfers or terminations of external personnel who possess organizational credentials and/or badges or who have system privileges within #{input('ps_07_odp_02')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      external providers are required to notify #{input('ps_07_odp_01')} of any personnel transfers or terminations of external personnel who possess organizational credentials and/or badges or who have system privileges within #{input('ps_07_odp_02')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective PS-07d.' do
