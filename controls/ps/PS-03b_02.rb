control 'PS-03b.[02]' do
  impact 0.5
  title "where rescreening is so indicated, individuals are rescreened #{input('ps_03_odp_02')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      where rescreening is so indicated, individuals are rescreened #{input('ps_03_odp_02')}.
  ...
  tag odp: %w{ps_03_odp_02 ps_3_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective PS-03b.[02]' do
