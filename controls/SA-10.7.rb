control 'SA-10 (7)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SA-10(07)[01] #{input('sa_10_07_odp_01')} are required to be included in the #{input('sa_10_07_odp_03')};
      SA-10(07)[02] #{input('sa_10_07_odp_02')} are required to be included in the #{input('sa_10_07_odp_04')}.
  ...
  tag baseline: %w{}
  tag odp: %w{sa_10_07_odp_01 sa_10_07_odp_02 sa_10_07_odp_03 sa_10_07_odp_04 sa_10_7_prm_1 sa_10_7_prm_2}

  describe 'NIST SP 800-53 Rev 5 control SA-10 (7)' do
