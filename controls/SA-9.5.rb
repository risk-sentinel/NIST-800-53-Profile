control 'SA-9 (5)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SA-09(05) based on #{input('sa_09_05_odp_03')}, #{input('sa_09_05_odp_01')} is/are restricted to #{input('sa_09_05_odp_02')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control SA-9 (5)' do
