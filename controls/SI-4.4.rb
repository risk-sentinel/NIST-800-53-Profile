control 'SI-4 (4)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      ...
      SI-04(04)(b)
        SI-04(04)(b)[01] inbound communications traffic is monitored #{input('si_04_04_odp_01')} for #{input('si_04_04_odp_02')};
        SI-04(04)(b)[02] outbound communications traffic is monitored #{input('si_04_04_odp_03')} for #{input('si_04_04_odp_04')}.
  ...
  tag odp: %w{si_04_04_odp_01 si_04_04_odp_02 si_04_04_odp_03 si_04_04_odp_04 si_4_4_prm_1 si_4_4_prm_2}

  describe 'NIST SP 800-53 Rev 5 control SI-4 (4)' do
