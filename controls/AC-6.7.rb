control 'AC-6 (7)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      AC-06(07)(a) privileges assigned to #{input('ac_06_07_odp_02')} are reviewed #{input('ac_06_07_odp_01')} to validate the need for such privileges;
  ...
  describe 'NIST SP 800-53 Rev 5 control AC-6 (7)' do
