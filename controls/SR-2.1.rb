control 'SR-2 (1)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SR-02(01) a supply chain risk management team consisting of #{input('sr_02_01_odp_01')} is established to lead and support #{input('sr_02_01_odp_02')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control SR-2 (1)' do
