control 'AC-19 (5)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      AC-19(05) #{input('ac_19_05_odp_01')} is employed to protect the confidentiality and integrity of information on #{input('ac_19_05_odp_02')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control AC-19 (5)' do
