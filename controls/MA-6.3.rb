control 'MA-6 (3)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      MA-06(03) predictive maintenance data is transferred to a maintenance management system using #{input('ma_06_03_odp')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control MA-6 (3)' do
