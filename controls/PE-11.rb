control 'PE-11' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      PE-11 an uninterruptible power supply is provided to facilitate #{input('pe_11_odp')} in the event of a primary power source loss.
  ...
  describe 'NIST SP 800-53 Rev 5 control PE-11' do
