control 'AU-6' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      AU-06a. system audit records are reviewed and analyzed #{input('au_06_odp_01')} for indications of #{input('au_06_odp_02')} and the potential impact of the inappropriate or unusual activity;
      AU-06b. findings are reported to #{input('au_06_odp_03')};
  ...
  describe 'NIST SP 800-53 Rev 5 control AU-6' do
