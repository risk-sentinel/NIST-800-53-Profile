control 'RA-3' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      ...
      RA-03c. risk assessment results are documented in #{input('ra_03_odp_01')};
      RA-03d. risk assessment results are reviewed #{input('ra_03_odp_03')};
      RA-03e. risk assessment results are disseminated to #{input('ra_03_odp_04')};
      RA-03f. the risk assessment is updated #{input('ra_03_odp_05')} or when there are significant changes to the system, its environment of operation, or other conditions that may impact the security or privacy state of the system.
  ...
  describe 'NIST SP 800-53 Rev 5 control RA-3' do
