control 'AU-06(09)' do
  impact 0.5
  title "information from non-technical sources is correlated with audit record information to enhance organization-wide situational awareness."
  desc <<~DESC
  ...
  tag nist: ['AU-6 (9)']
  tag control: 'AU-6 (9)'
  tag objective: 'AU-06(09)'
  tag rev: 'Rev_5'
  tag family: 'Audit and Accountability'
  tag baseline: %w{}
  tag control_au_6_9: true

  describe 'NIST SP 800-53A Rev 5 objective AU-06(09)' do
