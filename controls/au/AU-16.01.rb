control 'AU-16(01)' do
  impact 0.5
  title "the identity of individuals in cross-organizational audit trails is preserved."
  desc <<~DESC
  ...
  tag nist: ['AU-16 (1)']
  tag control: 'AU-16 (1)'
  tag objective: 'AU-16(01)'
  tag rev: 'Rev_5'
  tag family: 'Audit and Accountability'
  tag baseline: %w{}
  tag control_au_16_1: true

  describe 'NIST SP 800-53A Rev 5 objective AU-16(01)' do
