control 'AU-07(01)[02]' do
  impact 0.5
  title "the capability to process, sort, and search audit records for events of interest based on #{input('au_07_01_odp')} are implemented."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the capability to process, sort, and search audit records for events of interest based on #{input('au_07_01_odp')} are implemented.
  ...
  tag nist: ['AU-7 (1)']
  tag control: 'AU-7 (1)'
  tag objective: 'AU-07(01)[02]'
  tag rev: 'Rev_5'
  tag family: 'Audit and Accountability'
  tag baseline: %w{MODERATE HIGH}
  tag baseline_moderate: true
  tag baseline_high: true
  tag control_au_7_1: true
  tag odp: %w{au_07_01_odp}

  describe 'NIST SP 800-53A Rev 5 objective AU-07(01)[02]' do
