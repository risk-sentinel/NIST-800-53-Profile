control 'AU-07(01)[01]' do
  impact 0.5
  title "the capability to process, sort, and search audit records for events of interest based on #{input('au_07_01_odp')} are provided;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the capability to process, sort, and search audit records for events of interest based on #{input('au_07_01_odp')} are provided;
  ...
  describe 'NIST SP 800-53A Rev 5 objective AU-07(01)[01]' do
