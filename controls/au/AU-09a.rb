control 'AU-09a.' do
  impact 0.5
  title "audit information and audit logging tools are protected from unauthorized access, modification, and deletion;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective AU-09a.' do
