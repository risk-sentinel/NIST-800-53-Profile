control 'AU-05a.' do
  impact 0.5
  title "#{input('au_05_odp_01')} are alerted in the event of an audit logging process failure within #{input('au_05_odp_02')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('au_05_odp_01')} are alerted in the event of an audit logging process failure within #{input('au_05_odp_02')};
  ...
  tag control_au_5: true
  tag odp: %w{au_05_odp_01 au_05_odp_02 au_05_odp_03}

  describe 'NIST SP 800-53A Rev 5 objective AU-05a.' do
