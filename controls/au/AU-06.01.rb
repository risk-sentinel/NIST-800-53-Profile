control 'AU-06(01)' do
  impact 0.5
  title "audit record review, analysis, and reporting processes are integrated using #{input('au_06_01_odp')}."
  desc <<~DESC
    Integrate audit record review, analysis, and reporting processes using #{input('au_06_01_odp')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      audit record review, analysis, and reporting processes are integrated using #{input('au_06_01_odp')}.
  ...
  tag nist: ['AU-6 (1)']
  tag control: 'AU-6 (1)'
  tag objective: 'AU-06(01)'
  tag rev: 'Rev_5'
  tag family: 'Audit and Accountability'
  tag baseline: %w{MODERATE HIGH}
  tag baseline_moderate: true
  tag baseline_high: true
  tag control_au_6_1: true
  tag odp: %w{au_06_01_odp}

  describe 'NIST SP 800-53A Rev 5 objective AU-06(01)' do
