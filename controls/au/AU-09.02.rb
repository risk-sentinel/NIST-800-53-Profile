control 'AU-09(02)' do
  impact 0.5
  title "audit records are stored #{input('au_09_02_odp')} in a repository that is part of a physically different system or system component than the system or component being audited."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      audit records are stored #{input('au_09_02_odp')} in a repository that is part of a physically different system or system component than the system or component being audited.
  ...
  tag nist: ['AU-9 (2)']
  tag control: 'AU-9 (2)'
  tag objective: 'AU-09(02)'
  tag rev: 'Rev_5'
  tag family: 'Audit and Accountability'
  tag baseline: %w{HIGH}
  tag baseline_high: true
  tag control_au_9_2: true
  tag odp: %w{au_09_02_odp}

  describe 'NIST SP 800-53A Rev 5 objective AU-09(02)' do
