control 'AU-14a.[01]' do
  impact 0.5
  title "#{input('au_14_odp_01')} are provided with the capability to #{input('au_14_odp_02')} the content of a user session under #{input('au_14_odp_03')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('au_14_odp_01')} are provided with the capability to #{input('au_14_odp_02')} the content of a user session under #{input('au_14_odp_03')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective AU-14a.[01]' do
