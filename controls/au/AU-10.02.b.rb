control 'AU-10(02)(b)' do
  impact 0.5
  title "#{input('au_10_02_odp_02')} in the event of a validation error are performed."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('au_10_02_odp_02')} in the event of a validation error are performed.
  ...
  describe 'NIST SP 800-53A Rev 5 objective AU-10(02)(b)' do
