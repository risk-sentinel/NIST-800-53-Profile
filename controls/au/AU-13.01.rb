control 'AU-13(01)' do
  impact 0.5
  title "open-source information and information sites are monitored using #{input('au_13_01_odp')}."
  desc <<~DESC
    Monitor open-source information and information sites using #{input('au_13_01_odp')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      open-source information and information sites are monitored using #{input('au_13_01_odp')}.
  ...
  tag nist: ['AU-13 (1)']
  tag control: 'AU-13 (1)'
  tag objective: 'AU-13(01)'
  tag rev: 'Rev_5'
  tag family: 'Audit and Accountability'
  tag baseline: %w{}
  tag control_au_13_1: true
  tag odp: %w{au_13_01_odp}

  describe 'NIST SP 800-53A Rev 5 objective AU-13(01)' do
