control 'AU-03b.' do
  impact 0.5
  title "audit records contain information that establishes when the event occurred;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective AU-03b.' do
