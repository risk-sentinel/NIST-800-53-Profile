control 'AU-13(02)' do
  impact 0.5
  title "the list of open-source information sites being monitored is reviewed #{input('au_13_02_odp')}."
  desc <<~DESC
    Review the list of open-source information sites being monitored #{input('au_13_02_odp')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      the list of open-source information sites being monitored is reviewed #{input('au_13_02_odp')}.
  ...
  tag nist: ['AU-13 (2)']
  tag control: 'AU-13 (2)'
  tag objective: 'AU-13(02)'
  tag rev: 'Rev_5'
  tag family: 'Audit and Accountability'
  tag baseline: %w{}
  tag control_au_13_2: true
  tag odp: %w{au_13_02_odp}

  describe 'NIST SP 800-53A Rev 5 objective AU-13(02)' do
