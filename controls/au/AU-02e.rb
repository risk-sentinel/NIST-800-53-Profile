control 'AU-02e.' do
  impact 0.5
  title "the event types selected for logging are reviewed and updated #{input('au_02_odp_04')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the event types selected for logging are reviewed and updated #{input('au_02_odp_04')}.
  ...
  describe 'NIST SP 800-53A Rev 5 objective AU-02e.' do
