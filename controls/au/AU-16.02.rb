control 'AU-16(02)' do
  impact 0.5
  title "cross-organizational audit information is provided to #{input('au_16_02_odp_01')} based on #{input('au_16_02_odp_02')}."
  desc <<~DESC
    Provide cross-organizational audit information to #{input('au_16_02_odp_01')} based on #{input('au_16_02_odp_02')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      cross-organizational audit information is provided to #{input('au_16_02_odp_01')} based on #{input('au_16_02_odp_02')}.
  ...
  tag nist: ['AU-16 (2)']
  tag control: 'AU-16 (2)'
  tag objective: 'AU-16(02)'
  tag rev: 'Rev_5'
  tag family: 'Audit and Accountability'
  tag baseline: %w{}
  tag control_au_16_2: true
  tag odp: %w{au_16_02_odp_01 au_16_02_odp_02}

  describe 'NIST SP 800-53A Rev 5 objective AU-16(02)' do
