control 'AU-10(02)(a)' do
  impact 0.5
  title "the binding of the information producer identity to the information is validated at #{input('au_10_02_odp_01')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the binding of the information producer identity to the information is validated at #{input('au_10_02_odp_01')};
  ...
  tag nist: ['AU-10 (2)']
  tag control: 'AU-10 (2)'
  tag objective: 'AU-10(02)(a)'
  tag rev: 'Rev_5'
  tag family: 'Audit and Accountability'
  tag baseline: %w{}
  tag control_au_10_2: true
  tag odp: %w{au_10_02_odp_01 au_10_02_odp_02}

  describe 'NIST SP 800-53A Rev 5 objective AU-10(02)(a)' do
