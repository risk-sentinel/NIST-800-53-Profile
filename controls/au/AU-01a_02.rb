control 'AU-01a.[02]' do
  impact 0.5
  title "the audit and accountability policy is disseminated to #{input('au_01_odp_01')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the audit and accountability policy is disseminated to #{input('au_01_odp_01')};
  ...
  tag odp: %w{au_01_odp_01 au_01_odp_03 au_01_odp_04 au_01_odp_05 au_01_odp_06 au_01_odp_07 au_01_odp_08 au_1_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective AU-01a.[02]' do
