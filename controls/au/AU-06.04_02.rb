control 'AU-06(04)[02]' do
  impact 0.5
  title "the capability to centrally review and analyze audit records from multiple components within the system is implemented."
  desc <<~DESC
  ...
  tag nist: ['AU-6 (4)']
  tag control: 'AU-6 (4)'
  tag objective: 'AU-06(04)[02]'
  tag rev: 'Rev_5'
  tag family: 'Audit and Accountability'
  tag baseline: %w{}
  tag control_au_6_4: true

  describe 'NIST SP 800-53A Rev 5 objective AU-06(04)[02]' do
