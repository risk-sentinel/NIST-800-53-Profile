control 'AU-03a.' do
  impact 0.5
  title "audit records contain information that establishes what type of event occurred;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective AU-03a.' do
