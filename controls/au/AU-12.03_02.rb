control 'AU-12(03)[02]' do
  impact 0.5
  title "the capability for #{input('au_12_03_odp_01')} to change the logging to be performed on #{input('au_12_03_odp_02')} based on #{input('au_12_03_odp_03')} within #{input('au_12_03_odp_04')} is implemented."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the capability for #{input('au_12_03_odp_01')} to change the logging to be performed on #{input('au_12_03_odp_02')} based on #{input('au_12_03_odp_03')} within #{input('au_12_03_odp_04')} is implemented.
  ...
  describe 'NIST SP 800-53A Rev 5 objective AU-12(03)[02]' do
