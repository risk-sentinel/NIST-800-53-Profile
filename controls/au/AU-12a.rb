control 'AU-12a.' do
  impact 0.5
  title "audit record generation capability for the event types the system is capable of auditing (defined in AU-02_ODP[01]) is provided by #{input('au_12_odp_01')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      audit record generation capability for the event types the system is capable of auditing (defined in AU-02_ODP[01]) is provided by #{input('au_12_odp_01')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective AU-12a.' do
