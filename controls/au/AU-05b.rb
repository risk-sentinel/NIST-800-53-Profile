control 'AU-05b.' do
  impact 0.5
  title "#{input('au_05_odp_03')} are taken in the event of an audit logging process failure."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('au_05_odp_03')} are taken in the event of an audit logging process failure.
  ...
  describe 'NIST SP 800-53A Rev 5 objective AU-05b.' do
