control 'AU-12(01)' do
  impact 0.5
  title "audit records from #{input('au_12_01_odp_01')} are compiled into a system-wide (logical or physical) audit trail that is time-correlated to within #{input('au_12_01_odp_02')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      audit records from #{input('au_12_01_odp_01')} are compiled into a system-wide (logical or physical) audit trail that is time-correlated to within #{input('au_12_01_odp_02')}.
  ...
  tag nist: ['AU-12 (1)']
  tag control: 'AU-12 (1)'
  tag objective: 'AU-12(01)'
  tag rev: 'Rev_5'
  tag family: 'Audit and Accountability'
  tag baseline: %w{HIGH}
  tag baseline_high: true
  tag control_au_12_1: true
  tag odp: %w{au_12_01_odp_01 au_12_01_odp_02}

  describe 'NIST SP 800-53A Rev 5 objective AU-12(01)' do
