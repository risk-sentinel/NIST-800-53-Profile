control 'AU-14(01)' do
  impact 0.5
  title "session audits are initiated automatically at system start-up."
  desc <<~DESC
  ...
  tag nist: ['AU-14 (1)']
  tag control: 'AU-14 (1)'
  tag objective: 'AU-14(01)'
  tag rev: 'Rev_5'
  tag family: 'Audit and Accountability'
  tag baseline: %w{}
  tag control_au_14_1: true

  describe 'NIST SP 800-53A Rev 5 objective AU-14(01)' do
