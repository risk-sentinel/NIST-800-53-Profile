control 'AU-01c.01[01]' do
  impact 0.5
  title "the current audit and accountability policy is reviewed and updated #{input('au_01_odp_05')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the current audit and accountability policy is reviewed and updated #{input('au_01_odp_05')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective AU-01c.01[01]' do
