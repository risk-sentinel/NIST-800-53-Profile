control 'AU-03e.' do
  impact 0.5
  title "audit records contain information that establishes the outcome of the event;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective AU-03e.' do
