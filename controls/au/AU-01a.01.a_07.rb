control 'AU-01a.01(a)[07]' do
  impact 0.5
  title "the #{input('au_01_odp_03')} of the audit and accountability policy addresses compliance;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the #{input('au_01_odp_03')} of the audit and accountability policy addresses compliance;
  ...
  describe 'NIST SP 800-53A Rev 5 objective AU-01a.01(a)[07]' do
