control 'AU-06a.' do
  impact 0.5
  title "system audit records are reviewed and analyzed #{input('au_06_odp_01')} for indications of #{input('au_06_odp_02')} and the potential impact of the inappropriate or unusual activity;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      system audit records are reviewed and analyzed #{input('au_06_odp_01')} for indications of #{input('au_06_odp_02')} and the potential impact of the inappropriate or unusual activity;
  ...
  describe 'NIST SP 800-53A Rev 5 objective AU-06a.' do
