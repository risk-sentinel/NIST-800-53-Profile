control 'AU-05(01)' do
  impact 0.5
  title "a warning is provided to #{input('au_05_01_odp_01')} within #{input('au_05_01_odp_02')} when allocated audit log storage volume reaches #{input('au_05_01_odp_03')} of repository maximum audit log storage capacity."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      a warning is provided to #{input('au_05_01_odp_01')} within #{input('au_05_01_odp_02')} when allocated audit log storage volume reaches #{input('au_05_01_odp_03')} of repository maximum audit log storage capacity.
  ...
  tag nist: ['AU-5 (1)']
  tag control: 'AU-5 (1)'
  tag objective: 'AU-05(01)'
  tag rev: 'Rev_5'
  tag family: 'Audit and Accountability'
  tag baseline: %w{HIGH}
  tag baseline_high: true
  tag control_au_5_1: true
  tag odp: %w{au_05_01_odp_01 au_05_01_odp_02 au_05_01_odp_03}

  describe 'NIST SP 800-53A Rev 5 objective AU-05(01)' do
