control 'AU-01a.01(a)[04]' do
  impact 0.5
  title "the #{input('au_01_odp_03')} of the audit and accountability policy addresses responsibilities;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the #{input('au_01_odp_03')} of the audit and accountability policy addresses responsibilities;
  ...
  describe 'NIST SP 800-53A Rev 5 objective AU-01a.01(a)[04]' do
