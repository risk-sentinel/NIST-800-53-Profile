control 'AU-16(03)' do
  impact 0.5
  title "#{input('au_16_03_odp')} are implemented to disassociate individuals from audit information transmitted across organizational boundaries."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('au_16_03_odp')} are implemented to disassociate individuals from audit information transmitted across organizational boundaries.
  ...
  tag nist: ['AU-16 (3)']
  tag control: 'AU-16 (3)'
  tag objective: 'AU-16(03)'
  tag rev: 'Rev_5'
  tag family: 'Audit and Accountability'
  tag baseline: %w{}
  tag control_au_16_3: true
  tag odp: %w{au_16_03_odp}

  describe 'NIST SP 800-53A Rev 5 objective AU-16(03)' do
