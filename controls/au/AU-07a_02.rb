control 'AU-07a.[02]' do
  impact 0.5
  title "an audit record reduction and report generation capability is implemented that supports on-demand audit record review, analysis, and reporting requirements and after-the-fact investigations of incidents;"
  desc <<~DESC
  ...
  tag nist: ['AU-7']
  tag control: 'AU-7'
  tag objective: 'AU-07a.[02]'
  tag rev: 'Rev_5'
  tag family: 'Audit and Accountability'
  tag baseline: %w{MODERATE HIGH}
  tag baseline_moderate: true
  tag baseline_high: true
  tag control_au_7: true

  describe 'NIST SP 800-53A Rev 5 objective AU-07a.[02]' do
