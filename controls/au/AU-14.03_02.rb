control 'AU-14(03)[02]' do
  impact 0.5
  title "the capability for authorized users to remotely view and hear content related to an established user session in real time is implemented."
  desc <<~DESC
  ...
  tag nist: ['AU-14 (3)']
  tag control: 'AU-14 (3)'
  tag objective: 'AU-14(03)[02]'
  tag rev: 'Rev_5'
  tag family: 'Audit and Accountability'
  tag baseline: %w{}
  tag control_au_14_3: true

  describe 'NIST SP 800-53A Rev 5 objective AU-14(03)[02]' do
