control 'AU-03d.' do
  impact 0.5
  title "audit records contain information that establishes the source of the event;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective AU-03d.' do
