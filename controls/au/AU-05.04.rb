control 'AU-05(04)' do
  impact 0.5
  title "#{input('au_05_04_odp_01')} is/are invoked in the event of #{input('au_05_04_odp_02')} , unless an alternate audit logging capability exists."
  desc <<~DESC
    Invoke a #{input('au_05_04_odp_01')} in the event of #{input('au_05_04_odp_02')} , unless an alternate audit logging capability exists.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      #{input('au_05_04_odp_01')} is/are invoked in the event of #{input('au_05_04_odp_02')} , unless an alternate audit logging capability exists.
  ...
  tag nist: ['AU-5 (4)']
  tag control: 'AU-5 (4)'
  tag objective: 'AU-05(04)'
  tag rev: 'Rev_5'
  tag family: 'Audit and Accountability'
  tag baseline: %w{}
  tag control_au_5_4: true
  tag odp: %w{au_05_04_odp_01 au_05_04_odp_02}

  describe 'NIST SP 800-53A Rev 5 objective AU-05(04)' do
