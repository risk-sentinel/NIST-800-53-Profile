control 'AU-03f.' do
  impact 0.5
  title "audit records contain information that establishes the identity of any individuals, subjects, or objects/entities associated with the event."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective AU-03f.' do
