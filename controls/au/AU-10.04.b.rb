control 'AU-10(04)(b)' do
  impact 0.5
  title "#{input('au_10_04_odp_02')} are performed in the event of a validation error."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('au_10_04_odp_02')} are performed in the event of a validation error.
  ...
  describe 'NIST SP 800-53A Rev 5 objective AU-10(04)(b)' do
