control 'AU-02c.[02]' do
  impact 0.5
  title "the specified event types are logged within the system #{input('au_02_odp_03')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the specified event types are logged within the system #{input('au_02_odp_03')};
  ...
  tag odp: %w{au_02_odp_01 au_02_odp_03 au_02_odp_04 au_2_prm_2}

  describe 'NIST SP 800-53A Rev 5 objective AU-02c.[02]' do
