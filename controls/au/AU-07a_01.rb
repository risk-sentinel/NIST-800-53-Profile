control 'AU-07a.[01]' do
  impact 0.5
  title "an audit record reduction and report generation capability is provided that supports on-demand audit record review, analysis, and reporting requirements and after-the-fact investigations of incidents;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective AU-07a.[01]' do
