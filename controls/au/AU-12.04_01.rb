control 'AU-12(04)[01]' do
  impact 0.5
  title "the capability to audit the parameters of user query events for data sets containing personally identifiable information is provided;"
  desc <<~DESC
  ...
  tag nist: ['AU-12 (4)']
  tag control: 'AU-12 (4)'
  tag objective: 'AU-12(04)[01]'
  tag rev: 'Rev_5'
  tag family: 'Audit and Accountability'
  tag baseline: %w{}
  tag control_au_12_4: true

  describe 'NIST SP 800-53A Rev 5 objective AU-12(04)[01]' do
