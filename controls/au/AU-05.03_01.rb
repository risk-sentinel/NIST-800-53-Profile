control 'AU-05(03)[01]' do
  impact 0.5
  title "configurable network communications traffic volume thresholds reflecting limits on audit log storage capacity are enforced;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective AU-05(03)[01]' do
