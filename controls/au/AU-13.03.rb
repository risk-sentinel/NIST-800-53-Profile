control 'AU-13(03)' do
  impact 0.5
  title "discovery techniques, processes, and tools are employed to determine if external entities are replicating organizational information in an unauthorized manner."
  desc <<~DESC
  ...
  tag nist: ['AU-13 (3)']
  tag control: 'AU-13 (3)'
  tag objective: 'AU-13(03)'
  tag rev: 'Rev_5'
  tag family: 'Audit and Accountability'
  tag baseline: %w{}
  tag control_au_13_3: true

  describe 'NIST SP 800-53A Rev 5 objective AU-13(03)' do
