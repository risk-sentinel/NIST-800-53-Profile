control 'AU-02a.' do
  impact 0.5
  title "#{input('au_02_odp_01')} that the system is capable of logging are identified in support of the audit logging function;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('au_02_odp_01')} that the system is capable of logging are identified in support of the audit logging function;
  ...
  tag odp: %w{au_02_odp_01 au_02_odp_04 au_2_prm_2}

  describe 'NIST SP 800-53A Rev 5 objective AU-02a.' do
