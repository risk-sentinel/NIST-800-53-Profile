control 'AU-07b.[02]' do
  impact 0.5
  title "an audit record reduction and report generation capability is implemented that does not alter the original content or time ordering of audit records."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective AU-07b.[02]' do
