control 'SC-7 (24)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SC-07(24)(a) #{input('sc_07_24_odp')} are applied to data elements of personally identifiable information on systems that process personally identifiable information;
      SC-07(24)(b)
  ...
  describe 'NIST SP 800-53 Rev 5 control SC-7 (24)' do
