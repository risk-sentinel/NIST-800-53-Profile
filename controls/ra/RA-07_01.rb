control 'RA-07[01]' do
  impact 0.5
  title "findings from security assessments are responded to in accordance with organizational risk tolerance;"
  desc <<~DESC
  ...
  tag control_ra_7: true

  describe 'NIST SP 800-53A Rev 5 objective RA-07[01]' do
