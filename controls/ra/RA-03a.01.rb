control 'RA-03a.01' do
  impact 0.5
  title "a risk assessment is conducted to identify threats to and vulnerabilities in the system;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective RA-03a.01' do
