control 'RA-05(04)[02]' do
  impact 0.5
  title "#{input('ra_05_04_odp')} are taken when information about the system is confirmed as discoverable."
  desc <<~DESC
    Determine information about the system that is discoverable and take #{input('ra_05_04_odp')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      #{input('ra_05_04_odp')} are taken when information about the system is confirmed as discoverable.
  ...
  tag nist: ['RA-5 (4)']
  tag control: 'RA-5 (4)'
  tag objective: 'RA-05(04)[02]'
  tag rev: 'Rev_5'
  tag family: 'Risk Assessment'
  tag baseline: %w{HIGH}
  tag baseline_high: true
  tag control_ra_5_4: true
  tag odp: %w{ra_05_04_odp}

  describe 'NIST SP 800-53A Rev 5 objective RA-05(04)[02]' do
