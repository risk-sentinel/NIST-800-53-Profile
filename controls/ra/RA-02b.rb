control 'RA-02b.' do
  impact 0.5
  title "the security categorization results, including supporting rationale, are documented in the security plan for the system;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective RA-02b.' do
