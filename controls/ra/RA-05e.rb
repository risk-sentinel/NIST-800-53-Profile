control 'RA-05e.' do
  impact 0.5
  title "information obtained from the vulnerability monitoring process and control assessments is shared with #{input('ra_05_odp_04')} to help eliminate similar vulnerabilities in other systems;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      information obtained from the vulnerability monitoring process and control assessments is shared with #{input('ra_05_odp_04')} to help eliminate similar vulnerabilities in other systems;
  ...
  describe 'NIST SP 800-53A Rev 5 objective RA-05e.' do
