control 'RA-01a.01(b)' do
  impact 0.5
  title "the #{input('ra_01_odp_03')} risk assessment policy is consistent with applicable laws, executive orders, directives, regulations, policies, standards, and guidelines;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the #{input('ra_01_odp_03')} risk assessment policy is consistent with applicable laws, executive orders, directives, regulations, policies, standards, and guidelines;
  ...
  describe 'NIST SP 800-53A Rev 5 objective RA-01a.01(b)' do
