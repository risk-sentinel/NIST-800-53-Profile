control 'RA-05f.' do
  impact 0.5
  title "vulnerability monitoring tools that include the capability to readily update the vulnerabilities to be scanned are employed."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective RA-05f.' do
