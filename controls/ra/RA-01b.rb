control 'RA-01b.' do
  impact 0.5
  title "the #{input('ra_01_odp_04')} is designated to manage the development, documentation, and dissemination of the risk assessment policy and procedures;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the #{input('ra_01_odp_04')} is designated to manage the development, documentation, and dissemination of the risk assessment policy and procedures;
  ...
  describe 'NIST SP 800-53A Rev 5 objective RA-01b.' do
