control 'RA-07[04]' do
  impact 0.5
  title "findings from audits are responded to in accordance with organizational risk tolerance."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective RA-07[04]' do
