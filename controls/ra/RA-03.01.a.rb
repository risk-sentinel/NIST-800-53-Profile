control 'RA-03(01)(a)' do
  impact 0.5
  title "supply chain risks associated with #{input('ra_03_01_odp_01')} are assessed;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      supply chain risks associated with #{input('ra_03_01_odp_01')} are assessed;
  ...
  describe 'NIST SP 800-53A Rev 5 objective RA-03(01)(a)' do
