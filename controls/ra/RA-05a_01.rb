control 'RA-05a.[01]' do
  impact 0.5
  title "systems and hosted applications are monitored for vulnerabilities #{input('ra_05_odp_01')} and when new vulnerabilities potentially affecting the system are identified and reported;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      systems and hosted applications are monitored for vulnerabilities #{input('ra_05_odp_01')} and when new vulnerabilities potentially affecting the system are identified and reported;
  ...
  tag odp: %w{ra_05_odp_01 ra_05_odp_03 ra_05_odp_04 ra_5_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective RA-05a.[01]' do
