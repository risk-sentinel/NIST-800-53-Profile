control 'RA-03c.' do
  impact 0.5
  title "risk assessment results are documented in #{input('ra_03_odp_01')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      risk assessment results are documented in #{input('ra_03_odp_01')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective RA-03c.' do
