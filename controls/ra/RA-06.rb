control 'RA-06' do
  impact 0.5
  title "a technical surveillance countermeasures survey is employed at #{input('ra_06_odp_01')} #{input('ra_06_odp_02')}."
  desc <<~DESC
    Employ a technical surveillance countermeasures survey at #{input('ra_06_odp_01')} #{input('ra_06_odp_02')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      a technical surveillance countermeasures survey is employed at #{input('ra_06_odp_01')} #{input('ra_06_odp_02')}.
  ...
  tag baseline: %w{}
  tag control_ra_6: true
  tag odp: %w{ra_06_odp_01 ra_06_odp_02}

  describe 'NIST SP 800-53A Rev 5 objective RA-06' do
