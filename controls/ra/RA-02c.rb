control 'RA-02c.' do
  impact 0.5
  title "the authorizing official or authorizing official designated representative reviews and approves the security categorization decision."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective RA-02c.' do
