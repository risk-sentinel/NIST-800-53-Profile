control 'RA-03f.' do
  impact 0.5
  title "the risk assessment is updated #{input('ra_03_odp_05')} or when there are significant changes to the system, its environment of operation, or other conditions that may impact the security or privacy state of the system."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the risk assessment is updated #{input('ra_03_odp_05')} or when there are significant changes to the system, its environment of operation, or other conditions that may impact the security or privacy state of the system.
  ...
  describe 'NIST SP 800-53A Rev 5 objective RA-03f.' do
