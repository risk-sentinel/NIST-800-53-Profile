control 'RA-05(11)' do
  impact 0.5
  title "a public reporting channel is established for receiving reports of vulnerabilities in organizational systems and system components."
  desc <<~DESC
  ...
  tag control_ra_5_11: true

  describe 'NIST SP 800-53A Rev 5 objective RA-05(11)' do
