control 'RA-08a.' do
  impact 0.5
  title "privacy impact assessments are conducted for systems, programs, or other activities before developing or procuring information technology that processes personally identifiable information;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective RA-08a.' do
