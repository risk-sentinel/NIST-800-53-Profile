control 'RA-02(01)' do
  impact 0.5
  title "an impact-level prioritization of organizational systems is conducted to obtain additional granularity on system impact levels."
  desc <<~DESC
  ...
  tag nist: ['RA-2 (1)']
  tag control: 'RA-2 (1)'
  tag objective: 'RA-02(01)'
  tag rev: 'Rev_5'
  tag family: 'Risk Assessment'
  tag baseline: %w{}
  tag control_ra_2_1: true

  describe 'NIST SP 800-53A Rev 5 objective RA-02(01)' do
