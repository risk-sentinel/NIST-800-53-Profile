control 'RA-05(04)[01]' do
  impact 0.5
  title "information about the system is discoverable;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective RA-05(04)[01]' do
