control 'RA-05b.01' do
  impact 0.5
  title "vulnerability monitoring tools and techniques are employed to automate parts of the vulnerability management process by using standards for enumerating platforms, software flaws, and improper configurations;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective RA-05b.01' do
