control 'RA-05(08)' do
  impact 0.5
  title "historic audit logs are reviewed to determine if a vulnerability identified in a #{input('ra_05_08_odp_01')} has been previously exploited within #{input('ra_05_08_odp_02')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      historic audit logs are reviewed to determine if a vulnerability identified in a #{input('ra_05_08_odp_01')} has been previously exploited within #{input('ra_05_08_odp_02')}.
  ...
  tag nist: ['RA-5 (8)']
  tag control: 'RA-5 (8)'
  tag objective: 'RA-05(08)'
  tag rev: 'Rev_5'
  tag family: 'Risk Assessment'
  tag baseline: %w{}
  tag control_ra_5_8: true
  tag odp: %w{ra_05_08_odp_01 ra_05_08_odp_02}

  describe 'NIST SP 800-53A Rev 5 objective RA-05(08)' do
