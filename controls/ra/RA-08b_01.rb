control 'RA-08b.[01]' do
  impact 0.5
  title "privacy impact assessments are conducted for systems, programs, or other activities before initiating a collection of personally identifiable information that will be processed using information technology;"
  desc <<~DESC
  ...
  tag nist: ['RA-8']
  tag control: 'RA-8'
  tag objective: 'RA-08b.[01]'
  tag rev: 'Rev_5'
  tag family: 'Risk Assessment'
  tag baseline: %w{PRIVACY}
  tag baseline_privacy: true
  tag control_ra_8: true

  describe 'NIST SP 800-53A Rev 5 objective RA-08b.[01]' do
