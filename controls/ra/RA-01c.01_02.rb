control 'RA-01c.01[02]' do
  impact 0.5
  title "the current risk assessment policy is reviewed and updated following #{input('ra_01_odp_06')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the current risk assessment policy is reviewed and updated following #{input('ra_01_odp_06')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective RA-01c.01[02]' do
