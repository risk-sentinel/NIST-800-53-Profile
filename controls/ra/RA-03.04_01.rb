control 'RA-03(04)[01]' do
  impact 0.5
  title "#{input('ra_03_04_odp_01')} are employed to predict and identify risks to #{input('ra_03_04_odp_02')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('ra_03_04_odp_01')} are employed to predict and identify risks to #{input('ra_03_04_odp_02')};
  ...
  tag nist: ['RA-3 (4)']
  tag control: 'RA-3 (4)'
  tag objective: 'RA-03(04)[01]'
  tag rev: 'Rev_5'
  tag family: 'Risk Assessment'
  tag baseline: %w{}
  tag control_ra_3_4: true
  tag odp: %w{ra_03_04_odp_01 ra_03_04_odp_02 ra_3_4_prm_2}

  describe 'NIST SP 800-53A Rev 5 objective RA-03(04)[01]' do
