control 'RA-05c.' do
  impact 0.5
  title "vulnerability scan reports and results from vulnerability monitoring are analyzed;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective RA-05c.' do
