control 'RA-03a.02' do
  impact 0.5
  title "a risk assessment is conducted to determine the likelihood and magnitude of harm from unauthorized access, use, disclosure, disruption, modification, or destruction of the system; the information it processes, stores, or transmits; and any related information;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective RA-03a.02' do
