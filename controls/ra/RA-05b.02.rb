control 'RA-05b.02' do
  impact 0.5
  title "vulnerability monitoring tools and techniques are employed to facilitate interoperability among tools and to automate parts of the vulnerability management process by using standards for formatting checklists and test procedures;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective RA-05b.02' do
