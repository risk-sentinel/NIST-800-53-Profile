control 'RA-10b.' do
  impact 0.5
  title "the threat hunting capability is employed #{input('ra_10_odp')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the threat hunting capability is employed #{input('ra_10_odp')}.
  ...
  describe 'NIST SP 800-53A Rev 5 objective RA-10b.' do
