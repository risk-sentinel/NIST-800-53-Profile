control 'RA-01a.[04]' do
  impact 0.5
  title "the risk assessment procedures are disseminated to #{input('ra_01_odp_02')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the risk assessment procedures are disseminated to #{input('ra_01_odp_02')};
  ...
  tag odp: %w{ra_01_odp_02 ra_01_odp_03 ra_01_odp_04 ra_01_odp_05 ra_01_odp_06 ra_01_odp_07 ra_01_odp_08 ra_1_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective RA-01a.[04]' do
