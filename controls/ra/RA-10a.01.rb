control 'RA-10a.01' do
  impact 0.5
  title "a cyber threat capability is established and maintained to search for indicators of compromise in organizational systems;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective RA-10a.01' do
