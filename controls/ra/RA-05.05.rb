control 'RA-05(05)' do
  impact 0.5
  title "privileged access authorization is implemented to #{input('ra_05_05_odp_01')} for #{input('ra_05_05_odp_02')}."
  desc <<~DESC
    Implement privileged access authorization to #{input('ra_05_05_odp_01')} for #{input('ra_05_05_odp_02')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      privileged access authorization is implemented to #{input('ra_05_05_odp_01')} for #{input('ra_05_05_odp_02')}.
  ...
  tag nist: ['RA-5 (5)']
  tag control: 'RA-5 (5)'
  tag objective: 'RA-05(05)'
  tag rev: 'Rev_5'
  tag family: 'Risk Assessment'
  tag baseline: %w{MODERATE HIGH}
  tag baseline_moderate: true
  tag baseline_high: true
  tag control_ra_5_5: true
  tag odp: %w{ra_05_05_odp_01 ra_05_05_odp_02}

  describe 'NIST SP 800-53A Rev 5 objective RA-05(05)' do
