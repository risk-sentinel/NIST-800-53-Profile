control 'RA-03d.' do
  impact 0.5
  title "risk assessment results are reviewed #{input('ra_03_odp_03')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      risk assessment results are reviewed #{input('ra_03_odp_03')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective RA-03d.' do
