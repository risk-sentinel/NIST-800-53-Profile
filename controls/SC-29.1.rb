control 'SC-29 (1)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SC-29(01) virtualization techniques are employed to support the deployment of a diverse range of operating systems and applications that are changed #{input('sc_29_01_odp')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control SC-29 (1)' do
