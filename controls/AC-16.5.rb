control 'AC-16 (5)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      AC-16(05)[01] security attributes are displayed in human-readable form on each object that the system transmits to output devices to identify #{input('ac_16_05_odp_01')} using #{input('ac_16_05_odp_02')};
      AC-16(05)[02] privacy attributes are displayed in human-readable form on each object that the system transmits to output devices to identify #{input('ac_16_05_odp_01')} using #{input('ac_16_05_odp_02')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control AC-16 (5)' do
