control 'PS-3 (3)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      ...
      PS-03(03)(b) individuals accessing a system processing, storing, or transmitting information requiring special protection satisfy #{input('ps_03_03_odp')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control PS-3 (3)' do
