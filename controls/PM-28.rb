control 'PM-28' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      ...
      PM-28b. the results of risk framing activities are distributed to #{input('pm_28_odp_01')};
      PM-28c. risk framing considerations are reviewed and updated #{input('pm_28_odp_02')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control PM-28' do
