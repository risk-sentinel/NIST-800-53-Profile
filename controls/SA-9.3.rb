control 'SA-9 (3)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SA-09(03)[01] trust relationships with external service provides based on #{input('sa_09_03_odp_01')} are established and documented;
      SA-09(03)[02] trust relationships with external service provides based on #{input('sa_09_03_odp_01')} are maintained;
      SA-09(03)[03] trust relationships with external service provides based on #{input('sa_09_03_odp_02')} are established and documented;
      SA-09(03)[04] trust relationships with external service provides based on #{input('sa_09_03_odp_02')} are maintained.
  ...
  tag baseline: %w{}
  tag odp: %w{sa_09_03_odp_01 sa_09_03_odp_02 sa_9_3_prm_1}

  describe 'NIST SP 800-53 Rev 5 control SA-9 (3)' do
