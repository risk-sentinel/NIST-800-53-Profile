control 'AT-2 (4)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      AT-02(04) literacy training on recognizing suspicious communications and anomalous behavior in organizational systems using #{input('at_02_04_odp')} is provided.
  ...
  describe 'NIST SP 800-53 Rev 5 control AT-2 (4)' do
