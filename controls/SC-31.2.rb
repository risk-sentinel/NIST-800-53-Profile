control 'SC-31 (2)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SC-31(02) the maximum bandwidth for identified covert #{input('sc_31_02_odp_01')} channels is reduced to #{input('sc_31_02_odp_02')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control SC-31 (2)' do
