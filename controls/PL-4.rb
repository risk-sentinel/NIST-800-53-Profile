control 'PL-4' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      ...
      PL-04c. rules of behavior are reviewed and updated #{input('pl_04_odp_01')};
      PL-04d. individuals who have acknowledged a previous version of the rules of behavior are required to read and reacknowledge #{input('pl_04_odp_02')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control PL-4' do
