control 'CM-01a.[01]' do
  impact 0.5
  title "a configuration management policy is developed and documented;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-01a.[01]' do
