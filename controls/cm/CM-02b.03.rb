control 'CM-02b.03' do
  impact 0.5
  title "the baseline configuration of the system is reviewed and updated when system components are installed or upgraded."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-02b.03' do
