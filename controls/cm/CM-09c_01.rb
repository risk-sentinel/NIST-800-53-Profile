control 'CM-09c.[01]' do
  impact 0.5
  title "the configuration management plan defines the configuration items for the system;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-09c.[01]' do
