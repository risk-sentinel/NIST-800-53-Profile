control 'CM-07(01)(b)[03]' do
  impact 0.5
  title "#{input('cm_07_01_odp_04')} deemed to be unnecessary and/or non-secure are disabled or removed;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('cm_07_01_odp_04')} deemed to be unnecessary and/or non-secure are disabled or removed;
  ...
  tag odp: %w{cm_07_01_odp_01 cm_07_01_odp_04 cm_7_1_prm_2}

  describe 'NIST SP 800-53A Rev 5 objective CM-07(01)(b)[03]' do
