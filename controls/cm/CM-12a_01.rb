control 'CM-12a.[01]' do
  impact 0.5
  title "the location of #{input('cm_12_odp')} is identified and documented;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the location of #{input('cm_12_odp')} is identified and documented;
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-12a.[01]' do
