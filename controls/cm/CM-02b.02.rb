control 'CM-02b.02' do
  impact 0.5
  title "the baseline configuration of the system is reviewed and updated when required due to #{input('cm_02_odp_02')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the baseline configuration of the system is reviewed and updated when required due to #{input('cm_02_odp_02')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-02b.02' do
