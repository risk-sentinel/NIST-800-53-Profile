control 'CM-11c.' do
  impact 0.5
  title "compliance with #{input('cm_11_odp_01')} is monitored #{input('cm_11_odp_03')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      compliance with #{input('cm_11_odp_01')} is monitored #{input('cm_11_odp_03')}.
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-11c.' do
