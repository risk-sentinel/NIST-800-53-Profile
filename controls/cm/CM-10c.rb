control 'CM-10c.' do
  impact 0.5
  title "the use of peer-to-peer file sharing technology is controlled and documented to ensure that peer-to-peer file sharing is not used for the unauthorized distribution, display, performance, or reproduction of copyrighted work."
  desc <<~DESC
  ...
  tag control_cm_10: true

  describe 'NIST SP 800-53A Rev 5 objective CM-10c.' do
