control 'CM-04(02)[05]' do
  impact 0.5
  title "the impacted controls are producing the desired outcome with regard to meeting the security requirements for the system after system changes;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-04(02)[05]' do
