control 'CM-07(04)(b)' do
  impact 0.5
  title "an allow-all, deny-by-exception policy is employed to prohibit the execution of unauthorized software programs on the system;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-07(04)(b)' do
