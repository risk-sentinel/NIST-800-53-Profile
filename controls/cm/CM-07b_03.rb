control 'CM-07b.[03]' do
  impact 0.5
  title "the use of #{input('cm_07_odp_04')} is prohibited or restricted;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the use of #{input('cm_07_odp_04')} is prohibited or restricted;
  ...
  tag odp: %w{cm_07_odp_01 cm_07_odp_04 cm_7_prm_2}

  describe 'NIST SP 800-53A Rev 5 objective CM-07b.[03]' do
