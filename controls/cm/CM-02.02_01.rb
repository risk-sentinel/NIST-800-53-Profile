control 'CM-02(02)[01]' do
  impact 0.5
  title "the currency of the baseline configuration of the system is maintained using #{input('cm_02_02_odp')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the currency of the baseline configuration of the system is maintained using #{input('cm_02_02_odp')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-02(02)[01]' do
