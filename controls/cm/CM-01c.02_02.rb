control 'CM-01c.02[02]' do
  impact 0.5
  title "the current configuration management procedures are reviewed and updated following #{input('cm_01_odp_08')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the current configuration management procedures are reviewed and updated following #{input('cm_01_odp_08')}.
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-01c.02[02]' do
