control 'CM-07(01)(a)' do
  impact 0.5
  title "the system is reviewed #{input('cm_07_01_odp_01')} to identify unnecessary and/or non-secure functions, ports, protocols, software, and services:"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the system is reviewed #{input('cm_07_01_odp_01')} to identify unnecessary and/or non-secure functions, ports, protocols, software, and services:
  ...
  tag odp: %w{cm_07_01_odp_01 cm_7_1_prm_2}

  describe 'NIST SP 800-53A Rev 5 objective CM-07(01)(a)' do
