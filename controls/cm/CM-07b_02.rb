control 'CM-07b.[02]' do
  impact 0.5
  title "the use of #{input('cm_07_odp_03')} is prohibited or restricted;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the use of #{input('cm_07_odp_03')} is prohibited or restricted;
  ...
  tag odp: %w{cm_07_odp_01 cm_07_odp_03 cm_7_prm_2}

  describe 'NIST SP 800-53A Rev 5 objective CM-07b.[02]' do
