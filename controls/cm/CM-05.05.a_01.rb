control 'CM-05(05)(a)[01]' do
  impact 0.5
  title "privileges to change system components within a production or operational environment are limited;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-05(05)(a)[01]' do
