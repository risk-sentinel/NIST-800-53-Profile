control 'CM-03(07)' do
  impact 0.5
  title "changes to the system are reviewed #{input('cm_03_07_odp_01')} or when #{input('cm_03_07_odp_02')} to determine whether unauthorized changes have occurred."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      changes to the system are reviewed #{input('cm_03_07_odp_01')} or when #{input('cm_03_07_odp_02')} to determine whether unauthorized changes have occurred.
  ...
  tag nist: ['CM-3 (7)']
  tag control: 'CM-3 (7)'
  tag objective: 'CM-03(07)'
  tag rev: 'Rev_5'
  tag family: 'Configuration Management'
  tag baseline: %w{}
  tag control_cm_3_7: true
  tag odp: %w{cm_03_07_odp_01 cm_03_07_odp_02}

  describe 'NIST SP 800-53A Rev 5 objective CM-03(07)' do
