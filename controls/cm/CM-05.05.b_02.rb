control 'CM-05(05)(b)[02]' do
  impact 0.5
  title "privileges are reevaluated #{input('cm_05_05_odp_02')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      privileges are reevaluated #{input('cm_05_05_odp_02')}.
  ...
  tag nist: ['CM-5 (5)']
  tag control: 'CM-5 (5)'
  tag objective: 'CM-05(05)(b)[02]'
  tag rev: 'Rev_5'
  tag family: 'Configuration Management'
  tag baseline: %w{}
  tag control_cm_5_5: true
  tag odp: %w{cm_05_05_odp_02 cm_5_5_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective CM-05(05)(b)[02]' do
