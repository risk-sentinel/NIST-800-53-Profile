control 'CM-07(09)(c)' do
  impact 0.5
  title "the list of authorized hardware components is reviewed and updated #{input('cm_07_09_odp_02')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the list of authorized hardware components is reviewed and updated #{input('cm_07_09_odp_02')}.
  ...
  tag nist: ['CM-7 (9)']
  tag control: 'CM-7 (9)'
  tag objective: 'CM-07(09)(c)'
  tag rev: 'Rev_5'
  tag family: 'Configuration Management'
  tag baseline: %w{}
  tag control_cm_7_9: true
  tag odp: %w{cm_07_09_odp_01 cm_07_09_odp_02}

  describe 'NIST SP 800-53A Rev 5 objective CM-07(09)(c)' do
