control 'CM-07(04)(c)' do
  impact 0.5
  title "the list of unauthorized software programs is reviewed and updated #{input('cm_07_04_odp_02')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the list of unauthorized software programs is reviewed and updated #{input('cm_07_04_odp_02')}.
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-07(04)(c)' do
