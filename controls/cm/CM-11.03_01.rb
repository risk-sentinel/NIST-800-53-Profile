control 'CM-11(03)[01]' do
  impact 0.5
  title "compliance with software installation policies is enforced using #{input('cm_11_03_odp_01')};"
  desc <<~DESC
    Enforce and monitor compliance with software installation policies using #{input('cm_11_3_prm_1')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      compliance with software installation policies is enforced using #{input('cm_11_03_odp_01')};
  ...
  tag nist: ['CM-11 (3)']
  tag control: 'CM-11 (3)'
  tag objective: 'CM-11(03)[01]'
  tag rev: 'Rev_5'
  tag family: 'Configuration Management'
  tag baseline: %w{}
  tag control_cm_11_3: true
  tag odp: %w{cm_11_03_odp_01 cm_11_3_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective CM-11(03)[01]' do
