control 'CM-08(03)(a)[01]' do
  impact 0.5
  title "the presence of unauthorized hardware within the system is detected using #{input('cm_08_03_odp_01')} #{input('cm_08_03_odp_04')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the presence of unauthorized hardware within the system is detected using #{input('cm_08_03_odp_01')} #{input('cm_08_03_odp_04')};
  ...
  tag odp: %w{cm_08_03_odp_01 cm_08_03_odp_04 cm_08_03_odp_05 cm_8_3_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective CM-08(03)(a)[01]' do
