control 'CM-04(02)[01]' do
  impact 0.5
  title "the impacted controls are implemented correctly with regard to meeting the security requirements for the system after system changes;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-04(02)[01]' do
