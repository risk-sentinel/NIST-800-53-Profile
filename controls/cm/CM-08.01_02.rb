control 'CM-08(01)[02]' do
  impact 0.5
  title "the inventory of system components is updated as part of component removals;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-08(01)[02]' do
