control 'CM-03g.[01]' do
  impact 0.5
  title "configuration change control activities are coordinated and overseen by #{input('cm_03_odp_02')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      configuration change control activities are coordinated and overseen by #{input('cm_03_odp_02')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-03g.[01]' do
