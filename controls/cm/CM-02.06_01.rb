control 'CM-02(06)[01]' do
  impact 0.5
  title "a baseline configuration for system development environments that is managed separately from the operational baseline configuration is maintained;"
  desc <<~DESC
  ...
  tag nist: ['CM-2 (6)']
  tag control: 'CM-2 (6)'
  tag objective: 'CM-02(06)[01]'
  tag rev: 'Rev_5'
  tag family: 'Configuration Management'
  tag baseline: %w{}
  tag control_cm_2_6: true

  describe 'NIST SP 800-53A Rev 5 objective CM-02(06)[01]' do
