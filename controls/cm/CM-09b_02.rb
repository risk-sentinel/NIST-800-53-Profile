control 'CM-09b.[02]' do
  impact 0.5
  title "the configuration management plan establishes a process for managing the configuration of the configuration items;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-09b.[02]' do
