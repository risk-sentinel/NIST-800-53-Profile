control 'CM-03(04)[02]' do
  impact 0.5
  title "#{input('cm_03_04_odp_02')} are required to be members of the #{input('cm_03_04_odp_03')}."
  desc <<~DESC
    Require #{input('cm_3_4_prm_1')} to be members of the #{input('cm_03_04_odp_03')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      #{input('cm_03_04_odp_02')} are required to be members of the #{input('cm_03_04_odp_03')}.
  ...
  tag odp: %w{cm_03_04_odp_02 cm_03_04_odp_03 cm_3_4_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective CM-03(04)[02]' do
