control 'CM-04[01]' do
  impact 0.5
  title "changes to the system are analyzed to determine potential security impacts prior to change implementation;"
  desc <<~DESC
  ...
  tag control_cm_4: true

  describe 'NIST SP 800-53A Rev 5 objective CM-04[01]' do
