control 'CM-06d.[01]' do
  impact 0.5
  title "changes to the configuration settings are monitored in accordance with organizational policies and procedures;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-06d.[01]' do
