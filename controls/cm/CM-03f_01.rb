control 'CM-03f.[01]' do
  impact 0.5
  title "activities associated with configuration-controlled changes to the system are monitored;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-03f.[01]' do
