control 'CM-08a.02' do
  impact 0.5
  title "an inventory of system components that includes all components within the system is developed and documented;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-08a.02' do
