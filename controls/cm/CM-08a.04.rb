control 'CM-08a.04' do
  impact 0.5
  title "an inventory of system components that is at the level of granularity deemed necessary for tracking and reporting is developed and documented;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-08a.04' do
