control 'CM-06d.[02]' do
  impact 0.5
  title "changes to the configuration settings are controlled in accordance with organizational policies and procedures."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-06d.[02]' do
