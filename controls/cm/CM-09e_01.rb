control 'CM-09e.[01]' do
  impact 0.5
  title "the configuration management plan is protected from unauthorized disclosure;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-09e.[01]' do
