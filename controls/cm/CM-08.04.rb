control 'CM-08(04)' do
  impact 0.5
  title "individuals responsible and accountable for administering system components are identified by #{input('cm_08_04_odp')} in the system component inventory."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      individuals responsible and accountable for administering system components are identified by #{input('cm_08_04_odp')} in the system component inventory.
  ...
  tag nist: ['CM-8 (4)']
  tag control: 'CM-8 (4)'
  tag objective: 'CM-08(04)'
  tag rev: 'Rev_5'
  tag family: 'Configuration Management'
  tag baseline: %w{HIGH}
  tag baseline_high: true
  tag control_cm_8_4: true
  tag odp: %w{cm_08_04_odp}

  describe 'NIST SP 800-53A Rev 5 objective CM-08(04)' do
