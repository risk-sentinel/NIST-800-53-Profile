control 'CM-02(07)(a)' do
  impact 0.5
  title "#{input('cm_02_07_odp_01')} with #{input('cm_02_07_odp_02')} are issued to individuals traveling to locations that the organization deems to be of significant risk;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('cm_02_07_odp_01')} with #{input('cm_02_07_odp_02')} are issued to individuals traveling to locations that the organization deems to be of significant risk;
