control 'CM-02(07)(b)' do
  impact 0.5
  title "#{input('cm_02_07_odp_03')} are applied to the systems or system components when the individuals return from travel."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('cm_02_07_odp_03')} are applied to the systems or system components when the individuals return from travel.
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-02(07)(b)' do
