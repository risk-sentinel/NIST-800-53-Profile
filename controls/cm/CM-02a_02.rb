control 'CM-02a.[02]' do
  impact 0.5
  title "a current baseline configuration of the system is maintained under configuration control;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-02a.[02]' do
