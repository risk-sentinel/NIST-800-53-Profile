control 'CM-08b.' do
  impact 0.5
  title "the system component inventory is reviewed and updated #{input('cm_08_odp_02')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the system component inventory is reviewed and updated #{input('cm_08_odp_02')}.
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-08b.' do
