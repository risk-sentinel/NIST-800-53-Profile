control 'CM-03(02)[01]' do
  impact 0.5
  title "changes to the system are tested before finalizing the implementation of the changes;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-03(02)[01]' do
