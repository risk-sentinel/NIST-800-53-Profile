control 'CM-03(01)(c)' do
  impact 0.5
  title "#{input('cm_03_01_odp_01')} are used to highlight proposed changes to the system that have not been approved or disapproved within #{input('cm_03_01_odp_03')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('cm_03_01_odp_01')} are used to highlight proposed changes to the system that have not been approved or disapproved within #{input('cm_03_01_odp_03')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-03(01)(c)' do
