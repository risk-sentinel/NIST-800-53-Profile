control 'CM-03(01)(a)' do
  impact 0.5
  title "#{input('cm_03_01_odp_01')} are used to document proposed changes to the system;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('cm_03_01_odp_01')} are used to document proposed changes to the system;
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-03(01)(a)' do
