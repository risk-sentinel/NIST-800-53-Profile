control 'CM-08(09)(b)' do
  impact 0.5
  title "an acknowledgement of the component assignment is received from #{input('cm_08_09_odp')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      an acknowledgement of the component assignment is received from #{input('cm_08_09_odp')}.
  ...
  tag nist: ['CM-8 (9)']
  tag control: 'CM-8 (9)'
  tag objective: 'CM-08(09)(b)'
  tag rev: 'Rev_5'
  tag family: 'Configuration Management'
  tag baseline: %w{}
  tag control_cm_8_9: true
  tag odp: %w{cm_08_09_odp}

  describe 'NIST SP 800-53A Rev 5 objective CM-08(09)(b)' do
