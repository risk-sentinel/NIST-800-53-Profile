control 'CM-01a.[04]' do
  impact 0.5
  title "the configuration management procedures are disseminated to #{input('cm_01_odp_02')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the configuration management procedures are disseminated to #{input('cm_01_odp_02')};
  ...
  tag odp: %w{cm_01_odp_02 cm_01_odp_03 cm_01_odp_04 cm_01_odp_05 cm_01_odp_06 cm_01_odp_07 cm_01_odp_08 cm_1_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective CM-01a.[04]' do
