control 'CM-07(09)(b)' do
  impact 0.5
  title "the use or connection of unauthorized hardware components is prohibited;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-07(09)(b)' do
