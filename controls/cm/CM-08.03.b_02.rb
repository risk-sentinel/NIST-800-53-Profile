control 'CM-08(03)(b)[02]' do
  impact 0.5
  title "#{input('cm_08_03_odp_05')} are taken when unauthorized software is detected;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('cm_08_03_odp_05')} are taken when unauthorized software is detected;
  ...
  tag odp: %w{cm_08_03_odp_04 cm_08_03_odp_05 cm_8_3_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective CM-08(03)(b)[02]' do
