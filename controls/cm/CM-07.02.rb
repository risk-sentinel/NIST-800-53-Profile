control 'CM-07(02)' do
  impact 0.5
  title "program execution is prevented in accordance with #{input('cm_07_02_odp_01')}."
  desc <<~DESC
    Prevent program execution in accordance with #{input('cm_07_02_odp_01')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      program execution is prevented in accordance with #{input('cm_07_02_odp_01')}.
  ...
  tag nist: ['CM-7 (2)']
  tag control: 'CM-7 (2)'
  tag objective: 'CM-07(02)'
  tag rev: 'Rev_5'
  tag family: 'Configuration Management'
  tag baseline: %w{MODERATE HIGH}
  tag baseline_moderate: true
  tag baseline_high: true
  tag control_cm_7_2: true
  tag odp: %w{cm_07_02_odp_01}

  describe 'NIST SP 800-53A Rev 5 objective CM-07(02)' do
