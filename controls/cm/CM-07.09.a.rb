control 'CM-07(09)(a)' do
  impact 0.5
  title "#{input('cm_07_09_odp_01')} are identified;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('cm_07_09_odp_01')} are identified;
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-07(09)(a)' do
