control 'CM-03(01)(b)' do
  impact 0.5
  title "#{input('cm_03_01_odp_01')} are used to notify #{input('cm_03_01_odp_02')} of proposed changes to the system and request change approval;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('cm_03_01_odp_01')} are used to notify #{input('cm_03_01_odp_02')} of proposed changes to the system and request change approval;
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-03(01)(b)' do
