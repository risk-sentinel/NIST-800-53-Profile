control 'CM-08(06)[02]' do
  impact 0.5
  title "any approved deviations to current deployed configurations are included in the system component inventory."
  desc <<~DESC
  ...
  tag nist: ['CM-8 (6)']
  tag control: 'CM-8 (6)'
  tag objective: 'CM-08(06)[02]'
  tag rev: 'Rev_5'
  tag family: 'Configuration Management'
  tag baseline: %w{}
  tag control_cm_8_6: true

  describe 'NIST SP 800-53A Rev 5 objective CM-08(06)[02]' do
