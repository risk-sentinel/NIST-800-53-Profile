control 'CM-05(01)(b)' do
  impact 0.5
  title "audit records of enforcement actions are automatically generated."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-05(01)(b)' do
