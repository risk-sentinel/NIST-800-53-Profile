control 'CM-04[02]' do
  impact 0.5
  title "changes to the system are analyzed to determine potential privacy impacts prior to change implementation."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-04[02]' do
