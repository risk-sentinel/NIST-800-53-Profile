control 'CM-09c.[02]' do
  impact 0.5
  title "the configuration management plan places the configuration items under configuration management;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-09c.[02]' do
