control 'CM-03(01)(d)' do
  impact 0.5
  title "#{input('cm_03_01_odp_01')} are used to prohibit changes to the system until designated approvals are received;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('cm_03_01_odp_01')} are used to prohibit changes to the system until designated approvals are received;
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-03(01)(d)' do
