control 'CM-09a.[01]' do
  impact 0.5
  title "the configuration management plan addresses roles;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-09a.[01]' do
