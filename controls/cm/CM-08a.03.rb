control 'CM-08a.03' do
  impact 0.5
  title "an inventory of system components that does not include duplicate accounting of components or components assigned to any other system is developed and documented;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-08a.03' do
