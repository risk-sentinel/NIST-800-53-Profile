control 'CM-12a.[02]' do
  impact 0.5
  title "the specific system components on which #{input('cm_12_odp')} is processed are identified and documented;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the specific system components on which #{input('cm_12_odp')} is processed are identified and documented;
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-12a.[02]' do
