control 'CM-03g.[02]' do
  impact 0.5
  title "the configuration control element convenes #{input('cm_03_odp_03')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the configuration control element convenes #{input('cm_03_odp_03')}.
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-03g.[02]' do
