control 'CM-05(05)(a)[02]' do
  impact 0.5
  title "privileges to change system-related information within a production or operational environment are limited;"
  desc <<~DESC
  ...
  tag nist: ['CM-5 (5)']
  tag control: 'CM-5 (5)'
  tag objective: 'CM-05(05)(a)[02]'
  tag rev: 'Rev_5'
  tag family: 'Configuration Management'
  tag baseline: %w{}
  tag control_cm_5_5: true
  tag odp: %w{cm_5_5_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective CM-05(05)(a)[02]' do
