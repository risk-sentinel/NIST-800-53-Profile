control 'CM-08(02)[04]' do
  impact 0.5
  title "#{input('cm_08_02_odp_04')} are used to maintain the availability of the system component inventory."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('cm_08_02_odp_04')} are used to maintain the availability of the system component inventory.
  ...
  tag nist: ['CM-8 (2)']
  tag control: 'CM-8 (2)'
  tag objective: 'CM-08(02)[04]'
  tag rev: 'Rev_5'
  tag family: 'Configuration Management'
  tag baseline: %w{HIGH}
  tag baseline_high: true
  tag control_cm_8_2: true
  tag odp: %w{cm_08_02_odp_04 cm_8_2_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective CM-08(02)[04]' do
