control 'CM-07(07)(a)' do
  impact 0.5
  title "the execution of binary or machine-executable code obtained from sources with limited or no warranty is only allowed with the explicit approval of #{input('cm_07_07_odp')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the execution of binary or machine-executable code obtained from sources with limited or no warranty is only allowed with the explicit approval of #{input('cm_07_07_odp')};
  ...
  tag nist: ['CM-7 (7)']
  tag control: 'CM-7 (7)'
  tag objective: 'CM-07(07)(a)'
  tag rev: 'Rev_5'
  tag family: 'Configuration Management'
  tag baseline: %w{}
  tag control_cm_7_7: true
  tag odp: %w{cm_07_07_odp}

  describe 'NIST SP 800-53A Rev 5 objective CM-07(07)(a)' do
