control 'CM-03(03)[02]' do
  impact 0.5
  title "the updated baseline is deployed across the installed base using #{input('cm_03_03_odp')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the updated baseline is deployed across the installed base using #{input('cm_03_03_odp')}.
  ...
  tag nist: ['CM-3 (3)']
  tag control: 'CM-3 (3)'
  tag objective: 'CM-03(03)[02]'
  tag rev: 'Rev_5'
  tag family: 'Configuration Management'
  tag baseline: %w{}
  tag control_cm_3_3: true
  tag odp: %w{cm_03_03_odp}

  describe 'NIST SP 800-53A Rev 5 objective CM-03(03)[02]' do
