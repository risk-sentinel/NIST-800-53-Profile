control 'CM-09b.[01]' do
  impact 0.5
  title "the configuration management plan establishes a process for identifying configuration items throughout the system development life cycle;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-09b.[01]' do
