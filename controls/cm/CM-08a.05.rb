control 'CM-08a.05' do
  impact 0.5
  title "an inventory of system components that includes #{input('cm_08_odp_01')} is developed and documented;"
  desc <<~DESC
    a. Develop and document an inventory of system components that:
      ...
      5. Includes the following information to achieve system component accountability: #{input('cm_08_odp_01')} ; and
    b. Review and update the system component inventory #{input('cm_08_odp_02')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      an inventory of system components that includes #{input('cm_08_odp_01')} is developed and documented;
  ...
  tag control_cm_8: true
  tag odp: %w{cm_08_odp_01 cm_08_odp_02}

  describe 'NIST SP 800-53A Rev 5 objective CM-08a.05' do
