control 'CM-06a.' do
  impact 0.5
  title "configuration settings that reflect the most restrictive mode consistent with operational requirements are established and documented for components employed within the system using #{input('cm_06_odp_01')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      configuration settings that reflect the most restrictive mode consistent with operational requirements are established and documented for components employed within the system using #{input('cm_06_odp_01')};
  ...
  tag control_cm_6: true
  tag odp: %w{cm_06_odp_01 cm_06_odp_02 cm_06_odp_03}

  describe 'NIST SP 800-53A Rev 5 objective CM-06a.' do
