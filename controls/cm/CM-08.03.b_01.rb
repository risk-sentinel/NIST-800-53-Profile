control 'CM-08(03)(b)[01]' do
  impact 0.5
  title "#{input('cm_08_03_odp_05')} are taken when unauthorized hardware is detected;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('cm_08_03_odp_05')} are taken when unauthorized hardware is detected;
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-08(03)(b)[01]' do
