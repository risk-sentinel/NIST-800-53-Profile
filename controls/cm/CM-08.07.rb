control 'CM-08(07)' do
  impact 0.5
  title "a centralized repository for the system component inventory is provided."
  desc <<~DESC
  ...
  tag nist: ['CM-8 (7)']
  tag control: 'CM-8 (7)'
  tag objective: 'CM-08(07)'
  tag rev: 'Rev_5'
  tag family: 'Configuration Management'
  tag baseline: %w{}
  tag control_cm_8_7: true

  describe 'NIST SP 800-53A Rev 5 objective CM-08(07)' do
