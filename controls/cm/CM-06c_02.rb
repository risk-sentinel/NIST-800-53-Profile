control 'CM-06c.[02]' do
  impact 0.5
  title "any deviations from established configuration settings for #{input('cm_06_odp_02')} are approved;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      any deviations from established configuration settings for #{input('cm_06_odp_02')} are approved;
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-06c.[02]' do
