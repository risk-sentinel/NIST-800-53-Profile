control 'CM-12b.[02]' do
  impact 0.5
  title "the users who have access to the system and system components where #{input('cm_12_odp')} is stored are identified and documented;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the users who have access to the system and system components where #{input('cm_12_odp')} is stored are identified and documented;
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-12b.[02]' do
