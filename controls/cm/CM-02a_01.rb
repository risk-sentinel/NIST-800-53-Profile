control 'CM-02a.[01]' do
  impact 0.5
  title "a current baseline configuration of the system is developed and documented;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-02a.[01]' do
