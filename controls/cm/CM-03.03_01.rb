control 'CM-03(03)[01]' do
  impact 0.5
  title "changes to the current system baseline are implemented using #{input('cm_03_03_odp')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      changes to the current system baseline are implemented using #{input('cm_03_03_odp')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-03(03)[01]' do
