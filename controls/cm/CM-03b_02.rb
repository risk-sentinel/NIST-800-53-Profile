control 'CM-03b.[02]' do
  impact 0.5
  title "proposed configuration-controlled changes to the system are approved or disapproved with explicit consideration for security and privacy impact analyses;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-03b.[02]' do
