control 'CM-05[01]' do
  impact 0.5
  title "physical access restrictions associated with changes to the system are defined and documented;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-05[01]' do
