control 'CM-04(01)[01]' do
  impact 0.5
  title "changes to the system are analyzed in a separate test environment before implementation in an operational environment;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-04(01)[01]' do
