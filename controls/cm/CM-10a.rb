control 'CM-10a.' do
  impact 0.5
  title "software and associated documentation are used in accordance with contract agreements and copyright laws;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-10a.' do
