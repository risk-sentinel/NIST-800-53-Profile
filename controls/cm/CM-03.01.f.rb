control 'CM-03(01)(f)' do
  impact 0.5
  title "#{input('cm_03_01_odp_01')} are used to notify #{input('cm_03_01_odp_04')} when approved changes to the system are completed."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('cm_03_01_odp_01')} are used to notify #{input('cm_03_01_odp_04')} when approved changes to the system are completed.
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-03(01)(f)' do
