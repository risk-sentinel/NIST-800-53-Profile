control 'CM-11b.' do
  impact 0.5
  title "software installation policies are enforced through #{input('cm_11_odp_02')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      software installation policies are enforced through #{input('cm_11_odp_02')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-11b.' do
