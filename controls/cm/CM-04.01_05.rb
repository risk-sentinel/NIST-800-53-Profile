control 'CM-04(01)[05]' do
  impact 0.5
  title "changes to the system are analyzed for privacy impacts due to weaknesses;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-04(01)[05]' do
