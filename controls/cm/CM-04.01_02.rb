control 'CM-04(01)[02]' do
  impact 0.5
  title "changes to the system are analyzed for security impacts due to flaws;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-04(01)[02]' do
