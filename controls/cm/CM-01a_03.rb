control 'CM-01a.[03]' do
  impact 0.5
  title "configuration management procedures to facilitate the implementation of the configuration management policy and associated configuration management controls are developed and documented;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-01a.[03]' do
