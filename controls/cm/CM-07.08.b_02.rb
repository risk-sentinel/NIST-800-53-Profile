control 'CM-07(08)(b)[02]' do
  impact 0.5
  title "exceptions to the prohibition of binary or machine-executable code from sources with limited or no warranty or without the provision of source code are allowed only with the approval of the authorizing official."
  desc <<~DESC
  ...
  tag nist: ['CM-7 (8)']
  tag control: 'CM-7 (8)'
  tag objective: 'CM-07(08)(b)[02]'
  tag rev: 'Rev_5'
  tag family: 'Configuration Management'
  tag baseline: %w{}
  tag control_cm_7_8: true

  describe 'NIST SP 800-53A Rev 5 objective CM-07(08)(b)[02]' do
