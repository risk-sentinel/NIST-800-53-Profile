control 'CM-03b.[01]' do
  impact 0.5
  title "proposed configuration-controlled changes to the system are reviewed;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-03b.[01]' do
