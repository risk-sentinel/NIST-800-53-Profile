control 'CM-09d.' do
  impact 0.5
  title "the configuration management plan is reviewed and approved by #{input('cm_09_odp')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the configuration management plan is reviewed and approved by #{input('cm_09_odp')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-09d.' do
