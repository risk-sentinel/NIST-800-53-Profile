control 'CM-06(01)[02]' do
  impact 0.5
  title "configuration settings for #{input('cm_06_01_odp_01')} are applied using #{input('cm_06_01_odp_03')};"
  desc <<~DESC
    Manage, apply, and verify configuration settings for #{input('cm_06_01_odp_01')} using #{input('cm_6_1_prm_2')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      configuration settings for #{input('cm_06_01_odp_01')} are applied using #{input('cm_06_01_odp_03')};
  ...
  tag nist: ['CM-6 (1)']
  tag control: 'CM-6 (1)'
  tag objective: 'CM-06(01)[02]'
  tag rev: 'Rev_5'
  tag family: 'Configuration Management'
  tag baseline: %w{HIGH}
  tag baseline_high: true
  tag control_cm_6_1: true
  tag odp: %w{cm_06_01_odp_01 cm_06_01_odp_03 cm_6_1_prm_2}

  describe 'NIST SP 800-53A Rev 5 objective CM-06(01)[02]' do
