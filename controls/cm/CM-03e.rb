control 'CM-03e.' do
  impact 0.5
  title "records of configuration-controlled changes to the system are retained for #{input('cm_03_odp_01')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      records of configuration-controlled changes to the system are retained for #{input('cm_03_odp_01')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-03e.' do
