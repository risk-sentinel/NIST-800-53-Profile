control 'CM-07(07)(b)' do
  impact 0.5
  title "the execution of binary or machine-executable code without the provision of source code is only allowed with the explicit approval of #{input('cm_07_07_odp')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the execution of binary or machine-executable code without the provision of source code is only allowed with the explicit approval of #{input('cm_07_07_odp')}.
  ...
  describe 'NIST SP 800-53A Rev 5 objective CM-07(07)(b)' do
