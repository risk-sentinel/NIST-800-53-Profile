control 'CA-5' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      ...
      CA-05b. existing plan of action and milestones are updated #{input('ca_05_odp')} based on the findings from control assessments, independent audits or reviews, and continuous monitoring activities.
  ...
  describe 'NIST SP 800-53 Rev 5 control CA-5' do
