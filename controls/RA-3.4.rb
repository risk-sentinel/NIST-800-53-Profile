control 'RA-3 (4)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      RA-03(04)[01] #{input('ra_03_04_odp_01')} are employed to predict and identify risks to #{input('ra_03_04_odp_02')};
      RA-03(04)[02] #{input('ra_03_04_odp_03')} are employed to predict and identify risks to #{input('ra_03_04_odp_02')}.
  ...
  tag baseline: %w{}
  tag odp: %w{ra_03_04_odp_01 ra_03_04_odp_02 ra_03_04_odp_03 ra_3_4_prm_2}

  describe 'NIST SP 800-53 Rev 5 control RA-3 (4)' do
