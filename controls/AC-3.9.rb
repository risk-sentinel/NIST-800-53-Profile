control 'AC-3 (9)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      AC-03(09)(a) information is released outside of the system only if the receiving #{input('ac_03_09_odp_01')} provides #{input('ac_03_09_odp_02')};
      AC-03(09)(b) information is released outside of the system only if #{input('ac_03_09_odp_03')} are used to validate the appropriateness of the information designated for release.
  ...
  describe 'NIST SP 800-53 Rev 5 control AC-3 (9)' do
