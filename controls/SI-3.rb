control 'SI-3' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SI-03a.
        SI-03a.[01] #{input('si_03_odp_01')} malicious code protection mechanisms are implemented at system entry and exit points to detect malicious code;
        SI-03a.[02] #{input('si_03_odp_01')} malicious code protection mechanisms are implemented at system entry and exit points to eradicate malicious code;
      ...
      SI-03c.
        SI-03c.01
          SI-03c.01[01] malicious code protection mechanisms are configured to perform periodic scans of the system #{input('si_03_odp_02')};
          SI-03c.01[02] malicious code protection mechanisms are configured to perform real-time scans of files from external sources at #{input('si_03_odp_03')} as the files are downloaded, opened, or executed in accordance with organizational policy;
        SI-03c.02
          SI-03c.02[01] malicious code protection mechanisms are configured to #{input('si_03_odp_04')} in response to malicious code detection;
          SI-03c.02[02] malicious code protection mechanisms are configured to send alerts to #{input('si_03_odp_06')} in response to malicious code detection;
  ...
  describe 'NIST SP 800-53 Rev 5 control SI-3' do
