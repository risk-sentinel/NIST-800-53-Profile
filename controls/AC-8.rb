control 'AC-8' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      AC-08a. #{input('ac_08_odp_01')} is displayed to users before granting access to the system that provides privacy and security notices consistent with applicable laws, Executive Orders, directives, regulations, policies, standards, and guidelines;
      ...
      AC-08c.
        AC-08c.01 for publicly accessible systems, system use information #{input('ac_08_odp_02')} is displayed before granting further access to the publicly accessible system;
  ...
  describe 'NIST SP 800-53 Rev 5 control AC-8' do
