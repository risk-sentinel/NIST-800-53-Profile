control 'SC-12' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SC-12[01] cryptographic keys are established when cryptography is employed within the system in accordance with #{input('sc_12_odp')};
      SC-12[02] cryptographic keys are managed when cryptography is employed within the system in accordance with #{input('sc_12_odp')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control SC-12' do
