control 'IA-3 (1)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      IA-03(01) #{input('ia_03_01_odp_01')} are authenticated before establishing #{input('ia_03_01_odp_02')} connection using bidirectional authentication that is cryptographically based.
  ...
  describe 'NIST SP 800-53 Rev 5 control IA-3 (1)' do
