control 'SC-4 (2)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SC-04(02) unauthorized information transfer via shared resources is prevented in accordance with #{input('sc_04_02_odp')} when system processing explicitly switches between different information classification levels or security categories.
  ...
  describe 'NIST SP 800-53 Rev 5 control SC-4 (2)' do
