control 'CP-2' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      CP-02a.
        ...
        CP-02a.07
          CP-02a.07[01] a contingency plan for the system is developed that is reviewed by #{input('cp_02_odp_01')};
          CP-02a.07[02] a contingency plan for the system is developed that is approved by #{input('cp_02_odp_02')};
      CP-02b.
        CP-02b.[01] copies of the contingency plan are distributed to #{input('cp_02_odp_03')};
        CP-02b.[02] copies of the contingency plan are distributed to #{input('cp_02_odp_04')};
      CP-02c. contingency planning activities are coordinated with incident handling activities;
      CP-02d. the contingency plan for the system is reviewed #{input('cp_02_odp_05')};
      CP-02e.
      ...
      CP-02f.
        CP-02f.[01] contingency plan changes are communicated to #{input('cp_02_odp_06')};
        CP-02f.[02] contingency plan changes are communicated to #{input('cp_02_odp_07')};
      CP-02g.
  ...
  tag odp: %w{cp_02_odp_01 cp_02_odp_02 cp_02_odp_03 cp_02_odp_04 cp_02_odp_05 cp_02_odp_06 cp_02_odp_07 cp_2_prm_1 cp_2_prm_2 cp_2_prm_4}

  describe 'NIST SP 800-53 Rev 5 control CP-2' do
