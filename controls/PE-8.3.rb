control 'PE-8 (3)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      PE-08(03) personally identifiable information contained in visitor access records is limited to #{input('pe_08_03_odp')} identified in the privacy risk assessment.
  ...
  describe 'NIST SP 800-53 Rev 5 control PE-8 (3)' do
