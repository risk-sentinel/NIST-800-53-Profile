control 'SC-43' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SC-43a. usage restrictions and implementation guidelines are established for #{input('sc_43_odp')};
      SC-43b.
        SC-43b.[01] the use of #{input('sc_43_odp')} is authorized within the system;
        SC-43b.[02] the use of #{input('sc_43_odp')} is monitored within the system;
        SC-43b.[03] the use of #{input('sc_43_odp')} is controlled within the system.
  ...
  describe 'NIST SP 800-53 Rev 5 control SC-43' do
