control 'SA-17 (4)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      ...
      SA-17(04)(b) the developer of the system, system component, or system service is required to show via #{input('sa_17_04_odp')} that the descriptive top-level specification is consistent with the formal policy model;
  ...
  describe 'NIST SP 800-53 Rev 5 control SA-17 (4)' do
