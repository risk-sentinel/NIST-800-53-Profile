control 'SC-17' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SC-17a. public key certificates are issued under #{input('sc_17_odp')} , or public key certificates are obtained from an approved service provider;
  ...
  describe 'NIST SP 800-53 Rev 5 control SC-17' do
