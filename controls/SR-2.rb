control 'SR-2' do
  ...
  desc <<~DESC
    a. Develop a plan for managing supply chain risks associated with the research and development, design, manufacturing, acquisition, delivery, integration, operations and maintenance, and disposal of the following systems, system components or system services: #{input('sr_02_odp_01')};
    b. Review and update the supply chain risk management plan #{input('sr_02_odp_02')} or as required, to address threat, organizational or environmental changes; and
  ...
  desc 'check', <<~CHECK
    Determine if:
      SR-02a.
        ...
        SR-02a.[02] the supply chain risk management plan addresses risks associated with the research and development of #{input('sr_02_odp_01')};
        SR-02a.[03] the supply chain risk management plan addresses risks associated with the design of #{input('sr_02_odp_01')};
        SR-02a.[04] the supply chain risk management plan addresses risks associated with the manufacturing of #{input('sr_02_odp_01')};
        SR-02a.[05] the supply chain risk management plan addresses risks associated with the acquisition of #{input('sr_02_odp_01')};
        SR-02a.[06] the supply chain risk management plan addresses risks associated with the delivery of #{input('sr_02_odp_01')};
        SR-02a.[07] the supply chain risk management plan addresses risks associated with the integration of #{input('sr_02_odp_01')};
        SR-02a.[08] the supply chain risk management plan addresses risks associated with the operation and maintenance of #{input('sr_02_odp_01')};
        SR-02a.[09] the supply chain risk management plan addresses risks associated with the disposal of #{input('sr_02_odp_01')};
      SR-02b. the supply chain risk management plan is reviewed and updated #{input('sr_02_odp_02')} or as required to address threat, organizational, or environmental changes;
      SR-02c.
  ...
  tag odp: %w{sr_02_odp_01 sr_02_odp_02}

  describe 'NIST SP 800-53 Rev 5 control SR-2' do
