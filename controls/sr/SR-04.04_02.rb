control 'SR-04(04)[02]' do
  impact 0.5
  title "#{input('sr_04_04_odp_02')} is conducted to ensure the integrity of the system and system components."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('sr_04_04_odp_02')} is conducted to ensure the integrity of the system and system components.
  ...
  describe 'NIST SP 800-53A Rev 5 objective SR-04(04)[02]' do
