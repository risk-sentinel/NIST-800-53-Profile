control 'SR-07' do
  impact 0.5
  title "#{input('sr_07_odp')} are employed to protect supply chain-related information for the system, system component, or system service."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('sr_07_odp')} are employed to protect supply chain-related information for the system, system component, or system service.
  ...
  tag baseline: %w{}
  tag control_sr_7: true
  tag odp: %w{sr_07_odp}

  describe 'NIST SP 800-53A Rev 5 objective SR-07' do
