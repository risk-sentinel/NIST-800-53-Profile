control 'SR-02a.[04]' do
  impact 0.5
  title "the supply chain risk management plan addresses risks associated with the manufacturing of #{input('sr_02_odp_01')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the supply chain risk management plan addresses risks associated with the manufacturing of #{input('sr_02_odp_01')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective SR-02a.[04]' do
