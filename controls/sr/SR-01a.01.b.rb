control 'SR-01a.01(b)' do
  impact 0.5
  title "the #{input('sr_01_odp_03')} supply chain risk management policy is consistent with applicable laws, Executive Orders, directives, regulations, policies, standards, and guidelines;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the #{input('sr_01_odp_03')} supply chain risk management policy is consistent with applicable laws, Executive Orders, directives, regulations, policies, standards, and guidelines;
  ...
  describe 'NIST SP 800-53A Rev 5 objective SR-01a.01(b)' do
