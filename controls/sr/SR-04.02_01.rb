control 'SR-04(02)[01]' do
  impact 0.5
  title "the unique identification of #{input('sr_04_02_odp')} is established for tracking through the supply chain;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the unique identification of #{input('sr_04_02_odp')} is established for tracking through the supply chain;
  ...
  describe 'NIST SP 800-53A Rev 5 objective SR-04(02)[01]' do
