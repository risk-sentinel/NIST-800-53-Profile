control 'SR-03b.' do
  impact 0.5
  title "#{input('sr_03_odp_03')} are employed to protect against supply chain risks to the system, system component, or system service and to limit the harm or consequences from supply chain-related events;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('sr_03_odp_03')} are employed to protect against supply chain risks to the system, system component, or system service and to limit the harm or consequences from supply chain-related events;
  ...
  describe 'NIST SP 800-53A Rev 5 objective SR-03b.' do
