control 'SR-05(02)[04]' do
  impact 0.5
  title "the system, system component, or system service is assessed prior to update."
  desc <<~DESC
  ...
  tag nist: ['SR-5 (2)']
  tag control: 'SR-5 (2)'
  tag objective: 'SR-05(02)[04]'
  tag rev: 'Rev_5'
  tag family: 'Supply Chain Risk Management'
  tag baseline: %w{}
  tag control_sr_5_2: true

  describe 'NIST SP 800-53A Rev 5 objective SR-05(02)[04]' do
