control 'SR-11a.[01]' do
  impact 0.5
  title "an anti-counterfeit policy is developed and implemented;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SR-11a.[01]' do
