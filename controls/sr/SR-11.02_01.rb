control 'SR-11(02)[01]' do
  impact 0.5
  title "configuration control over #{input('sr_11_02_odp')} awaiting service or repair is maintained;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      configuration control over #{input('sr_11_02_odp')} awaiting service or repair is maintained;
  ...
  describe 'NIST SP 800-53A Rev 5 objective SR-11(02)[01]' do
