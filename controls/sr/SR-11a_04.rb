control 'SR-11a.[04]' do
  impact 0.5
  title "the anti-counterfeit procedures include the means to prevent counterfeit components from entering the system;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SR-11a.[04]' do
