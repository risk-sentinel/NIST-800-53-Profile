control 'SR-04(01)[01]' do
  impact 0.5
  title "unique identification of #{input('sr_04_01_odp')} is established;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      unique identification of #{input('sr_04_01_odp')} is established;
  ...
  tag nist: ['SR-4 (1)']
  tag control: 'SR-4 (1)'
  tag objective: 'SR-04(01)[01]'
  tag rev: 'Rev_5'
  tag family: 'Supply Chain Risk Management'
  tag baseline: %w{}
  tag control_sr_4_1: true
  tag odp: %w{sr_04_01_odp}

  describe 'NIST SP 800-53A Rev 5 objective SR-04(01)[01]' do
