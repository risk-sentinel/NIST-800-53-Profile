control 'SR-03c.' do
  impact 0.5
  title "the selected and implemented supply chain processes and controls are documented in #{input('sr_03_odp_04')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the selected and implemented supply chain processes and controls are documented in #{input('sr_03_odp_04')}.
  ...
  describe 'NIST SP 800-53A Rev 5 objective SR-03c.' do
