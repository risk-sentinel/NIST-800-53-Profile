control 'SR-04[02]' do
  impact 0.5
  title "valid provenance is monitored for #{input('sr_04_odp')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      valid provenance is monitored for #{input('sr_04_odp')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective SR-04[02]' do
