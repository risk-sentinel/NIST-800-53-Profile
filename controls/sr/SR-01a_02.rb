control 'SR-01a.[02]' do
  impact 0.5
  title "the supply chain risk management policy is disseminated to #{input('sr_01_odp_01')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the supply chain risk management policy is disseminated to #{input('sr_01_odp_01')};
  ...
  tag odp: %w{sr_01_odp_01 sr_01_odp_03 sr_01_odp_04 sr_01_odp_05 sr_01_odp_06 sr_01_odp_07 sr_01_odp_08 sr_1_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective SR-01a.[02]' do
