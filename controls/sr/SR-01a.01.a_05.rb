control 'SR-01a.01(a)[05]' do
  impact 0.5
  title "the #{input('sr_01_odp_03')} supply chain risk management policy addresses management commitment;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the #{input('sr_01_odp_03')} supply chain risk management policy addresses management commitment;
  ...
  describe 'NIST SP 800-53A Rev 5 objective SR-01a.01(a)[05]' do
