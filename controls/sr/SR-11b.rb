control 'SR-11b.' do
  impact 0.5
  title "counterfeit system components are reported to #{input('sr_11_odp_01')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      counterfeit system components are reported to #{input('sr_11_odp_01')}.
  ...
  describe 'NIST SP 800-53A Rev 5 objective SR-11b.' do
