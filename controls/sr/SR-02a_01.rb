control 'SR-02a.[01]' do
  impact 0.5
  title "a plan for managing supply chain risks is developed;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SR-02a.[01]' do
