control 'SR-03a.[02]' do
  impact 0.5
  title "the process or processes to identify and address weaknesses or deficiencies in the supply chain elements and processes of #{input('sr_03_odp_01')} is/are coordinated with #{input('sr_03_odp_02')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the process or processes to identify and address weaknesses or deficiencies in the supply chain elements and processes of #{input('sr_03_odp_01')} is/are coordinated with #{input('sr_03_odp_02')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective SR-03a.[02]' do
