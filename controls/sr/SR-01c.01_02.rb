control 'SR-01c.01[02]' do
  impact 0.5
  title "the current supply chain risk management policy is reviewed and updated following #{input('sr_01_odp_06')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the current supply chain risk management policy is reviewed and updated following #{input('sr_01_odp_06')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective SR-01c.01[02]' do
