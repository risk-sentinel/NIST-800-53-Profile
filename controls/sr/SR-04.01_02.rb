control 'SR-04(01)[02]' do
  impact 0.5
  title "unique identification of #{input('sr_04_01_odp')} is maintained."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      unique identification of #{input('sr_04_01_odp')} is maintained.
  ...
  describe 'NIST SP 800-53A Rev 5 objective SR-04(01)[02]' do
