control 'SR-08' do
  impact 0.5
  title "agreements and procedures are established with entities involved in the supply chain for the system, system components, or system service for #{input('sr_08_odp_01')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      agreements and procedures are established with entities involved in the supply chain for the system, system components, or system service for #{input('sr_08_odp_01')}.
  ...
  tag control_sr_8: true
  tag odp: %w{sr_08_odp_01}

  describe 'NIST SP 800-53A Rev 5 objective SR-08' do
