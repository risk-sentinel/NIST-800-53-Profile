control 'SR-04(04)[01]' do
  impact 0.5
  title "#{input('sr_04_04_odp_01')} are employed to ensure the integrity of the system and system components;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('sr_04_04_odp_01')} are employed to ensure the integrity of the system and system components;
  ...
  tag nist: ['SR-4 (4)']
  tag control: 'SR-4 (4)'
  tag objective: 'SR-04(04)[01]'
  tag rev: 'Rev_5'
  tag family: 'Supply Chain Risk Management'
  tag baseline: %w{}
  tag control_sr_4_4: true
  tag odp: %w{sr_04_04_odp_01 sr_04_04_odp_02}

  describe 'NIST SP 800-53A Rev 5 objective SR-04(04)[01]' do
