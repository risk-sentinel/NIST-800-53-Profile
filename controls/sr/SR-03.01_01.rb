control 'SR-03(01)[01]' do
  impact 0.5
  title "a diverse set of sources is employed for #{input('sr_03_01_odp_01')};"
  desc <<~DESC
    Employ a diverse set of sources for the following system components and services: #{input('sr_3_1_prm_1')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      a diverse set of sources is employed for #{input('sr_03_01_odp_01')};
  ...
  tag nist: ['SR-3 (1)']
  tag control: 'SR-3 (1)'
  tag objective: 'SR-03(01)[01]'
  tag rev: 'Rev_5'
  tag family: 'Supply Chain Risk Management'
  tag baseline: %w{}
  tag control_sr_3_1: true
  tag odp: %w{sr_03_01_odp_01 sr_3_1_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective SR-03(01)[01]' do
