control 'SR-02b.' do
  impact 0.5
  title "the supply chain risk management plan is reviewed and updated #{input('sr_02_odp_02')} or as required to address threat, organizational, or environmental changes;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the supply chain risk management plan is reviewed and updated #{input('sr_02_odp_02')} or as required to address threat, organizational, or environmental changes;
  ...
  tag control_sr_2: true
  tag odp: %w{sr_02_odp_01 sr_02_odp_02}

  describe 'NIST SP 800-53A Rev 5 objective SR-02b.' do
