control 'SR-04(03)[02]' do
  impact 0.5
  title "#{input('sr_04_03_odp_02')} are employed to validate that the system or system component received has not been altered."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('sr_04_03_odp_02')} are employed to validate that the system or system component received has not been altered.
  ...
  tag nist: ['SR-4 (3)']
  tag control: 'SR-4 (3)'
  tag objective: 'SR-04(03)[02]'
  tag rev: 'Rev_5'
  tag family: 'Supply Chain Risk Management'
  tag baseline: %w{}
  tag control_sr_4_3: true
  tag odp: %w{sr_04_03_odp_02 sr_4_3_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective SR-04(03)[02]' do
