control 'SR-09(01)' do
  impact 0.5
  title "anti-tamper technologies, tools, and techniques are employed throughout the system development life cycle."
  desc <<~DESC
  ...
  tag nist: ['SR-9 (1)']
  tag control: 'SR-9 (1)'
  tag objective: 'SR-09(01)'
  tag rev: 'Rev_5'
  tag family: 'Supply Chain Risk Management'
  tag baseline: %w{HIGH}
  tag baseline_high: true
  tag control_sr_9_1: true

  describe 'NIST SP 800-53A Rev 5 objective SR-09(01)' do
