control 'PL-02a.07[02]' do
  impact 0.5
  title "a privacy plan for the system is developed that describes any specific threats to the system that are of concern to the organization;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PL-02a.07[02]' do
