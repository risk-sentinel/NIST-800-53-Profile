control 'PL-08(01)(b)[02]' do
  impact 0.5
  title "the privacy architecture for the system is designed using a defense-in-depth approach that ensures the allocated controls operate in a coordinated and mutually reinforcing manner."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PL-08(01)(b)[02]' do
