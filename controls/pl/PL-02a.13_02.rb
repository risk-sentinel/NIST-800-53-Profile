control 'PL-02a.13[02]' do
  impact 0.5
  title "a privacy plan for the system is developed that includes risk determinations for privacy architecture and design decisions;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PL-02a.13[02]' do
