control 'PL-02b.[02]' do
  impact 0.5
  title "subsequent changes to the plans are communicated to #{input('pl_02_odp_02')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      subsequent changes to the plans are communicated to #{input('pl_02_odp_02')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective PL-02b.[02]' do
