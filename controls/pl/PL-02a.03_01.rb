control 'PL-02a.03[01]' do
  impact 0.5
  title "a security plan for the system is developed that describes the operational context of the system in terms of mission and business processes;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PL-02a.03[01]' do
