control 'PL-08c.[06]' do
  impact 0.5
  title "planned architecture changes are reflected in procurements and acquisitions."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PL-08c.[06]' do
