control 'PL-02a.10[02]' do
  impact 0.5
  title "a privacy plan for the system is developed that provides an overview of the privacy requirements for the system;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PL-02a.10[02]' do
