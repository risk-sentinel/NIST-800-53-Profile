control 'PL-02a.02[01]' do
  impact 0.5
  title "a security plan for the system is developed that explicitly defines the constituent system components;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PL-02a.02[01]' do
