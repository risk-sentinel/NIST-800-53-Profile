control 'PL-08(01)(a)[02]' do
  impact 0.5
  title "the privacy architecture for the system is designed using a defense-in-depth approach that allocates #{input('pl_08_01_odp_01')} to #{input('pl_08_01_odp_02')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the privacy architecture for the system is designed using a defense-in-depth approach that allocates #{input('pl_08_01_odp_01')} to #{input('pl_08_01_odp_02')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective PL-08(01)(a)[02]' do
