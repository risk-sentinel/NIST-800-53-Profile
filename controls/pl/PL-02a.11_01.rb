control 'PL-02a.11[01]' do
  impact 0.5
  title "a security plan for the system is developed that identifies any relevant control baselines or overlays, if applicable;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PL-02a.11[01]' do
