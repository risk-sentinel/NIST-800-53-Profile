control 'PL-02a.13[01]' do
  impact 0.5
  title "a security plan for the system is developed that includes risk determinations for security architecture and design decisions;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PL-02a.13[01]' do
