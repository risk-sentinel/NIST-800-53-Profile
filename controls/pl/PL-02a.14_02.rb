control 'PL-02a.14[02]' do
  impact 0.5
  title "a privacy plan for the system is developed that includes privacy-related activities affecting the system that require planning and coordination with #{input('pl_02_odp_01')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      a privacy plan for the system is developed that includes privacy-related activities affecting the system that require planning and coordination with #{input('pl_02_odp_01')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective PL-02a.14[02]' do
