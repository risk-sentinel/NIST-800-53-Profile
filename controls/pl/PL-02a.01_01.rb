control 'PL-02a.01[01]' do
  impact 0.5
  title "a security plan for the system is developed that is consistent with the organization’s enterprise architecture;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PL-02a.01[01]' do
