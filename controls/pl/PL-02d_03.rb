control 'PL-02d.[03]' do
  impact 0.5
  title "plans are updated to address problems identified during control assessments;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PL-02d.[03]' do
