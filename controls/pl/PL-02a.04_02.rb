control 'PL-02a.04[02]' do
  impact 0.5
  title "a privacy plan for the system is developed that identifies the individuals that fulfill system roles and responsibilities;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PL-02a.04[02]' do
