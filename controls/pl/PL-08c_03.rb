control 'PL-08c.[03]' do
  impact 0.5
  title "planned architecture changes are reflected in the Concept of Operations (CONOPS);"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PL-08c.[03]' do
