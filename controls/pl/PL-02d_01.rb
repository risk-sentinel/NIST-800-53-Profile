control 'PL-02d.[01]' do
  impact 0.5
  title "plans are updated to address changes to the system and environment of operations;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PL-02d.[01]' do
