control 'PL-07a.' do
  impact 0.5
  title "a CONOPS for the system describing how the organization intends to operate the system from the perspective of information security and privacy is developed;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PL-07a.' do
