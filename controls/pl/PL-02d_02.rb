control 'PL-02d.[02]' do
  impact 0.5
  title "plans are updated to address problems identified during the plan implementation;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PL-02d.[02]' do
