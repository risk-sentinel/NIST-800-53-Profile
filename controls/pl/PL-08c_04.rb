control 'PL-08c.[04]' do
  impact 0.5
  title "planned architecture changes are reflected in criticality analysis;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PL-08c.[04]' do
