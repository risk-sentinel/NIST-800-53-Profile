control 'PL-04c.' do
  impact 0.5
  title "rules of behavior are reviewed and updated #{input('pl_04_odp_01')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      rules of behavior are reviewed and updated #{input('pl_04_odp_01')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective PL-04c.' do
