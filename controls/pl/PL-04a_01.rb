control 'PL-04a.[01]' do
  impact 0.5
  title "rules that describe responsibilities and expected behavior for information and system usage, security, and privacy are established for individuals requiring access to the system;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PL-04a.[01]' do
