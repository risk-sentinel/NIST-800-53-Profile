control 'PL-08(01)(a)[01]' do
  impact 0.5
  title "the security architecture for the system is designed using a defense-in-depth approach that allocates #{input('pl_08_01_odp_01')} to #{input('pl_08_01_odp_02')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the security architecture for the system is designed using a defense-in-depth approach that allocates #{input('pl_08_01_odp_01')} to #{input('pl_08_01_odp_02')};
  ...
  tag nist: ['PL-8 (1)']
  tag control: 'PL-8 (1)'
  tag objective: 'PL-08(01)(a)[01]'
  tag rev: 'Rev_5'
  tag family: 'Planning'
  tag baseline: %w{}
  tag control_pl_8_1: true
  tag odp: %w{pl_08_01_odp_01 pl_08_01_odp_02}

  describe 'NIST SP 800-53A Rev 5 objective PL-08(01)(a)[01]' do
