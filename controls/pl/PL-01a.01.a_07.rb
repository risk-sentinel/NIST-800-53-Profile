control 'PL-01a.01(a)[07]' do
  impact 0.5
  title "the #{input('pl_01_odp_03')} planning policy addresses compliance;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the #{input('pl_01_odp_03')} planning policy addresses compliance;
  ...
  describe 'NIST SP 800-53A Rev 5 objective PL-01a.01(a)[07]' do
