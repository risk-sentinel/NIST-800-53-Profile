control 'PL-02e.[02]' do
  impact 0.5
  title "plans are protected from unauthorized modification."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PL-02e.[02]' do
