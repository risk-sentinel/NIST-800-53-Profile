control 'PL-02a.15[02]' do
  impact 0.5
  title "a privacy plan for the system is developed that is reviewed and approved by the authorizing official or designated representative prior to plan implementation."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PL-02a.15[02]' do
