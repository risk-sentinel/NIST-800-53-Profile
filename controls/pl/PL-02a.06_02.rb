control 'PL-02a.06[02]' do
  impact 0.5
  title "a privacy plan for the system is developed that provides the security categorization of the system, including supporting rationale;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PL-02a.06[02]' do
