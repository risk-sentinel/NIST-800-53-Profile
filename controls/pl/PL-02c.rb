control 'PL-02c.' do
  impact 0.5
  title "plans are reviewed #{input('pl_02_odp_03')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      plans are reviewed #{input('pl_02_odp_03')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective PL-02c.' do
