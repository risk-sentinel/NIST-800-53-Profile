control 'PL-08a.04[02]' do
  impact 0.5
  title "a privacy architecture for the system describes any assumptions about and dependencies on external systems and services;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PL-08a.04[02]' do
