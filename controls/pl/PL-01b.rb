control 'PL-01b.' do
  impact 0.5
  title "the #{input('pl_01_odp_04')} is designated to manage the development, documentation, and dissemination of the planning policy and procedures;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the #{input('pl_01_odp_04')} is designated to manage the development, documentation, and dissemination of the planning policy and procedures;
  ...
  describe 'NIST SP 800-53A Rev 5 objective PL-01b.' do
