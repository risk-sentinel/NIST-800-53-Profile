control 'PL-11' do
  impact 0.5
  title "the selected control baseline is tailored by applying specified tailoring actions."
  desc <<~DESC
  ...
  tag control_pl_11: true

  describe 'NIST SP 800-53A Rev 5 objective PL-11' do
