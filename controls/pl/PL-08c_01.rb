control 'PL-08c.[01]' do
  impact 0.5
  title "planned architecture changes are reflected in the security plan;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PL-08c.[01]' do
