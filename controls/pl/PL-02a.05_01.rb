control 'PL-02a.05[01]' do
  impact 0.5
  title "a security plan for the system is developed that identifies the information types processed, stored, and transmitted by the system;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PL-02a.05[01]' do
