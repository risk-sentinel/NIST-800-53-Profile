control 'PL-04(01)(c)' do
  impact 0.5
  title "the rules of behavior include restrictions on the use of organization-provided identifiers (e.g., email addresses) and authentication secrets (e.g., passwords) for creating accounts on external sites/applications."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PL-04(01)(c)' do
