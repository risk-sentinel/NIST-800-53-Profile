control 'PL-04d.' do
  impact 0.5
  title "individuals who have acknowledged a previous version of the rules of behavior are required to read and reacknowledge #{input('pl_04_odp_02')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      individuals who have acknowledged a previous version of the rules of behavior are required to read and reacknowledge #{input('pl_04_odp_02')}.
  ...
  describe 'NIST SP 800-53A Rev 5 objective PL-04d.' do
