control 'PL-01a.[02]' do
  impact 0.5
  title "the planning policy is disseminated to #{input('pl_01_odp_01')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the planning policy is disseminated to #{input('pl_01_odp_01')};
  ...
  tag odp: %w{pl_01_odp_01 pl_01_odp_03 pl_01_odp_04 pl_01_odp_05 pl_01_odp_06 pl_01_odp_07 pl_01_odp_08 pl_1_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective PL-01a.[02]' do
