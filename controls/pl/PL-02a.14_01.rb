control 'PL-02a.14[01]' do
  impact 0.5
  title "a security plan for the system is developed that includes security-related activities affecting the system that require planning and coordination with #{input('pl_02_odp_01')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      a security plan for the system is developed that includes security-related activities affecting the system that require planning and coordination with #{input('pl_02_odp_01')};
  ...
  tag control_pl_2: true
  tag odp: %w{pl_02_odp_01 pl_02_odp_02 pl_02_odp_03}

  describe 'NIST SP 800-53A Rev 5 objective PL-02a.14[01]' do
