control 'PL-08b.' do
  impact 0.5
  title "changes in the enterprise architecture are reviewed and updated #{input('pl_08_odp')} to reflect changes in the enterprise architecture;"
  desc <<~DESC
    ...
    b. Review and update the architectures #{input('pl_08_odp')} to reflect changes in the enterprise architecture; and
    c. Reflect planned architecture changes in security and privacy plans, Concept of Operations (CONOPS), criticality analysis, organizational procedures, and procurements and acquisitions.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      changes in the enterprise architecture are reviewed and updated #{input('pl_08_odp')} to reflect changes in the enterprise architecture;
  ...
  tag control_pl_8: true
  tag odp: %w{pl_08_odp}

  describe 'NIST SP 800-53A Rev 5 objective PL-08b.' do
