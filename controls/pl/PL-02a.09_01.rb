control 'PL-02a.09[01]' do
  impact 0.5
  title "a security plan for the system is developed that describes the operational environment for the system and any dependencies on or connections to other systems or system components;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PL-02a.09[01]' do
