control 'PL-02b.[01]' do
  impact 0.5
  title "copies of the plans are distributed to #{input('pl_02_odp_02')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      copies of the plans are distributed to #{input('pl_02_odp_02')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective PL-02b.[01]' do
