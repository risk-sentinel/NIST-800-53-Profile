control 'SC-16 (3)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SC-16(03) #{input('sc_16_03_odp')} are implemented to bind security and privacy attributes to transmitted information.
  ...
  describe 'NIST SP 800-53 Rev 5 control SC-16 (3)' do
