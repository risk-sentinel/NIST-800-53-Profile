control 'SI-7 (2)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SI-07(02) automated tools that provide notification to #{input('si_07_02_odp')} upon discovering discrepancies during integrity verification are employed.
  ...
  describe 'NIST SP 800-53 Rev 5 control SI-7 (2)' do
