control 'RA-9' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      RA-09 critical system components and functions are identified by performing a criticality analysis for #{input('ra_09_odp_01')} at #{input('ra_09_odp_02')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control RA-9' do
