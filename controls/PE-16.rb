control 'PE-16' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      PE-16a.
        PE-16a.[01] #{input('pe_16_odp_01')} are authorized when entering the facility;
        PE-16a.[02] #{input('pe_16_odp_01')} are controlled when entering the facility;
        PE-16a.[03] #{input('pe_16_odp_02')} are authorized when exiting the facility;
        PE-16a.[04] #{input('pe_16_odp_02')} are controlled when exiting the facility;
  ...
  tag odp: %w{pe_16_odp_01 pe_16_odp_02 pe_16_prm_1}

  describe 'NIST SP 800-53 Rev 5 control PE-16' do
