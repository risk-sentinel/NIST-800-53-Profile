control 'SA-8' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SA-08[01] #{input('sa_08_odp_01')} are applied in the specification of the system and system components;
      SA-08[02] #{input('sa_08_odp_01')} are applied in the design of the system and system components;
      SA-08[03] #{input('sa_08_odp_01')} are applied in the development of the system and system components;
      SA-08[04] #{input('sa_08_odp_01')} are applied in the implementation of the system and system components;
      SA-08[05] #{input('sa_08_odp_01')} are applied in the modification of the system and system components;
      SA-08[06] #{input('sa_08_odp_02')} are applied in the specification of the system and system components;
      SA-08[07] #{input('sa_08_odp_02')} are applied in the design of the system and system components;
      SA-08[08] #{input('sa_08_odp_02')} are applied in the development of the system and system components;
      SA-08[09] #{input('sa_08_odp_02')} are applied in the implementation of the system and system components;
      SA-08[10] #{input('sa_08_odp_02')} are applied in the modification of the system and system components.
  ...
  tag odp: %w{sa_08_odp_01 sa_08_odp_02 sa_8_prm_1}

  describe 'NIST SP 800-53 Rev 5 control SA-8' do
