control 'CM-12 (1)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      CM-12(01) automated tools are used to identify #{input('cm_12_01_odp_01')} on #{input('cm_12_01_odp_02')} to ensure that controls are in place to protect organizational information and individual privacy.
  ...
  describe 'NIST SP 800-53 Rev 5 control CM-12 (1)' do
