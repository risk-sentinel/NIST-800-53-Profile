control 'AU-12' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      AU-12a. audit record generation capability for the event types the system is capable of auditing (defined in AU-02_ODP[01]) is provided by #{input('au_12_odp_01')};
      AU-12b. #{input('au_12_odp_02')} is/are allowed to select the event types that are to be logged by specific components of the system;
  ...
  describe 'NIST SP 800-53 Rev 5 control AU-12' do
