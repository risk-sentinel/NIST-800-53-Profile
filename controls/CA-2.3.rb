control 'CA-2 (3)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      CA-02(03) the results of control assessments performed by #{input('ca_02_03_odp_01')} on #{input('ca_02_03_odp_02')} are leveraged when the assessment meets #{input('ca_02_03_odp_03')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control CA-2 (3)' do
