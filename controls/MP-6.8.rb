control 'MP-6 (8)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      MP-06(08) the capability to purge or wipe information from #{input('mp_06_08_odp_01')} #{input('mp_06_08_odp_02')} is provided.
  ...
  describe 'NIST SP 800-53 Rev 5 control MP-6 (8)' do
