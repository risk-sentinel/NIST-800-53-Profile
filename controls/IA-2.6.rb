control 'IA-2 (6)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      IA-02(06)(a) multi-factor authentication is implemented for #{input('ia_02_06_odp_01')} access to #{input('ia_02_06_odp_02')} such that one of the factors is provided by a device separate from the system gaining access;
      IA-02(06)(b) multi-factor authentication is implemented for #{input('ia_02_06_odp_01')} access to #{input('ia_02_06_odp_02')} such that the device meets #{input('ia_02_06_odp_03')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control IA-2 (6)' do
