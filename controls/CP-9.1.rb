control 'CP-9 (1)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      CP-09(01)[01] backup information is tested #{input('cp_09_01_odp_01')} to verify media reliability;
      CP-09(01)[02] backup information is tested #{input('cp_09_01_odp_02')} to verify information integrity.
  ...
  tag odp: %w{cp_09_01_odp_01 cp_09_01_odp_02 cp_9_1_prm_1}

  describe 'NIST SP 800-53 Rev 5 control CP-9 (1)' do
