control 'PL-8 (2)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      PL-08(02) #{input('pl_08_02_odp_01')} that are allocated to #{input('pl_08_02_odp_02')} are required to be obtained from different suppliers.
  ...
  describe 'NIST SP 800-53 Rev 5 control PL-8 (2)' do
