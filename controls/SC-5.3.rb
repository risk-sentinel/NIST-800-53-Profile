control 'SC-5 (3)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SC-05(03)(a) #{input('sc_05_03_odp_01')} are employed to detect indicators of denial-of-service attacks against or launched from the system;
      SC-05(03)(b) #{input('sc_05_03_odp_02')} are monitored to determine if sufficient resources exist to prevent effective denial-of-service attacks.
  ...
  describe 'NIST SP 800-53 Rev 5 control SC-5 (3)' do
