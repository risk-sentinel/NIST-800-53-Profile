control 'SA-15 (7)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SA-15(07)(a) the developer of the system, system component, or system service is required to perform automated vulnerability analysis #{input('sa_15_07_odp_01')} using #{input('sa_15_07_odp_02')};
      SA-15(07)(b) the developer of the system, system component, or system service is required to determine the exploitation potential for discovered vulnerabilities #{input('sa_15_07_odp_01')};
      SA-15(07)(c) the developer of the system, system component, or system service is required to determine potential risk mitigations #{input('sa_15_07_odp_01')} for delivered vulnerabilities;
      SA-15(07)(d) the developer of the system, system component, or system service is required to deliver the outputs of the tools and results of the analysis #{input('sa_15_07_odp_01')} to #{input('sa_15_07_odp_03')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control SA-15 (7)' do
