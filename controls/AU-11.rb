control 'AU-11' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      AU-11 audit records are retained for #{input('au_11_odp')} to provide support for after-the-fact investigations of incidents and to meet regulatory and organizational information retention requirements.
  ...
  describe 'NIST SP 800-53 Rev 5 control AU-11' do
