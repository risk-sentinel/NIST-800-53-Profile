control 'AC-24 (2)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      AC-24(02)[01] access control decisions are enforced based on #{input('ac_24_02_odp_01')} that do not include the identity of the user or process acting on behalf of the user (if selected);
      AC-24(02)[02] access control decisions are enforced based on #{input('ac_24_02_odp_02')} that do not include the identity of the user or process acting on behalf of the user (if selected).
  ...
  tag baseline: %w{}
  tag odp: %w{ac_24_02_odp_01 ac_24_02_odp_02 ac_24_2_prm_1}

  describe 'NIST SP 800-53 Rev 5 control AC-24 (2)' do
