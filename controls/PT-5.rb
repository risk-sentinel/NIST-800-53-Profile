control 'PT-5' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      PT-05a.
        ...
        PT-05a.[02] a notice to individuals about the processing of personally identifiable information is provided such that the notice is subsequently available to individuals #{input('pt_05_odp_01')};
      ...
      PT-05e. a notice to individuals about the processing of personally identifiable information which includes #{input('pt_05_odp_02')} is provided.
  ...
  describe 'NIST SP 800-53 Rev 5 control PT-5' do
