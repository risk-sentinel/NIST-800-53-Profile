control 'AC-16 (1)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      AC-16(01)[01] security attributes are dynamically associated with #{input('ac_16_01_odp_01')} in accordance with the following security policies as information is created and combined: #{input('ac_16_01_odp_05')};
      AC-16(01)[02] security attributes are dynamically associated with #{input('ac_16_01_odp_02')} in accordance with the following security policies as information is created and combined: #{input('ac_16_01_odp_05')};
      AC-16(01)[03] privacy attributes are dynamically associated with #{input('ac_16_01_odp_03')} in accordance with the following privacy policies as information is created and combined: #{input('ac_16_01_odp_06')};
      AC-16(01)[04] privacy attributes are dynamically associated with #{input('ac_16_01_odp_04')} in accordance with the following privacy policies as information is created and combined: #{input('ac_16_01_odp_06')}.
  ...
  tag baseline: %w{}
  tag odp: %w{ac_16_01_odp_01 ac_16_01_odp_02 ac_16_01_odp_03 ac_16_01_odp_04 ac_16_01_odp_05 ac_16_01_odp_06 ac_16_1_prm_1 ac_16_1_prm_2}

  describe 'NIST SP 800-53 Rev 5 control AC-16 (1)' do
