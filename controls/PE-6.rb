control 'PE-6' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      ...
      PE-06b.
        PE-06b.[01] physical access logs are reviewed #{input('pe_06_odp_01')};
        PE-06b.[02] physical access logs are reviewed upon occurrence of #{input('pe_06_odp_02')};
      PE-06c.
  ...
  describe 'NIST SP 800-53 Rev 5 control PE-6' do
