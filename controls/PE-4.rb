control 'PE-4' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      PE-04 physical access to #{input('pe_04_odp_01')} within organizational facilities is controlled using #{input('pe_04_odp_02')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control PE-4' do
