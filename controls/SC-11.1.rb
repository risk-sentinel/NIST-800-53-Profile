control 'SC-11 (1)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      ...
      SC-11(01)(b) the trusted communication path for communications between the #{input('sc_11_01_odp')} of the system and the user is initiated.
  ...
  describe 'NIST SP 800-53 Rev 5 control SC-11 (1)' do
