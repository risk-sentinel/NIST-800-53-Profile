control 'CP-01b.' do
  impact 0.5
  title "the #{input('cp_01_odp_04')} is designated to manage the development, documentation, and dissemination of the contingency planning policy and procedures;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the #{input('cp_01_odp_04')} is designated to manage the development, documentation, and dissemination of the contingency planning policy and procedures;
  ...
  describe 'NIST SP 800-53A Rev 5 objective CP-01b.' do
