control 'CP-08(01)(a)[01]' do
  impact 0.5
  title "primary telecommunications service agreements that contain priority-of-service provisions in accordance with availability requirements (including recovery time objectives) are developed;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CP-08(01)(a)[01]' do
