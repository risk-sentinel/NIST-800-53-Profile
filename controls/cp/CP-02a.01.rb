control 'CP-02a.01' do
  impact 0.5
  title "a contingency plan for the system is developed that identifies essential mission and business functions and associated contingency requirements;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CP-02a.01' do
