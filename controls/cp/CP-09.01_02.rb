control 'CP-09(01)[02]' do
  impact 0.5
  title "backup information is tested #{input('cp_09_01_odp_02')} to verify information integrity."
  desc <<~DESC
    Test backup information #{input('cp_9_1_prm_1')} to verify media reliability and information integrity.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      backup information is tested #{input('cp_09_01_odp_02')} to verify information integrity.
  ...
  tag odp: %w{cp_09_01_odp_02 cp_9_1_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective CP-09(01)[02]' do
