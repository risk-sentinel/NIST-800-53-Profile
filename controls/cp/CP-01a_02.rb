control 'CP-01a.[02]' do
  impact 0.5
  title "the contingency planning policy is disseminated to #{input('cp_01_odp_01')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the contingency planning policy is disseminated to #{input('cp_01_odp_01')};
  ...
  tag odp: %w{cp_01_odp_01 cp_01_odp_03 cp_01_odp_04 cp_01_odp_05 cp_01_odp_06 cp_01_odp_07 cp_01_odp_08 cp_1_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective CP-01a.[02]' do
