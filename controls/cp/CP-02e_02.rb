control 'CP-02e.[02]' do
  impact 0.5
  title "the contingency plan is updated to address problems encountered during contingency plan implementation, execution, or testing;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CP-02e.[02]' do
