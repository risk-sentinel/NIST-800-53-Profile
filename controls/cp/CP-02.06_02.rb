control 'CP-02(06)[02]' do
  impact 0.5
  title "operational continuity is sustained until full system restoration at primary processing and/or storage sites."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CP-02(06)[02]' do
