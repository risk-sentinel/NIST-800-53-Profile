control 'CP-07b.[02]' do
  impact 0.5
  title "the equipment and supplies required to resume operations are made available at the alternate processing site or if contracts are in place to support delivery to the site within #{input('cp_07_odp_02')} for resumption;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the equipment and supplies required to resume operations are made available at the alternate processing site or if contracts are in place to support delivery to the site within #{input('cp_07_odp_02')} for resumption;
  ...
  describe 'NIST SP 800-53A Rev 5 objective CP-07b.[02]' do
