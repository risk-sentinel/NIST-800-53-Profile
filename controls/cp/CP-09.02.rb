control 'CP-09(02)' do
  impact 0.5
  title "a sample of backup information in the restoration of selected system functions is used as part of contingency plan testing."
  desc <<~DESC
  ...
  tag nist: ['CP-9 (2)']
  tag control: 'CP-9 (2)'
  tag objective: 'CP-09(02)'
  tag rev: 'Rev_5'
  tag family: 'Contingency Planning'
  tag baseline: %w{HIGH}
  tag baseline_high: true
  tag control_cp_9_2: true

  describe 'NIST SP 800-53A Rev 5 objective CP-09(02)' do
