control 'CP-09c.' do
  impact 0.5
  title "backups of system documentation, including security- and privacy-related documentation are conducted #{input('cp_09_odp_04')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      backups of system documentation, including security- and privacy-related documentation are conducted #{input('cp_09_odp_04')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective CP-09c.' do
