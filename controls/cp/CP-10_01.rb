control 'CP-10[01]' do
  impact 0.5
  title "the recovery of the system to a known state is provided within #{input('cp_10_odp_01')} after a disruption, compromise, or failure;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the recovery of the system to a known state is provided within #{input('cp_10_odp_01')} after a disruption, compromise, or failure;
  ...
  tag odp: %w{cp_10_odp_01 cp_10_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective CP-10[01]' do
