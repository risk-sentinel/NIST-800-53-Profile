control 'CP-06a.[02]' do
  impact 0.5
  title "establishment of the alternate storage site includes necessary agreements to permit the storage and retrieval of system backup information;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CP-06a.[02]' do
