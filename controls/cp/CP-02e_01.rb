control 'CP-02e.[01]' do
  impact 0.5
  title "the contingency plan is updated to address changes to the organization, system, or environment of operation;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CP-02e.[01]' do
