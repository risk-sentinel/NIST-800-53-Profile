control 'CP-02a.06' do
  impact 0.5
  title "a contingency plan for the system is developed that addresses the sharing of contingency information;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CP-02a.06' do
