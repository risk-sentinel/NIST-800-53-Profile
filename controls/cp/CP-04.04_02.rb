control 'CP-04(04)[02]' do
  impact 0.5
  title "a full reconstitution of the system to a known state is included as part of contingency plan testing."
  desc <<~DESC
  ...
  tag nist: ['CP-4 (4)']
  tag control: 'CP-4 (4)'
  tag objective: 'CP-04(04)[02]'
  tag rev: 'Rev_5'
  tag family: 'Contingency Planning'
  tag baseline: %w{}
  tag control_cp_4_4: true

  describe 'NIST SP 800-53A Rev 5 objective CP-04(04)[02]' do
