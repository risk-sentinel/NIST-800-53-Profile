control 'CP-02c.' do
  impact 0.5
  title "contingency planning activities are coordinated with incident handling activities;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CP-02c.' do
