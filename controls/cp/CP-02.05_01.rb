control 'CP-02(05)[01]' do
  impact 0.5
  title "the continuance of #{input('cp_02_05_odp')} mission and business functions with minimal or no loss of operational continuity is planned for;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the continuance of #{input('cp_02_05_odp')} mission and business functions with minimal or no loss of operational continuity is planned for;
  ...
  tag nist: ['CP-2 (5)']
  tag control: 'CP-2 (5)'
  tag objective: 'CP-02(05)[01]'
  tag rev: 'Rev_5'
  tag family: 'Contingency Planning'
  tag baseline: %w{HIGH}
  tag baseline_high: true
  tag control_cp_2_5: true
  tag odp: %w{cp_02_05_odp}

  describe 'NIST SP 800-53A Rev 5 objective CP-02(05)[01]' do
