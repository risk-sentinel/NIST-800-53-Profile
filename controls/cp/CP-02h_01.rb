control 'CP-02h.[01]' do
  impact 0.5
  title "the contingency plan is protected from unauthorized disclosure;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CP-02h.[01]' do
