control 'CP-07(06)[01]' do
  impact 0.5
  title "circumstances that preclude returning to the primary processing site are planned for;"
  desc <<~DESC
  ...
  tag nist: ['CP-7 (6)']
  tag control: 'CP-7 (6)'
  tag objective: 'CP-07(06)[01]'
  tag rev: 'Rev_5'
  tag family: 'Contingency Planning'
  tag baseline: %w{}
  tag control_cp_7_6: true

  describe 'NIST SP 800-53A Rev 5 objective CP-07(06)[01]' do
