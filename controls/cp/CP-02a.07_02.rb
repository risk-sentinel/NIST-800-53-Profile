control 'CP-02a.07[02]' do
  impact 0.5
  title "a contingency plan for the system is developed that is approved by #{input('cp_02_odp_02')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      a contingency plan for the system is developed that is approved by #{input('cp_02_odp_02')};
  ...
  tag odp: %w{cp_02_odp_02 cp_02_odp_05 cp_2_prm_1 cp_2_prm_2 cp_2_prm_4}

  describe 'NIST SP 800-53A Rev 5 objective CP-02a.07[02]' do
