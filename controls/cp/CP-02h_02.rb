control 'CP-02h.[02]' do
  impact 0.5
  title "the contingency plan is protected from unauthorized modification."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CP-02h.[02]' do
