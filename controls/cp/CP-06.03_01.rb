control 'CP-06(03)[01]' do
  impact 0.5
  title "potential accessibility problems to the alternate storage site in the event of an area-wide disruption or disaster are identified;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CP-06(03)[01]' do
