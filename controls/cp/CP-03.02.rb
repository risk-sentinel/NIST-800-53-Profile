control 'CP-03(02)' do
  impact 0.5
  title "mechanisms used in operations are employed to provide a more thorough and realistic contingency training environment."
  desc <<~DESC
  ...
  tag nist: ['CP-3 (2)']
  tag control: 'CP-3 (2)'
  tag objective: 'CP-03(02)'
  tag rev: 'Rev_5'
  tag family: 'Contingency Planning'
  tag baseline: %w{}
  tag control_cp_3_2: true

  describe 'NIST SP 800-53A Rev 5 objective CP-03(02)' do
