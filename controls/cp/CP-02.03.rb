control 'CP-02(03)' do
  impact 0.5
  title "the resumption of #{input('cp_02_03_odp_01')} mission and business functions are planned for within #{input('cp_02_03_odp_02')} of contingency plan activation."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the resumption of #{input('cp_02_03_odp_01')} mission and business functions are planned for within #{input('cp_02_03_odp_02')} of contingency plan activation.
  ...
  tag nist: ['CP-2 (3)']
  tag control: 'CP-2 (3)'
  tag objective: 'CP-02(03)'
  tag rev: 'Rev_5'
  tag family: 'Contingency Planning'
  tag baseline: %w{MODERATE HIGH}
  tag baseline_moderate: true
  tag baseline_high: true
  tag control_cp_2_3: true
  tag odp: %w{cp_02_03_odp_01 cp_02_03_odp_02}

  describe 'NIST SP 800-53A Rev 5 objective CP-02(03)' do
