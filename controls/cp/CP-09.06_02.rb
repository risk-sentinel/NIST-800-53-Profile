control 'CP-09(06)[02]' do
  impact 0.5
  title "system backup is conducted by maintaining a redundant secondary system that can be activated without loss of information or disruption to operations."
  desc <<~DESC
  ...
  tag nist: ['CP-9 (6)']
  tag control: 'CP-9 (6)'
  tag objective: 'CP-09(06)[02]'
  tag rev: 'Rev_5'
  tag family: 'Contingency Planning'
  tag baseline: %w{}
  tag control_cp_9_6: true

  describe 'NIST SP 800-53A Rev 5 objective CP-09(06)[02]' do
