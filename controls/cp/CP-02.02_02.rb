control 'CP-02(02)[02]' do
  impact 0.5
  title "capacity planning is conducted so that the necessary capacity exists during contingency operations for telecommunications;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CP-02(02)[02]' do
