control 'CP-02(02)[01]' do
  impact 0.5
  title "capacity planning is conducted so that the necessary capacity exists during contingency operations for information processing;"
  desc <<~DESC
  ...
  tag nist: ['CP-2 (2)']
  tag control: 'CP-2 (2)'
  tag objective: 'CP-02(02)[01]'
  tag rev: 'Rev_5'
  tag family: 'Contingency Planning'
  tag baseline: %w{HIGH}
  tag baseline_high: true
  tag control_cp_2_2: true

  describe 'NIST SP 800-53A Rev 5 objective CP-02(02)[01]' do
