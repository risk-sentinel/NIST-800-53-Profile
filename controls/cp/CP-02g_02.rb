control 'CP-02g.[02]' do
  impact 0.5
  title "lessons learned from contingency plan training or actual contingency activities are incorporated into contingency testing and training;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CP-02g.[02]' do
