control 'CP-02a.02[01]' do
  impact 0.5
  title "a contingency plan for the system is developed that provides recovery objectives;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CP-02a.02[01]' do
