control 'CP-04a.[03]' do
  impact 0.5
  title "#{input('cp_04_odp_03')} are used to determine the readiness to execute the plan;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('cp_04_odp_03')} are used to determine the readiness to execute the plan;
  ...
  tag odp: %w{cp_04_odp_01 cp_04_odp_03 cp_4_prm_2}

  describe 'NIST SP 800-53A Rev 5 objective CP-04a.[03]' do
