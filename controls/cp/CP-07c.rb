control 'CP-07c.' do
  impact 0.5
  title "controls provided at the alternate processing site are equivalent to those at the primary site."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CP-07c.' do
