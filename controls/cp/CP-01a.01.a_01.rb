control 'CP-01a.01(a)[01]' do
  impact 0.5
  title "the #{input('cp_01_odp_03')} contingency planning policy addresses purpose;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the #{input('cp_01_odp_03')} contingency planning policy addresses purpose;
  ...
  describe 'NIST SP 800-53A Rev 5 objective CP-01a.01(a)[01]' do
