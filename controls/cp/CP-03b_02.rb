control 'CP-03b.[02]' do
  impact 0.5
  title "the contingency plan training content is reviewed and updated following #{input('cp_03_odp_04')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the contingency plan training content is reviewed and updated following #{input('cp_03_odp_04')}.
  ...
  describe 'NIST SP 800-53A Rev 5 objective CP-03b.[02]' do
