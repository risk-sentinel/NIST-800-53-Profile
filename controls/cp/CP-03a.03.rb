control 'CP-03a.03' do
  impact 0.5
  title "contingency training is provided to system users consistent with assigned roles and responsibilities #{input('cp_03_odp_02')} thereafter;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      contingency training is provided to system users consistent with assigned roles and responsibilities #{input('cp_03_odp_02')} thereafter;
  ...
  describe 'NIST SP 800-53A Rev 5 objective CP-03a.03' do
