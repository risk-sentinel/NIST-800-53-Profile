control 'CP-07(01)' do
  impact 0.5
  title "an alternate processing site that is sufficiently separated from the primary processing site to reduce susceptibility to the same threats is identified."
  desc <<~DESC
  ...
  tag nist: ['CP-7 (1)']
  tag control: 'CP-7 (1)'
  tag objective: 'CP-07(01)'
  tag rev: 'Rev_5'
  tag family: 'Contingency Planning'
  tag baseline: %w{MODERATE HIGH}
  tag baseline_moderate: true
  tag baseline_high: true
  tag control_cp_7_1: true

  describe 'NIST SP 800-53A Rev 5 objective CP-07(01)' do
