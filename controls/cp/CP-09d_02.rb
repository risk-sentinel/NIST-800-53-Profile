control 'CP-09d.[02]' do
  impact 0.5
  title "the integrity of backup information is protected;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CP-09d.[02]' do
