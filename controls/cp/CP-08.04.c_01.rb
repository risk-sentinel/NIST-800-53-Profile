control 'CP-08(04)(c)[01]' do
  impact 0.5
  title "evidence of contingency testing by providers is obtained #{input('cp_08_04_odp_01')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      evidence of contingency testing by providers is obtained #{input('cp_08_04_odp_01')}.
  ...
  tag nist: ['CP-8 (4)']
  tag control: 'CP-8 (4)'
  tag objective: 'CP-08(04)(c)[01]'
  tag rev: 'Rev_5'
  tag family: 'Contingency Planning'
  tag baseline: %w{HIGH}
  tag baseline_high: true
  tag control_cp_8_4: true
  tag odp: %w{cp_08_04_odp_01 cp_8_4_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective CP-08(04)(c)[01]' do
