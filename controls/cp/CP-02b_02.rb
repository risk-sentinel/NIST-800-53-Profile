control 'CP-02b.[02]' do
  impact 0.5
  title "copies of the contingency plan are distributed to #{input('cp_02_odp_04')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      copies of the contingency plan are distributed to #{input('cp_02_odp_04')};
  ...
  tag odp: %w{cp_02_odp_04 cp_02_odp_05 cp_2_prm_1 cp_2_prm_2 cp_2_prm_4}

  describe 'NIST SP 800-53A Rev 5 objective CP-02b.[02]' do
