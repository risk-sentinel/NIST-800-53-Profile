control 'CP-02f.[02]' do
  impact 0.5
  title "contingency plan changes are communicated to #{input('cp_02_odp_07')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      contingency plan changes are communicated to #{input('cp_02_odp_07')};
  ...
  tag odp: %w{cp_02_odp_05 cp_02_odp_07 cp_2_prm_1 cp_2_prm_2 cp_2_prm_4}

  describe 'NIST SP 800-53A Rev 5 objective CP-02f.[02]' do
