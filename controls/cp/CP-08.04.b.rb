control 'CP-08(04)(b)' do
  impact 0.5
  title "provider contingency plans are reviewed to ensure that the plans meet organizational contingency requirements;"
  desc <<~DESC
  ...
  tag nist: ['CP-8 (4)']
  tag control: 'CP-8 (4)'
  tag objective: 'CP-08(04)(b)'
  tag rev: 'Rev_5'
  tag family: 'Contingency Planning'
  tag baseline: %w{HIGH}
  tag baseline_high: true
  tag control_cp_8_4: true
  tag odp: %w{cp_8_4_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective CP-08(04)(b)' do
