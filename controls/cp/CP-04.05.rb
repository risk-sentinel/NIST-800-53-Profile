control 'CP-04(05)' do
  impact 0.5
  title "#{input('cp_04_05_odp_01')} are employed to disrupt and adversely affect the #{input('cp_04_05_odp_02')}."
  desc <<~DESC
    Employ #{input('cp_04_05_odp_01')} to #{input('cp_04_05_odp_02')} to disrupt and adversely affect the system or system component.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      #{input('cp_04_05_odp_01')} are employed to disrupt and adversely affect the #{input('cp_04_05_odp_02')}.
  ...
  tag nist: ['CP-4 (5)']
  tag control: 'CP-4 (5)'
  tag objective: 'CP-04(05)'
  tag rev: 'Rev_5'
  tag family: 'Contingency Planning'
  tag baseline: %w{}
  tag control_cp_4_5: true
  tag odp: %w{cp_04_05_odp_01 cp_04_05_odp_02}

  describe 'NIST SP 800-53A Rev 5 objective CP-04(05)' do
