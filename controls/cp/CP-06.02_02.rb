control 'CP-06(02)[02]' do
  impact 0.5
  title "the alternate storage site is configured to facilitate recovery operations in accordance with recovery point objectives."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CP-06(02)[02]' do
