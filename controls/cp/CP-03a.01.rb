control 'CP-03a.01' do
  impact 0.5
  title "contingency training is provided to system users consistent with assigned roles and responsibilities within #{input('cp_03_odp_01')} of assuming a contingency role or responsibility;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      contingency training is provided to system users consistent with assigned roles and responsibilities within #{input('cp_03_odp_01')} of assuming a contingency role or responsibility;
  ...
  describe 'NIST SP 800-53A Rev 5 objective CP-03a.01' do
