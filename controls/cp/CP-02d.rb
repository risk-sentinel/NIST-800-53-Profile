control 'CP-02d.' do
  impact 0.5
  title "the contingency plan for the system is reviewed #{input('cp_02_odp_05')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the contingency plan for the system is reviewed #{input('cp_02_odp_05')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective CP-02d.' do
