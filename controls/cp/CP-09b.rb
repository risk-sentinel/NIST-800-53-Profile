control 'CP-09b.' do
  impact 0.5
  title "backups of system-level information contained in the system are conducted #{input('cp_09_odp_03')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      backups of system-level information contained in the system are conducted #{input('cp_09_odp_03')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective CP-09b.' do
