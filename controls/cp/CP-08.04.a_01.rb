control 'CP-08(04)(a)[01]' do
  impact 0.5
  title "primary telecommunications service providers are required to have contingency plans;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CP-08(04)(a)[01]' do
