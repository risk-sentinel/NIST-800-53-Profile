control 'CP-04a.[01]' do
  impact 0.5
  title "the contingency plan for the system is tested #{input('cp_04_odp_01')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the contingency plan for the system is tested #{input('cp_04_odp_01')};
  ...
  tag odp: %w{cp_04_odp_01 cp_4_prm_2}

  describe 'NIST SP 800-53A Rev 5 objective CP-04a.[01]' do
