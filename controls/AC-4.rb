control 'AC-4' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      AC-04 approved authorizations are enforced for controlling the flow of information within the system and between connected systems based on #{input('ac_04_odp')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control AC-4' do
