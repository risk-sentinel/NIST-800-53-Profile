control 'CP-9 (8)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      CP-09(08) cryptographic mechanisms are implemented to prevent unauthorized disclosure and modification of #{input('cp_09_08_odp')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control CP-9 (8)' do
