control 'IA-13' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      IA-13[01] identity providers are employed to manage user, device, and non-person entity (NPE) identities, attributes and access rights supporting authentication decisions in accordance with #{input('ia_13_odp_02')} using #{input('ia_13_odp_02')};
      IA-13[02] identity providers are employed to manage user, device, and non-person entity (NPE) identities, attributes and access rights supporting authorization decisions in accordance with #{input('ia_13_odp_02')} using #{input('ia_13_odp_02')};
      IA-13[03] authorization servers are employed to manage user, device, and non-person entity (NPE) identities, attributes and access rights supporting authentication decisions in accordance with #{input('ia_13_odp_02')} using #{input('ia_13_odp_02')};
      IA-13[04] authorization servers are employed to manage user, device, and non-person entity (NPE) identities, attributes and access rights supporting authorization decisions in accordance with #{input('ia_13_odp_02')} using #{input('ia_13_odp_02')};
  ...
  describe 'NIST SP 800-53 Rev 5 control IA-13' do
