control 'CP-3' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      CP-03a.
        CP-03a.01 contingency training is provided to system users consistent with assigned roles and responsibilities within #{input('cp_03_odp_01')} of assuming a contingency role or responsibility;
        ...
        CP-03a.03 contingency training is provided to system users consistent with assigned roles and responsibilities #{input('cp_03_odp_02')} thereafter;
      CP-03b.
        CP-03b.[01] the contingency plan training content is reviewed and updated #{input('cp_03_odp_03')};
        CP-03b.[02] the contingency plan training content is reviewed and updated following #{input('cp_03_odp_04')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control CP-3' do
