control 'SA-9 (2)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SA-09(02) providers of #{input('sa_09_02_odp')} are required to identify the functions, ports, protocols, and other services required for the use of such services.
  ...
  describe 'NIST SP 800-53 Rev 5 control SA-9 (2)' do
