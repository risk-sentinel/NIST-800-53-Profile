control 'AU-10' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      AU-10 irrefutable evidence is provided that an individual (or process acting on behalf of an individual) has performed #{input('au_10_odp')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control AU-10' do
