control 'PS-4' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      PS-04a. upon termination of individual employment, system access is disabled within #{input('ps_04_odp_01')};
      PS-04b. upon termination of individual employment, any authenticators and credentials are terminated or revoked;
      PS-04c. upon termination of individual employment, exit interviews that include a discussion of #{input('ps_04_odp_02')} are conducted;
  ...
  describe 'NIST SP 800-53 Rev 5 control PS-4' do
