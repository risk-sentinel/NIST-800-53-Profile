control 'SI-10 (2)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SI-10(02)[01] input validation errors are reviewed within #{input('si_10_02_odp_01')};
      SI-10(02)[02] input validation errors are resolved within #{input('si_10_02_odp_02')}.
  ...
  tag baseline: %w{}
  tag odp: %w{si_10_02_odp_01 si_10_02_odp_02 si_10_2_prm_1}

  describe 'NIST SP 800-53 Rev 5 control SI-10 (2)' do
