control 'MP-6 (3)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      MP-06(03) non-destructive sanitization techniques are applied to portable storage devices prior to connecting such devices to the system under #{input('mp_06_03_odp')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control MP-6 (3)' do
