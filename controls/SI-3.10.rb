control 'SI-3 (10)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SI-03(10)(a) #{input('si_03_10_odp')} are employed to analyze the characteristics and behavior of malicious code;
      SI-03(10)(b)
  ...
  describe 'NIST SP 800-53 Rev 5 control SI-3 (10)' do
