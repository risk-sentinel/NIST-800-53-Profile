control 'MA-4 (5)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      MA-04(05)(a) the approval of each nonlocal maintenance session is required by #{input('ma_04_05_odp_01')};
      MA-04(05)(b) #{input('ma_04_05_odp_02')} is/are notified of the date and time of planned nonlocal maintenance.
  ...
  describe 'NIST SP 800-53 Rev 5 control MA-4 (5)' do
