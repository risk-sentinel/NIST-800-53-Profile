control 'CA-3' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      CA-03a. the exchange of information between the system and other systems is approved and managed using #{input('ca_03_odp_01')};
      CA-03b.
      ...
      CA-03c. agreements are reviewed and updated #{input('ca_03_odp_03')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control CA-3' do
