control 'CP-2 (6)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      CP-02(06)[01] the transfer of #{input('cp_02_06_odp')} mission and business functions to alternate processing and/or storage sites with minimal or no loss of operational continuity is planned for;
  ...
  describe 'NIST SP 800-53 Rev 5 control CP-2 (6)' do
