control 'SA-10' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SA-10a. the developer of the system, system component, or system service is required to perform configuration management during system, component, or service #{input('sa_10_odp_01')};
      SA-10b.
        SA-10b.[01] the developer of the system, system component, or system service is required to document the integrity of changes to #{input('sa_10_odp_02')};
        SA-10b.[02] the developer of the system, system component, or system service is required to manage the integrity of changes to #{input('sa_10_odp_02')};
        SA-10b.[03] the developer of the system, system component, or system service is required to control the integrity of changes to #{input('sa_10_odp_02')};
      ...
      SA-10e.
        ...
        SA-10e.[03] the developer of the system, system component, or system service is required to report findings to #{input('sa_10_odp_03')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control SA-10' do
