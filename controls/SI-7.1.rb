control 'SI-7 (1)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SI-07(01)[01] an integrity check of #{input('si_07_01_odp_01')} is performed #{input('si_07_01_odp_02')};
      SI-07(01)[02] an integrity check of #{input('si_07_01_odp_05')} is performed #{input('si_07_01_odp_06')};
      SI-07(01)[03] an integrity check of #{input('si_07_01_odp_09')} is performed #{input('si_07_01_odp_10')}.
  ...
  tag odp: %w{si_07_01_odp_01 si_07_01_odp_02 si_07_01_odp_05 si_07_01_odp_06 si_07_01_odp_09 si_07_01_odp_10 si_7_1_prm_1 si_7_1_prm_2}

  describe 'NIST SP 800-53 Rev 5 control SI-7 (1)' do
