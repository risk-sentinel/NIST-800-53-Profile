control 'SA-11 (3)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SA-11(03)(a)
        SA-11(03)(a)[01] an independent agent is required to satisfy #{input('sa_11_03_odp')} to verify the correct implementation of the developer security assessment plan and the evidence produced during testing and evaluation;
        SA-11(03)(a)[02] an independent agent is required to satisfy #{input('sa_11_03_odp')} to verify the correct implementation of the developer privacy assessment plan and the evidence produced during testing and evaluation;
  ...
  describe 'NIST SP 800-53 Rev 5 control SA-11 (3)' do
