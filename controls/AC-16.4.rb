control 'AC-16 (4)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      AC-16(04)[01] authorized individuals (or processes acting on behalf of individuals) are provided with the capability to associate #{input('ac_16_04_odp_01')} with #{input('ac_16_04_odp_05')};
      AC-16(04)[02] authorized individuals (or processes acting on behalf of individuals) are provided with the capability to associate #{input('ac_16_04_odp_02')} with #{input('ac_16_04_odp_06')};
      AC-16(04)[03] authorized individuals (or processes acting on behalf of individuals) are provided with the capability to associate #{input('ac_16_04_odp_03')} with #{input('ac_16_04_odp_07')};
      AC-16(04)[04] authorized individuals (or processes acting on behalf of individuals) are provided with the capability to associate #{input('ac_16_04_odp_04')} with #{input('ac_16_04_odp_08')}.
  ...
  tag baseline: %w{}
  tag odp: %w{ac_16_04_odp_01 ac_16_04_odp_02 ac_16_04_odp_03 ac_16_04_odp_04 ac_16_04_odp_05 ac_16_04_odp_06 ac_16_04_odp_07 ac_16_04_odp_08 ac_16_4_prm_1 ac_16_4_prm_2}

  describe 'NIST SP 800-53 Rev 5 control AC-16 (4)' do
