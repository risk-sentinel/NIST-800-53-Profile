control 'PM-5 (1)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      ...
      PM-05(01)[03] an inventory of all systems, applications, and projects that process personally identifiable information is updated #{input('pm_05_01_odp')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control PM-5 (1)' do
