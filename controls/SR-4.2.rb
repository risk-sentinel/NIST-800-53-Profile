control 'SR-4 (2)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SR-04(02)[01] the unique identification of #{input('sr_04_02_odp')} is established for tracking through the supply chain;
      SR-04(02)[02] the unique identification of #{input('sr_04_02_odp')} is maintained for tracking through the supply chain.
  ...
  describe 'NIST SP 800-53 Rev 5 control SR-4 (2)' do
