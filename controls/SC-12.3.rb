control 'SC-12 (3)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SC-12(03)[01] asymmetric cryptographic keys are produced using #{input('sc_12_03_odp')};
      SC-12(03)[02] asymmetric cryptographic keys are controlled using #{input('sc_12_03_odp')};
      SC-12(03)[03] asymmetric cryptographic keys are distributed using #{input('sc_12_03_odp')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control SC-12 (3)' do
