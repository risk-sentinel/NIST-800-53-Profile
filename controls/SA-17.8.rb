control 'SA-17 (8)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SA-17(08) #{input('sa_17_08_odp_01')} are designed with coordinated behavior to implement #{input('sa_17_08_odp_02')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control SA-17 (8)' do
