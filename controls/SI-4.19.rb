control 'SI-4 (19)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SI-04(19) #{input('si_04_19_odp_01')} is implemented on individuals who have been identified by #{input('si_04_19_odp_02')} as posing an increased level of risk.
  ...
  describe 'NIST SP 800-53 Rev 5 control SI-4 (19)' do
