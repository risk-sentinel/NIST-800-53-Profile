control 'AC-16 (8)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      AC-16(08)[01] #{input('ac_16_08_odp_01')} are implemented in associating security attributes to information;
      AC-16(08)[02] #{input('ac_16_08_odp_02')} are implemented in associating privacy attributes to information.
  ...
  tag baseline: %w{}
  tag odp: %w{ac_16_08_odp_01 ac_16_08_odp_02 ac_16_8_prm_1}

  describe 'NIST SP 800-53 Rev 5 control AC-16 (8)' do
