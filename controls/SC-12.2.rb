control 'SC-12 (2)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SC-12(02)[01] symmetric cryptographic keys are produced using #{input('sc_12_02_odp')} key management technology and processes;
      SC-12(02)[02] symmetric cryptographic keys are controlled using #{input('sc_12_02_odp')} key management technology and processes;
      SC-12(02)[03] symmetric cryptographic keys are distributed using #{input('sc_12_02_odp')} key management technology and processes.
  ...
  describe 'NIST SP 800-53 Rev 5 control SC-12 (2)' do
