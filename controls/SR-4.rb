control 'SR-4' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SR-04[01] valid provenance is documented for #{input('sr_04_odp')};
      SR-04[02] valid provenance is monitored for #{input('sr_04_odp')};
      SR-04[03] valid provenance is maintained for #{input('sr_04_odp')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control SR-4' do
