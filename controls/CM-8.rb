control 'CM-8' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      CM-08a.
        ...
        CM-08a.05 an inventory of system components that includes #{input('cm_08_odp_01')} is developed and documented;
      CM-08b. the system component inventory is reviewed and updated #{input('cm_08_odp_02')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control CM-8' do
