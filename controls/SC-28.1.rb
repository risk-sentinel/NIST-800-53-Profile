control 'SC-28 (1)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SC-28(01)[01] cryptographic mechanisms are implemented to prevent unauthorized disclosure of #{input('sc_28_01_odp_01')} at rest on #{input('sc_28_01_odp_02')};
      SC-28(01)[02] cryptographic mechanisms are implemented to prevent unauthorized modification of #{input('sc_28_01_odp_01')} at rest on #{input('sc_28_01_odp_02')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control SC-28 (1)' do
