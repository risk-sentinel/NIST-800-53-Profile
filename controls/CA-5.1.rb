control 'CA-5 (1)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      CA-05(01) #{input('ca_05_01_odp')} are used to ensure the accuracy, currency, and availability of the plan of action and milestones for the system.
  ...
  describe 'NIST SP 800-53 Rev 5 control CA-5 (1)' do
