control 'MP-7' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      MP-07a. the use of #{input('mp_07_odp_01')} is #{input('mp_07_odp_02')} on #{input('mp_07_odp_03')} using #{input('mp_07_odp_04')};
  ...
  describe 'NIST SP 800-53 Rev 5 control MP-7' do
