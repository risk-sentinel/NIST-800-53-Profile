control 'SI-10 (5)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SI-10(05) the use of information inputs is restricted to #{input('si_10_05_odp_01')} and/or #{input('si_10_05_odp_02')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control SI-10 (5)' do
