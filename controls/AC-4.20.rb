control 'AC-4 (20)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      AC-04(20) #{input('ac_04_20_odp_01')} are employed to control the flow of #{input('ac_04_20_odp_02')} across security domains.
  ...
  describe 'NIST SP 800-53 Rev 5 control AC-4 (20)' do
