control 'AC-6 (1)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      AC-06(01)(a)
        AC-06(01)(a)[01] access is authorized for #{input('ac_06_01_odp_01')} to #{input('ac_06_01_odp_02')};
        AC-06(01)(a)[02] access is authorized for #{input('ac_06_01_odp_01')} to #{input('ac_06_01_odp_03')};
        AC-06(01)(a)[03] access is authorized for #{input('ac_06_01_odp_01')} to #{input('ac_06_01_odp_04')};
      AC-06(01)(b) access is authorized for #{input('ac_06_01_odp_01')} to #{input('ac_06_01_odp_05')}.
  ...
  tag odp: %w{ac_06_01_odp_01 ac_06_01_odp_02 ac_06_01_odp_03 ac_06_01_odp_04 ac_06_01_odp_05 ac_6_1_prm_2}

  describe 'NIST SP 800-53 Rev 5 control AC-6 (1)' do
