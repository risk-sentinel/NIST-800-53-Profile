control 'AC-24 (1)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      AC-24(01) #{input('ac_24_01_odp_01')} is transmitted using #{input('ac_24_01_odp_02')} to #{input('ac_24_01_odp_03')} that enforce access control decisions.
  ...
  describe 'NIST SP 800-53 Rev 5 control AC-24 (1)' do
