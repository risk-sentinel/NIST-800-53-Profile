control 'SI-12 (1)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SI-12(01) personally identifiable information being processed in the information life cycle is limited to #{input('si_12_01_odp')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control SI-12 (1)' do
