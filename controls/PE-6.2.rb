control 'PE-6 (2)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      PE-06(02)[01] #{input('pe_06_02_odp_01')} are recognized;
      PE-06(02)[02] #{input('pe_06_02_odp_02')} are initiated using #{input('pe_06_02_odp_03')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control PE-6 (2)' do
