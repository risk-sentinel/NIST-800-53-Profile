control 'PT-3 (2)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      PT-03(02) the processing purposes of personally identifiable information are tracked using #{input('pt_03_02_odp')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control PT-3 (2)' do
