control 'AC-3 (8)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      AC-03(08)[01] revocation of access authorizations is enforced, resulting from changes to the security attributes of subjects based on #{input('ac_03_08_odp')};
      AC-03(08)[02] revocation of access authorizations is enforced resulting from changes to the security attributes of objects based on #{input('ac_03_08_odp')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control AC-3 (8)' do
