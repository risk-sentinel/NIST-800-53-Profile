control 'AU-10 (1)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      AU-10(01)(a) the identity of the information producer is bound with the information to #{input('au_10_01_odp')};
  ...
  describe 'NIST SP 800-53 Rev 5 control AU-10 (1)' do
