control 'SI-2 (4)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SI-02(04) automated patch management tools are employed to facilitate flaw remediation to #{input('si_02_04_odp')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control SI-2 (4)' do
