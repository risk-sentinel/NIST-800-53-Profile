control 'AT-3 (5)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      AT-03(05) #{input('at_03_05_odp_01')} are provided with initial and refresher training #{input('at_03_05_odp_02')} in the employment and operation of personally identifiable information processing and transparency controls.
  ...
  describe 'NIST SP 800-53 Rev 5 control AT-3 (5)' do
