control 'PE-13 (1)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      ...
      PE-13(01)[02] fire detection systems that notify #{input('pe_13_01_odp_01')} automatically are employed in the event of a fire;
      PE-13(01)[03] fire detection systems that notify #{input('pe_13_01_odp_02')} automatically are employed in the event of a fire.
  ...
  describe 'NIST SP 800-53 Rev 5 control PE-13 (1)' do
