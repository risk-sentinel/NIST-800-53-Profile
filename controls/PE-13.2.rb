control 'PE-13 (2)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      PE-13(02)(a)
        ...
        PE-13(02)(a)[02] fire suppression systems that notify #{input('pe_13_02_odp_01')} automatically are employed;
        PE-13(02)(a)[03] fire suppression systems that notify #{input('pe_13_02_odp_02')} automatically are employed;
  ...
  describe 'NIST SP 800-53 Rev 5 control PE-13 (2)' do
