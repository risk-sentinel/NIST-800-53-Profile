control 'CA-03(06)' do
  impact 0.5
  title "individuals or systems transferring data between interconnecting systems have the requisite authorizations (i.e., write permissions or privileges) prior to accepting such data."
  desc <<~DESC
  ...
  tag nist: ['CA-3 (6)']
  tag control: 'CA-3 (6)'
  tag objective: 'CA-03(06)'
  tag rev: 'Rev_5'
  tag family: 'Assessment, Authorization, and Monitoring'
  tag baseline: %w{HIGH}
  tag baseline_high: true
  tag control_ca_3_6: true

  describe 'NIST SP 800-53A Rev 5 objective CA-03(06)' do
