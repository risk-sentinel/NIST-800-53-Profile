control 'CA-07g.[02]' do
  impact 0.5
  title "system-level continuous monitoring includes reporting the privacy status of the system to #{input('ca_07_odp_06')} #{input('ca_07_odp_07')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      system-level continuous monitoring includes reporting the privacy status of the system to #{input('ca_07_odp_06')} #{input('ca_07_odp_07')}.
  ...
  tag odp: %w{ca_07_odp_01 ca_07_odp_02 ca_07_odp_03 ca_07_odp_06 ca_07_odp_07 ca_7_prm_4 ca_7_prm_5}

  describe 'NIST SP 800-53A Rev 5 objective CA-07g.[02]' do
