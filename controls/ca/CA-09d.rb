control 'CA-09d.' do
  impact 0.5
  title "the continued need for each internal connection is reviewed #{input('ca_09_odp_03')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the continued need for each internal connection is reviewed #{input('ca_09_odp_03')}.
  ...
  tag control_ca_9: true
  tag odp: %w{ca_09_odp_01 ca_09_odp_02 ca_09_odp_03}

  describe 'NIST SP 800-53A Rev 5 objective CA-09d.' do
