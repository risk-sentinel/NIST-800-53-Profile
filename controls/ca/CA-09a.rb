control 'CA-09a.' do
  impact 0.5
  title "internal connections of #{input('ca_09_odp_01')} to the system are authorized;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      internal connections of #{input('ca_09_odp_01')} to the system are authorized;
  ...
  describe 'NIST SP 800-53A Rev 5 objective CA-09a.' do
