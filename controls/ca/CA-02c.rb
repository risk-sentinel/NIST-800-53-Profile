control 'CA-02c.' do
  impact 0.5
  title "the control assessment plan is reviewed and approved by the authorizing official or designated representative prior to conducting the assessment;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CA-02c.' do
