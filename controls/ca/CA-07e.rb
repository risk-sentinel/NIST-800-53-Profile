control 'CA-07e.' do
  impact 0.5
  title "system-level continuous monitoring includes correlation and analysis of information generated by control assessments and monitoring;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CA-07e.' do
