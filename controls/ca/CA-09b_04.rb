control 'CA-09b.[04]' do
  impact 0.5
  title "for each internal connection, the nature of the information communicated is documented;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CA-09b.[04]' do
