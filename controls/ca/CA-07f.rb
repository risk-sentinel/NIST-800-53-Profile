control 'CA-07f.' do
  impact 0.5
  title "system-level continuous monitoring includes response actions to address the results of the analysis of control assessment and monitoring information;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CA-07f.' do
