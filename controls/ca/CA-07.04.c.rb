control 'CA-07(04)(c)' do
  impact 0.5
  title "change monitoring is included in risk monitoring."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CA-07(04)(c)' do
