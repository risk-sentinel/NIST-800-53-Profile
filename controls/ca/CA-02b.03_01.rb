control 'CA-02b.03[01]' do
  impact 0.5
  title "a control assessment plan is developed that describes the scope of the assessment, including the assessment environment;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CA-02b.03[01]' do
