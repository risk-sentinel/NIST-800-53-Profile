control 'CA-02f.' do
  impact 0.5
  title "the results of the control assessment are provided to #{input('ca_02_odp_02')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the results of the control assessment are provided to #{input('ca_02_odp_02')}.
  ...
  describe 'NIST SP 800-53A Rev 5 objective CA-02f.' do
