control 'CA-06c.01' do
  impact 0.5
  title "before commencing operations, the authorizing official for the system accepts the use of common controls inherited by the system;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CA-06c.01' do
