control 'CA-01c.02[01]' do
  impact 0.5
  title "the current assessment, authorization, and monitoring procedures are reviewed and updated #{input('ca_01_odp_07')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the current assessment, authorization, and monitoring procedures are reviewed and updated #{input('ca_01_odp_07')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective CA-01c.02[01]' do
