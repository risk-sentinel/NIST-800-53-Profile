control 'CA-07(03)[03]' do
  impact 0.5
  title "trend analysis is employed to determine if the types of activities used in the continuous monitoring process need to be modified based on empirical data."
  desc <<~DESC
  ...
  tag nist: ['CA-7 (3)']
  tag control: 'CA-7 (3)'
  tag objective: 'CA-07(03)[03]'
  tag rev: 'Rev_5'
  tag family: 'Assessment, Authorization, and Monitoring'
  tag baseline: %w{}
  tag control_ca_7_3: true

  describe 'NIST SP 800-53A Rev 5 objective CA-07(03)[03]' do
