control 'CA-07b.[01]' do
  impact 0.5
  title "system-level continuous monitoring includes established #{input('ca_07_odp_02')} for monitoring;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      system-level continuous monitoring includes established #{input('ca_07_odp_02')} for monitoring;
  ...
  describe 'NIST SP 800-53A Rev 5 objective CA-07b.[01]' do
