control 'CA-02e.' do
  impact 0.5
  title "a control assessment report is produced that documents the results of the assessment;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CA-02e.' do
