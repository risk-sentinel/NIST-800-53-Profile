control 'CA-02d.[01]' do
  impact 0.5
  title "controls are assessed in the system and its environment of operation #{input('ca_02_odp_01')} to determine the extent to which the controls are implemented correctly, operating as intended, and producing the desired outcome with respect to meeting established security requirements;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      controls are assessed in the system and its environment of operation #{input('ca_02_odp_01')} to determine the extent to which the controls are implemented correctly, operating as intended, and producing the desired outcome with respect to meeting established security requirements;
  ...
  describe 'NIST SP 800-53A Rev 5 objective CA-02d.[01]' do
