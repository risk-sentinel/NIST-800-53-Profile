control 'CA-03c.' do
  impact 0.5
  title "agreements are reviewed and updated #{input('ca_03_odp_03')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      agreements are reviewed and updated #{input('ca_03_odp_03')}.
  ...
  describe 'NIST SP 800-53A Rev 5 objective CA-03c.' do
