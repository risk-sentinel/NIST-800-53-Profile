control 'CA-02(01)' do
  impact 0.5
  title "independent assessors or assessment teams are employed to conduct control assessments."
  desc <<~DESC
  ...
  tag nist: ['CA-2 (1)']
  tag control: 'CA-2 (1)'
  tag objective: 'CA-02(01)'
  tag rev: 'Rev_5'
  tag family: 'Assessment, Authorization, and Monitoring'
  tag baseline: %w{MODERATE HIGH}
  tag baseline_moderate: true
  tag baseline_high: true
  tag control_ca_2_1: true

  describe 'NIST SP 800-53A Rev 5 objective CA-02(01)' do
