control 'CA-07(04)(b)' do
  impact 0.5
  title "compliance monitoring is included in risk monitoring;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CA-07(04)(b)' do
