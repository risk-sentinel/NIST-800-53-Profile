control 'CA-07[02]' do
  impact 0.5
  title "system-level continuous monitoring is implemented in accordance with the organization-level continuous monitoring strategy;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CA-07[02]' do
