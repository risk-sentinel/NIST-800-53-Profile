control 'CA-07c.' do
  impact 0.5
  title "system-level continuous monitoring includes ongoing control assessments in accordance with the continuous monitoring strategy;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CA-07c.' do
