control 'CA-09(01)[01]' do
  impact 0.5
  title "security compliance checks are performed on constituent system components prior to the establishment of the internal connection;"
  desc <<~DESC
  ...
  tag nist: ['CA-9 (1)']
  tag control: 'CA-9 (1)'
  tag objective: 'CA-09(01)[01]'
  tag rev: 'Rev_5'
  tag family: 'Assessment, Authorization, and Monitoring'
  tag baseline: %w{}
  tag control_ca_9_1: true

  describe 'NIST SP 800-53A Rev 5 objective CA-09(01)[01]' do
