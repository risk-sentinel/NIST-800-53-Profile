control 'CA-01a.[04]' do
  impact 0.5
  title "the assessment, authorization, and monitoring procedures are disseminated to #{input('ca_01_odp_02')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the assessment, authorization, and monitoring procedures are disseminated to #{input('ca_01_odp_02')};
  ...
  tag odp: %w{ca_01_odp_02 ca_01_odp_03 ca_01_odp_04 ca_01_odp_05 ca_01_odp_06 ca_01_odp_07 ca_01_odp_08 ca_1_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective CA-01a.[04]' do
