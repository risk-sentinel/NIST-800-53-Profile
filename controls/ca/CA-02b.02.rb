control 'CA-02b.02' do
  impact 0.5
  title "a control assessment plan is developed that describes the scope of the assessment, including assessment procedures to be used to determine control effectiveness;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CA-02b.02' do
