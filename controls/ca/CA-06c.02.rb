control 'CA-06c.02' do
  impact 0.5
  title "before commencing operations, the authorizing official for the system authorizes the system to operate;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CA-06c.02' do
