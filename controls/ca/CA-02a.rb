control 'CA-02a.' do
  impact 0.5
  title "an appropriate assessor or assessment team is selected for the type of assessment to be conducted;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CA-02a.' do
