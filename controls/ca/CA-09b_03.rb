control 'CA-09b.[03]' do
  impact 0.5
  title "for each internal connection, the privacy requirements are documented;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CA-09b.[03]' do
