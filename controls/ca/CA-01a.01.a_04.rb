control 'CA-01a.01(a)[04]' do
  impact 0.5
  title "the #{input('ca_01_odp_03')} assessment, authorization, and monitoring policy addresses responsibilities;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the #{input('ca_01_odp_03')} assessment, authorization, and monitoring policy addresses responsibilities;
  ...
  describe 'NIST SP 800-53A Rev 5 objective CA-01a.01(a)[04]' do
