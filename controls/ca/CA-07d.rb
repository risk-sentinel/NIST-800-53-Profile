control 'CA-07d.' do
  impact 0.5
  title "system-level continuous monitoring includes ongoing monitoring of system and organization-defined metrics in accordance with the continuous monitoring strategy;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CA-07d.' do
