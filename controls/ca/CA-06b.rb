control 'CA-06b.' do
  impact 0.5
  title "a senior official is assigned as the authorizing official for common controls available for inheritance by organizational systems;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CA-06b.' do
