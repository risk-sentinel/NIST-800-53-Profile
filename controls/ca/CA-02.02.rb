control 'CA-02(02)' do
  impact 0.5
  title "#{input('ca_02_02_odp_01')} #{input('ca_02_02_odp_02')} #{input('ca_02_02_odp_03')} are included as part of control assessments."
  desc <<~DESC
    Include as part of control assessments, #{input('ca_02_02_odp_01')}, #{input('ca_02_02_odp_02')}, #{input('ca_02_02_odp_03')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      #{input('ca_02_02_odp_01')} #{input('ca_02_02_odp_02')} #{input('ca_02_02_odp_03')} are included as part of control assessments.
