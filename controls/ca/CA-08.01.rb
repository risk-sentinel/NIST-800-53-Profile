control 'CA-08(01)' do
  impact 0.5
  title "an independent penetration testing agent or team is employed to perform penetration testing on the system or system components."
  desc <<~DESC
  ...
  tag nist: ['CA-8 (1)']
  tag control: 'CA-8 (1)'
  tag objective: 'CA-08(01)'
  tag rev: 'Rev_5'
  tag family: 'Assessment, Authorization, and Monitoring'
  tag baseline: %w{HIGH}
  tag baseline_high: true
  tag control_ca_8_1: true

  describe 'NIST SP 800-53A Rev 5 objective CA-08(01)' do
