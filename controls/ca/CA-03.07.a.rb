control 'CA-03(07)(a)' do
  impact 0.5
  title "transitive (downstream) information exchanges with other systems through the systems identified in CA-03a are identified;"
  desc <<~DESC
  ...
  tag nist: ['CA-3 (7)']
  tag control: 'CA-3 (7)'
  tag objective: 'CA-03(07)(a)'
  tag rev: 'Rev_5'
  tag family: 'Assessment, Authorization, and Monitoring'
  tag baseline: %w{}
  tag control_ca_3_7: true

  describe 'NIST SP 800-53A Rev 5 objective CA-03(07)(a)' do
