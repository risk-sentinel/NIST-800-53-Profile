control 'CA-01a.01(a)[01]' do
  impact 0.5
  title "the #{input('ca_01_odp_03')} assessment, authorization, and monitoring policy addresses purpose;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the #{input('ca_01_odp_03')} assessment, authorization, and monitoring policy addresses purpose;
  ...
  describe 'NIST SP 800-53A Rev 5 objective CA-01a.01(a)[01]' do
