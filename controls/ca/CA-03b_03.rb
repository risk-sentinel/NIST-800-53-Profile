control 'CA-03b.[03]' do
  impact 0.5
  title "privacy requirements are documented as part of each exchange agreement;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CA-03b.[03]' do
