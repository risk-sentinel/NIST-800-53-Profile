control 'CA-01a.01(b)' do
  impact 0.5
  title "the #{input('ca_01_odp_03')} assessment, authorization, and monitoring policy is consistent with applicable laws, executive orders, directives, regulations, policies, standards, and guidelines;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the #{input('ca_01_odp_03')} assessment, authorization, and monitoring policy is consistent with applicable laws, executive orders, directives, regulations, policies, standards, and guidelines;
  ...
  tag control_ca_1: true
  tag odp: %w{ca_01_odp_03 ca_01_odp_04 ca_01_odp_05 ca_01_odp_06 ca_01_odp_07 ca_01_odp_08 ca_1_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective CA-01a.01(b)' do
