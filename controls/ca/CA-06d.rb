control 'CA-06d.' do
  impact 0.5
  title "the authorizing official for common controls authorizes the use of those controls for inheritance by organizational systems;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective CA-06d.' do
