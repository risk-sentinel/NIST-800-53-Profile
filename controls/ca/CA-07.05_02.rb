control 'CA-07(05)[02]' do
  impact 0.5
  title "#{input('ca_07_05_odp_02')} are employed to validate that implemented controls are operating in a consistent manner."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('ca_07_05_odp_02')} are employed to validate that implemented controls are operating in a consistent manner.
  ...
  tag nist: ['CA-7 (5)']
  tag control: 'CA-7 (5)'
  tag objective: 'CA-07(05)[02]'
  tag rev: 'Rev_5'
  tag family: 'Assessment, Authorization, and Monitoring'
  tag baseline: %w{}
  tag control_ca_7_5: true
  tag odp: %w{ca_07_05_odp_02 ca_7_5_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective CA-07(05)[02]' do
