control 'CA-07g.[01]' do
  impact 0.5
  title "system-level continuous monitoring includes reporting the security status of the system to #{input('ca_07_odp_04')} #{input('ca_07_odp_05')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      system-level continuous monitoring includes reporting the security status of the system to #{input('ca_07_odp_04')} #{input('ca_07_odp_05')};
  ...
  tag odp: %w{ca_07_odp_01 ca_07_odp_02 ca_07_odp_03 ca_07_odp_04 ca_07_odp_05 ca_7_prm_4 ca_7_prm_5}

  describe 'NIST SP 800-53A Rev 5 objective CA-07g.[01]' do
