control 'CA-06(02)[01]' do
  impact 0.5
  title "a joint authorization process is employed for the system;"
  desc <<~DESC
  ...
  tag nist: ['CA-6 (2)']
  tag control: 'CA-6 (2)'
  tag objective: 'CA-06(02)[01]'
  tag rev: 'Rev_5'
  tag family: 'Assessment, Authorization, and Monitoring'
  tag baseline: %w{}
  tag control_ca_6_2: true

  describe 'NIST SP 800-53A Rev 5 objective CA-06(02)[01]' do
