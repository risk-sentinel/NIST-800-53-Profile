control 'CA-08' do
  impact 0.5
  title "penetration testing is conducted #{input('ca_08_odp_01')} on #{input('ca_08_odp_02')}."
  desc <<~DESC
    Conduct penetration testing #{input('ca_08_odp_01')} on #{input('ca_08_odp_02')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      penetration testing is conducted #{input('ca_08_odp_01')} on #{input('ca_08_odp_02')}.
  ...
  tag control_ca_8: true
  tag odp: %w{ca_08_odp_01 ca_08_odp_02}

  describe 'NIST SP 800-53A Rev 5 objective CA-08' do
