control 'CA-07a.' do
  impact 0.5
  title "system-level continuous monitoring includes establishment of the following system-level metrics to be monitored: #{input('ca_07_odp_01')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      system-level continuous monitoring includes establishment of the following system-level metrics to be monitored: #{input('ca_07_odp_01')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective CA-07a.' do
