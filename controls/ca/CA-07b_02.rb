control 'CA-07b.[02]' do
  impact 0.5
  title "system-level continuous monitoring includes established #{input('ca_07_odp_03')} for assessment of control effectiveness;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      system-level continuous monitoring includes established #{input('ca_07_odp_03')} for assessment of control effectiveness;
  ...
  describe 'NIST SP 800-53A Rev 5 objective CA-07b.[02]' do
