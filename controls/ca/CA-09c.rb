control 'CA-09c.' do
  impact 0.5
  title "internal system connections are terminated after #{input('ca_09_odp_02')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      internal system connections are terminated after #{input('ca_09_odp_02')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective CA-09c.' do
