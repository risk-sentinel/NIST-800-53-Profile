control 'SI-4 (7)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SI-04(07)(a) #{input('si_04_07_odp_01')} are notified of detected suspicious events;
      SI-04(07)(b) #{input('si_04_07_odp_02')} are taken upon the detection of suspicious events.
  ...
  describe 'NIST SP 800-53 Rev 5 control SI-4 (7)' do
