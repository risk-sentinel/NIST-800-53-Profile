control 'MA-05(05)' do
  impact 0.5
  title "non-escorted personnel performing maintenance activities not directly associated with the system but in the physical proximity of the system have required access authorizations."
  desc <<~DESC
  ...
  tag nist: ['MA-5 (5)']
  tag control: 'MA-5 (5)'
  tag objective: 'MA-05(05)'
  tag rev: 'Rev_5'
  tag family: 'Maintenance'
  tag baseline: %w{}
  tag control_ma_5_5: true

  describe 'NIST SP 800-53A Rev 5 objective MA-05(05)' do
