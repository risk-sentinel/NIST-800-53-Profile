control 'MA-05a.[02]' do
  impact 0.5
  title "a list of authorized maintenance organizations or personnel is maintained;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective MA-05a.[02]' do
