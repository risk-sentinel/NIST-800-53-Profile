control 'MA-04c.' do
  impact 0.5
  title "strong authentication is employed in the establishment of nonlocal maintenance and diagnostic sessions;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective MA-04c.' do
