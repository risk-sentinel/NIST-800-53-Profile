control 'MA-05a.[01]' do
  impact 0.5
  title "a process for maintenance personnel authorization is established;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective MA-05a.[01]' do
