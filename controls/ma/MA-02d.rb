control 'MA-02d.' do
  impact 0.5
  title "equipment is sanitized to remove #{input('ma_02_odp_02')} from associated media prior to removal from organizational facilities for off-site maintenance, repair, or replacement;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      equipment is sanitized to remove #{input('ma_02_odp_02')} from associated media prior to removal from organizational facilities for off-site maintenance, repair, or replacement;
  ...
  describe 'NIST SP 800-53A Rev 5 objective MA-02d.' do
