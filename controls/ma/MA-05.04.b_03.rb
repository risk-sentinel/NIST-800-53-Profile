control 'MA-05(04)(b)[03]' do
  impact 0.5
  title "detailed operational conditions regarding the use of foreign nationals to conduct maintenance and diagnostic activities on classified systems are fully documented within Memoranda of Agreements."
  desc <<~DESC
    Ensure that:
  ...
  tag nist: ['MA-5 (4)']
  tag control: 'MA-5 (4)'
  tag objective: 'MA-05(04)(b)[03]'
  tag rev: 'Rev_5'
  tag family: 'Maintenance'
  tag baseline: %w{}
  tag control_ma_5_4: true

  describe 'NIST SP 800-53A Rev 5 objective MA-05(04)(b)[03]' do
