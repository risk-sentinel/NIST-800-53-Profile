control 'MA-02f.' do
  impact 0.5
  title "#{input('ma_02_odp_03')} is included in organizational maintenance records."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('ma_02_odp_03')} is included in organizational maintenance records.
  ...
  describe 'NIST SP 800-53A Rev 5 objective MA-02f.' do
