control 'MA-04(04)(b)(02)' do
  impact 0.5
  title "nonlocal maintenance sessions are protected by logically separated communication paths."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective MA-04(04)(b)(02)' do
