control 'MA-02(02)(a)[01]' do
  impact 0.5
  title "#{input('ma_02_02_odp_01')} are used to schedule maintenance, repair, and replacement actions for the system;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('ma_02_02_odp_01')} are used to schedule maintenance, repair, and replacement actions for the system;
  ...
  tag nist: ['MA-2 (2)']
  tag control: 'MA-2 (2)'
  tag objective: 'MA-02(02)(a)[01]'
  tag rev: 'Rev_5'
  tag family: 'Maintenance'
  tag baseline: %w{HIGH}
  tag baseline_high: true
  tag control_ma_2_2: true
  tag odp: %w{ma_02_02_odp_01 ma_2_2_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective MA-02(02)(a)[01]' do
