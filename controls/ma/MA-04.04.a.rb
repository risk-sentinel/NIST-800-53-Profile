control 'MA-04(04)(a)' do
  impact 0.5
  title "nonlocal maintenance sessions are protected by employing #{input('ma_04_04_odp')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      nonlocal maintenance sessions are protected by employing #{input('ma_04_04_odp')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective MA-04(04)(a)' do
