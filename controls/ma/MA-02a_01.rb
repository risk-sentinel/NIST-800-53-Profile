control 'MA-02a.[01]' do
  impact 0.5
  title "maintenance, repair, and replacement of system components are scheduled in accordance with manufacturer or vendor specifications and/or organizational requirements;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective MA-02a.[01]' do
