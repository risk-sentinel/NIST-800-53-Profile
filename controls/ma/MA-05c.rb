control 'MA-05c.' do
  impact 0.5
  title "organizational personnel with required access authorizations and technical competence is/are designated to supervise the maintenance activities of personnel who do not possess the required access authorizations."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective MA-05c.' do
