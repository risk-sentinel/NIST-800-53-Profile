control 'MA-04(03)(b)[03]' do
  impact 0.5
  title "the component is inspected and sanitized (for potentially malicious software) after the service is performed and before reconnecting the component to the system."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective MA-04(03)(b)[03]' do
