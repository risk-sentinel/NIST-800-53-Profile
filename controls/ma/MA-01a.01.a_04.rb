control 'MA-01a.01(a)[04]' do
  impact 0.5
  title "the #{input('ma_01_odp_03')} maintenance policy addresses responsibilities;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the #{input('ma_01_odp_03')} maintenance policy addresses responsibilities;
  ...
  describe 'NIST SP 800-53A Rev 5 objective MA-01a.01(a)[04]' do
