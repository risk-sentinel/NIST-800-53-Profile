control 'MA-05(03)' do
  impact 0.5
  title "personnel performing maintenance and diagnostic activities on a system processing, storing, or transmitting classified information are U.S. citizens."
  desc <<~DESC
  ...
  tag nist: ['MA-5 (3)']
  tag control: 'MA-5 (3)'
  tag objective: 'MA-05(03)'
  tag rev: 'Rev_5'
  tag family: 'Maintenance'
  tag baseline: %w{}
  tag control_ma_5_3: true

  describe 'NIST SP 800-53A Rev 5 objective MA-05(03)' do
