control 'MA-03(04)' do
  impact 0.5
  title "the use of maintenance tools is restricted to authorized personnel only."
  desc <<~DESC
  ...
  tag nist: ['MA-3 (4)']
  tag control: 'MA-3 (4)'
  tag objective: 'MA-03(04)'
  tag rev: 'Rev_5'
  tag family: 'Maintenance'
  tag baseline: %w{}
  tag control_ma_3_4: true

  describe 'NIST SP 800-53A Rev 5 objective MA-03(04)' do
