control 'MA-03a.[03]' do
  impact 0.5
  title "the use of system maintenance tools is monitored;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective MA-03a.[03]' do
