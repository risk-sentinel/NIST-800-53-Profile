control 'MA-03(03)(d)' do
  impact 0.5
  title "the removal of maintenance equipment containing organizational information is prevented by obtaining an exemption from #{input('ma_03_03_odp')} explicitly authorizing removal of the equipment from the facility."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the removal of maintenance equipment containing organizational information is prevented by obtaining an exemption from #{input('ma_03_03_odp')} explicitly authorizing removal of the equipment from the facility.
  ...
  describe 'NIST SP 800-53A Rev 5 objective MA-03(03)(d)' do
