control 'MA-03(05)' do
  impact 0.5
  title "the use of maintenance tools that execute with increased privilege is monitored."
  desc <<~DESC
  ...
  tag nist: ['MA-3 (5)']
  tag control: 'MA-3 (5)'
  tag objective: 'MA-03(05)'
  tag rev: 'Rev_5'
  tag family: 'Maintenance'
  tag baseline: %w{}
  tag control_ma_3_5: true

  describe 'NIST SP 800-53A Rev 5 objective MA-03(05)' do
