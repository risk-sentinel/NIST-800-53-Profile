control 'MA-04(01)(b)[02]' do
  impact 0.5
  title "the audit records of the diagnostic sessions are reviewed to detect anomalous behavior."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective MA-04(01)(b)[02]' do
