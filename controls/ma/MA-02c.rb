control 'MA-02c.' do
  impact 0.5
  title "#{input('ma_02_odp_01')} is/are required to explicitly approve the removal of the system or system components from organizational facilities for off-site maintenance, repair, or replacement;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('ma_02_odp_01')} is/are required to explicitly approve the removal of the system or system components from organizational facilities for off-site maintenance, repair, or replacement;
  ...
  describe 'NIST SP 800-53A Rev 5 objective MA-02c.' do
