control 'MA-04e.[01]' do
  impact 0.5
  title "session connections are terminated when nonlocal maintenance is completed;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective MA-04e.[01]' do
