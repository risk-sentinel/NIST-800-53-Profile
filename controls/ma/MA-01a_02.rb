control 'MA-01a.[02]' do
  impact 0.5
  title "the maintenance policy is disseminated to #{input('ma_01_odp_01')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the maintenance policy is disseminated to #{input('ma_01_odp_01')};
  ...
  tag odp: %w{ma_01_odp_01 ma_01_odp_03 ma_01_odp_04 ma_01_odp_05 ma_01_odp_06 ma_01_odp_07 ma_01_odp_08 ma_1_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective MA-01a.[02]' do
