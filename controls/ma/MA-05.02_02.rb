control 'MA-05(02)[02]' do
  impact 0.5
  title "personnel performing maintenance and diagnostic activities on a system processing, storing, or transmitting classified information possess formal access approvals for at least the highest classification level and for compartments of information on the system."
  desc <<~DESC
  ...
  tag nist: ['MA-5 (2)']
  tag control: 'MA-5 (2)'
  tag objective: 'MA-05(02)[02]'
  tag rev: 'Rev_5'
  tag family: 'Maintenance'
  tag baseline: %w{}
  tag control_ma_5_2: true

  describe 'NIST SP 800-53A Rev 5 objective MA-05(02)[02]' do
