control 'MA-04(03)(b)[02]' do
  impact 0.5
  title "the component to be serviced is sanitized (for organizational information);"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective MA-04(03)(b)[02]' do
