control 'MA-04(03)(b)[01]' do
  impact 0.5
  title "the component to be serviced is removed from the system prior to nonlocal maintenance or diagnostic services;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective MA-04(03)(b)[01]' do
