control 'MA-04b.[02]' do
  impact 0.5
  title "the use of nonlocal maintenance and diagnostic tools are documented in the security plan for the system;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective MA-04b.[02]' do
