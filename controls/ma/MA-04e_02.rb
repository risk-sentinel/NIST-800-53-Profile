control 'MA-04e.[02]' do
  impact 0.5
  title "network connections are terminated when nonlocal maintenance is completed."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective MA-04e.[02]' do
