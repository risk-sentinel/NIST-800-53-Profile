control 'MA-01a.01(a)[07]' do
  impact 0.5
  title "the #{input('ma_01_odp_03')} maintenance policy addresses compliance;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the #{input('ma_01_odp_03')} maintenance policy addresses compliance;
  ...
  describe 'NIST SP 800-53A Rev 5 objective MA-01a.01(a)[07]' do
