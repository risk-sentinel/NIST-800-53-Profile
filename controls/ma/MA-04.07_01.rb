control 'MA-04(07)[01]' do
  impact 0.5
  title "session connection termination is verified after the completion of nonlocal maintenance and diagnostic sessions;"
  desc <<~DESC
  ...
  tag nist: ['MA-4 (7)']
  tag control: 'MA-4 (7)'
  tag objective: 'MA-04(07)[01]'
  tag rev: 'Rev_5'
  tag family: 'Maintenance'
  tag baseline: %w{}
  tag control_ma_4_7: true

  describe 'NIST SP 800-53A Rev 5 objective MA-04(07)[01]' do
