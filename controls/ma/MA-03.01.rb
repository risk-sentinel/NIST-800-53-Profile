control 'MA-03(01)' do
  impact 0.5
  title "maintenance tools used by maintenance personnel are inspected for improper or unauthorized modifications."
  desc <<~DESC
  ...
  tag nist: ['MA-3 (1)']
  tag control: 'MA-3 (1)'
  tag objective: 'MA-03(01)'
  tag rev: 'Rev_5'
  tag family: 'Maintenance'
  tag baseline: %w{MODERATE HIGH}
  tag baseline_moderate: true
  tag baseline_high: true
  tag control_ma_3_1: true

  describe 'NIST SP 800-53A Rev 5 objective MA-03(01)' do
