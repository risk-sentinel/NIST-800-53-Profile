control 'MA-04a.[01]' do
  impact 0.5
  title "nonlocal maintenance and diagnostic activities are approved;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective MA-04a.[01]' do
