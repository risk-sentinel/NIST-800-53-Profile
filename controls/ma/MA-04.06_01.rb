control 'MA-04(06)[01]' do
  impact 0.5
  title "#{input('ma_04_06_odp')} are implemented to protect the integrity of nonlocal maintenance and diagnostic communications;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('ma_04_06_odp')} are implemented to protect the integrity of nonlocal maintenance and diagnostic communications;
  ...
  describe 'NIST SP 800-53A Rev 5 objective MA-04(06)[01]' do
