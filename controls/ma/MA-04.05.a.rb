control 'MA-04(05)(a)' do
  impact 0.5
  title "the approval of each nonlocal maintenance session is required by #{input('ma_04_05_odp_01')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the approval of each nonlocal maintenance session is required by #{input('ma_04_05_odp_01')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective MA-04(05)(a)' do
