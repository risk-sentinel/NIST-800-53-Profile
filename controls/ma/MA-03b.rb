control 'MA-03b.' do
  impact 0.5
  title "previously approved system maintenance tools are reviewed #{input('ma_03_odp')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      previously approved system maintenance tools are reviewed #{input('ma_03_odp')}.
  ...
  describe 'NIST SP 800-53A Rev 5 objective MA-03b.' do
