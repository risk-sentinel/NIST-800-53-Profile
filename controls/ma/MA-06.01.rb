control 'MA-06(01)' do
  impact 0.5
  title "preventive maintenance is performed on #{input('ma_06_01_odp_01')} at #{input('ma_06_01_odp_02')}."
  desc <<~DESC
    Perform preventive maintenance on #{input('ma_06_01_odp_01')} at #{input('ma_06_01_odp_02')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      preventive maintenance is performed on #{input('ma_06_01_odp_01')} at #{input('ma_06_01_odp_02')}.
  ...
  tag nist: ['MA-6 (1)']
  tag control: 'MA-6 (1)'
  tag objective: 'MA-06(01)'
  tag rev: 'Rev_5'
  tag family: 'Maintenance'
  tag baseline: %w{}
  tag control_ma_6_1: true
  tag odp: %w{ma_06_01_odp_01 ma_06_01_odp_02}

  describe 'NIST SP 800-53A Rev 5 objective MA-06(01)' do
