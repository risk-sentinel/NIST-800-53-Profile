control 'MA-02(02)(b)[03]' do
  impact 0.5
  title "up-to date, accurate, and complete records of all replacement actions requested, scheduled, in process, and completed are produced."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective MA-02(02)(b)[03]' do
