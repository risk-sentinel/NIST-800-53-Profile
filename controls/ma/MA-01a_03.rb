control 'MA-01a.[03]' do
  impact 0.5
  title "maintenance procedures to facilitate the implementation of the maintenance policy and associated maintenance controls are developed and documented;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective MA-01a.[03]' do
