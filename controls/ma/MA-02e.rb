control 'MA-02e.' do
  impact 0.5
  title "all potentially impacted controls are checked to verify that the controls are still functioning properly following maintenance, repair, or replacement actions;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective MA-02e.' do
