control 'MA-04(03)(a)[01]' do
  impact 0.5
  title "nonlocal maintenance services are required to be performed from a system that implements a security capability comparable to the capability implemented on the system being serviced;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective MA-04(03)(a)[01]' do
