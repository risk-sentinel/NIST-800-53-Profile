control 'MA-04b.[01]' do
  impact 0.5
  title "the use of nonlocal maintenance and diagnostic tools are allowed only as consistent with organizational policy;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective MA-04b.[01]' do
