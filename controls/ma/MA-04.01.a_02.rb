control 'MA-04(01)(a)[02]' do
  impact 0.5
  title "#{input('ma_04_01_odp_02')} are logged for nonlocal diagnostic sessions;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('ma_04_01_odp_02')} are logged for nonlocal diagnostic sessions;
  ...
  tag nist: ['MA-4 (1)']
  tag control: 'MA-4 (1)'
  tag objective: 'MA-04(01)(a)[02]'
  tag rev: 'Rev_5'
  tag family: 'Maintenance'
  tag baseline: %w{}
  tag control_ma_4_1: true
  tag odp: %w{ma_04_01_odp_02 ma_4_1_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective MA-04(01)(a)[02]' do
