control 'MA-03(06)' do
  impact 0.5
  title "maintenance tools are inspected to ensure that the latest software updates and patches are installed."
  desc <<~DESC
  ...
  tag nist: ['MA-3 (6)']
  tag control: 'MA-3 (6)'
  tag objective: 'MA-03(06)'
  tag rev: 'Rev_5'
  tag family: 'Maintenance'
  tag baseline: %w{}
  tag control_ma_3_6: true

  describe 'NIST SP 800-53A Rev 5 objective MA-03(06)' do
