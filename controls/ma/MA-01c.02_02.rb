control 'MA-01c.02[02]' do
  impact 0.5
  title "the current maintenance procedures are reviewed and updated following #{input('ma_01_odp_08')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the current maintenance procedures are reviewed and updated following #{input('ma_01_odp_08')}.
  ...
  describe 'NIST SP 800-53A Rev 5 objective MA-01c.02[02]' do
