control 'SC-18 (3)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SC-18(03)[01] the download of #{input('sc_18_03_odp')} is prevented;
      SC-18(03)[02] the execution of #{input('sc_18_03_odp')} is prevented.
  ...
  describe 'NIST SP 800-53 Rev 5 control SC-18 (3)' do
