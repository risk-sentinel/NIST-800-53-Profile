control 'PE-3 (2)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      PE-03(02) security checks are performed #{input('pe_03_02_odp')} at the physical perimeter of the facility or system for exfiltration of information or removal of system components.
  ...
  describe 'NIST SP 800-53 Rev 5 control PE-3 (2)' do
