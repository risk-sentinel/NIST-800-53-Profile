control 'CP-7' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      CP-07a. an alternate processing site, including necessary agreements to permit the transfer and resumption of #{input('cp_07_odp_01')} for essential mission and business functions, is established within #{input('cp_07_odp_02')} when the primary processing capabilities are unavailable;
      CP-07b.
        CP-07b.[01] the equipment and supplies required to transfer operations are made available at the alternate processing site or if contracts are in place to support delivery to the site within #{input('cp_07_odp_02')} for transfer;
        CP-07b.[02] the equipment and supplies required to resume operations are made available at the alternate processing site or if contracts are in place to support delivery to the site within #{input('cp_07_odp_02')} for resumption;
  ...
  describe 'NIST SP 800-53 Rev 5 control CP-7' do
