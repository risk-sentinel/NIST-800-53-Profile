control 'SC-29' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SC-29 a diverse set of information technologies is employed for #{input('sc_29_odp')} in the implementation of the system.
  ...
  describe 'NIST SP 800-53 Rev 5 control SC-29' do
