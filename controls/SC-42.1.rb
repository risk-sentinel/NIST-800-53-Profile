control 'SC-42 (1)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SC-42(01) the system is configured so that data or information collected by the #{input('sc_42_01_odp')} is only reported to authorized individuals or roles.
  ...
  describe 'NIST SP 800-53 Rev 5 control SC-42 (1)' do
