control 'SA-04(10)' do
  impact 0.5
  title "only information technology products on the FIPS 201-approved products list for the Personal Identity Verification (PIV) capability implemented within organizational systems are employed."
  desc <<~DESC
  ...
  tag control_sa_4_10: true

  describe 'NIST SP 800-53A Rev 5 objective SA-04(10)' do
