control 'SA-09(03)[01]' do
  impact 0.5
  title "trust relationships with external service provides based on #{input('sa_09_03_odp_01')} are established and documented;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      trust relationships with external service provides based on #{input('sa_09_03_odp_01')} are established and documented;
  ...
  tag nist: ['SA-9 (3)']
  tag control: 'SA-9 (3)'
  tag objective: 'SA-09(03)[01]'
  tag rev: 'Rev_5'
  tag family: 'System and Services Acquisition'
  tag baseline: %w{}
  tag control_sa_9_3: true
  tag odp: %w{sa_09_03_odp_01 sa_9_3_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective SA-09(03)[01]' do
