control 'SA-15(10)[01]' do
  impact 0.5
  title "the developer of the system, system component, or system service is required to provide an incident response plan;"
  desc <<~DESC
  ...
  tag objective: 'SA-15(10)[01]'
  tag rev: 'Rev_5'
  tag family: 'System and Services Acquisition'
  tag baseline: %w{}
  tag control_sa_15_10: true

  describe 'NIST SP 800-53A Rev 5 objective SA-15(10)[01]' do
