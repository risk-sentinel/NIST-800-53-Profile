control 'SA-03(03)[01]' do
  impact 0.5
  title "a technology refresh schedule is planned for the system throughout the system development life cycle;"
  desc <<~DESC
  ...
  tag nist: ['SA-3 (3)']
  tag control: 'SA-3 (3)'
  tag objective: 'SA-03(03)[01]'
  tag rev: 'Rev_5'
  tag family: 'System and Services Acquisition'
  tag baseline: %w{}
  tag control_sa_3_3: true

  describe 'NIST SP 800-53A Rev 5 objective SA-03(03)[01]' do
