control 'SA-01c.01[01]' do
  impact 0.5
  title "the system and services acquisition policy is reviewed and updated #{input('sa_01_odp_05')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the system and services acquisition policy is reviewed and updated #{input('sa_01_odp_05')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective SA-01c.01[01]' do
