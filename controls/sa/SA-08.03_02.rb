control 'SA-08(03)[02]' do
  impact 0.5
  title "#{input('sa_08_03_odp_02')} implement the security design principle of layering."
  desc <<~DESC
    Implement the security design principles of modularity and layering in #{input('sa_8_3_prm_1')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      #{input('sa_08_03_odp_02')} implement the security design principle of layering.
  ...
  tag nist: ['SA-8 (3)']
  tag control: 'SA-8 (3)'
  tag objective: 'SA-08(03)[02]'
  tag rev: 'Rev_5'
  tag family: 'System and Services Acquisition'
  tag baseline: %w{}
  tag control_sa_8_3: true
  tag odp: %w{sa_08_03_odp_02 sa_8_3_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective SA-08(03)[02]' do
