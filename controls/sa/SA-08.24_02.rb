control 'SA-08(24)[02]' do
  impact 0.5
  title "#{input('sa_08_24_odp_02')} implement the security design principle of secure recovery."
  desc <<~DESC
    Implement the security design principle of secure failure and recovery in #{input('sa_8_24_prm_1')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      #{input('sa_08_24_odp_02')} implement the security design principle of secure recovery.
  ...
  tag nist: ['SA-8 (24)']
  tag control: 'SA-8 (24)'
  tag objective: 'SA-08(24)[02]'
  tag rev: 'Rev_5'
  tag family: 'System and Services Acquisition'
  tag baseline: %w{}
  tag control_sa_8_24: true
  tag odp: %w{sa_08_24_odp_02 sa_8_24_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective SA-08(24)[02]' do
