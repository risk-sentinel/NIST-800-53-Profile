control 'SA-09b.[01]' do
  impact 0.5
  title "organizational oversight with regard to external system services are defined and documented;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SA-09b.[01]' do
