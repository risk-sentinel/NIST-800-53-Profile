control 'SA-21b.' do
  impact 0.5
  title "the developer of #{input('sa_21_odp_01')} is required to satisfy #{input('sa_21_odp_03')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the developer of #{input('sa_21_odp_01')} is required to satisfy #{input('sa_21_odp_03')}.
  ...
  describe 'NIST SP 800-53A Rev 5 objective SA-21b.' do
