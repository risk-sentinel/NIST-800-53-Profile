control 'SA-17(03)(c)' do
  impact 0.5
  title "the developer of the system, system component, or system service is required to show via informal demonstration that the formal top-level specification completely covers the interfaces to security-relevant hardware, software, and firmware;"
  desc <<~DESC
  ...
  tag nist: ['SA-17 (3)']
  tag control: 'SA-17 (3)'
  tag objective: 'SA-17(03)(c)'
  tag rev: 'Rev_5'
  tag family: 'System and Services Acquisition'
  tag baseline: %w{}
  tag control_sa_17_3: true

  describe 'NIST SP 800-53A Rev 5 objective SA-17(03)(c)' do
