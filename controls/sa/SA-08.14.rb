control 'SA-08(14)' do
  impact 0.5
  title "#{input('sa_08_14_odp')} implement the security design principle of least privilege."
  desc <<~DESC
    Implement the security design principle of least privilege in #{input('sa_08_14_odp')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      #{input('sa_08_14_odp')} implement the security design principle of least privilege.
  ...
  tag nist: ['SA-8 (14)']
  tag control: 'SA-8 (14)'
  tag objective: 'SA-08(14)'
  tag rev: 'Rev_5'
  tag family: 'System and Services Acquisition'
  tag baseline: %w{}
  tag control_sa_8_14: true
  tag odp: %w{sa_08_14_odp}

  describe 'NIST SP 800-53A Rev 5 objective SA-08(14)' do
