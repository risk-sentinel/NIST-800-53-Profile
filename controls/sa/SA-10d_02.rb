control 'SA-10d.[02]' do
  impact 0.5
  title "the developer of the system, system component, or system service is required to document the potential security impacts of approved changes;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SA-10d.[02]' do
