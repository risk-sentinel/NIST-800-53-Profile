control 'SA-15(08)[01]' do
  impact 0.5
  title "the developer of the system, system component, or system service is required to use threat modeling from similar systems, components, or services to inform the current development process;"
  desc <<~DESC
  ...
  tag nist: ['SA-15 (8)']
  tag control: 'SA-15 (8)'
  tag objective: 'SA-15(08)[01]'
  tag rev: 'Rev_5'
  tag family: 'System and Services Acquisition'
  tag baseline: %w{}
  tag control_sa_15_8: true

  describe 'NIST SP 800-53A Rev 5 objective SA-15(08)[01]' do
