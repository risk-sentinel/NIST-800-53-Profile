control 'SA-08[09]' do
  impact 0.5
  title "#{input('sa_08_odp_02')} are applied in the implementation of the system and system components;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('sa_08_odp_02')} are applied in the implementation of the system and system components;
  ...
  tag odp: %w{sa_08_odp_02 sa_8_prm_1}
