control 'SA-15(02)[02]' do
  impact 0.5
  title "the developer of the system, system component, or system service is required to select and employ privacy tracking tools for use during the development process."
  desc <<~DESC
  ...
  tag nist: ['SA-15 (2)']
  tag control: 'SA-15 (2)'
  tag objective: 'SA-15(02)[02]'
  tag rev: 'Rev_5'
  tag family: 'System and Services Acquisition'
  tag baseline: %w{}
  tag control_sa_15_2: true

  describe 'NIST SP 800-53A Rev 5 objective SA-15(02)[02]' do
