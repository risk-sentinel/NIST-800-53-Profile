control 'SA-03c.[01]' do
  impact 0.5
  title "individuals with information security roles and responsibilities are identified;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SA-03c.[01]' do
