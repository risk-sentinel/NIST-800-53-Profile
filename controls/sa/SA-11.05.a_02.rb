control 'SA-11(05)(a)[02]' do
  impact 0.5
  title "the developer of the system, system component, or system service is required to perform penetration testing at the following level of rigor: #{input('sa_11_05_odp_02')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the developer of the system, system component, or system service is required to perform penetration testing at the following level of rigor: #{input('sa_11_05_odp_02')};
  ...
  tag nist: ['SA-11 (5)']
  tag control: 'SA-11 (5)'
  tag objective: 'SA-11(05)(a)[02]'
  tag rev: 'Rev_5'
  tag family: 'System and Services Acquisition'
  tag baseline: %w{}
  tag control_sa_11_5: true
  tag odp: %w{sa_11_05_odp_02 sa_11_05_odp_03 sa_11_5_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective SA-11(05)(a)[02]' do
