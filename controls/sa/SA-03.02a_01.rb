control 'SA-03(02)a.[01]' do
  impact 0.5
  title "the use of live data in pre-production environments is approved for the system, system component, or system service;"
  desc <<~DESC
  ...
  tag nist: ['SA-3 (2)']
  tag control: 'SA-3 (2)'
  tag objective: 'SA-03(02)a.[01]'
  tag rev: 'Rev_5'
  tag family: 'System and Services Acquisition'
  tag baseline: %w{}
  tag control_sa_3_2: true

  describe 'NIST SP 800-53A Rev 5 objective SA-03(02)a.[01]' do
