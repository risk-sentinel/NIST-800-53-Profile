control 'SA-09(03)[03]' do
  impact 0.5
  title "trust relationships with external service provides based on #{input('sa_09_03_odp_02')} are established and documented;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      trust relationships with external service provides based on #{input('sa_09_03_odp_02')} are established and documented;
  ...
  describe 'NIST SP 800-53A Rev 5 objective SA-09(03)[03]' do
