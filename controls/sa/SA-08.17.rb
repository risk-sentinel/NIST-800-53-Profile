control 'SA-08(17)' do
  impact 0.5
  title "#{input('sa_08_17_odp')} implement the security design principle of secure distributed composition."
  desc <<~DESC
    Implement the security design principle of secure distributed composition in #{input('sa_08_17_odp')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      #{input('sa_08_17_odp')} implement the security design principle of secure distributed composition.
  ...
  tag nist: ['SA-8 (17)']
  tag control: 'SA-8 (17)'
  tag objective: 'SA-08(17)'
  tag rev: 'Rev_5'
  tag family: 'System and Services Acquisition'
  tag baseline: %w{}
  tag control_sa_8_17: true
  tag odp: %w{sa_08_17_odp}

  describe 'NIST SP 800-53A Rev 5 objective SA-08(17)' do
