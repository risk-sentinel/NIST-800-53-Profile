control 'SA-15(01)(b)' do
  impact 0.5
  title "the developer of the system, system component, or system service is required to provide evidence of meeting the quality metrics #{input('sa_15_01_odp_01')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the developer of the system, system component, or system service is required to provide evidence of meeting the quality metrics #{input('sa_15_01_odp_01')}.
  ...
  tag nist: ['SA-15 (1)']
  tag control: 'SA-15 (1)'
  tag objective: 'SA-15(01)(b)'
  tag rev: 'Rev_5'
  tag family: 'System and Services Acquisition'
  tag baseline: %w{}
  tag control_sa_15_1: true
  tag odp: %w{sa_15_01_odp_01}

  describe 'NIST SP 800-53A Rev 5 objective SA-15(01)(b)' do
