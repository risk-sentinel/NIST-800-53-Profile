control 'SA-24a.04' do
  impact 0.5
  title "organizational systems, system components, or system services achieve cyber resiliency through #{input('sa_24_odp_04')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      organizational systems, system components, or system services achieve cyber resiliency through #{input('sa_24_odp_04')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective SA-24a.04' do
