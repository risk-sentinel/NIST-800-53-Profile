control 'SA-10(06)' do
  impact 0.5
  title "the developer of the system, system component, or system service is required to execute procedures for ensuring that security-relevant hardware, software, and firmware updates distributed to the organization are exactly as specified by the master copies."
  desc <<~DESC
  ...
  tag nist: ['SA-10 (6)']
  tag control: 'SA-10 (6)'
  tag objective: 'SA-10(06)'
  tag rev: 'Rev_5'
  tag family: 'System and Services Acquisition'
  tag baseline: %w{}
  tag control_sa_10_6: true

  describe 'NIST SP 800-53A Rev 5 objective SA-10(06)' do
