control 'SA-08(11)' do
  impact 0.5
  title "#{input('sa_08_11_odp')} implement the security design principle of inverse modification threshold."
  desc <<~DESC
    Implement the security design principle of inverse modification threshold in #{input('sa_08_11_odp')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      #{input('sa_08_11_odp')} implement the security design principle of inverse modification threshold.
  ...
  tag nist: ['SA-8 (11)']
  tag control: 'SA-8 (11)'
  tag objective: 'SA-08(11)'
  tag rev: 'Rev_5'
  tag family: 'System and Services Acquisition'
  tag baseline: %w{}
  tag control_sa_8_11: true
  tag odp: %w{sa_08_11_odp}

  describe 'NIST SP 800-53A Rev 5 objective SA-08(11)' do
