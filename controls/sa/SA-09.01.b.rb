control 'SA-09(01)(b)' do
  impact 0.5
  title "#{input('sa_09_01_odp')} approve the acquisition or outsourcing of dedicated information security services."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('sa_09_01_odp')} approve the acquisition or outsourcing of dedicated information security services.
  ...
  tag nist: ['SA-9 (1)']
  tag control: 'SA-9 (1)'
  tag objective: 'SA-09(01)(b)'
  tag rev: 'Rev_5'
  tag family: 'System and Services Acquisition'
  tag baseline: %w{}
  tag control_sa_9_1: true
  tag odp: %w{sa_09_01_odp}

  describe 'NIST SP 800-53A Rev 5 objective SA-09(01)(b)' do
