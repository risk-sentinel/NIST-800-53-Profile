control 'SA-17(05)(a)' do
  impact 0.5
  title "the developer of the system, system component, or system service is required to design and structure the security-relevant hardware, software, and firmware to use a complete, conceptually simple protection mechanism with precisely defined semantics;"
  desc <<~DESC
  ...
  tag nist: ['SA-17 (5)']
  tag control: 'SA-17 (5)'
  tag objective: 'SA-17(05)(a)'
  tag rev: 'Rev_5'
  tag family: 'System and Services Acquisition'
  tag baseline: %w{}
  tag control_sa_17_5: true

  describe 'NIST SP 800-53A Rev 5 objective SA-17(05)(a)' do
