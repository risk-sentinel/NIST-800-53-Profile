control 'SA-08(13)' do
  impact 0.5
  title "#{input('sa_08_13_odp')} implement the security design principle of minimized security elements."
  desc <<~DESC
    Implement the security design principle of minimized security elements in #{input('sa_08_13_odp')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      #{input('sa_08_13_odp')} implement the security design principle of minimized security elements.
  ...
  tag nist: ['SA-8 (13)']
  tag control: 'SA-8 (13)'
  tag objective: 'SA-08(13)'
  tag rev: 'Rev_5'
  tag family: 'System and Services Acquisition'
  tag baseline: %w{}
  tag control_sa_8_13: true
  tag odp: %w{sa_08_13_odp}

  describe 'NIST SP 800-53A Rev 5 objective SA-08(13)' do
