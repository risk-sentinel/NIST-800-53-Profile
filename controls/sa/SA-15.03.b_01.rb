control 'SA-15(03)(b)[01]' do
  impact 0.5
  title "the developer of the system, system component, or system service is required to perform a criticality analysis at the following rigor level: #{input('sa_15_03_odp_02')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the developer of the system, system component, or system service is required to perform a criticality analysis at the following rigor level: #{input('sa_15_03_odp_02')};
  ...
  tag odp: %w{sa_15_03_odp_01 sa_15_03_odp_02 sa_15_3_prm_2}

  describe 'NIST SP 800-53A Rev 5 objective SA-15(03)(b)[01]' do
