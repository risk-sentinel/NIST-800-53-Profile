control 'SA-10(07)[02]' do
  impact 0.5
  title "#{input('sa_10_07_odp_02')} are required to be included in the #{input('sa_10_07_odp_04')}."
  desc <<~DESC
    Require #{input('sa_10_7_prm_1')} to be included in the #{input('sa_10_7_prm_2')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      #{input('sa_10_07_odp_02')} are required to be included in the #{input('sa_10_07_odp_04')}.
  ...
  tag nist: ['SA-10 (7)']
  tag control: 'SA-10 (7)'
  tag objective: 'SA-10(07)[02]'
  tag rev: 'Rev_5'
  tag family: 'System and Services Acquisition'
  tag baseline: %w{}
  tag control_sa_10_7: true
  tag odp: %w{sa_10_07_odp_02 sa_10_07_odp_04 sa_10_7_prm_1 sa_10_7_prm_2}

  describe 'NIST SP 800-53A Rev 5 objective SA-10(07)[02]' do
