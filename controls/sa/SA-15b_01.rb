control 'SA-15b.[01]' do
  impact 0.5
  title "the developer of the system, system component, or system service is required to follow a documented development process in which the development process, standards, tools, tool options, and tool configurations are reviewed #{input('sa_15_odp_01')} to determine that the process, standards, tools, tool options, and tool configurations selected and employed satisfy #{input('sa_15_odp_02')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the developer of the system, system component, or system service is required to follow a documented development process in which the development process, standards, tools, tool options, and tool configurations are reviewed #{input('sa_15_odp_01')} to determine that the process, standards, tools, tool options, and tool configurations selected and employed satisfy #{input('sa_15_odp_02')};
  ...
  tag odp: %w{sa_15_odp_01 sa_15_odp_02 sa_15_prm_2}

  describe 'NIST SP 800-53A Rev 5 objective SA-15b.[01]' do
