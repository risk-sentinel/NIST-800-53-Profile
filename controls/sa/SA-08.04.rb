control 'SA-08(04)' do
  impact 0.5
  title "#{input('sa_08_04_odp')} implement the security design principle of partially ordered dependencies."
  desc <<~DESC
    Implement the security design principle of partially ordered dependencies in #{input('sa_08_04_odp')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      #{input('sa_08_04_odp')} implement the security design principle of partially ordered dependencies.
  ...
  tag nist: ['SA-8 (4)']
  tag control: 'SA-8 (4)'
  tag objective: 'SA-08(04)'
  tag rev: 'Rev_5'
  tag family: 'System and Services Acquisition'
  tag baseline: %w{}
  tag control_sa_8_4: true
  tag odp: %w{sa_08_04_odp}

  describe 'NIST SP 800-53A Rev 5 objective SA-08(04)' do
