control 'SA-08[01]' do
  impact 0.5
  title "#{input('sa_08_odp_01')} are applied in the specification of the system and system components;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('sa_08_odp_01')} are applied in the specification of the system and system components;
  ...
  describe 'NIST SP 800-53A Rev 5 objective SA-08[01]' do
