control 'SA-15(03)(a)' do
  impact 0.5
  title "the developer of the system, system component, or system service is required to perform a criticality analysis at #{input('sa_15_03_odp_01')} in the system development life cycle;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the developer of the system, system component, or system service is required to perform a criticality analysis at #{input('sa_15_03_odp_01')} in the system development life cycle;
  ...
  tag odp: %w{sa_15_03_odp_01 sa_15_3_prm_2}

  describe 'NIST SP 800-53A Rev 5 objective SA-15(03)(a)' do
