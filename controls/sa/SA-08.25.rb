control 'SA-08(25)' do
  impact 0.5
  title "#{input('sa_08_25_odp')} implement the security design principle of economic security."
  desc <<~DESC
    Implement the security design principle of economic security in #{input('sa_08_25_odp')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      #{input('sa_08_25_odp')} implement the security design principle of economic security.
  ...
  tag nist: ['SA-8 (25)']
  tag control: 'SA-8 (25)'
  tag objective: 'SA-08(25)'
  tag rev: 'Rev_5'
  tag family: 'System and Services Acquisition'
  tag baseline: %w{}
  tag control_sa_8_25: true
  tag odp: %w{sa_08_25_odp}

  describe 'NIST SP 800-53A Rev 5 objective SA-08(25)' do
