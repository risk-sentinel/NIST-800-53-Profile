control 'SA-09(04)' do
  impact 0.5
  title "#{input('sa_09_04_odp_02')} are taken to verify that the interests of #{input('sa_09_04_odp_01')} are consistent with and reflect organizational interests."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('sa_09_04_odp_02')} are taken to verify that the interests of #{input('sa_09_04_odp_01')} are consistent with and reflect organizational interests.
  ...
  tag nist: ['SA-9 (4)']
  tag control: 'SA-9 (4)'
  tag objective: 'SA-09(04)'
  tag rev: 'Rev_5'
  tag family: 'System and Services Acquisition'
  tag baseline: %w{}
  tag control_sa_9_4: true
  tag odp: %w{sa_09_04_odp_01 sa_09_04_odp_02}

  describe 'NIST SP 800-53A Rev 5 objective SA-09(04)' do
