control 'SA-03b.[02]' do
  impact 0.5
  title "privacy roles and responsibilities are defined and documented throughout the system development life cycle;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SA-03b.[02]' do
