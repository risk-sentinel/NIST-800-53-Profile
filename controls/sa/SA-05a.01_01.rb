control 'SA-05a.01[01]' do
  impact 0.5
  title "administrator documentation for the system, system component, or system service that describes the secure configuration of the system, component, or service is obtained or developed;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SA-05a.01[01]' do
