control 'SA-04(06)(a)' do
  ...
  tag nist: ['SA-4 (6)']
  tag control: 'SA-4 (6)'
  tag objective: 'SA-04(06)(a)'
  tag rev: 'Rev_5'
  tag family: 'System and Services Acquisition'
  tag baseline: %w{}
  tag control_sa_4_6: true

  describe 'NIST SP 800-53A Rev 5 objective SA-04(06)(a)' do
