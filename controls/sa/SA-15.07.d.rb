control 'SA-15(07)(d)' do
  impact 0.5
  title "the developer of the system, system component, or system service is required to deliver the outputs of the tools and results of the analysis #{input('sa_15_07_odp_01')} to #{input('sa_15_07_odp_03')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the developer of the system, system component, or system service is required to deliver the outputs of the tools and results of the analysis #{input('sa_15_07_odp_01')} to #{input('sa_15_07_odp_03')}.
  ...
  describe 'NIST SP 800-53A Rev 5 objective SA-15(07)(d)' do
