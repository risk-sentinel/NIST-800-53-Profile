control 'SA-09(03)[02]' do
  impact 0.5
  title "trust relationships with external service provides based on #{input('sa_09_03_odp_01')} are maintained;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      trust relationships with external service provides based on #{input('sa_09_03_odp_01')} are maintained;
  ...
  describe 'NIST SP 800-53A Rev 5 objective SA-09(03)[02]' do
