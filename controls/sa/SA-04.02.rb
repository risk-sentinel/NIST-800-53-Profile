control 'SA-04(02)' do
  impact 0.5
  title "the developer of the system, system component, or system service is required to provide design and implementation information for the controls that includes using #{input('sa_04_02_odp_01')} at #{input('sa_04_02_odp_03')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the developer of the system, system component, or system service is required to provide design and implementation information for the controls that includes using #{input('sa_04_02_odp_01')} at #{input('sa_04_02_odp_03')}.
  ...
  tag nist: ['SA-4 (2)']
  tag control: 'SA-4 (2)'
  tag objective: 'SA-04(02)'
  tag rev: 'Rev_5'
  tag family: 'System and Services Acquisition'
  tag baseline: %w{MODERATE HIGH}
  tag baseline_moderate: true
  tag baseline_high: true
  tag control_sa_4_2: true
  tag odp: %w{sa_04_02_odp_01 sa_04_02_odp_03}

  describe 'NIST SP 800-53A Rev 5 objective SA-04(02)' do
