control 'SA-24b.[02]' do
  impact 0.5
  title "selected cyber resiliency objectives are implemented as part of an organizational risk management process of systems security engineering process;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SA-24b.[02]' do
