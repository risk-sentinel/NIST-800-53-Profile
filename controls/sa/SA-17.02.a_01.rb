control 'SA-17(02)(a)[01]' do
  impact 0.5
  title "the developer of the system, system component, or system service is required to define security-relevant hardware;"
  desc <<~DESC
  ...
  tag nist: ['SA-17 (2)']
  tag control: 'SA-17 (2)'
  tag objective: 'SA-17(02)(a)[01]'
  tag rev: 'Rev_5'
  tag family: 'System and Services Acquisition'
  tag baseline: %w{}
  tag control_sa_17_2: true

  describe 'NIST SP 800-53A Rev 5 objective SA-17(02)(a)[01]' do
