control 'SA-22b.' do
  impact 0.5
  title "#{input('sa_22_odp_01')} provide options for alternative sources for continued support for unsupported components."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('sa_22_odp_01')} provide options for alternative sources for continued support for unsupported components.
  ...
  tag control_sa_22: true
  tag odp: %w{sa_22_odp_01}

  describe 'NIST SP 800-53A Rev 5 objective SA-22b.' do
