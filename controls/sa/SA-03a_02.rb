control 'SA-03a.[02]' do
  impact 0.5
  title "the system is acquired, developed, and managed using #{input('sa_03_odp')} that incorporates privacy considerations;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the system is acquired, developed, and managed using #{input('sa_03_odp')} that incorporates privacy considerations;
  ...
  describe 'NIST SP 800-53A Rev 5 objective SA-03a.[02]' do
