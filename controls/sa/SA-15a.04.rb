control 'SA-15a.04' do
  impact 0.5
  title "the developer of the system, system component, or system service is required to follow a documented development process that documents, manages, and ensures the integrity of changes to the process and/or tools used in development;"
  desc <<~DESC
  ...
  tag odp: %w{sa_15_odp_01 sa_15_prm_2}

  describe 'NIST SP 800-53A Rev 5 objective SA-15a.04' do
