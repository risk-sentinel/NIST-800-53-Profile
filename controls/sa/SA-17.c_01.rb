control 'SA-17(c)[01]' do
  impact 0.5
  title "the developer of the system, system component, or system service is required to produce a design specification and security architecture that express how individual security functions, mechanisms, and services work together to provide required security capabilities and a unified approach to protection;"
  desc <<~DESC
  ...
  tag nist: ['SA-17']
  tag control: 'SA-17'
  tag objective: 'SA-17(c)[01]'
  tag rev: 'Rev_5'
  tag family: 'System and Services Acquisition'
  tag baseline: %w{HIGH}
  tag baseline_high: true
  tag control_sa_17: true

  describe 'NIST SP 800-53A Rev 5 objective SA-17(c)[01]' do
