control 'SA-08(26)' do
  impact 0.5
  title "#{input('sa_08_26_odp')} implement the security design principle of performance security."
  desc <<~DESC
    Implement the security design principle of performance security in #{input('sa_08_26_odp')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      #{input('sa_08_26_odp')} implement the security design principle of performance security.
  ...
  tag nist: ['SA-8 (26)']
  tag control: 'SA-8 (26)'
  tag objective: 'SA-08(26)'
  tag rev: 'Rev_5'
  tag family: 'System and Services Acquisition'
  tag baseline: %w{}
  tag control_sa_8_26: true
  tag odp: %w{sa_08_26_odp}

  describe 'NIST SP 800-53A Rev 5 objective SA-08(26)' do
