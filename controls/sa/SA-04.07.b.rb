control 'SA-04(07)(b)' do
  impact 0.5
  title "if no NIAP-approved Protection Profile exists for a specific technology type but a commercially provided information technology product relies on cryptographic functionality to enforce its security policy, that cryptographic module is required to be FIPS-validated or NSA-approved."
  desc <<~DESC
  ...
  tag nist: ['SA-4 (7)']
  tag control: 'SA-4 (7)'
  tag objective: 'SA-04(07)(b)'
  tag rev: 'Rev_5'
  tag family: 'System and Services Acquisition'
  tag baseline: %w{}
  tag control_sa_4_7: true

  describe 'NIST SP 800-53A Rev 5 objective SA-04(07)(b)' do
