control 'SA-15(07)(a)' do
  impact 0.5
  title "the developer of the system, system component, or system service is required to perform automated vulnerability analysis #{input('sa_15_07_odp_01')} using #{input('sa_15_07_odp_02')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the developer of the system, system component, or system service is required to perform automated vulnerability analysis #{input('sa_15_07_odp_01')} using #{input('sa_15_07_odp_02')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective SA-15(07)(a)' do
