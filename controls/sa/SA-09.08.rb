control 'SA-09(08)' do
  impact 0.5
  title "the geographic location of information processing and data storage is restricted to facilities located within the legal jurisdictional boundary of the United States."
  desc <<~DESC
  ...
  tag nist: ['SA-9 (8)']
  tag control: 'SA-9 (8)'
  tag objective: 'SA-09(08)'
  tag rev: 'Rev_5'
  tag family: 'System and Services Acquisition'
  tag baseline: %w{}
  tag control_sa_9_8: true

  describe 'NIST SP 800-53A Rev 5 objective SA-09(08)' do
