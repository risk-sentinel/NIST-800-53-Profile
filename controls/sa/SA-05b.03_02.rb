control 'SA-05b.03[02]' do
  impact 0.5
  title "user documentation for the system, system component, or system service that describes user responsibilities for maintaining the privacy of individuals is obtained or developed;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SA-05b.03[02]' do
