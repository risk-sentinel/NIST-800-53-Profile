control 'SA-08(28)' do
  impact 0.5
  title "#{input('sa_08_28_odp')} implement the security design principle of acceptable security."
  desc <<~DESC
    Implement the security design principle of acceptable security in #{input('sa_08_28_odp')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      #{input('sa_08_28_odp')} implement the security design principle of acceptable security.
  ...
  tag nist: ['SA-8 (28)']
  tag control: 'SA-8 (28)'
  tag objective: 'SA-08(28)'
  tag rev: 'Rev_5'
  tag family: 'System and Services Acquisition'
  tag baseline: %w{}
  tag control_sa_8_28: true
  tag odp: %w{sa_08_28_odp}

  describe 'NIST SP 800-53A Rev 5 objective SA-08(28)' do
