control 'SA-11(02)(d)[02]' do
  impact 0.5
  title "the developer of the system, system component, or system service is required to perform threat modeling during the subsequent testing and evaluation of the system, component, or service that produces evidence that meets #{input('sa_11_02_odp_05')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the developer of the system, system component, or system service is required to perform threat modeling during the subsequent testing and evaluation of the system, component, or service that produces evidence that meets #{input('sa_11_02_odp_05')};
  ...
  tag nist: ['SA-11 (2)']
  tag control: 'SA-11 (2)'
  tag objective: 'SA-11(02)(d)[02]'
  tag rev: 'Rev_5'
  tag family: 'System and Services Acquisition'
  tag baseline: %w{}
  tag control_sa_11_2: true
  tag odp: %w{sa_11_02_odp_01 sa_11_02_odp_02 sa_11_02_odp_05 sa_11_2_prm_3 sa_11_2_prm_4}

  describe 'NIST SP 800-53A Rev 5 objective SA-11(02)(d)[02]' do
