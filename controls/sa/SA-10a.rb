control 'SA-10a.' do
  impact 0.5
  title "the developer of the system, system component, or system service is required to perform configuration management during system, component, or service #{input('sa_10_odp_01')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the developer of the system, system component, or system service is required to perform configuration management during system, component, or service #{input('sa_10_odp_01')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective SA-10a.' do
