control 'SA-11(01)[01]' do
  impact 0.5
  title "the developer of the system, system component, or system service is required to employ static code analysis tools to identify common flaws;"
  desc <<~DESC
  ...
  tag nist: ['SA-11 (1)']
  tag control: 'SA-11 (1)'
  tag objective: 'SA-11(01)[01]'
  tag rev: 'Rev_5'
  tag family: 'System and Services Acquisition'
  tag baseline: %w{}
  tag control_sa_11_1: true

  describe 'NIST SP 800-53A Rev 5 objective SA-11(01)[01]' do
