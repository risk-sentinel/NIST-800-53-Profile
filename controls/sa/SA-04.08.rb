control 'SA-04(08)' do
  impact 0.5
  title "the developer of the system, system component, or system service is required to produce a plan for the continuous monitoring of control effectiveness that is consistent with the continuous monitoring program of the organization."
  desc <<~DESC
  ...
  tag nist: ['SA-4 (8)']
  tag control: 'SA-4 (8)'
  tag objective: 'SA-04(08)'
  tag rev: 'Rev_5'
  tag family: 'System and Services Acquisition'
  tag baseline: %w{}
  tag control_sa_4_8: true

  describe 'NIST SP 800-53A Rev 5 objective SA-04(08)' do
