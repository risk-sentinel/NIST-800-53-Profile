control 'SA-17(04)(a)[03]' do
  impact 0.5
  title "as an integral part of the development process, the developer of the system, system component, or system service is required to produce an informal, descriptive top-level specification that specifies the interfaces to security-relevant hardware, software, and firmware in terms of effects;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SA-17(04)(a)[03]' do
