control 'SA-11(04)' do
  impact 0.5
  title "the developer of the system, system component, or system service is required to perform a manual code review of #{input('sa_11_04_odp_01')} using #{input('sa_11_04_odp_02')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the developer of the system, system component, or system service is required to perform a manual code review of #{input('sa_11_04_odp_01')} using #{input('sa_11_04_odp_02')}.
  ...
  tag nist: ['SA-11 (4)']
  tag control: 'SA-11 (4)'
  tag objective: 'SA-11(04)'
  tag rev: 'Rev_5'
  tag family: 'System and Services Acquisition'
  tag baseline: %w{}
  tag control_sa_11_4: true
  tag odp: %w{sa_11_04_odp_01 sa_11_04_odp_02}

  describe 'NIST SP 800-53A Rev 5 objective SA-11(04)' do
