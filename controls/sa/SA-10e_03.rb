control 'SA-10e.[03]' do
  impact 0.5
  title "the developer of the system, system component, or system service is required to report findings to #{input('sa_10_odp_03')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the developer of the system, system component, or system service is required to report findings to #{input('sa_10_odp_03')}.
  ...
  describe 'NIST SP 800-53A Rev 5 objective SA-10e.[03]' do
