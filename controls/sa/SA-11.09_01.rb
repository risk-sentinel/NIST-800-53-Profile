control 'SA-11(09)[01]' do
  impact 0.5
  title "the developer of the system, system component, or system service is required to employ interactive application security testing tools to identify flaws;"
  desc <<~DESC
  ...
  tag nist: ['SA-11 (9)']
  tag control: 'SA-11 (9)'
  tag objective: 'SA-11(09)[01]'
  tag rev: 'Rev_5'
  tag family: 'System and Services Acquisition'
  tag baseline: %w{}
  tag control_sa_11_9: true

  describe 'NIST SP 800-53A Rev 5 objective SA-11(09)[01]' do
