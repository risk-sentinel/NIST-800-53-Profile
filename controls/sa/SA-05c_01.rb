control 'SA-05c.[01]' do
  impact 0.5
  title "attempts to obtain system, system component, or system service documentation when such documentation is either unavailable or nonexistent is documented;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SA-05c.[01]' do
