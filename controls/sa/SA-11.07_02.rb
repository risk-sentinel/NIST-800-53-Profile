control 'SA-11(07)[02]' do
  impact 0.5
  title "the developer of the system, system component, or system service is required to verify that the scope of testing and evaluation provides complete coverage of the required controls at #{input('sa_11_07_odp_02')}."
  desc <<~DESC
    Require the developer of the system, system component, or system service to verify that the scope of testing and evaluation provides complete coverage of the required controls at the following level of rigor: #{input('sa_11_7_prm_1')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      the developer of the system, system component, or system service is required to verify that the scope of testing and evaluation provides complete coverage of the required controls at #{input('sa_11_07_odp_02')}.
  ...
  tag nist: ['SA-11 (7)']
  tag control: 'SA-11 (7)'
  tag objective: 'SA-11(07)[02]'
  tag rev: 'Rev_5'
  tag family: 'System and Services Acquisition'
  tag baseline: %w{}
  tag control_sa_11_7: true
  tag odp: %w{sa_11_07_odp_02 sa_11_7_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective SA-11(07)[02]' do
