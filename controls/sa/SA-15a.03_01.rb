control 'SA-15a.03[01]' do
  impact 0.5
  title "the developer of the system, system component, or system service is required to follow a documented development process that documents the specific tool used in the development process;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SA-15a.03[01]' do
