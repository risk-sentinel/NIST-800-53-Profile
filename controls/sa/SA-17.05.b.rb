control 'SA-17(05)(b)' do
  impact 0.5
  title "the developer of the system, system component, or system service is required to internally structure the security-relevant hardware, software, and firmware with specific regard for this mechanism."
  desc <<~DESC
  ...
  tag nist: ['SA-17 (5)']
  tag control: 'SA-17 (5)'
  tag objective: 'SA-17(05)(b)'
  tag rev: 'Rev_5'
  tag family: 'System and Services Acquisition'
  tag baseline: %w{}
  tag control_sa_17_5: true

  describe 'NIST SP 800-53A Rev 5 objective SA-17(05)(b)' do
