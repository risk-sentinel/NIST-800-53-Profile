control 'SA-02b.[01]' do
  impact 0.5
  title "the resources required to protect the system or system service are determined and documented as part of the organizational capital planning and investment control process;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SA-02b.[01]' do
