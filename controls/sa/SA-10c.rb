control 'SA-10c.' do
  impact 0.5
  title "the developer of the system, system component, or system service is required to implement only organization-approved changes to the system, component, or service;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SA-10c.' do
