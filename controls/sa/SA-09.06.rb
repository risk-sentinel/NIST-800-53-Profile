control 'SA-09(06)' do
  impact 0.5
  title "exclusive control of cryptographic keys is maintained for encrypted material stored or transmitted through an external system."
  desc <<~DESC
  ...
  tag nist: ['SA-9 (6)']
  tag control: 'SA-9 (6)'
  tag objective: 'SA-09(06)'
  tag rev: 'Rev_5'
  tag family: 'System and Services Acquisition'
  tag baseline: %w{}
  tag control_sa_9_6: true

  describe 'NIST SP 800-53A Rev 5 objective SA-09(06)' do
