control 'SA-09a.[03]' do
  impact 0.5
  title "providers of external system services employ #{input('sa_09_odp_01')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      providers of external system services employ #{input('sa_09_odp_01')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective SA-09a.[03]' do
