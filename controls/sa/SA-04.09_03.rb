control 'SA-04(09)[03]' do
  impact 0.5
  title "the developer of the system, system component, or system service is required to identify the protocols intended for organizational use;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SA-04(09)[03]' do
