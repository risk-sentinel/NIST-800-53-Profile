control 'SA-10(04)[01]' do
  impact 0.5
  title "the developer of the system, system component, or system service is required to employ tools for comparing newly generated versions of security-relevant hardware descriptions with previous versions;"
  desc <<~DESC
  ...
  tag nist: ['SA-10 (4)']
  tag control: 'SA-10 (4)'
  tag objective: 'SA-10(04)[01]'
  tag rev: 'Rev_5'
  tag family: 'System and Services Acquisition'
  tag baseline: %w{}
  tag control_sa_10_4: true

  describe 'NIST SP 800-53A Rev 5 objective SA-10(04)[01]' do
