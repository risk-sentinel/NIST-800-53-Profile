control 'SA-11(03)(a)[01]' do
  impact 0.5
  title "an independent agent is required to satisfy #{input('sa_11_03_odp')} to verify the correct implementation of the developer security assessment plan and the evidence produced during testing and evaluation;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      an independent agent is required to satisfy #{input('sa_11_03_odp')} to verify the correct implementation of the developer security assessment plan and the evidence produced during testing and evaluation;
  ...
  describe 'NIST SP 800-53A Rev 5 objective SA-11(03)(a)[01]' do
