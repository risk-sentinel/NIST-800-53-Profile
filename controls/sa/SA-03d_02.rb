control 'SA-03d.[02]' do
  impact 0.5
  title "organizational privacy risk management processes are integrated into system development life cycle activities."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SA-03d.[02]' do
