control 'SA-17(06)' do
  impact 0.5
  title "the developer of the system, system component, or system service is required to structure security-relevant hardware, software, and firmware to facilitate testing."
  desc <<~DESC
  ...
  tag nist: ['SA-17 (6)']
  tag control: 'SA-17 (6)'
  tag objective: 'SA-17(06)'
  tag rev: 'Rev_5'
  tag family: 'System and Services Acquisition'
  tag baseline: %w{}
  tag control_sa_17_6: true

  describe 'NIST SP 800-53A Rev 5 objective SA-17(06)' do
