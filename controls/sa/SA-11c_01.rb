control 'SA-11c.[01]' do
  impact 0.5
  title "the developer of the system, system component, or system service is required at all post-design stages of the system development life cycle to produce evidence of the execution of the assessment plan;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SA-11c.[01]' do
