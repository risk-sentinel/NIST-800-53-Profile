control 'SA-08(12)' do
  impact 0.5
  title "#{input('sa_08_12_odp')} implement the security design principle of hierarchical protection."
  desc <<~DESC
    Implement the security design principle of hierarchical protection in #{input('sa_08_12_odp')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      #{input('sa_08_12_odp')} implement the security design principle of hierarchical protection.
  ...
  tag nist: ['SA-8 (12)']
  tag control: 'SA-8 (12)'
  tag objective: 'SA-08(12)'
  tag rev: 'Rev_5'
  tag family: 'System and Services Acquisition'
  tag baseline: %w{}
  tag control_sa_8_12: true
  tag odp: %w{sa_08_12_odp}

  describe 'NIST SP 800-53A Rev 5 objective SA-08(12)' do
