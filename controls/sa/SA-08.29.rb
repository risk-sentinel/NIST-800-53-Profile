control 'SA-08(29)' do
  impact 0.5
  title "#{input('sa_08_29_odp')} implement the security design principle of repeatable and documented procedures."
  desc <<~DESC
    Implement the security design principle of repeatable and documented procedures in #{input('sa_08_29_odp')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      #{input('sa_08_29_odp')} implement the security design principle of repeatable and documented procedures.
  ...
  tag nist: ['SA-8 (29)']
  tag control: 'SA-8 (29)'
  tag objective: 'SA-08(29)'
  tag rev: 'Rev_5'
  tag family: 'System and Services Acquisition'
  tag baseline: %w{}
  tag control_sa_8_29: true
  tag odp: %w{sa_08_29_odp}

  describe 'NIST SP 800-53A Rev 5 objective SA-08(29)' do
