control 'SA-17(03)(b)' do
  impact 0.5
  title "the developer of the system, system component, or system service is required to show proof that the formal top-level specification is consistent with the formal policy model to the extent feasible with additional informal demonstration as necessary;"
  desc <<~DESC
  ...
  tag nist: ['SA-17 (3)']
  tag control: 'SA-17 (3)'
  tag objective: 'SA-17(03)(b)'
  tag rev: 'Rev_5'
  tag family: 'System and Services Acquisition'
  tag baseline: %w{}
  tag control_sa_17_3: true

  describe 'NIST SP 800-53A Rev 5 objective SA-17(03)(b)' do
