control 'SA-05a.02[04]' do
  impact 0.5
  title "administrator documentation for the system, system component, or system service that describes the effective maintenance of privacy functions and mechanisms is obtained or developed;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SA-05a.02[04]' do
