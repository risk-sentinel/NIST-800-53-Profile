control 'SA-01a.01(a)[06]' do
  impact 0.5
  title "the #{input('sa_01_odp_03')} system and services acquisition policy addresses coordination among organizational entities;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the #{input('sa_01_odp_03')} system and services acquisition policy addresses coordination among organizational entities;
  ...
  describe 'NIST SP 800-53A Rev 5 objective SA-01a.01(a)[06]' do
