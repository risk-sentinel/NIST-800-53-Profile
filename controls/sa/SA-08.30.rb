control 'SA-08(30)' do
  impact 0.5
  title "#{input('sa_08_30_odp')} implement the security design principle of procedural rigor."
  desc <<~DESC
    Implement the security design principle of procedural rigor in #{input('sa_08_30_odp')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      #{input('sa_08_30_odp')} implement the security design principle of procedural rigor.
  ...
  tag nist: ['SA-8 (30)']
  tag control: 'SA-8 (30)'
  tag objective: 'SA-08(30)'
  tag rev: 'Rev_5'
  tag family: 'System and Services Acquisition'
  tag baseline: %w{}
  tag control_sa_8_30: true
  tag odp: %w{sa_08_30_odp}

  describe 'NIST SP 800-53A Rev 5 objective SA-08(30)' do
