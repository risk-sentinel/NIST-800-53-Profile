control 'SA-04(12)(a)' do
  impact 0.5
  title "organizational data ownership requirements are included in the acquisition contract;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SA-04(12)(a)' do
