control 'SA-17(01)(a)[02]' do
  impact 0.5
  title "as an integral part of the development process, the developer of the system, system component, or system service is required to produce a formal policy model describing the #{input('sa_17_01_odp_02')} to be enforced;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      as an integral part of the development process, the developer of the system, system component, or system service is required to produce a formal policy model describing the #{input('sa_17_01_odp_02')} to be enforced;
  ...
  tag nist: ['SA-17 (1)']
  tag control: 'SA-17 (1)'
  tag objective: 'SA-17(01)(a)[02]'
  tag rev: 'Rev_5'
  tag family: 'System and Services Acquisition'
  tag baseline: %w{}
  tag control_sa_17_1: true
  tag odp: %w{sa_17_01_odp_02 sa_17_1_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective SA-17(01)(a)[02]' do
