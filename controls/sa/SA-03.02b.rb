control 'SA-03(02)b.' do
  impact 0.5
  title "pre-production environments for the system, system component, or system service are protected at the same impact or classification level as any live data in use within the pre-production environments."
  desc <<~DESC
  ...
  tag nist: ['SA-3 (2)']
  tag control: 'SA-3 (2)'
  tag objective: 'SA-03(02)b.'
  tag rev: 'Rev_5'
  tag family: 'System and Services Acquisition'
  tag baseline: %w{}
  tag control_sa_3_2: true

  describe 'NIST SP 800-53A Rev 5 objective SA-03(02)b.' do
