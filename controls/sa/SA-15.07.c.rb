control 'SA-15(07)(c)' do
  impact 0.5
  title "the developer of the system, system component, or system service is required to determine potential risk mitigations #{input('sa_15_07_odp_01')} for delivered vulnerabilities;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the developer of the system, system component, or system service is required to determine potential risk mitigations #{input('sa_15_07_odp_01')} for delivered vulnerabilities;
  ...
  describe 'NIST SP 800-53A Rev 5 objective SA-15(07)(c)' do
