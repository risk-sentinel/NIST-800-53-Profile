control 'SA-10b.[01]' do
  impact 0.5
  title "the developer of the system, system component, or system service is required to document the integrity of changes to #{input('sa_10_odp_02')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the developer of the system, system component, or system service is required to document the integrity of changes to #{input('sa_10_odp_02')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective SA-10b.[01]' do
