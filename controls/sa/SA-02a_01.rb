control 'SA-02a.[01]' do
  impact 0.5
  title "the high-level information security requirements for the system or system service are determined in mission and business process planning;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SA-02a.[01]' do
