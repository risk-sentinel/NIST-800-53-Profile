control 'SA-04(12)(b)' do
  impact 0.5
  title "all data to be removed from the contractor’s system and returned to the organization is required within #{input('sa_04_12_odp')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      all data to be removed from the contractor’s system and returned to the organization is required within #{input('sa_04_12_odp')}.
  ...
  tag nist: ['SA-4 (12)']
  tag control: 'SA-4 (12)'
  tag objective: 'SA-04(12)(b)'
  tag rev: 'Rev_5'
  tag family: 'System and Services Acquisition'
  tag baseline: %w{}
  tag control_sa_4_12: true
  tag odp: %w{sa_04_12_odp}

  describe 'NIST SP 800-53A Rev 5 objective SA-04(12)(b)' do
