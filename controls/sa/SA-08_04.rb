control 'SA-08[04]' do
  impact 0.5
  title "#{input('sa_08_odp_01')} are applied in the implementation of the system and system components;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('sa_08_odp_01')} are applied in the implementation of the system and system components;
