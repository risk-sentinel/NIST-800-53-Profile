control 'SA-01a.[04]' do
  impact 0.5
  title "the system and services acquisition procedures are disseminated to #{input('sa_01_odp_02')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the system and services acquisition procedures are disseminated to #{input('sa_01_odp_02')};
  ...
  tag odp: %w{sa_01_odp_02 sa_01_odp_03 sa_01_odp_04 sa_01_odp_05 sa_01_odp_06 sa_01_odp_07 sa_01_odp_08 sa_1_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective SA-01a.[04]' do
