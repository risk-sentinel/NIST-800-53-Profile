control 'SA-22a.' do
  impact 0.5
  title "system components are replaced when support for the components is no longer available from the developer, vendor, or manufacturer;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SA-22a.' do
