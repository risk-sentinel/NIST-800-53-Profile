control 'SA-17(04)(b)' do
  impact 0.5
  title "the developer of the system, system component, or system service is required to show via #{input('sa_17_04_odp')} that the descriptive top-level specification is consistent with the formal policy model;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the developer of the system, system component, or system service is required to show via #{input('sa_17_04_odp')} that the descriptive top-level specification is consistent with the formal policy model;
  ...
  describe 'NIST SP 800-53A Rev 5 objective SA-17(04)(b)' do
