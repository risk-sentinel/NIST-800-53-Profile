control 'SA-24a.01' do
  impact 0.5
  title "organizational systems, system components, or system services achieve cyber resiliency through #{input('sa_24_odp_01')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      organizational systems, system components, or system services achieve cyber resiliency through #{input('sa_24_odp_01')};
  ...
  tag nist: ['SA-24']
  tag control: 'SA-24'
  tag objective: 'SA-24a.01'
  tag rev: 'Rev_5'
  tag family: 'System and Services Acquisition'
  tag baseline: %w{}
  tag control_sa_24: true
  tag odp: %w{sa_24_odp_01 sa_24_odp_02 sa_24_odp_03 sa_24_odp_04 sa_24_odp_05}

  describe 'NIST SP 800-53A Rev 5 objective SA-24a.01' do
