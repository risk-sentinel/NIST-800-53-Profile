control 'SA-10(01)' do
  impact 0.5
  title "the developer of the system, system component, or system service is required to enable integrity verification of software and firmware components."
  desc <<~DESC
  ...
  tag nist: ['SA-10 (1)']
  tag control: 'SA-10 (1)'
  tag objective: 'SA-10(01)'
  tag rev: 'Rev_5'
  tag family: 'System and Services Acquisition'
  tag baseline: %w{}
  tag control_sa_10_1: true

  describe 'NIST SP 800-53A Rev 5 objective SA-10(01)' do
