control 'SA-17(03)(a)[01]' do
  impact 0.5
  title "as an integral part of the development process, the developer of the system, system component, or system service is required to produce a formal top-level specification that specifies the interfaces to security-relevant hardware, software, and firmware in terms of exceptions;"
  desc <<~DESC
  ...
  tag nist: ['SA-17 (3)']
  tag control: 'SA-17 (3)'
  tag objective: 'SA-17(03)(a)[01]'
  tag rev: 'Rev_5'
  tag family: 'System and Services Acquisition'
  tag baseline: %w{}
  tag control_sa_17_3: true

  describe 'NIST SP 800-53A Rev 5 objective SA-17(03)(a)[01]' do
