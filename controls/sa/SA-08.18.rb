control 'SA-08(18)' do
  impact 0.5
  title "#{input('sa_08_18_odp')} implement the security design principle of trusted communications channels."
  desc <<~DESC
    Implement the security design principle of trusted communications channels in #{input('sa_08_18_odp')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      #{input('sa_08_18_odp')} implement the security design principle of trusted communications channels.
  ...
  tag nist: ['SA-8 (18)']
  tag control: 'SA-8 (18)'
  tag objective: 'SA-08(18)'
  tag rev: 'Rev_5'
  tag family: 'System and Services Acquisition'
  tag baseline: %w{}
  tag control_sa_8_18: true
  tag odp: %w{sa_08_18_odp}

  describe 'NIST SP 800-53A Rev 5 objective SA-08(18)' do
