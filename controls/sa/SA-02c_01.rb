control 'SA-02c.[01]' do
  impact 0.5
  title "a discrete line item for information security is established in organizational programming and budgeting documentation;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SA-02c.[01]' do
