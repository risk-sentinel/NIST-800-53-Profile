control 'SA-08(19)' do
  impact 0.5
  title "#{input('sa_08_19_odp')} implement the security design principle of continuous protection."
  desc <<~DESC
    Implement the security design principle of continuous protection in #{input('sa_08_19_odp')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      #{input('sa_08_19_odp')} implement the security design principle of continuous protection.
  ...
  tag nist: ['SA-8 (19)']
  tag control: 'SA-8 (19)'
  tag objective: 'SA-08(19)'
  tag rev: 'Rev_5'
  tag family: 'System and Services Acquisition'
  tag baseline: %w{}
  tag control_sa_8_19: true
  tag odp: %w{sa_08_19_odp}

  describe 'NIST SP 800-53A Rev 5 objective SA-08(19)' do
