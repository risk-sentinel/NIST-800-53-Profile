control 'SA-09(07)' do
  impact 0.5
  title "the capability is provided to check the integrity of information while it resides in the external system."
  desc <<~DESC
  ...
  tag nist: ['SA-9 (7)']
  tag control: 'SA-9 (7)'
  tag objective: 'SA-09(07)'
  tag rev: 'Rev_5'
  tag family: 'System and Services Acquisition'
  tag baseline: %w{}
  tag control_sa_9_7: true

  describe 'NIST SP 800-53A Rev 5 objective SA-09(07)' do
