control 'SA-15(06)' do
  impact 0.5
  title "the developer of the system, system component, or system service is required to implement an explicit process to continuously improve the development process."
  desc <<~DESC
  ...
  tag nist: ['SA-15 (6)']
  tag control: 'SA-15 (6)'
  tag objective: 'SA-15(06)'
  tag rev: 'Rev_5'
  tag family: 'System and Services Acquisition'
  tag baseline: %w{}
  tag control_sa_15_6: true

  describe 'NIST SP 800-53A Rev 5 objective SA-15(06)' do
