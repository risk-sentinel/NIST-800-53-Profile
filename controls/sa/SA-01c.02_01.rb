control 'SA-01c.02[01]' do
  impact 0.5
  title "the current system and services acquisition procedures are reviewed and updated #{input('sa_01_odp_07')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the current system and services acquisition procedures are reviewed and updated #{input('sa_01_odp_07')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective SA-01c.02[01]' do
