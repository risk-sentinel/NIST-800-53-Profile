control 'SA-05c.[02]' do
  impact 0.5
  title "after attempts to obtain system, system component, or system service documentation when such documentation is either unavailable or nonexistent, #{input('sa_05_odp_01')} are taken in response;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      after attempts to obtain system, system component, or system service documentation when such documentation is either unavailable or nonexistent, #{input('sa_05_odp_01')} are taken in response;
  ...
  describe 'NIST SP 800-53A Rev 5 objective SA-05c.[02]' do
