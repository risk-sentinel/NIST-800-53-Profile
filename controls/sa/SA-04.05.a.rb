control 'SA-04(05)(a)' do
  impact 0.5
  title "the developer of the system, system component, or system service is required to deliver the system, component, or service with #{input('sa_04_05_odp')} implemented;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the developer of the system, system component, or system service is required to deliver the system, component, or service with #{input('sa_04_05_odp')} implemented;
  ...
  describe 'NIST SP 800-53A Rev 5 objective SA-04(05)(a)' do
