control 'SA-03a.[01]' do
  impact 0.5
  title "the system is acquired, developed, and managed using #{input('sa_03_odp')} that incorporates information security considerations;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the system is acquired, developed, and managed using #{input('sa_03_odp')} that incorporates information security considerations;
  ...
  tag control_sa_3: true
  tag odp: %w{sa_03_odp}

  describe 'NIST SP 800-53A Rev 5 objective SA-03a.[01]' do
