control 'SA-04c.[02]' do
  impact 0.5
  title "privacy assurance requirements, descriptions, and criteria are included explicitly or by reference using #{input('sa_04_odp_01')} in the acquisition contract for the system, system component, or system service;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      privacy assurance requirements, descriptions, and criteria are included explicitly or by reference using #{input('sa_04_odp_01')} in the acquisition contract for the system, system component, or system service;
  ...
  describe 'NIST SP 800-53A Rev 5 objective SA-04c.[02]' do
