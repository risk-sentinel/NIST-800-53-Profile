control 'SA-08[08]' do
  impact 0.5
  title "#{input('sa_08_odp_02')} are applied in the development of the system and system components;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('sa_08_odp_02')} are applied in the development of the system and system components;
