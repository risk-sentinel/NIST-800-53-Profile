control 'SA-09a.[02]' do
  impact 0.5
  title "providers of external system services comply with organizational privacy requirements;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SA-09a.[02]' do
