control 'SA-11b.' do
  impact 0.5
  title "the developer of the system, system component, or system service is required at all post-design stages of the system development life cycle to perform #{input('sa_11_odp_01')} testing/evaluation #{input('sa_11_odp_02')} at #{input('sa_11_odp_03')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the developer of the system, system component, or system service is required at all post-design stages of the system development life cycle to perform #{input('sa_11_odp_01')} testing/evaluation #{input('sa_11_odp_02')} at #{input('sa_11_odp_03')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective SA-11b.' do
