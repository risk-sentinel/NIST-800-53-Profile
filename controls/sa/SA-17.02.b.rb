control 'SA-17(02)(b)' do
  impact 0.5
  title "the developer of the system, system component, or system service is required to provide a rationale that the definition for security-relevant hardware, software, and firmware is complete."
  desc <<~DESC
  ...
  tag nist: ['SA-17 (2)']
  tag control: 'SA-17 (2)'
  tag objective: 'SA-17(02)(b)'
  tag rev: 'Rev_5'
  tag family: 'System and Services Acquisition'
  tag baseline: %w{}
  tag control_sa_17_2: true

  describe 'NIST SP 800-53A Rev 5 objective SA-17(02)(b)' do
