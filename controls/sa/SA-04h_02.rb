control 'SA-04h.[02]' do
  impact 0.5
  title "the allocation of responsibility or identification of parties responsible for privacy requirements, descriptions, and criteria are included explicitly or by reference using #{input('sa_04_odp_01')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the allocation of responsibility or identification of parties responsible for privacy requirements, descriptions, and criteria are included explicitly or by reference using #{input('sa_04_odp_01')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective SA-04h.[02]' do
