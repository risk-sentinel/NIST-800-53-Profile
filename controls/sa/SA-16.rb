control 'SA-16' do
  impact 0.5
  title "the developer of the system, system component, or system service is required to provide #{input('sa_16_odp')} on the correct use and operation of the implemented security and privacy functions, controls, and/or mechanisms."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the developer of the system, system component, or system service is required to provide #{input('sa_16_odp')} on the correct use and operation of the implemented security and privacy functions, controls, and/or mechanisms.
  ...
  tag control_sa_16: true
  tag odp: %w{sa_16_odp}

  describe 'NIST SP 800-53A Rev 5 objective SA-16' do
