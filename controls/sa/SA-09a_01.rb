control 'SA-09a.[01]' do
  impact 0.5
  title "providers of external system services comply with organizational security requirements;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SA-09a.[01]' do
