control 'SA-10d.[01]' do
  impact 0.5
  title "the developer of the system, system component, or system service is required to document approved changes to the system, component, or service;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SA-10d.[01]' do
