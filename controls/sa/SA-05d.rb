control 'SA-05d.' do
  impact 0.5
  title "documentation is distributed to #{input('sa_05_odp_02')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      documentation is distributed to #{input('sa_05_odp_02')}.
  ...
  describe 'NIST SP 800-53A Rev 5 objective SA-05d.' do
