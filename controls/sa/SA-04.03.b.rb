control 'SA-04(03)(b)' do
  impact 0.5
  title "the developer of the system, system component, or system service is required to demonstrate the use of a system development life cycle process that includes #{input('sa_04_03_odp_02')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the developer of the system, system component, or system service is required to demonstrate the use of a system development life cycle process that includes #{input('sa_04_03_odp_02')};
  ...
  tag nist: ['SA-4 (3)']
  tag control: 'SA-4 (3)'
  tag objective: 'SA-04(03)(b)'
  tag rev: 'Rev_5'
  tag family: 'System and Services Acquisition'
  tag baseline: %w{}
  tag control_sa_4_3: true
  tag odp: %w{sa_04_03_odp_01 sa_04_03_odp_02 sa_04_03_odp_05}

  describe 'NIST SP 800-53A Rev 5 objective SA-04(03)(b)' do
