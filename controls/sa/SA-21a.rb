control 'SA-21a.' do
  impact 0.5
  title "the developer of #{input('sa_21_odp_01')} is required to have appropriate access authorizations as determined by assigned #{input('sa_21_odp_02')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the developer of #{input('sa_21_odp_01')} is required to have appropriate access authorizations as determined by assigned #{input('sa_21_odp_02')};
  ...
  tag nist: ['SA-21']
  tag control: 'SA-21'
  tag objective: 'SA-21a.'
  tag rev: 'Rev_5'
  tag family: 'System and Services Acquisition'
  tag baseline: %w{HIGH}
  tag baseline_high: true
  tag control_sa_21: true
  tag odp: %w{sa_21_odp_01 sa_21_odp_02 sa_21_odp_03}

  describe 'NIST SP 800-53A Rev 5 objective SA-21a.' do
