control 'SA-08[10]' do
  impact 0.5
  title "#{input('sa_08_odp_02')} are applied in the modification of the system and system components."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('sa_08_odp_02')} are applied in the modification of the system and system components.
