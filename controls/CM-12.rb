control 'CM-12' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      CM-12a.
        CM-12a.[01] the location of #{input('cm_12_odp')} is identified and documented;
        CM-12a.[02] the specific system components on which #{input('cm_12_odp')} is processed are identified and documented;
        CM-12a.[03] the specific system components on which #{input('cm_12_odp')} is stored are identified and documented;
      CM-12b.
        CM-12b.[01] the users who have access to the system and system components where #{input('cm_12_odp')} is processed are identified and documented;
        CM-12b.[02] the users who have access to the system and system components where #{input('cm_12_odp')} is stored are identified and documented;
      CM-12c.
        CM-12c.[01] changes to the location (i.e., system or system components) where #{input('cm_12_odp')} is processed are documented;
        CM-12c.[02] changes to the location (i.e., system or system components) where #{input('cm_12_odp')} is stored are documented.
  ...
  describe 'NIST SP 800-53 Rev 5 control CM-12' do
