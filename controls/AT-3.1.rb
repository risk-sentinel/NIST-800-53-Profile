control 'AT-3 (1)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      AT-03(01) #{input('at_03_01_odp_01')} are provided with initial and refresher training #{input('at_03_01_odp_02')} in the employment and operation of environmental controls.
  ...
  describe 'NIST SP 800-53 Rev 5 control AT-3 (1)' do
