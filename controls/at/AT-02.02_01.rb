control 'AT-02(02)[01]' do
  impact 0.5
  title "literacy training on recognizing potential indicators of insider threat is provided;"
  desc <<~DESC
  ...
  tag control_at_2_2: true

  describe 'NIST SP 800-53A Rev 5 objective AT-02(02)[01]' do
