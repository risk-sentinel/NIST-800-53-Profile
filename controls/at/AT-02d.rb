control 'AT-02d.' do
  impact 0.5
  title "lessons learned from internal or external security incidents or breaches are incorporated into literacy training and awareness techniques."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective AT-02d.' do
