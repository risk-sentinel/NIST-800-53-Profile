control 'AT-02a.01[04]' do
  impact 0.5
  title "privacy literacy training is provided to system users (including managers, senior executives, and contractors) #{input('at_02_odp_02')} thereafter;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      privacy literacy training is provided to system users (including managers, senior executives, and contractors) #{input('at_02_odp_02')} thereafter;
  ...
  tag odp: %w{at_02_odp_02 at_02_odp_05 at_02_odp_06 at_02_odp_07 at_2_prm_1 at_2_prm_2}

  describe 'NIST SP 800-53A Rev 5 objective AT-02a.01[04]' do
