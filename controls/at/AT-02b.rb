control 'AT-02b.' do
  impact 0.5
  title "#{input('at_02_odp_05')} are employed to increase the security and privacy awareness of system users;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('at_02_odp_05')} are employed to increase the security and privacy awareness of system users;
  ...
  tag odp: %w{at_02_odp_05 at_02_odp_06 at_02_odp_07 at_2_prm_1 at_2_prm_2}

  describe 'NIST SP 800-53A Rev 5 objective AT-02b.' do
