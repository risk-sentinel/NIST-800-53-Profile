control 'AT-02(05)' do
  impact 0.5
  title "literacy training on the advanced persistent threat is provided."
  desc <<~DESC
  ...
  tag nist: ['AT-2 (5)']
  tag control: 'AT-2 (5)'
  tag objective: 'AT-02(05)'
  tag rev: 'Rev_5'
  tag family: 'Awareness and Training'
  tag baseline: %w{}
  tag control_at_2_5: true

  describe 'NIST SP 800-53A Rev 5 objective AT-02(05)' do
