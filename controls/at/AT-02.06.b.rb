control 'AT-02(06)(b)' do
  impact 0.5
  title "system operations reflects current cyber threat information."
  desc <<~DESC
  ...
  tag nist: ['AT-2 (6)']
  tag control: 'AT-2 (6)'
  tag objective: 'AT-02(06)(b)'
  tag rev: 'Rev_5'
  tag family: 'Awareness and Training'
  tag baseline: %w{}
  tag control_at_2_6: true

  describe 'NIST SP 800-53A Rev 5 objective AT-02(06)(b)' do
