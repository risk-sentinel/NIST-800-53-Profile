control 'AT-03a.01[04]' do
  impact 0.5
  title "role-based privacy training is provided to #{input('at_03_odp_02')} #{input('at_03_odp_03')} thereafter;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      role-based privacy training is provided to #{input('at_03_odp_02')} #{input('at_03_odp_03')} thereafter;
  ...
  describe 'NIST SP 800-53A Rev 5 objective AT-03a.01[04]' do
