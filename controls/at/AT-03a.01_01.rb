control 'AT-03a.01[01]' do
  impact 0.5
  title "role-based security training is provided to #{input('at_03_odp_01')} before authorizing access to the system, information, or performing assigned duties;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      role-based security training is provided to #{input('at_03_odp_01')} before authorizing access to the system, information, or performing assigned duties;
  ...
  tag odp: %w{at_03_odp_01 at_03_odp_03 at_03_odp_04 at_03_odp_05 at_3_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective AT-03a.01[01]' do
