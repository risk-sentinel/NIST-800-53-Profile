control 'AT-01b.' do
  impact 0.5
  title "the #{input('at_01_odp_04')} is designated to manage the development, documentation, and dissemination of the awareness and training policy and procedures;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the #{input('at_01_odp_04')} is designated to manage the development, documentation, and dissemination of the awareness and training policy and procedures;
  ...
  describe 'NIST SP 800-53A Rev 5 objective AT-01b.' do
