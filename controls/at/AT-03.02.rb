control 'AT-03(02)' do
  impact 0.5
  title "#{input('at_03_02_odp_01')} is/are provided with initial and refresher training #{input('at_03_02_odp_02')} in the employment and operation of physical security controls."
  desc <<~DESC
    Provide #{input('at_03_02_odp_01')} with initial and #{input('at_03_02_odp_02')} training in the employment and operation of physical security controls.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      #{input('at_03_02_odp_01')} is/are provided with initial and refresher training #{input('at_03_02_odp_02')} in the employment and operation of physical security controls.
  ...
  tag nist: ['AT-3 (2)']
  tag control: 'AT-3 (2)'
  tag objective: 'AT-03(02)'
  tag rev: 'Rev_5'
  tag family: 'Awareness and Training'
  tag baseline: %w{}
  tag control_at_3_2: true
  tag odp: %w{at_03_02_odp_01 at_03_02_odp_02}

  describe 'NIST SP 800-53A Rev 5 objective AT-03(02)' do
