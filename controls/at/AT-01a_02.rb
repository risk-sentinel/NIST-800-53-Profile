control 'AT-01a.[02]' do
  impact 0.5
  title "the awareness and training policy is disseminated to #{input('at_01_odp_01')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the awareness and training policy is disseminated to #{input('at_01_odp_01')};
  ...
  tag odp: %w{at_01_odp_01 at_01_odp_03 at_01_odp_04 at_01_odp_05 at_01_odp_06 at_01_odp_07 at_01_odp_08 at_1_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective AT-01a.[02]' do
