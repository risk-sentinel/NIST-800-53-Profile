control 'AT-04a.[02]' do
  impact 0.5
  title "information security and privacy training activities, including security and privacy awareness training and specific role-based security and privacy training, are monitored;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective AT-04a.[02]' do
