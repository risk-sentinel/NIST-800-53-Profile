control 'AT-04b.' do
  impact 0.5
  title "individual training records are retained for #{input('at_04_odp')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      individual training records are retained for #{input('at_04_odp')}.
  ...
  describe 'NIST SP 800-53A Rev 5 objective AT-04b.' do
