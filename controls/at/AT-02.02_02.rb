control 'AT-02(02)[02]' do
  impact 0.5
  title "literacy training on reporting potential indicators of insider threat is provided."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective AT-02(02)[02]' do
