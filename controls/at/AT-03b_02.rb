control 'AT-03b.[02]' do
  impact 0.5
  title "role-based training content is updated following #{input('at_03_odp_05')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      role-based training content is updated following #{input('at_03_odp_05')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective AT-03b.[02]' do
