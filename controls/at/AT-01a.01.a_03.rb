control 'AT-01a.01(a)[03]' do
  impact 0.5
  title "the #{input('at_01_odp_03')} awareness and training policy addresses roles;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the #{input('at_01_odp_03')} awareness and training policy addresses roles;
  ...
  describe 'NIST SP 800-53A Rev 5 objective AT-01a.01(a)[03]' do
