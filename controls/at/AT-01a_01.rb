control 'AT-01a.[01]' do
  impact 0.5
  title "an awareness and training policy is developed and documented;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective AT-01a.[01]' do
