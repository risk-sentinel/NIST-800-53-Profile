control 'AT-03a.01[03]' do
  impact 0.5
  title "role-based security training is provided to #{input('at_03_odp_01')} #{input('at_03_odp_03')} thereafter;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      role-based security training is provided to #{input('at_03_odp_01')} #{input('at_03_odp_03')} thereafter;
  ...
  describe 'NIST SP 800-53A Rev 5 objective AT-03a.01[03]' do
