control 'AT-01c.01[01]' do
  impact 0.5
  title "the current awareness and training policy is reviewed and updated #{input('at_01_odp_05')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the current awareness and training policy is reviewed and updated #{input('at_01_odp_05')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective AT-01c.01[01]' do
