control 'AT-02c.[02]' do
  impact 0.5
  title "literacy training and awareness content is updated following #{input('at_02_odp_07')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      literacy training and awareness content is updated following #{input('at_02_odp_07')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective AT-02c.[02]' do
