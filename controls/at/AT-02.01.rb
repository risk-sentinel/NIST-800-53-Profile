control 'AT-02(01)' do
  impact 0.5
  title "practical exercises in literacy training that simulate events and incidents are provided."
  desc <<~DESC
  ...
  tag nist: ['AT-2 (1)']
  tag control: 'AT-2 (1)'
  tag objective: 'AT-02(01)'
  tag rev: 'Rev_5'
  tag family: 'Awareness and Training'
  tag baseline: %w{}
  tag control_at_2_1: true

  describe 'NIST SP 800-53A Rev 5 objective AT-02(01)' do
