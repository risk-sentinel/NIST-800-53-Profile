control 'AT-03(03)[02]' do
  impact 0.5
  title "practical exercises in privacy training that reinforce training objectives are provided."
  desc <<~DESC
  ...
  tag nist: ['AT-3 (3)']
  tag control: 'AT-3 (3)'
  tag objective: 'AT-03(03)[02]'
  tag rev: 'Rev_5'
  tag family: 'Awareness and Training'
  tag baseline: %w{}
  tag control_at_3_3: true

  describe 'NIST SP 800-53A Rev 5 objective AT-03(03)[02]' do
