control 'AT-03b.[01]' do
  impact 0.5
  title "role-based training content is updated #{input('at_03_odp_04')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      role-based training content is updated #{input('at_03_odp_04')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective AT-03b.[01]' do
