control 'AT-02a.02[01]' do
  impact 0.5
  title "security literacy training is provided to system users (including managers, senior executives, and contractors) when required by system changes or following #{input('at_02_odp_03')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      security literacy training is provided to system users (including managers, senior executives, and contractors) when required by system changes or following #{input('at_02_odp_03')};
  ...
  tag odp: %w{at_02_odp_03 at_02_odp_05 at_02_odp_06 at_02_odp_07 at_2_prm_1 at_2_prm_2}

  describe 'NIST SP 800-53A Rev 5 objective AT-02a.02[01]' do
