control 'AT-03a.02[01]' do
  impact 0.5
  title "role-based security training is provided to personnel with assigned security roles and responsibilities when required by system changes;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective AT-03a.02[01]' do
