control 'AT-02a.01[01]' do
  impact 0.5
  title "security literacy training is provided to system users (including managers, senior executives, and contractors) as part of initial training for new users;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective AT-02a.01[01]' do
