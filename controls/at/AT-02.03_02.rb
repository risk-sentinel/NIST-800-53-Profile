control 'AT-02(03)[02]' do
  impact 0.5
  title "literacy training on reporting potential and actual instances of social engineering is provided;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective AT-02(03)[02]' do
