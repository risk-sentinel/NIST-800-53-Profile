control 'SR-11 (1)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SR-11(01) #{input('sr_11_01_odp')} are trained to detect counterfeit system components (including hardware, software, and firmware).
  ...
  describe 'NIST SP 800-53 Rev 5 control SR-11 (1)' do
