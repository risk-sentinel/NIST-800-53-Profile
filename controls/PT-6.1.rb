control 'PT-6 (1)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      PT-06(01) all routine uses published in the system of records notice are reviewed #{input('pt_06_01_odp')} to ensure continued accuracy, and to ensure that routine uses continue to be compatible with the purpose for which the information was collected.
  ...
  describe 'NIST SP 800-53 Rev 5 control PT-6 (1)' do
