control 'SA-4 (11)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SA-04(11) #{input('sa_04_11_odp')} are defined in the acquisition contract for the operation of a system of records on behalf of an organization to accomplish an organizational mission or function.
  ...
  describe 'NIST SP 800-53 Rev 5 control SA-4 (11)' do
