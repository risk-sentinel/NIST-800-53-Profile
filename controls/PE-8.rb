control 'PE-8' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      PE-08a. visitor access records for the facility where the system resides are maintained for #{input('pe_08_odp_01')};
      PE-08b. visitor access records are reviewed #{input('pe_08_odp_02')};
      PE-08c. visitor access records anomalies are reported to #{input('pe_08_odp_03')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control PE-8' do
