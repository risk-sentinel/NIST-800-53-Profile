control 'SC-7' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      ...
      SC-07b. subnetworks for publicly accessible system components are #{input('sc_07_odp')} separated from internal organizational networks;
  ...
  describe 'NIST SP 800-53 Rev 5 control SC-7' do
