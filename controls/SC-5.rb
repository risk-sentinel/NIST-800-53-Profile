control 'SC-5' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SC-05a. the effects of #{input('sc_05_odp_01')} are #{input('sc_05_odp_02')};
      SC-05b. #{input('sc_05_odp_03')} are employed to achieve the denial-of-service protection objective.
  ...
  describe 'NIST SP 800-53 Rev 5 control SC-5' do
