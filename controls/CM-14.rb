control 'CM-14' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      CM-14[01] the installation of #{input('cm_14_odp_01')} is prevented unless it is verified that the software has been digitally signed using a certificate recognized and approved by the organization;
      CM-14[02] the installation of #{input('cm_14_odp_02')} is prevented unless it is verified that the firmware has been digitally signed using a certificate recognized and approved by the organization.
  ...
  tag baseline: %w{}
  tag odp: %w{cm_14_odp_01 cm_14_odp_02 cm_14_prm_1}

  describe 'NIST SP 800-53 Rev 5 control CM-14' do
