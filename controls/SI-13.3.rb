control 'SI-13 (3)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SI-13(03) transfers are initiated manually between active and standby system components when the use of the active component reaches #{input('si_13_03_odp')} of the mean time to failure.
  ...
  describe 'NIST SP 800-53 Rev 5 control SI-13 (3)' do
