control 'SC-40 (2)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SC-40(02) cryptographic mechanisms to reduce the detection potential of wireless links to #{input('sc_40_02_odp')} are implemented.
  ...
  describe 'NIST SP 800-53 Rev 5 control SC-40 (2)' do
