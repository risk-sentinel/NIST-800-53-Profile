control 'CM-7 (4)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      CM-07(04)(a) #{input('cm_07_04_odp_01')} are identified;
      ...
      CM-07(04)(c) the list of unauthorized software programs is reviewed and updated #{input('cm_07_04_odp_02')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control CM-7 (4)' do
