control 'AC-6 (2)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      AC-06(02) users of system accounts (or roles) with access to #{input('ac_06_02_odp')} are required to use non-privileged accounts or roles when accessing non-security functions.
  ...
  describe 'NIST SP 800-53 Rev 5 control AC-6 (2)' do
