control 'AC-4 (2)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      AC-04(02) protected processing domains are used to enforce #{input('ac_04_02_odp')} as a basis for flow control decisions.
  ...
  describe 'NIST SP 800-53 Rev 5 control AC-4 (2)' do
