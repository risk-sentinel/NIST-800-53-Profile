control 'CM-8 (3)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      CM-08(03)(a)
        CM-08(03)(a)[01] the presence of unauthorized hardware within the system is detected using #{input('cm_08_03_odp_01')} #{input('cm_08_03_odp_04')};
        CM-08(03)(a)[02] the presence of unauthorized software within the system is detected using #{input('cm_08_03_odp_02')} #{input('cm_08_03_odp_04')};
        CM-08(03)(a)[03] the presence of unauthorized firmware within the system is detected using #{input('cm_08_03_odp_03')} #{input('cm_08_03_odp_04')};
      CM-08(03)(b)
        CM-08(03)(b)[01] #{input('cm_08_03_odp_05')} are taken when unauthorized hardware is detected;
        CM-08(03)(b)[02] #{input('cm_08_03_odp_05')} are taken when unauthorized software is detected;
        CM-08(03)(b)[03] #{input('cm_08_03_odp_05')} are taken when unauthorized firmware is detected.
  ...
  tag odp: %w{cm_08_03_odp_01 cm_08_03_odp_02 cm_08_03_odp_03 cm_08_03_odp_04 cm_08_03_odp_05 cm_8_3_prm_1}

  describe 'NIST SP 800-53 Rev 5 control CM-8 (3)' do
