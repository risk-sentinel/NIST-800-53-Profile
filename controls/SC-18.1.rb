control 'SC-18 (1)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SC-18(01)[01] #{input('sc_18_01_odp_01')} is identified;
      SC-18(01)[02] #{input('sc_18_01_odp_02')} are taken if unacceptable mobile code is identified.
  ...
  describe 'NIST SP 800-53 Rev 5 control SC-18 (1)' do
