control 'AC-16' do
  ...
  desc <<~DESC
    a. Provide the means to associate #{input('ac_16_prm_1')} with #{input('ac_16_prm_2')} for information in storage, in process, and/or in transmission;
    b. Ensure that the attribute associations are made and retained with the information;
    c. Establish the following permitted security and privacy attributes from the attributes defined in [AC-16a](#ac-16_smt.a) for #{input('ac_16_prm_3')}: #{input('ac_16_prm_4')};
    d. Determine the following permitted attribute values or ranges for each of the established attributes: #{input('ac_16_odp_09')};
    e. Audit changes to attributes; and
    f. Review #{input('ac_16_prm_6')} for applicability #{input('ac_16_prm_7')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      AC-16a.
        AC-16a.[01] the means to associate #{input('ac_16_odp_01')} with #{input('ac_16_odp_03')} for information in storage, in process, and/or in transmission are provided;
        AC-16a.[02] the means to associate #{input('ac_16_odp_02')} with #{input('ac_16_odp_04')} for information in storage, in process, and/or in transmission are provided;
      AC-16b.
        AC-16b.[01] attribute associations are made;
        AC-16b.[02] attribute associations are retained with the information;
      AC-16c.
        AC-16c.[01] the following permitted security attributes are established from the attributes defined in AC-16_ODP[01] for #{input('ac_16_odp_05')}: #{input('ac_16_odp_07')};
        AC-16c.[02] the following permitted privacy attributes are established from the attributes defined in AC-16_ODP[02] for #{input('ac_16_odp_06')}: #{input('ac_16_odp_08')};
      AC-16d. the following permitted attribute values or ranges for each of the established attributes are determined: #{input('ac_16_odp_09')};
      AC-16e. changes to attributes are audited;
      AC-16f.
        AC-16f.[01] #{input('ac_16_odp_07')} are reviewed for applicability #{input('ac_16_odp_10')};
        AC-16f.[02] #{input('ac_16_odp_08')} are reviewed for applicability #{input('ac_16_odp_11')}.

    Assessment methods and objects:
      EXAMINE: Access control policy; procedures addressing the association of security and privacy attributes to information in storage, in process, and in transmission; system design documentation; system configuration settings and associated documentation; system audit records; system security plan; privacy plan; other relevant documents or records
      ...
      TEST: Organizational capability supporting and maintaining the association of security and privacy attributes to information in storage, in process, and in transmission
  CHECK
  desc 'fix', <<~FIX
  ...
  tag baseline: %w{}
  tag odp: %w{ac_16_odp_01 ac_16_odp_02 ac_16_odp_03 ac_16_odp_04 ac_16_odp_05 ac_16_odp_06 ac_16_odp_07 ac_16_odp_08 ac_16_odp_09 ac_16_odp_10 ac_16_odp_11 ac_16_prm_1 ac_16_prm_2 ac_16_prm_3 ac_16_prm_4 ac_16_prm_6 ac_16_prm_7}

  describe 'NIST SP 800-53 Rev 5 control AC-16' do
