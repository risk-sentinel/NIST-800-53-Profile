control 'IA-5' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      ...
      IA-05f. system authenticators are managed through the change or refreshment of authenticators #{input('ia_05_odp_01')} or when #{input('ia_05_odp_02')} occur;
  ...
  describe 'NIST SP 800-53 Rev 5 control IA-5' do
