control 'SI-7' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SI-07a.
        SI-07a.[01] integrity verification tools are employed to detect unauthorized changes to #{input('si_07_odp_01')};
        SI-07a.[02] integrity verification tools are employed to detect unauthorized changes to #{input('si_07_odp_02')};
        SI-07a.[03] integrity verification tools are employed to detect unauthorized changes to #{input('si_07_odp_03')};
      SI-07b.
        SI-07b.[01] #{input('si_07_odp_04')} are taken when unauthorized changes to the software, are detected;
        SI-07b.[02] #{input('si_07_odp_05')} are taken when unauthorized changes to the firmware are detected;
        SI-07b.[03] #{input('si_07_odp_06')} are taken when unauthorized changes to the information are detected.
  ...
  tag odp: %w{si_07_odp_01 si_07_odp_02 si_07_odp_03 si_07_odp_04 si_07_odp_05 si_07_odp_06 si_7_prm_1 si_7_prm_2}

  describe 'NIST SP 800-53 Rev 5 control SI-7' do
