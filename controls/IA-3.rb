control 'IA-3' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      IA-03 #{input('ia_03_odp_01')} are uniquely identified and authenticated before establishing a #{input('ia_03_odp_02')} connection.
  ...
  describe 'NIST SP 800-53 Rev 5 control IA-3' do
