control 'SA-15 (5)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SA-15(05) the developer of the system, system component, or system service is required to reduce attack surfaces to #{input('sa_15_05_odp')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control SA-15 (5)' do
