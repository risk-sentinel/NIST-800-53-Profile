control 'PE-14 (2)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      ...
      PE-14(02)[02] the environmental control monitoring capability provides an alarm or notification to #{input('pe_14_02_odp')} when changes are potentially harmful to personnel or equipment.
  ...
  describe 'NIST SP 800-53 Rev 5 control PE-14 (2)' do
