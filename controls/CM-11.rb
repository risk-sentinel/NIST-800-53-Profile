control 'CM-11' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      CM-11a. #{input('cm_11_odp_01')} governing the installation of software by users are established;
      CM-11b. software installation policies are enforced through #{input('cm_11_odp_02')};
      CM-11c. compliance with #{input('cm_11_odp_01')} is monitored #{input('cm_11_odp_03')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control CM-11' do
