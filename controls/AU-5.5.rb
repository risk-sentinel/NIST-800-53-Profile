control 'AU-5 (5)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      AU-05(05) an alternate audit logging capability is provided in the event of a failure in primary audit logging capability that implements #{input('au_05_05_odp')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control AU-5 (5)' do
