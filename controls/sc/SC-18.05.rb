control 'SC-18(05)' do
  impact 0.5
  title "execution of permitted mobile code is allowed only in confined virtual machine environments."
  desc <<~DESC
  ...
  tag nist: ['SC-18 (5)']
  tag control: 'SC-18 (5)'
  tag objective: 'SC-18(05)'
  tag rev: 'Rev_5'
  tag family: 'System and Communications Protection'
  tag baseline: %w{}
  tag control_sc_18_5: true

  describe 'NIST SP 800-53A Rev 5 objective SC-18(05)' do
