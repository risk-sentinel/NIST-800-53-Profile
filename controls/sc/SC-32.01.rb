control 'SC-32(01)' do
  impact 0.5
  title "privileged functions are partitioned into separate physical domains."
  desc <<~DESC
  ...
  tag nist: ['SC-32 (1)']
  tag control: 'SC-32 (1)'
  tag objective: 'SC-32(01)'
  tag rev: 'Rev_5'
  tag family: 'System and Communications Protection'
  tag baseline: %w{}
  tag control_sc_32_1: true

  describe 'NIST SP 800-53A Rev 5 objective SC-32(01)' do
