control 'SC-43b.[03]' do
  impact 0.5
  title "the use of #{input('sc_43_odp')} is controlled within the system."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the use of #{input('sc_43_odp')} is controlled within the system.
  ...
  describe 'NIST SP 800-53A Rev 5 objective SC-43b.[03]' do
