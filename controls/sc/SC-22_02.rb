control 'SC-22[02]' do
  impact 0.5
  title "the systems that collectively provide name/address resolution services for an organization implement internal role separation;"
  desc <<~DESC
  ...
  tag control_sc_22: true

  describe 'NIST SP 800-53A Rev 5 objective SC-22[02]' do
