control 'SC-18(01)[02]' do
  impact 0.5
  title "#{input('sc_18_01_odp_02')} are taken if unacceptable mobile code is identified."
  desc <<~DESC
    Identify #{input('sc_18_01_odp_01')} and take #{input('sc_18_01_odp_02')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      #{input('sc_18_01_odp_02')} are taken if unacceptable mobile code is identified.
    ...
    Assessment methods and objects:
      ...
      TEST: Mechanisms supporting and/or implementing mobile code detection, inspection, and corrective capabilities
  CHECK
  desc 'fix', <<~FIX
  ...
  tag nist: ['SC-18 (1)']
  tag control: 'SC-18 (1)'
  tag objective: 'SC-18(01)[02]'
  tag rev: 'Rev_5'
  tag family: 'System and Communications Protection'
  tag baseline: %w{}
  tag control_sc_18_1: true
  tag odp: %w{sc_18_01_odp_01 sc_18_01_odp_02}

  describe 'NIST SP 800-53A Rev 5 objective SC-18(01)[02]' do
