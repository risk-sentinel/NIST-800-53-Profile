control 'SC-23(03)[02]' do
  impact 0.5
  title "only system-generated session identifiers are recognized."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SC-23(03)[02]' do
