control 'SC-21[01]' do
  impact 0.5
  title "data origin authentication is requested for the name/address resolution responses that the system receives from authoritative sources;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SC-21[01]' do
