control 'SC-13b.' do
  impact 0.5
  title "#{input('sc_13_odp_02')} for each specified cryptographic use (defined in SC-13_ODP[01]) are implemented."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('sc_13_odp_02')} for each specified cryptographic use (defined in SC-13_ODP[01]) are implemented.
  ...
  tag control_sc_13: true
  tag odp: %w{sc_13_odp_01 sc_13_odp_02}

  describe 'NIST SP 800-53A Rev 5 objective SC-13b.' do
