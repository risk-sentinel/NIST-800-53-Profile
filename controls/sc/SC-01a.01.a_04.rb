control 'SC-01a.01(a)[04]' do
  impact 0.5
  title "the #{input('sc_01_odp_03')} system and communications protection policy addresses responsibilities;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the #{input('sc_01_odp_03')} system and communications protection policy addresses responsibilities;
  ...
  describe 'NIST SP 800-53A Rev 5 objective SC-01a.01(a)[04]' do
