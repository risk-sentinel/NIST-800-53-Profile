control 'SC-03(03)' do
  impact 0.5
  title "the number of non-security functions included within the isolation boundary containing security functions is minimized."
  desc <<~DESC
  ...
  tag nist: ['SC-3 (3)']
  tag control: 'SC-3 (3)'
  tag objective: 'SC-03(03)'
  tag rev: 'Rev_5'
  tag family: 'System and Communications Protection'
  tag baseline: %w{}
  tag control_sc_3_3: true

  describe 'NIST SP 800-53A Rev 5 objective SC-03(03)' do
