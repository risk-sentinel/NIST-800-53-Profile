control 'SC-15b.' do
  impact 0.5
  title "an explicit indication of use is provided to users physically present at the devices."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SC-15b.' do
