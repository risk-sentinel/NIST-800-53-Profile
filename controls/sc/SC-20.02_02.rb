control 'SC-20(02)[02]' do
  impact 0.5
  title "integrity protection artifacts are provided for internal name/address resolution queries."
  desc <<~DESC
  ...
  tag nist: ['SC-20 (2)']
  tag control: 'SC-20 (2)'
  tag objective: 'SC-20(02)[02]'
  tag rev: 'Rev_5'
  tag family: 'System and Communications Protection'
  tag baseline: %w{}
  tag control_sc_20_2: true

  describe 'NIST SP 800-53A Rev 5 objective SC-20(02)[02]' do
