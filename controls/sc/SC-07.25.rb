control 'SC-07(25)' do
  impact 0.5
  title "the direct connection of #{input('sc_07_25_odp_01')} to an external network without the use of #{input('sc_07_25_odp_02')} is prohibited."
  desc <<~DESC
    Prohibit the direct connection of #{input('sc_07_25_odp_01')} to an external network without the use of #{input('sc_07_25_odp_02')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      the direct connection of #{input('sc_07_25_odp_01')} to an external network without the use of #{input('sc_07_25_odp_02')} is prohibited.
  ...
  tag nist: ['SC-7 (25)']
  tag control: 'SC-7 (25)'
  tag objective: 'SC-07(25)'
  tag rev: 'Rev_5'
  tag family: 'System and Communications Protection'
  tag baseline: %w{}
  tag control_sc_7_25: true
  tag odp: %w{sc_07_25_odp_01 sc_07_25_odp_02}

  describe 'NIST SP 800-53A Rev 5 objective SC-07(25)' do
