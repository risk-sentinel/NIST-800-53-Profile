control 'SC-01a.[02]' do
  impact 0.5
  title "the system and communications protection policy is disseminated to #{input('sc_01_odp_01')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the system and communications protection policy is disseminated to #{input('sc_01_odp_01')};
  ...
  tag odp: %w{sc_01_odp_01 sc_01_odp_03 sc_01_odp_04 sc_01_odp_05 sc_01_odp_06 sc_01_odp_07 sc_01_odp_08 sc_1_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective SC-01a.[02]' do
