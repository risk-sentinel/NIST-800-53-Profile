control 'SC-07(18)' do
  impact 0.5
  title "systems are prevented from entering unsecure states in the event of an operational failure of a boundary protection device."
  desc <<~DESC
  ...
  tag nist: ['SC-7 (18)']
  tag control: 'SC-7 (18)'
  tag objective: 'SC-07(18)'
  tag rev: 'Rev_5'
  tag family: 'System and Communications Protection'
  tag baseline: %w{HIGH}
  tag baseline_high: true
  tag control_sc_7_18: true

  describe 'NIST SP 800-53A Rev 5 objective SC-07(18)' do
