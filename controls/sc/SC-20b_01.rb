control 'SC-20b.[01]' do
  impact 0.5
  title "the means to indicate the security status of child zones (and if the child supports secure resolution services) is provided when operating as part of a distributed, hierarchical namespace;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SC-20b.[01]' do
