control 'SC-03(01)' do
  impact 0.5
  title "hardware separation mechanisms are employed to implement security function isolation."
  desc <<~DESC
  ...
  tag nist: ['SC-3 (1)']
  tag control: 'SC-3 (1)'
  tag objective: 'SC-03(01)'
  tag rev: 'Rev_5'
  tag family: 'System and Communications Protection'
  tag baseline: %w{}
  tag control_sc_3_1: true

  describe 'NIST SP 800-53A Rev 5 objective SC-03(01)' do
