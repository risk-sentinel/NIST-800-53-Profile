control 'SC-12(02)[03]' do
  impact 0.5
  title "symmetric cryptographic keys are distributed using #{input('sc_12_02_odp')} key management technology and processes."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      symmetric cryptographic keys are distributed using #{input('sc_12_02_odp')} key management technology and processes.
  ...
  describe 'NIST SP 800-53A Rev 5 objective SC-12(02)[03]' do
