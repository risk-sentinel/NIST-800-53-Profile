control 'SC-18(04)[01]' do
  impact 0.5
  title "the automatic execution of mobile code in #{input('sc_18_04_odp_01')} is prevented;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the automatic execution of mobile code in #{input('sc_18_04_odp_01')} is prevented;
  ...
  tag nist: ['SC-18 (4)']
  tag control: 'SC-18 (4)'
  tag objective: 'SC-18(04)[01]'
  tag rev: 'Rev_5'
  tag family: 'System and Communications Protection'
  tag baseline: %w{}
  tag control_sc_18_4: true
  tag odp: %w{sc_18_04_odp_01 sc_18_04_odp_02}

  describe 'NIST SP 800-53A Rev 5 objective SC-18(04)[01]' do
