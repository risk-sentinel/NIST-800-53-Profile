control 'SC-45(01)(a)' do
  impact 0.5
  title "the internal system clocks are compared #{input('sc_45_01_odp_01')} with #{input('sc_45_01_odp_02')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the internal system clocks are compared #{input('sc_45_01_odp_01')} with #{input('sc_45_01_odp_02')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective SC-45(01)(a)' do
