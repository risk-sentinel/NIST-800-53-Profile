control 'SC-08' do
  impact 0.5
  title "the #{input('sc_08_odp')} of transmitted information is/are protected."
  desc <<~DESC
    Protect the #{input('sc_08_odp')} of transmitted information.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      the #{input('sc_08_odp')} of transmitted information is/are protected.
  ...
  tag control_sc_8: true
  tag odp: %w{sc_08_odp}

  describe 'NIST SP 800-53A Rev 5 objective SC-08' do
