control 'SC-18b.[01]' do
  impact 0.5
  title "the use of mobile code is authorized within the system;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SC-18b.[01]' do
