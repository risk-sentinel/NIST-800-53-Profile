control 'SC-05a.' do
  impact 0.5
  title "the effects of #{input('sc_05_odp_01')} are #{input('sc_05_odp_02')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the effects of #{input('sc_05_odp_01')} are #{input('sc_05_odp_02')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective SC-05a.' do
