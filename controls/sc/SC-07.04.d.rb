control 'SC-07(04)(d)' do
  impact 0.5
  title "each exception to the traffic flow policy is documented with a supporting mission or business need and duration of that need;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SC-07(04)(d)' do
