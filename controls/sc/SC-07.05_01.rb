control 'SC-07(05)[01]' do
  impact 0.5
  title "network communications traffic is denied by default #{input('sc_07_05_odp_01')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      network communications traffic is denied by default #{input('sc_07_05_odp_01')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective SC-07(05)[01]' do
