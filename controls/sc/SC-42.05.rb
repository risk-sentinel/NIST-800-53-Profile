control 'SC-42(05)' do
  impact 0.5
  title "the #{input('sc_42_05_odp')} configured to minimize the collection of information about individuals that is not needed are employed."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the #{input('sc_42_05_odp')} configured to minimize the collection of information about individuals that is not needed are employed.
  ...
  tag nist: ['SC-42 (5)']
  tag control: 'SC-42 (5)'
  tag objective: 'SC-42(05)'
  tag rev: 'Rev_5'
  tag family: 'System and Communications Protection'
  tag baseline: %w{}
  tag control_sc_42_5: true
  tag odp: %w{sc_42_05_odp}

  describe 'NIST SP 800-53A Rev 5 objective SC-42(05)' do
