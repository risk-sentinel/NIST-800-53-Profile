control 'SC-07(04)(c)[02]' do
  impact 0.5
  title "the integrity of the information being transmitted across each interface is protected;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SC-07(04)(c)[02]' do
