control 'SC-07(15)[02]' do
  impact 0.5
  title "networked, privileged accesses are routed through a dedicated, managed interface for purposes of auditing."
  desc <<~DESC
  ...
  tag nist: ['SC-7 (15)']
  tag control: 'SC-7 (15)'
  tag objective: 'SC-07(15)[02]'
  tag rev: 'Rev_5'
  tag family: 'System and Communications Protection'
  tag baseline: %w{}
  tag control_sc_7_15: true

  describe 'NIST SP 800-53A Rev 5 objective SC-07(15)[02]' do
