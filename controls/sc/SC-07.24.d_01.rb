control 'SC-07(24)(d)[01]' do
  impact 0.5
  title "exceptions for systems that process personally identifiable information are reviewed;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SC-07(24)(d)[01]' do
