control 'SC-07(16)' do
  impact 0.5
  title "the discovery of specific system components that represent a managed interface is prevented."
  desc <<~DESC
  ...
  tag nist: ['SC-7 (16)']
  tag control: 'SC-7 (16)'
  tag objective: 'SC-07(16)'
  tag rev: 'Rev_5'
  tag family: 'System and Communications Protection'
  tag baseline: %w{}
  tag control_sc_7_16: true

  describe 'NIST SP 800-53A Rev 5 objective SC-07(16)' do
