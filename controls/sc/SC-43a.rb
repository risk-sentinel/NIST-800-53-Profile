control 'SC-43a.' do
  impact 0.5
  title "usage restrictions and implementation guidelines are established for #{input('sc_43_odp')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      usage restrictions and implementation guidelines are established for #{input('sc_43_odp')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective SC-43a.' do
