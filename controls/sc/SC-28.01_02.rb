control 'SC-28(01)[02]' do
  impact 0.5
  title "cryptographic mechanisms are implemented to prevent unauthorized modification of #{input('sc_28_01_odp_01')} at rest on #{input('sc_28_01_odp_02')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      cryptographic mechanisms are implemented to prevent unauthorized modification of #{input('sc_28_01_odp_01')} at rest on #{input('sc_28_01_odp_02')}.
  ...
  describe 'NIST SP 800-53A Rev 5 objective SC-28(01)[02]' do
