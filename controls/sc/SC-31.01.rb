control 'SC-31(01)' do
  impact 0.5
  title "a subset of the identified covert channels is tested to determine the channels that are exploitable."
  desc <<~DESC
  ...
  tag nist: ['SC-31 (1)']
  tag control: 'SC-31 (1)'
  tag objective: 'SC-31(01)'
  tag rev: 'Rev_5'
  tag family: 'System and Communications Protection'
  tag baseline: %w{}
  tag control_sc_31_1: true

  describe 'NIST SP 800-53A Rev 5 objective SC-31(01)' do
