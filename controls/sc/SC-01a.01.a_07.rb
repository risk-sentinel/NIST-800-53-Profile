control 'SC-01a.01(a)[07]' do
  impact 0.5
  title "the #{input('sc_01_odp_03')} system and communications protection policy addresses compliance;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the #{input('sc_01_odp_03')} system and communications protection policy addresses compliance;
  ...
  describe 'NIST SP 800-53A Rev 5 objective SC-01a.01(a)[07]' do
