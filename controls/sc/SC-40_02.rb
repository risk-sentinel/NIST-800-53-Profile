control 'SC-40[02]' do
  impact 0.5
  title "internal #{input('sc_40_odp_03')} are protected from #{input('sc_40_odp_04')}."
  desc <<~DESC
    Protect external and internal #{input('sc_40_prm_1')} from the following signal parameter attacks: #{input('sc_40_prm_2')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      internal #{input('sc_40_odp_03')} are protected from #{input('sc_40_odp_04')}.
  ...
  tag odp: %w{sc_40_odp_03 sc_40_odp_04 sc_40_prm_1 sc_40_prm_2}
