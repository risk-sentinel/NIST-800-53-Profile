control 'SC-36(01)(b)' do
  impact 0.5
  title "#{input('sc_36_01_odp_02')} are taken in response to identified faults, errors, or compromise."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('sc_36_01_odp_02')} are taken in response to identified faults, errors, or compromise.
  ...
  describe 'NIST SP 800-53A Rev 5 objective SC-36(01)(b)' do
