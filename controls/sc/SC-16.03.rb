control 'SC-16(03)' do
  impact 0.5
  title "#{input('sc_16_03_odp')} are implemented to bind security and privacy attributes to transmitted information."
  desc <<~DESC
    Implement #{input('sc_16_03_odp')} to bind security and privacy attributes to transmitted information.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      #{input('sc_16_03_odp')} are implemented to bind security and privacy attributes to transmitted information.
  ...
  tag nist: ['SC-16 (3)']
  tag control: 'SC-16 (3)'
  tag objective: 'SC-16(03)'
  tag rev: 'Rev_5'
  tag family: 'System and Communications Protection'
  tag baseline: %w{}
  tag control_sc_16_3: true
  tag odp: %w{sc_16_03_odp}

  describe 'NIST SP 800-53A Rev 5 objective SC-16(03)' do
