control 'SC-07(28)' do
  impact 0.5
  title "the direct connection of the #{input('sc_07_28_odp')} to a public network is prohibited."
  desc <<~DESC
    Prohibit the direct connection of #{input('sc_07_28_odp')} to a public network.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      the direct connection of the #{input('sc_07_28_odp')} to a public network is prohibited.
  ...
  tag nist: ['SC-7 (28)']
  tag control: 'SC-7 (28)'
  tag objective: 'SC-07(28)'
  tag rev: 'Rev_5'
  tag family: 'System and Communications Protection'
  tag baseline: %w{}
  tag control_sc_7_28: true
  tag odp: %w{sc_07_28_odp}

  describe 'NIST SP 800-53A Rev 5 objective SC-07(28)' do
