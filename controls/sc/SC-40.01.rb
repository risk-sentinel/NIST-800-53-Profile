control 'SC-40(01)' do
  impact 0.5
  title "cryptographic mechanisms that achieve #{input('sc_40_01_odp')} against the effects of intentional electromagnetic interference are implemented."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      cryptographic mechanisms that achieve #{input('sc_40_01_odp')} against the effects of intentional electromagnetic interference are implemented.
  ...
  tag nist: ['SC-40 (1)']
  tag control: 'SC-40 (1)'
  tag objective: 'SC-40(01)'
  tag rev: 'Rev_5'
  tag family: 'System and Communications Protection'
  tag baseline: %w{}
  tag control_sc_40_1: true
  tag odp: %w{sc_40_01_odp}

  describe 'NIST SP 800-53A Rev 5 objective SC-40(01)' do
