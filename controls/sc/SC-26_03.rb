control 'SC-26[03]' do
  impact 0.5
  title "components within organizational systems specifically designed to be the target of malicious attacks are included to analyze such attacks."
  desc <<~DESC
  ...
  tag nist: ['SC-26']
  tag control: 'SC-26'
  tag objective: 'SC-26[03]'
  tag rev: 'Rev_5'
  tag family: 'System and Communications Protection'
  tag baseline: %w{}
  tag control_sc_26: true

  describe 'NIST SP 800-53A Rev 5 objective SC-26[03]' do
