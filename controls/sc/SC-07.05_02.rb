control 'SC-07(05)[02]' do
  impact 0.5
  title "network communications traffic is allowed by exception #{input('sc_07_05_odp_01')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      network communications traffic is allowed by exception #{input('sc_07_05_odp_01')}.
  ...
  tag nist: ['SC-7 (5)']
  tag control: 'SC-7 (5)'
  tag objective: 'SC-07(05)[02]'
  tag rev: 'Rev_5'
  tag family: 'System and Communications Protection'
  tag baseline: %w{MODERATE HIGH}
  tag baseline_moderate: true
  tag baseline_high: true
  tag control_sc_7_5: true
  tag odp: %w{sc_07_05_odp_01}

  describe 'NIST SP 800-53A Rev 5 objective SC-07(05)[02]' do
