control 'SC-51a.' do
  impact 0.5
  title "hardware-based write-protect for #{input('sc_51_odp_01')} is employed;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      hardware-based write-protect for #{input('sc_51_odp_01')} is employed;
  ...
  describe 'NIST SP 800-53A Rev 5 objective SC-51a.' do
