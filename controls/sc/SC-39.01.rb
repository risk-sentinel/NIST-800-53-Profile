control 'SC-39(01)' do
  impact 0.5
  title "hardware separation is implemented to facilitate process isolation."
  desc <<~DESC
  ...
  tag nist: ['SC-39 (1)']
  tag control: 'SC-39 (1)'
  tag objective: 'SC-39(01)'
  tag rev: 'Rev_5'
  tag family: 'System and Communications Protection'
  tag baseline: %w{}
  tag control_sc_39_1: true

  describe 'NIST SP 800-53A Rev 5 objective SC-39(01)' do
