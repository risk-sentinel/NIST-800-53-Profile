control 'SC-07(04)(h)' do
  impact 0.5
  title "unauthorized control plane traffic is filtered from external networks."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SC-07(04)(h)' do
