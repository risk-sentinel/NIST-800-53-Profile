control 'SC-02(02)' do
  impact 0.5
  title "state information is stored separately from applications and software."
  desc <<~DESC
  ...
  tag nist: ['SC-2 (2)']
  tag control: 'SC-2 (2)'
  tag objective: 'SC-02(02)'
  tag rev: 'Rev_5'
  tag family: 'System and Communications Protection'
  tag baseline: %w{}
  tag control_sc_2_2: true

  describe 'NIST SP 800-53A Rev 5 objective SC-02(02)' do
