control 'SC-45(02)(a)' do
  impact 0.5
  title "a secondary authoritative time source is identified that is in a different geographic region than the primary authoritative time source;"
  desc <<~DESC
  ...
  tag nist: ['SC-45 (2)']
  tag control: 'SC-45 (2)'
  tag objective: 'SC-45(02)(a)'
  tag rev: 'Rev_5'
  tag family: 'System and Communications Protection'
  tag baseline: %w{}
  tag control_sc_45_2: true

  describe 'NIST SP 800-53A Rev 5 objective SC-45(02)(a)' do
