control 'SC-07(09)(a)[01]' do
  impact 0.5
  title "outgoing communications traffic posing a threat to external systems is detected;"
  desc <<~DESC
  ...
  tag nist: ['SC-7 (9)']
  tag control: 'SC-7 (9)'
  tag objective: 'SC-07(09)(a)[01]'
  tag rev: 'Rev_5'
  tag family: 'System and Communications Protection'
  tag baseline: %w{}
  tag control_sc_7_9: true

  describe 'NIST SP 800-53A Rev 5 objective SC-07(09)(a)[01]' do
