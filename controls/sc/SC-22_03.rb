control 'SC-22[03]' do
  impact 0.5
  title "the systems that collectively provide name/address resolution services for an organization implement external role separation."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SC-22[03]' do
