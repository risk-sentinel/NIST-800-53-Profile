control 'SC-07(04)(e)[02]' do
  impact 0.5
  title "exceptions to the traffic flow policy that are no longer supported by an explicit mission or business need are removed;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SC-07(04)(e)[02]' do
