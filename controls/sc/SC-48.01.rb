control 'SC-48(01)' do
  impact 0.5
  title "#{input('sc_48_01_odp_01')} are dynamically relocated to #{input('sc_48_01_odp_02')} under #{input('sc_48_01_odp_03')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('sc_48_01_odp_01')} are dynamically relocated to #{input('sc_48_01_odp_02')} under #{input('sc_48_01_odp_03')}.
  ...
  tag nist: ['SC-48 (1)']
  tag control: 'SC-48 (1)'
  tag objective: 'SC-48(01)'
  tag rev: 'Rev_5'
  tag family: 'System and Communications Protection'
  tag baseline: %w{}
  tag control_sc_48_1: true
  tag odp: %w{sc_48_01_odp_01 sc_48_01_odp_02 sc_48_01_odp_03}

  describe 'NIST SP 800-53A Rev 5 objective SC-48(01)' do
