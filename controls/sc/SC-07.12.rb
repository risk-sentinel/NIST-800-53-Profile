control 'SC-07(12)' do
  impact 0.5
  title "#{input('sc_07_12_odp_01')} are implemented at #{input('sc_07_12_odp_02')}."
  desc <<~DESC
    Implement #{input('sc_07_12_odp_01')} at #{input('sc_07_12_odp_02')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      #{input('sc_07_12_odp_01')} are implemented at #{input('sc_07_12_odp_02')}.
  ...
  tag nist: ['SC-7 (12)']
  tag control: 'SC-7 (12)'
  tag objective: 'SC-07(12)'
  tag rev: 'Rev_5'
  tag family: 'System and Communications Protection'
  tag baseline: %w{}
  tag control_sc_7_12: true
  tag odp: %w{sc_07_12_odp_01 sc_07_12_odp_02}

  describe 'NIST SP 800-53A Rev 5 objective SC-07(12)' do
