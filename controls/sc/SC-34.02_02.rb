control 'SC-34(02)[02]' do
  impact 0.5
  title "the media is controlled after such information has been recorded onto the media;"
  desc <<~DESC
  ...
  tag nist: ['SC-34 (2)']
  tag control: 'SC-34 (2)'
  tag objective: 'SC-34(02)[02]'
  tag rev: 'Rev_5'
  tag family: 'System and Communications Protection'
  tag baseline: %w{}
  tag control_sc_34_2: true

  describe 'NIST SP 800-53A Rev 5 objective SC-34(02)[02]' do
