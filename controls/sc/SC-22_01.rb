control 'SC-22[01]' do
  impact 0.5
  title "the systems that collectively provide name/address resolution services for an organization are fault-tolerant;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SC-22[01]' do
