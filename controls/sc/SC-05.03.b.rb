control 'SC-05(03)(b)' do
  impact 0.5
  title "#{input('sc_05_03_odp_02')} are monitored to determine if sufficient resources exist to prevent effective denial-of-service attacks."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('sc_05_03_odp_02')} are monitored to determine if sufficient resources exist to prevent effective denial-of-service attacks.
  ...
  describe 'NIST SP 800-53A Rev 5 objective SC-05(03)(b)' do
