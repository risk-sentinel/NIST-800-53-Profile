control 'SC-18(02)[02]' do
  impact 0.5
  title "the development of mobile code to be deployed in the system meets #{input('sc_18_02_odp')};"
  desc <<~DESC
    Verify that the acquisition, development, and use of mobile code to be deployed in the system meets #{input('sc_18_02_odp')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      the development of mobile code to be deployed in the system meets #{input('sc_18_02_odp')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective SC-18(02)[02]' do
