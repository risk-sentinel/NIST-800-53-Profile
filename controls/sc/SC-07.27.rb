control 'SC-07(27)' do
  impact 0.5
  title "the direct connection of #{input('sc_07_27_odp_01')} to an external network without the use of a #{input('sc_07_27_odp_02')} is prohibited."
  desc <<~DESC
    Prohibit the direct connection of #{input('sc_07_27_odp_01')} to an external network without the use of #{input('sc_07_27_odp_02')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      the direct connection of #{input('sc_07_27_odp_01')} to an external network without the use of a #{input('sc_07_27_odp_02')} is prohibited.
  ...
  tag nist: ['SC-7 (27)']
  tag control: 'SC-7 (27)'
  tag objective: 'SC-07(27)'
  tag rev: 'Rev_5'
  tag family: 'System and Communications Protection'
  tag baseline: %w{}
  tag control_sc_7_27: true
  tag odp: %w{sc_07_27_odp_01 sc_07_27_odp_02}

  describe 'NIST SP 800-53A Rev 5 objective SC-07(27)' do
