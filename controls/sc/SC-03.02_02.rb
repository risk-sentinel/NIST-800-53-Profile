control 'SC-03(02)[02]' do
  impact 0.5
  title "security functions enforcing access control are isolated from other security functions;"
  desc <<~DESC
  ...
  tag nist: ['SC-3 (2)']
  tag control: 'SC-3 (2)'
  tag objective: 'SC-03(02)[02]'
  tag rev: 'Rev_5'
  tag family: 'System and Communications Protection'
  tag baseline: %w{}
  tag control_sc_3_2: true

  describe 'NIST SP 800-53A Rev 5 objective SC-03(02)[02]' do
