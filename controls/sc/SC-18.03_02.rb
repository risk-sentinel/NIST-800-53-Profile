control 'SC-18(03)[02]' do
  impact 0.5
  title "the execution of #{input('sc_18_03_odp')} is prevented."
  desc <<~DESC
    Prevent the download and execution of #{input('sc_18_03_odp')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      the execution of #{input('sc_18_03_odp')} is prevented.
  ...
  describe 'NIST SP 800-53A Rev 5 objective SC-18(03)[02]' do
