control 'SC-07b.' do
  impact 0.5
  title "subnetworks for publicly accessible system components are #{input('sc_07_odp')} separated from internal organizational networks;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      subnetworks for publicly accessible system components are #{input('sc_07_odp')} separated from internal organizational networks;
  ...
  describe 'NIST SP 800-53A Rev 5 objective SC-07b.' do
