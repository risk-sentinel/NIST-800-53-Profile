control 'SC-07(04)(g)' do
  impact 0.5
  title "information is published to enable remote networks to detect unauthorized control plane traffic from internal networks;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SC-07(04)(g)' do
