control 'SC-15a.' do
  impact 0.5
  title "remote activation of collaborative computing devices and applications is prohibited except #{input('sc_15_odp')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      remote activation of collaborative computing devices and applications is prohibited except #{input('sc_15_odp')};
  ...
  tag control_sc_15: true
  tag odp: %w{sc_15_odp}

  describe 'NIST SP 800-53A Rev 5 objective SC-15a.' do
