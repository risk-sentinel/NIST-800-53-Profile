control 'SC-07(04)(e)[01]' do
  impact 0.5
  title "exceptions to the traffic flow policy are reviewed #{input('sc_07_04_odp')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      exceptions to the traffic flow policy are reviewed #{input('sc_07_04_odp')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective SC-07(04)(e)[01]' do
