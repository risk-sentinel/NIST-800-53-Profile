control 'SC-18(04)[02]' do
  impact 0.5
  title "#{input('sc_18_04_odp_02')} are enforced prior to executing mobile code."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('sc_18_04_odp_02')} are enforced prior to executing mobile code.
  ...
  describe 'NIST SP 800-53A Rev 5 objective SC-18(04)[02]' do
