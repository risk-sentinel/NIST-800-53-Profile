control 'SC-15(03)' do
  impact 0.5
  title "collaborative computing devices and applications are disabled or removed from #{input('sc_15_03_odp_01')} in #{input('sc_15_03_odp_02')}."
  desc <<~DESC
    Disable or remove collaborative computing devices and applications from #{input('sc_15_03_odp_01')} in #{input('sc_15_03_odp_02')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      collaborative computing devices and applications are disabled or removed from #{input('sc_15_03_odp_01')} in #{input('sc_15_03_odp_02')}.
  ...
  tag nist: ['SC-15 (3)']
  tag control: 'SC-15 (3)'
  tag objective: 'SC-15(03)'
  tag rev: 'Rev_5'
  tag family: 'System and Communications Protection'
  tag baseline: %w{}
  tag control_sc_15_3: true
  tag odp: %w{sc_15_03_odp_01 sc_15_03_odp_02}

  describe 'NIST SP 800-53A Rev 5 objective SC-15(03)' do
