control 'SC-51b.[01]' do
  impact 0.5
  title "specific procedures are implemented for #{input('sc_51_odp_02')} to manually disable hardware write-protect for firmware modifications;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      specific procedures are implemented for #{input('sc_51_odp_02')} to manually disable hardware write-protect for firmware modifications;
  ...
  describe 'NIST SP 800-53A Rev 5 objective SC-51b.[01]' do
