control 'SC-18(01)[01]' do
  impact 0.5
  title "#{input('sc_18_01_odp_01')} is identified;"
  desc <<~DESC
    Identify #{input('sc_18_01_odp_01')} and take #{input('sc_18_01_odp_02')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      #{input('sc_18_01_odp_01')} is identified;
  ...
  describe 'NIST SP 800-53A Rev 5 objective SC-18(01)[01]' do
