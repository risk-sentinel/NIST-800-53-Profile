control 'SC-08(02)[01]' do
  impact 0.5
  title "information #{input('sc_08_02_odp')} is/are maintained during preparation for transmission;"
  desc <<~DESC
    Maintain the #{input('sc_08_02_odp')} of information during preparation for transmission and during reception.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      information #{input('sc_08_02_odp')} is/are maintained during preparation for transmission;
  ...
  describe 'NIST SP 800-53A Rev 5 objective SC-08(02)[01]' do
