control 'SC-08(05)' do
  impact 0.5
  title "the #{input('sc_08_05_odp_01')} is implemented to #{input('sc_08_05_odp_02')} during transmission."
  desc <<~DESC
    Implement #{input('sc_08_05_odp_01')} to #{input('sc_08_05_odp_02')} during transmission.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      the #{input('sc_08_05_odp_01')} is implemented to #{input('sc_08_05_odp_02')} during transmission.
  ...
  tag nist: ['SC-8 (5)']
  tag control: 'SC-8 (5)'
  tag objective: 'SC-08(05)'
  tag rev: 'Rev_5'
  tag family: 'System and Communications Protection'
  tag baseline: %w{}
  tag control_sc_8_5: true
  tag odp: %w{sc_08_05_odp_01 sc_08_05_odp_02}

  describe 'NIST SP 800-53A Rev 5 objective SC-08(05)' do
