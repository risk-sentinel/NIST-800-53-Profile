control 'SC-11b.' do
  impact 0.5
  title "users are permitted to invoke the trusted communication path for communications between the user and the #{input('sc_11_odp_02')} of the system, including authentication and re-authentication, at a minimum."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      users are permitted to invoke the trusted communication path for communications between the user and the #{input('sc_11_odp_02')} of the system, including authentication and re-authentication, at a minimum.
  ...
  describe 'NIST SP 800-53A Rev 5 objective SC-11b.' do
