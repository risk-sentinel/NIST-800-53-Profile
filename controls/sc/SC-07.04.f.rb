control 'SC-07(04)(f)' do
  impact 0.5
  title "unauthorized exchanges of control plan traffic with external networks are prevented;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SC-07(04)(f)' do
