control 'SC-08(03)' do
  impact 0.5
  title "cryptographic mechanisms are implemented to protect message externals unless otherwise protected by #{input('sc_08_03_odp')}."
  desc <<~DESC
    Implement cryptographic mechanisms to protect message externals unless otherwise protected by #{input('sc_08_03_odp')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      cryptographic mechanisms are implemented to protect message externals unless otherwise protected by #{input('sc_08_03_odp')}.
  ...
  tag nist: ['SC-8 (3)']
  tag control: 'SC-8 (3)'
  tag objective: 'SC-08(03)'
  tag rev: 'Rev_5'
  tag family: 'System and Communications Protection'
  tag baseline: %w{}
  tag control_sc_8_3: true
  tag odp: %w{sc_08_03_odp}

  describe 'NIST SP 800-53A Rev 5 objective SC-08(03)' do
