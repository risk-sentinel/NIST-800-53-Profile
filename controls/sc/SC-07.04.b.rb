control 'SC-07(04)(b)' do
  impact 0.5
  title "a traffic flow policy is established for each managed interface;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SC-07(04)(b)' do
