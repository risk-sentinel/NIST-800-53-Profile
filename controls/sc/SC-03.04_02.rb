control 'SC-03(04)[02]' do
  impact 0.5
  title "security functions are implemented as largely independent modules that minimize coupling between modules."
  desc <<~DESC
  ...
  tag nist: ['SC-3 (4)']
  tag control: 'SC-3 (4)'
  tag objective: 'SC-03(04)[02]'
  tag rev: 'Rev_5'
  tag family: 'System and Communications Protection'
  tag baseline: %w{}
  tag control_sc_3_4: true

  describe 'NIST SP 800-53A Rev 5 objective SC-03(04)[02]' do
