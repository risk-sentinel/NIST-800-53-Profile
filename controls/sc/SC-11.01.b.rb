control 'SC-11(01)(b)' do
  impact 0.5
  title "the trusted communication path for communications between the #{input('sc_11_01_odp')} of the system and the user is initiated."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the trusted communication path for communications between the #{input('sc_11_01_odp')} of the system and the user is initiated.
  ...
  describe 'NIST SP 800-53A Rev 5 objective SC-11(01)(b)' do
