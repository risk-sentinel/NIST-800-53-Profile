control 'SC-07(08)' do
  impact 0.5
  title "#{input('sc_07_08_odp_01')} is routed to #{input('sc_07_08_odp_02')} through authenticated proxy servers at managed interfaces."
  desc <<~DESC
    Route #{input('sc_07_08_odp_01')} to #{input('sc_07_08_odp_02')} through authenticated proxy servers at managed interfaces.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      #{input('sc_07_08_odp_01')} is routed to #{input('sc_07_08_odp_02')} through authenticated proxy servers at managed interfaces.
  ...
  tag nist: ['SC-7 (8)']
  tag control: 'SC-7 (8)'
  tag objective: 'SC-07(08)'
  tag rev: 'Rev_5'
  tag family: 'System and Communications Protection'
  tag baseline: %w{MODERATE HIGH}
  tag baseline_moderate: true
  tag baseline_high: true
  tag control_sc_7_8: true
  tag odp: %w{sc_07_08_odp_01 sc_07_08_odp_02}

  describe 'NIST SP 800-53A Rev 5 objective SC-07(08)' do
