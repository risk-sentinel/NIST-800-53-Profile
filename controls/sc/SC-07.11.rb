control 'SC-07(11)' do
  impact 0.5
  title "only incoming communications from #{input('sc_07_11_odp_01')} are allowed to be routed to #{input('sc_07_11_odp_02')}."
  desc <<~DESC
    Only allow incoming communications from #{input('sc_07_11_odp_01')} to be routed to #{input('sc_07_11_odp_02')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      only incoming communications from #{input('sc_07_11_odp_01')} are allowed to be routed to #{input('sc_07_11_odp_02')}.
  ...
  tag nist: ['SC-7 (11)']
  tag control: 'SC-7 (11)'
  tag objective: 'SC-07(11)'
  tag rev: 'Rev_5'
  tag family: 'System and Communications Protection'
  tag baseline: %w{}
  tag control_sc_7_11: true
  tag odp: %w{sc_07_11_odp_01 sc_07_11_odp_02}

  describe 'NIST SP 800-53A Rev 5 objective SC-07(11)' do
