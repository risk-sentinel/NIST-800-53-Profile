control 'SC-30(02)' do
  impact 0.5
  title "#{input('sc_30_02_odp')} are employed to introduce randomness into organizational operations and assets."
  desc <<~DESC
    Employ #{input('sc_30_02_odp')} to introduce randomness into organizational operations and assets.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      #{input('sc_30_02_odp')} are employed to introduce randomness into organizational operations and assets.
  ...
  tag nist: ['SC-30 (2)']
  tag control: 'SC-30 (2)'
  tag objective: 'SC-30(02)'
  tag rev: 'Rev_5'
  tag family: 'System and Communications Protection'
  tag baseline: %w{}
  tag control_sc_30_2: true
  tag odp: %w{sc_30_02_odp}

  describe 'NIST SP 800-53A Rev 5 objective SC-30(02)' do
