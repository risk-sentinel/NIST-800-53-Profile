control 'SC-23(03)[01]' do
  impact 0.5
  title "a unique session identifier is generated for each session with #{input('sc_23_03_odp')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      a unique session identifier is generated for each session with #{input('sc_23_03_odp')};
  ...
  tag nist: ['SC-23 (3)']
  tag control: 'SC-23 (3)'
  tag objective: 'SC-23(03)[01]'
  tag rev: 'Rev_5'
  tag family: 'System and Communications Protection'
  tag baseline: %w{}
  tag control_sc_23_3: true
  tag odp: %w{sc_23_03_odp}

  describe 'NIST SP 800-53A Rev 5 objective SC-23(03)[01]' do
