control 'SC-01c.01[02]' do
  impact 0.5
  title "the current system and communications protection policy is reviewed and updated following #{input('sc_01_odp_06')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the current system and communications protection policy is reviewed and updated following #{input('sc_01_odp_06')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective SC-01c.01[02]' do
