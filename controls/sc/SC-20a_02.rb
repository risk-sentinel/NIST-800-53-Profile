control 'SC-20a.[02]' do
  impact 0.5
  title "integrity verification artifacts are provided along with the authoritative name resolution data that the system returns in response to external name/address resolution queries;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SC-20a.[02]' do
