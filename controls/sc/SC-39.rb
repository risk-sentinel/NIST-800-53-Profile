control 'SC-39' do
  impact 0.5
  title "a separate execution domain is maintained for each executing system process."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    ...
    Assessment methods and objects:
      ...
      TEST: Mechanisms supporting and/or implementing separate execution domains for each executing process
  CHECK
  desc 'fix', <<~FIX
  ...
  tag control_sc_39: true

  describe 'NIST SP 800-53A Rev 5 objective SC-39' do
