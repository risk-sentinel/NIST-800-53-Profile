control 'SC-06' do
  impact 0.5
  title "the availability of resources is protected by allocating #{input('sc_06_odp_01')} by #{input('sc_06_odp_02')}."
  desc <<~DESC
    Protect the availability of resources by allocating #{input('sc_06_odp_01')} by #{input('sc_06_odp_02')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      the availability of resources is protected by allocating #{input('sc_06_odp_01')} by #{input('sc_06_odp_02')}.
  ...
  tag baseline: %w{}
  tag control_sc_6: true
  tag odp: %w{sc_06_odp_01 sc_06_odp_02}

  describe 'NIST SP 800-53A Rev 5 objective SC-06' do
