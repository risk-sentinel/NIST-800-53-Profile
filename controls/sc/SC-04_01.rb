control 'SC-04[01]' do
  impact 0.5
  title "unauthorized information transfer via shared system resources is prevented;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SC-04[01]' do
