control 'SC-45(01)(b)' do
  impact 0.5
  title "the internal system clocks are synchronized with the authoritative time source when the time difference is greater than #{input('sc_45_01_odp_03')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the internal system clocks are synchronized with the authoritative time source when the time difference is greater than #{input('sc_45_01_odp_03')}.
  ...
  tag nist: ['SC-45 (1)']
  tag control: 'SC-45 (1)'
  tag objective: 'SC-45(01)(b)'
  tag rev: 'Rev_5'
  tag family: 'System and Communications Protection'
  tag baseline: %w{}
  tag control_sc_45_1: true
  tag odp: %w{sc_45_01_odp_01 sc_45_01_odp_02 sc_45_01_odp_03}

  describe 'NIST SP 800-53A Rev 5 objective SC-45(01)(b)' do
