control 'SC-07(23)' do
  impact 0.5
  title "feedback to senders is disabled on protocol format validation failure."
  desc <<~DESC
  ...
  tag nist: ['SC-7 (23)']
  tag control: 'SC-7 (23)'
  tag objective: 'SC-07(23)'
  tag rev: 'Rev_5'
  tag family: 'System and Communications Protection'
  tag baseline: %w{}
  tag control_sc_7_23: true

  describe 'NIST SP 800-53A Rev 5 objective SC-07(23)' do
