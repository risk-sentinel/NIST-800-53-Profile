control 'SC-17b.' do
  impact 0.5
  title "only approved trust anchors are included in trust stores or certificate stores managed by the organization."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SC-17b.' do
