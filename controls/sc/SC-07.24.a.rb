control 'SC-07(24)(a)' do
  impact 0.5
  title "#{input('sc_07_24_odp')} are applied to data elements of personally identifiable information on systems that process personally identifiable information;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('sc_07_24_odp')} are applied to data elements of personally identifiable information on systems that process personally identifiable information;
  ...
  describe 'NIST SP 800-53A Rev 5 objective SC-07(24)(a)' do
