control 'SC-30(03)' do
  impact 0.5
  title "the location of #{input('sc_30_03_odp_01')} is changed #{input('sc_30_03_odp_02')}."
  desc <<~DESC
    Change the location of #{input('sc_30_03_odp_01')} #{input('sc_30_03_odp_02')}].
  DESC
  desc 'check', <<~CHECK
    Determine if:
      the location of #{input('sc_30_03_odp_01')} is changed #{input('sc_30_03_odp_02')}.
  ...
  tag nist: ['SC-30 (3)']
  tag control: 'SC-30 (3)'
  tag objective: 'SC-30(03)'
  tag rev: 'Rev_5'
  tag family: 'System and Communications Protection'
  tag baseline: %w{}
  tag control_sc_30_3: true
  tag odp: %w{sc_30_03_odp_01 sc_30_03_odp_02}

  describe 'NIST SP 800-53A Rev 5 objective SC-30(03)' do
