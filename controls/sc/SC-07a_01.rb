control 'SC-07a.[01]' do
  impact 0.5
  title "communications at external managed interfaces to the system are monitored;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SC-07a.[01]' do
