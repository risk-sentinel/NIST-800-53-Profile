control 'SC-07(09)(b)' do
  impact 0.5
  title "the identity of internal users associated with denied communications is audited."
  desc <<~DESC
  ...
  tag nist: ['SC-7 (9)']
  tag control: 'SC-7 (9)'
  tag objective: 'SC-07(09)(b)'
  tag rev: 'Rev_5'
  tag family: 'System and Communications Protection'
  tag baseline: %w{}
  tag control_sc_7_9: true

  describe 'NIST SP 800-53A Rev 5 objective SC-07(09)(b)' do
