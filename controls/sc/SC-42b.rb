control 'SC-42b.' do
  impact 0.5
  title "an explicit indication of sensor use is provided to #{input('sc_42_odp_05')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      an explicit indication of sensor use is provided to #{input('sc_42_odp_05')}.
  ...
  describe 'NIST SP 800-53A Rev 5 objective SC-42b.' do
