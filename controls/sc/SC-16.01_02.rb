control 'SC-16(01)[02]' do
  impact 0.5
  title "the integrity of transmitted privacy attributes is verified."
  desc <<~DESC
  ...
  tag nist: ['SC-16 (1)']
  tag control: 'SC-16 (1)'
  tag objective: 'SC-16(01)[02]'
  tag rev: 'Rev_5'
  tag family: 'System and Communications Protection'
  tag baseline: %w{}
  tag control_sc_16_1: true

  describe 'NIST SP 800-53A Rev 5 objective SC-16(01)[02]' do
