control 'SC-18a.[04]' do
  impact 0.5
  title "unacceptable mobile code technologies are defined;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SC-18a.[04]' do
