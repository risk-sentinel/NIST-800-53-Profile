control 'SC-04(02)' do
  impact 0.5
  title "unauthorized information transfer via shared resources is prevented in accordance with #{input('sc_04_02_odp')} when system processing explicitly switches between different information classification levels or security categories."
  desc <<~DESC
    Prevent unauthorized information transfer via shared resources in accordance with #{input('sc_04_02_odp')} when system processing explicitly switches between different information classification levels or security categories.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      unauthorized information transfer via shared resources is prevented in accordance with #{input('sc_04_02_odp')} when system processing explicitly switches between different information classification levels or security categories.
  ...
  tag baseline: %w{}
  tag control_sc_4_2: true
  tag odp: %w{sc_04_02_odp}
