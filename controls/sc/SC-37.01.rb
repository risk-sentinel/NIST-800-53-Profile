control 'SC-37(01)' do
  impact 0.5
  title "#{input('sc_37_01_odp_01')} are employed to ensure that only #{input('sc_37_01_odp_02')} receive #{input('sc_37_01_odp_03')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('sc_37_01_odp_01')} are employed to ensure that only #{input('sc_37_01_odp_02')} receive #{input('sc_37_01_odp_03')}.
  ...
  tag nist: ['SC-37 (1)']
  tag control: 'SC-37 (1)'
  tag objective: 'SC-37(01)'
  tag rev: 'Rev_5'
  tag family: 'System and Communications Protection'
  tag baseline: %w{}
  tag control_sc_37_1: true
  tag odp: %w{sc_37_01_odp_01 sc_37_01_odp_02 sc_37_01_odp_03}

  describe 'NIST SP 800-53A Rev 5 objective SC-37(01)' do
