control 'SC-07(26)' do
  impact 0.5
  title "the direct connection of classified national security system to an external network without the use of a #{input('sc_07_26_odp')} is prohibited."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the direct connection of classified national security system to an external network without the use of a #{input('sc_07_26_odp')} is prohibited.
  ...
  tag nist: ['SC-7 (26)']
  tag control: 'SC-7 (26)'
  tag objective: 'SC-07(26)'
  tag rev: 'Rev_5'
  tag family: 'System and Communications Protection'
  tag baseline: %w{}
  tag control_sc_7_26: true
  tag odp: %w{sc_07_26_odp}

  describe 'NIST SP 800-53A Rev 5 objective SC-07(26)' do
