control 'SC-07(22)' do
  impact 0.5
  title "separate network addresses are implemented to connect to systems in different security domains."
  desc <<~DESC
  ...
  tag nist: ['SC-7 (22)']
  tag control: 'SC-7 (22)'
  tag objective: 'SC-07(22)'
  tag rev: 'Rev_5'
  tag family: 'System and Communications Protection'
  tag baseline: %w{}
  tag control_sc_7_22: true

  describe 'NIST SP 800-53A Rev 5 objective SC-07(22)' do
