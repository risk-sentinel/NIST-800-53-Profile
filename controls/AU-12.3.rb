control 'AU-12 (3)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      AU-12(03)[01] the capability for #{input('au_12_03_odp_01')} to change the logging to be performed on #{input('au_12_03_odp_02')} based on #{input('au_12_03_odp_03')} within #{input('au_12_03_odp_04')} is provided;
      AU-12(03)[02] the capability for #{input('au_12_03_odp_01')} to change the logging to be performed on #{input('au_12_03_odp_02')} based on #{input('au_12_03_odp_03')} within #{input('au_12_03_odp_04')} is implemented.
  ...
  describe 'NIST SP 800-53 Rev 5 control AU-12 (3)' do
