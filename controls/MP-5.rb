control 'MP-5' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      MP-05a.
        MP-05a.[01] #{input('mp_05_odp_01')} are protected during transport outside of controlled areas using #{input('mp_05_odp_02')};
        MP-05a.[02] #{input('mp_05_odp_01')} are controlled during transport outside of controlled areas using #{input('mp_05_odp_03')};
  ...
  tag odp: %w{mp_05_odp_01 mp_05_odp_02 mp_05_odp_03 mp_5_prm_2}

  describe 'NIST SP 800-53 Rev 5 control MP-5' do
