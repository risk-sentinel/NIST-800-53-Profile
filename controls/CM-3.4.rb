control 'CM-3 (4)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      CM-03(04)[01] #{input('cm_03_04_odp_01')} are required to be members of the #{input('cm_03_04_odp_03')};
      CM-03(04)[02] #{input('cm_03_04_odp_02')} are required to be members of the #{input('cm_03_04_odp_03')}.
  ...
  tag odp: %w{cm_03_04_odp_01 cm_03_04_odp_02 cm_03_04_odp_03 cm_3_4_prm_1}

  describe 'NIST SP 800-53 Rev 5 control CM-3 (4)' do
