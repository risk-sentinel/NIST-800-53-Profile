control 'SI-2 (2)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SI-02(02) system components have applicable security-relevant software and firmware updates installed #{input('si_02_02_odp_02')} using #{input('si_02_02_odp_01')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control SI-2 (2)' do
