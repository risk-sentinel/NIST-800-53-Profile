control 'SC-8 (2)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SC-08(02)[01] information #{input('sc_08_02_odp')} is/are maintained during preparation for transmission;
      SC-08(02)[02] information #{input('sc_08_02_odp')} is/are maintained during reception.
  ...
  describe 'NIST SP 800-53 Rev 5 control SC-8 (2)' do
