control 'IR-2' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      IR-02a.
        IR-02a.01 incident response training is provided to system users consistent with assigned roles and responsibilities within #{input('ir_02_odp_01')} of assuming an incident response role or responsibility or acquiring system access;
        ...
        IR-02a.03 incident response training is provided to system users consistent with assigned roles and responsibilities #{input('ir_02_odp_02')} thereafter;
      IR-02b.
        IR-02b.[01] incident response training content is reviewed and updated #{input('ir_02_odp_03')};
        IR-02b.[02] incident response training content is reviewed and updated following #{input('ir_02_odp_04')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control IR-2' do
