control 'IR-4 (11)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      ...
      IR-04(11)[02] the integrated incident response team can be deployed to any location identified by the organization in #{input('ir_04_11_odp')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control IR-4 (11)' do
