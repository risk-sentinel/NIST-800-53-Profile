control 'IR-6' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      IR-06a. personnel is/are required to report suspected incidents to the organizational incident response capability within #{input('ir_06_odp_01')};
      IR-06b. incident information is reported to #{input('ir_06_odp_02')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control IR-6' do
