control 'CM-7 (1)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      CM-07(01)(a) the system is reviewed #{input('cm_07_01_odp_01')} to identify unnecessary and/or non-secure functions, ports, protocols, software, and services:
      CM-07(01)(b)
        CM-07(01)(b)[01] #{input('cm_07_01_odp_02')} deemed to be unnecessary and/or non-secure are disabled or removed;
        CM-07(01)(b)[02] #{input('cm_07_01_odp_03')} deemed to be unnecessary and/or non-secure are disabled or removed;
        CM-07(01)(b)[03] #{input('cm_07_01_odp_04')} deemed to be unnecessary and/or non-secure are disabled or removed;
        CM-07(01)(b)[04] #{input('cm_07_01_odp_05')} deemed to be unnecessary and/or non-secure is disabled or removed;
        CM-07(01)(b)[05] #{input('cm_07_01_odp_06')} deemed to be unnecessary and/or non-secure are disabled or removed.
  ...
  tag odp: %w{cm_07_01_odp_01 cm_07_01_odp_02 cm_07_01_odp_03 cm_07_01_odp_04 cm_07_01_odp_05 cm_07_01_odp_06 cm_7_1_prm_2}

  describe 'NIST SP 800-53 Rev 5 control CM-7 (1)' do
