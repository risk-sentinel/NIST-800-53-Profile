control 'SA-15 (3)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SA-15(03)(a) the developer of the system, system component, or system service is required to perform a criticality analysis at #{input('sa_15_03_odp_01')} in the system development life cycle;
      SA-15(03)(b)
        SA-15(03)(b)[01] the developer of the system, system component, or system service is required to perform a criticality analysis at the following rigor level: #{input('sa_15_03_odp_02')};
        SA-15(03)(b)[02] the developer of the system, system component, or system service is required to perform a criticality analysis at the following rigor level: #{input('sa_15_03_odp_03')} .
  ...
  tag odp: %w{sa_15_03_odp_01 sa_15_03_odp_02 sa_15_03_odp_03 sa_15_3_prm_2}

  describe 'NIST SP 800-53 Rev 5 control SA-15 (3)' do
