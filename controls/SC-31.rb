control 'SC-31' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SC-31a. a covert channel analysis is performed to identify those aspects of communications within the system that are potential avenues for covert #{input('sc_31_odp')} channels;
  ...
  describe 'NIST SP 800-53 Rev 5 control SC-31' do
