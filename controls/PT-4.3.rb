control 'PT-4 (3)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      PT-04(03) the #{input('pt_04_03_odp')} are implemented for individuals to revoke consent to the processing of their personally identifiable information.
  ...
  describe 'NIST SP 800-53 Rev 5 control PT-4 (3)' do
