control 'AU-2' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      AU-02a. #{input('au_02_odp_01')} that the system is capable of logging are identified in support of the audit logging function;
      ...
      AU-02c.
        AU-02c.[01] #{input('au_02_odp_02')} are specified for logging within the system;
        AU-02c.[02] the specified event types are logged within the system #{input('au_02_odp_03')};
      ...
      AU-02e. the event types selected for logging are reviewed and updated #{input('au_02_odp_04')}.
  ...
  tag odp: %w{au_02_odp_01 au_02_odp_02 au_02_odp_03 au_02_odp_04 au_2_prm_2}

  describe 'NIST SP 800-53 Rev 5 control AU-2' do
