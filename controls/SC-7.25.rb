control 'SC-7 (25)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SC-07(25) the direct connection of #{input('sc_07_25_odp_01')} to an external network without the use of #{input('sc_07_25_odp_02')} is prohibited.
  ...
  describe 'NIST SP 800-53 Rev 5 control SC-7 (25)' do
