control 'SI-4' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SI-04a.
        SI-04a.01 the system is monitored to detect attacks and indicators of potential attacks in accordance with #{input('si_04_odp_01')};
        SI-04a.02
      ...
      SI-04b. unauthorized use of the system is identified through #{input('si_04_odp_02')};
      SI-04c.
      ...
      SI-04g. #{input('si_04_odp_03')} is provided to #{input('si_04_odp_04')} #{input('si_04_odp_05')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control SI-4' do
