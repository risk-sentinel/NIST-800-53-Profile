control 'PS-7' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      ...
      PS-07d. external providers are required to notify #{input('ps_07_odp_01')} of any personnel transfers or terminations of external personnel who possess organizational credentials and/or badges or who have system privileges within #{input('ps_07_odp_02')};
  ...
  describe 'NIST SP 800-53 Rev 5 control PS-7' do
