control 'PM-31' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      PM-31 an organization-wide continuous monitoring strategy is developed;
        PM-31a. continuous monitoring programs are implemented that include establishing #{input('pm_31_odp_01')} to be monitored;
        PM-31b.
          PM-31b.[01] continuous monitoring programs are implemented that establish #{input('pm_31_odp_02')} for monitoring;
          PM-31b.[02] continuous monitoring programs are implemented that establish #{input('pm_31_odp_03')} for assessment of control effectiveness;
        PM-31c. continuous monitoring programs are implemented that include monitoring #{input('pm_31_odp_01')} on an ongoing basis in accordance with the continuous monitoring strategy;
        PM-31d.
        ...
        PM-31f.
          PM-31f.[01] continuous monitoring programs are implemented that include reporting the security status of organizational systems to #{input('pm_31_odp_04')} #{input('pm_31_odp_06')};
          PM-31f.[02] continuous monitoring programs are implemented that include reporting the privacy status of organizational systems to #{input('pm_31_odp_05')} #{input('pm_31_odp_07')}.
  ...
  tag odp: %w{pm_31_odp_01 pm_31_odp_02 pm_31_odp_03 pm_31_odp_04 pm_31_odp_05 pm_31_odp_06 pm_31_odp_07 pm_31_prm_4 pm_31_prm_5}

  describe 'NIST SP 800-53 Rev 5 control PM-31' do
