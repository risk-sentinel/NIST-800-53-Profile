control 'AC-4 (21)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      AC-04(21)[01] information flows are separated logically using #{input('ac_04_21_odp_01')} to accomplish #{input('ac_04_21_odp_03')};
      AC-04(21)[02] information flows are separated physically using #{input('ac_04_21_odp_02')} to accomplish #{input('ac_04_21_odp_03')}.
  ...
  tag baseline: %w{}
  tag odp: %w{ac_04_21_odp_01 ac_04_21_odp_02 ac_04_21_odp_03 ac_4_21_prm_1}

  describe 'NIST SP 800-53 Rev 5 control AC-4 (21)' do
