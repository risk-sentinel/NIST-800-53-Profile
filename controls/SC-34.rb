control 'SC-34' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SC-34a. the operating environment for #{input('sc_34_odp_01')} is loaded and executed from hardware-enforced, read-only media;
      SC-34b. #{input('sc_34_odp_02')} for #{input('sc_34_odp_01')} are loaded and executed from hardware-enforced, read-only media.
  ...
  describe 'NIST SP 800-53 Rev 5 control SC-34' do
