control 'MA-3 (3)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      ...
      MA-03(03)(d) the removal of maintenance equipment containing organizational information is prevented by obtaining an exemption from #{input('ma_03_03_odp')} explicitly authorizing removal of the equipment from the facility.
  ...
  describe 'NIST SP 800-53 Rev 5 control MA-3 (3)' do
