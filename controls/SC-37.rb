control 'SC-37' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SC-37 #{input('sc_37_odp_01')} are employed for the physical delivery or electronic transmission of #{input('sc_37_odp_02')} to #{input('sc_37_odp_03')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control SC-37' do
