control 'PE-17' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      PE-17a. #{input('pe_17_odp_01')} are determined and documented;
      PE-17b. #{input('pe_17_odp_02')} are employed at alternate work sites;
  ...
  describe 'NIST SP 800-53 Rev 5 control PE-17' do
