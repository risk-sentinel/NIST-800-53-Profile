control 'AC-2 (3)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      AC-02(03)(a) accounts are disabled within #{input('ac_02_03_odp_01')} when the accounts have expired;
      AC-02(03)(b) accounts are disabled within #{input('ac_02_03_odp_01')} when the accounts are no longer associated with a user or individual;
      AC-02(03)(c) accounts are disabled within #{input('ac_02_03_odp_01')} when the accounts are in violation of organizational policy;
      AC-02(03)(d) accounts are disabled within #{input('ac_02_03_odp_01')} when the accounts have been inactive for #{input('ac_02_03_odp_02')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control AC-2 (3)' do
