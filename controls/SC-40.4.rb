control 'SC-40 (4)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SC-40(04) cryptographic mechanisms are implemented to prevent the identification of #{input('sc_40_04_odp')} by using the transmitter signal parameters.
  ...
  describe 'NIST SP 800-53 Rev 5 control SC-40 (4)' do
