control 'SI-14 (1)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SI-14(01) the software and data employed during system component and service refreshes are obtained from #{input('si_14_01_odp')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control SI-14 (1)' do
