control 'CA-7 (5)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      CA-07(05)[01] #{input('ca_07_05_odp_01')} are employed to validate that policies are established;
      CA-07(05)[02] #{input('ca_07_05_odp_02')} are employed to validate that implemented controls are operating in a consistent manner.
  ...
  tag baseline: %w{}
  tag odp: %w{ca_07_05_odp_01 ca_07_05_odp_02 ca_7_5_prm_1}

  describe 'NIST SP 800-53 Rev 5 control CA-7 (5)' do
