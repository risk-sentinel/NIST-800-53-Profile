control 'CM-11 (3)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      CM-11(03)[01] compliance with software installation policies is enforced using #{input('cm_11_03_odp_01')};
      CM-11(03)[02] compliance with software installation policies is monitored using #{input('cm_11_03_odp_02')}.
  ...
  tag baseline: %w{}
  tag odp: %w{cm_11_03_odp_01 cm_11_03_odp_02 cm_11_3_prm_1}

  describe 'NIST SP 800-53 Rev 5 control CM-11 (3)' do
