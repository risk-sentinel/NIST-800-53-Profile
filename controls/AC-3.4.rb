control 'AC-3 (4)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      AC-03(04)[01] #{input('ac_03_04_odp_01')} is enforced over the set of covered subjects specified in the policy;
      AC-03(04)[02] #{input('ac_03_04_odp_02')} is enforced over the set of covered objects specified in the policy;
      AC-03(04)(a) #{input('ac_03_04_odp_01')} and #{input('ac_03_04_odp_02')} are enforced where the policy specifies that a subject that has been granted access to information can pass the information to any other subjects or objects;
      AC-03(04)(b) #{input('ac_03_04_odp_01')} and #{input('ac_03_04_odp_02')} are enforced where the policy specifies that a subject that has been granted access to information can grant its privileges to other subjects;
      AC-03(04)(c) #{input('ac_03_04_odp_01')} and #{input('ac_03_04_odp_02')} are enforced where the policy specifies that a subject that has been granted access to information can change security attributes on subjects, objects, the system, or the system’s components;
      AC-03(04)(d) #{input('ac_03_04_odp_01')} and #{input('ac_03_04_odp_02')} are enforced where the policy specifies that a subject that has been granted access to information can choose the security attributes to be associated with newly created or revised objects;
      AC-03(04)(e) #{input('ac_03_04_odp_01')} and #{input('ac_03_04_odp_02')} are enforced where the policy specifies that a subject that has been granted access to information can change the rules governing access control.
  ...
  tag baseline: %w{}
  tag odp: %w{ac_03_04_odp_01 ac_03_04_odp_02 ac_3_4_prm_1}

  describe 'NIST SP 800-53 Rev 5 control AC-3 (4)' do
