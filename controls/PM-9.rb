control 'PM-9' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      ...
      PM-09c. the risk management strategy is reviewed and updated #{input('pm_09_odp')} or as required to address organizational changes.
  ...
  describe 'NIST SP 800-53 Rev 5 control PM-9' do
