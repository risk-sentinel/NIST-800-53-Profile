control 'SI-10 (1)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SI-10(01)(a) a manual override capability for the validation of #{input('si_10_odp')} is provided;
      SI-10(01)(b) the use of the manual override capability is restricted to only #{input('si_10_01_odp')};
  ...
  describe 'NIST SP 800-53 Rev 5 control SI-10 (1)' do
