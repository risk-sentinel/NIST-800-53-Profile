control 'CM-2 (2)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      CM-02(02)[01] the currency of the baseline configuration of the system is maintained using #{input('cm_02_02_odp')};
      CM-02(02)[02] the completeness of the baseline configuration of the system is maintained using #{input('cm_02_02_odp')};
      CM-02(02)[03] the accuracy of the baseline configuration of the system is maintained using #{input('cm_02_02_odp')};
      CM-02(02)[04] the availability of the baseline configuration of the system is maintained using #{input('cm_02_02_odp')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control CM-2 (2)' do
