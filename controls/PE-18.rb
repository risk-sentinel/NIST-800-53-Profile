control 'PE-18' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      PE-18 system components are positioned within the facility to minimize potential damage from #{input('pe_18_odp')} and to minimize the opportunity for unauthorized access.
  ...
  describe 'NIST SP 800-53 Rev 5 control PE-18' do
