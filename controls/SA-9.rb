control 'SA-9' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SA-09a.
        ...
        SA-09a.[03] providers of external system services employ #{input('sa_09_odp_01')};
      SA-09b.
      ...
      SA-09c. #{input('sa_09_odp_02')} are employed to monitor control compliance by external service providers on an ongoing basis.
  ...
  describe 'NIST SP 800-53 Rev 5 control SA-9' do
