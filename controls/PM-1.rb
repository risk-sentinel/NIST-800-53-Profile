control 'PM-1' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      ...
      PM-01b.
        PM-01b.[01] the information security program plan is reviewed and updated #{input('pm_01_odp_01')};
        PM-01b.[02] the information security program plan is reviewed and updated following #{input('pm_01_odp_02')};
      PM-01c.
  ...
  describe 'NIST SP 800-53 Rev 5 control PM-1' do
