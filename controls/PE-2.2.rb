control 'PE-2 (2)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      PE-02(02) two forms of identification are required from #{input('pe_02_02_odp')} for visitor access to the facility where the system resides.
  ...
  describe 'NIST SP 800-53 Rev 5 control PE-2 (2)' do
