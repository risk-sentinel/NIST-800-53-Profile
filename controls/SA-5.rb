control 'SA-5' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      ...
      SA-05c.
        ...
        SA-05c.[02] after attempts to obtain system, system component, or system service documentation when such documentation is either unavailable or nonexistent, #{input('sa_05_odp_01')} are taken in response;
      SA-05d. documentation is distributed to #{input('sa_05_odp_02')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control SA-5' do
