control 'AU-9' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      ...
      AU-09b. #{input('au_09_odp')} are alerted upon detection of unauthorized access, modification, or deletion of audit information.
  ...
  describe 'NIST SP 800-53 Rev 5 control AU-9' do
