control 'AC-7 (2)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      AC-07(02) information is purged or wiped from #{input('ac_07_02_odp_01')} based on #{input('ac_07_02_odp_02')} after #{input('ac_07_02_odp_03')} consecutive, unsuccessful device logon attempts.
  ...
  describe 'NIST SP 800-53 Rev 5 control AC-7 (2)' do
