control 'IR-4 (3)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      IR-04(03)[01] #{input('ir_04_03_odp_01')} are identified;
      IR-04(03)[02] #{input('ir_04_03_odp_02')} are taken in response to those incidents (defined in IR-04(03)_ODP[01]) to ensure the continuation of organizational mission and business functions.
  ...
  describe 'NIST SP 800-53 Rev 5 control IR-4 (3)' do
