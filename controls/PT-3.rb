control 'PT-3' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      PT-03a. the #{input('pt_03_odp_01')} for processing personally identifiable information is/are identified and documented;
      PT-03b.
      ...
      PT-03c. the #{input('pt_03_odp_02')} of personally identifiable information are restricted to only that which is compatible with the identified purpose(s);
      PT-03d.
        PT-03d.[01] changes in the processing of personally identifiable information are monitored;
        PT-03d.[02] #{input('pt_03_odp_03')} are implemented to ensure that any changes are made in accordance with #{input('pt_03_odp_04')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control PT-3' do
