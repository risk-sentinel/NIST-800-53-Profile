control 'SI-12 (2)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SI-12(02)[01] #{input('si_12_02_odp_01')} are used to minimize the use of personally identifiable information for research;
      SI-12(02)[02] #{input('si_12_02_odp_02')} are used to minimize the use of personally identifiable information for testing;
      SI-12(02)[03] #{input('si_12_02_odp_03')} are used to minimize the use of personally identifiable information for training.
  ...
  tag odp: %w{si_12_02_odp_01 si_12_02_odp_02 si_12_02_odp_03 si_12_2_prm_1}

  describe 'NIST SP 800-53 Rev 5 control SI-12 (2)' do
