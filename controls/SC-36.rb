control 'SC-36' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SC-36[01] #{input('sc_36_odp_01')} are distributed across #{input('sc_36_odp_02')};
      SC-36[02] #{input('sc_36_odp_03')} are distributed across #{input('sc_36_odp_04')}.
  ...
  tag baseline: %w{}
  tag odp: %w{sc_36_odp_01 sc_36_odp_02 sc_36_odp_03 sc_36_odp_04 sc_36_prm_1 sc_36_prm_2}

  describe 'NIST SP 800-53 Rev 5 control SC-36' do
