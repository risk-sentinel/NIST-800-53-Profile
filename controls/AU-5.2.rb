control 'AU-5 (2)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      AU-05(02) an alert is provided within #{input('au_05_02_odp_01')} to #{input('au_05_02_odp_02')} when #{input('au_05_02_odp_03')} occur.
  ...
  describe 'NIST SP 800-53 Rev 5 control AU-5 (2)' do
