control 'AT-2' do
    ...
    Determine if:
      AT-02a.
        AT-02a.01
          ...
          AT-02a.01[03] security literacy training is provided to system users (including managers, senior executives, and contractors) #{input('at_02_odp_01')} thereafter;
          AT-02a.01[04] privacy literacy training is provided to system users (including managers, senior executives, and contractors) #{input('at_02_odp_02')} thereafter;
        AT-02a.02
          AT-02a.02[01] security literacy training is provided to system users (including managers, senior executives, and contractors) when required by system changes or following #{input('at_02_odp_03')};
          AT-02a.02[02] privacy literacy training is provided to system users (including managers, senior executives, and contractors) when required by system changes or following #{input('at_02_odp_04')};
      AT-02b. #{input('at_02_odp_05')} are employed to increase the security and privacy awareness of system users;
      AT-02c.
        AT-02c.[01] literacy training and awareness content is updated #{input('at_02_odp_06')};
        AT-02c.[02] literacy training and awareness content is updated following #{input('at_02_odp_07')};
  ...
  tag odp: %w{at_02_odp_01 at_02_odp_02 at_02_odp_03 at_02_odp_04 at_02_odp_05 at_02_odp_06 at_02_odp_07 at_2_prm_1 at_2_prm_2}

  describe 'NIST SP 800-53 Rev 5 control AT-2' do
