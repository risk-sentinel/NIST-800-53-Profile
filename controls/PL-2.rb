control 'PL-2' do
  ...
  desc <<~DESC
    a. Develop security and privacy plans for the system that:
      ...
      14. Include security- and privacy-related activities affecting the system that require planning and coordination with #{input('pl_02_odp_01')} ; and
      15. Are reviewed and approved by the authorizing official or designated representative prior to plan implementation.
    b. Distribute copies of the plans and communicate subsequent changes to the plans to #{input('pl_02_odp_02')};
    c. Review the plans #{input('pl_02_odp_03')};
  ...
  desc 'check', <<~CHECK
    Determine if:
      PL-02a.
        ...
        PL-02a.14
          PL-02a.14[01] a security plan for the system is developed that includes security-related activities affecting the system that require planning and coordination with #{input('pl_02_odp_01')};
          PL-02a.14[02] a privacy plan for the system is developed that includes privacy-related activities affecting the system that require planning and coordination with #{input('pl_02_odp_01')};
        PL-02a.15
      ...
      PL-02b.
        PL-02b.[01] copies of the plans are distributed to #{input('pl_02_odp_02')};
        PL-02b.[02] subsequent changes to the plans are communicated to #{input('pl_02_odp_02')};
      PL-02c. plans are reviewed #{input('pl_02_odp_03')};
      PL-02d.
  ...
  tag odp: %w{pl_02_odp_01 pl_02_odp_02 pl_02_odp_03}

  describe 'NIST SP 800-53 Rev 5 control PL-2' do
