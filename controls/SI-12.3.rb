control 'SI-12 (3)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SI-12(03)[01] #{input('si_12_03_odp_01')} are used to dispose of information following the retention period;
      SI-12(03)[02] #{input('si_12_03_odp_02')} are used to destroy information following the retention period;
      SI-12(03)[03] #{input('si_12_03_odp_03')} are used to erase information following the retention period.
  ...
  tag odp: %w{si_12_03_odp_01 si_12_03_odp_02 si_12_03_odp_03 si_12_3_prm_1}

  describe 'NIST SP 800-53 Rev 5 control SI-12 (3)' do
