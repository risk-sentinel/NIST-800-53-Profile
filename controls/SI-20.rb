control 'SI-20' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SI-20 data or capabilities are embedded in #{input('si_20_odp')} to determine if organizational data has been exfiltrated or improperly removed from the organization.
  ...
  describe 'NIST SP 800-53 Rev 5 control SI-20' do
