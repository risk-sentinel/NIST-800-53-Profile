control 'MP-04a.[03]' do
  impact 0.5
  title "#{input('mp_04_odp_03')} are securely stored within #{input('mp_04_odp_05')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('mp_04_odp_03')} are securely stored within #{input('mp_04_odp_05')};
  ...
  tag odp: %w{mp_04_odp_03 mp_04_odp_05 mp_4_prm_1 mp_4_prm_2}

  describe 'NIST SP 800-53A Rev 5 objective MP-04a.[03]' do
