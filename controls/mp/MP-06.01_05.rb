control 'MP-06(01)[05]' do
  impact 0.5
  title "media sanitization and disposal actions are verified."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective MP-06(01)[05]' do
