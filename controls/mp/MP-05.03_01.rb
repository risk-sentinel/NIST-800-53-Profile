control 'MP-05(03)[01]' do
  impact 0.5
  title "a custodian to transport system media outside of controlled areas is identified;"
  desc <<~DESC
  ...
  tag nist: ['MP-5 (3)']
  tag control: 'MP-5 (3)'
  tag objective: 'MP-05(03)[01]'
  tag rev: 'Rev_5'
  tag family: 'Media Protection'
  tag baseline: %w{}
  tag control_mp_5_3: true

  describe 'NIST SP 800-53A Rev 5 objective MP-05(03)[01]' do
