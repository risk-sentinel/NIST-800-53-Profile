control 'MP-06b.' do
  impact 0.5
  title "sanitization mechanisms with strength and integrity commensurate with the security category or classification of the information are employed."
  desc <<~DESC
  ...
  tag odp: %w{mp_6_prm_1 mp_6_prm_2}

  describe 'NIST SP 800-53A Rev 5 objective MP-06b.' do
