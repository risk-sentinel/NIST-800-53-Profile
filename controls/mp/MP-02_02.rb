control 'MP-02[02]' do
  impact 0.5
  title "access to #{input('mp_02_odp_03')} is restricted to #{input('mp_02_odp_04')}."
  desc <<~DESC
    Restrict access to #{input('mp_2_prm_1')} to #{input('mp_2_prm_2')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      access to #{input('mp_02_odp_03')} is restricted to #{input('mp_02_odp_04')}.
  ...
  tag odp: %w{mp_02_odp_03 mp_02_odp_04 mp_2_prm_1 mp_2_prm_2}

  describe 'NIST SP 800-53A Rev 5 objective MP-02[02]' do
