control 'MP-06a.[01]' do
  impact 0.5
  title "#{input('mp_06_odp_01')} is sanitized using #{input('mp_06_odp_04')} prior to disposal;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('mp_06_odp_01')} is sanitized using #{input('mp_06_odp_04')} prior to disposal;
  ...
  tag odp: %w{mp_06_odp_01 mp_06_odp_04 mp_6_prm_1 mp_6_prm_2}

  describe 'NIST SP 800-53A Rev 5 objective MP-06a.[01]' do
