control 'MP-06(01)[01]' do
  impact 0.5
  title "media sanitization and disposal actions are reviewed;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective MP-06(01)[01]' do
