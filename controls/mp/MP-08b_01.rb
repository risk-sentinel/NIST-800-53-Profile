control 'MP-08b.[01]' do
  impact 0.5
  title "there is verification that the system media downgrading process is commensurate with the security category and/or classification level of the information to be removed;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective MP-08b.[01]' do
