control 'MP-01c.01[01]' do
  impact 0.5
  title "the current media protection policy is reviewed and updated #{input('mp_01_odp_05')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the current media protection policy is reviewed and updated #{input('mp_01_odp_05')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective MP-01c.01[01]' do
