control 'MP-05a.[02]' do
  impact 0.5
  title "#{input('mp_05_odp_01')} are controlled during transport outside of controlled areas using #{input('mp_05_odp_03')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('mp_05_odp_01')} are controlled during transport outside of controlled areas using #{input('mp_05_odp_03')};
  ...
  tag odp: %w{mp_05_odp_01 mp_05_odp_03 mp_5_prm_2}

  describe 'NIST SP 800-53A Rev 5 objective MP-05a.[02]' do
