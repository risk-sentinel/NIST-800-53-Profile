control 'MP-06a.[03]' do
  impact 0.5
  title "#{input('mp_06_odp_03')} is sanitized using #{input('mp_06_odp_06')} prior to release for reuse;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('mp_06_odp_03')} is sanitized using #{input('mp_06_odp_06')} prior to release for reuse;
  ...
  tag odp: %w{mp_06_odp_03 mp_06_odp_06 mp_6_prm_1 mp_6_prm_2}

  describe 'NIST SP 800-53A Rev 5 objective MP-06a.[03]' do
