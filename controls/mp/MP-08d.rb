control 'MP-08d.' do
  impact 0.5
  title "the identified system media is downgraded using the #{input('mp_08_odp_01')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the identified system media is downgraded using the #{input('mp_08_odp_01')}.
  ...
  describe 'NIST SP 800-53A Rev 5 objective MP-08d.' do
