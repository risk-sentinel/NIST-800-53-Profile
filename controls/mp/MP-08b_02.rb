control 'MP-08b.[02]' do
  impact 0.5
  title "there is verification that the system media downgrading process is commensurate with the access authorizations of the potential recipients of the downgraded information;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective MP-08b.[02]' do
