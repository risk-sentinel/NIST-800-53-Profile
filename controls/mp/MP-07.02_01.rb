control 'MP-07(02)[01]' do
  impact 0.5
  title "sanitization-resistant media is identified;"
  desc <<~DESC
  ...
  tag nist: ['MP-7 (2)']
  tag control: 'MP-7 (2)'
  tag objective: 'MP-07(02)[01]'
  tag rev: 'Rev_5'
  tag family: 'Media Protection'
  tag baseline: %w{}
  tag control_mp_7_2: true

  describe 'NIST SP 800-53A Rev 5 objective MP-07(02)[01]' do
