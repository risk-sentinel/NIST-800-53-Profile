control 'MP-01a.[02]' do
  impact 0.5
  title "the media protection policy is disseminated to #{input('mp_01_odp_01')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the media protection policy is disseminated to #{input('mp_01_odp_01')};
  ...
  tag odp: %w{mp_01_odp_01 mp_01_odp_03 mp_01_odp_04 mp_01_odp_05 mp_01_odp_06 mp_01_odp_07 mp_01_odp_08 mp_1_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective MP-01a.[02]' do
