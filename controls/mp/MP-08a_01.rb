control 'MP-08a.[01]' do
  impact 0.5
  title "a #{input('mp_08_odp_01')} is established;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      a #{input('mp_08_odp_01')} is established;
  ...
  describe 'NIST SP 800-53A Rev 5 objective MP-08a.[01]' do
