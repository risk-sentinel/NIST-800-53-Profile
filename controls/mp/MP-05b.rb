control 'MP-05b.' do
  impact 0.5
  title "accountability for system media is maintained during transport outside of controlled areas;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective MP-05b.' do
