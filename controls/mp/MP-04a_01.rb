control 'MP-04a.[01]' do
  impact 0.5
  title "#{input('mp_04_odp_01')} are physically controlled;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('mp_04_odp_01')} are physically controlled;
  ...
  tag odp: %w{mp_04_odp_01 mp_4_prm_1 mp_4_prm_2}

  describe 'NIST SP 800-53A Rev 5 objective MP-04a.[01]' do
