control 'MP-08a.[02]' do
  impact 0.5
  title "the #{input('mp_08_odp_01')} includes employing downgrading mechanisms with strength and integrity commensurate with the security category or classification of the information;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the #{input('mp_08_odp_01')} includes employing downgrading mechanisms with strength and integrity commensurate with the security category or classification of the information;
  ...
  describe 'NIST SP 800-53A Rev 5 objective MP-08a.[02]' do
