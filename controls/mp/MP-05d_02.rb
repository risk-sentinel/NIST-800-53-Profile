control 'MP-05d.[02]' do
  impact 0.5
  title "activities associated with the transport of system media are restricted to identified authorized personnel."
  desc <<~DESC
  ...
  tag odp: %w{mp_05_odp_01 mp_5_prm_2}

  describe 'NIST SP 800-53A Rev 5 objective MP-05d.[02]' do
