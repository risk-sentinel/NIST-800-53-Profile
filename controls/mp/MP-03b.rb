control 'MP-03b.' do
  impact 0.5
  title "#{input('mp_03_odp_01')} remain within #{input('mp_03_odp_02')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('mp_03_odp_01')} remain within #{input('mp_03_odp_02')}.
  ...
  describe 'NIST SP 800-53A Rev 5 objective MP-03b.' do
