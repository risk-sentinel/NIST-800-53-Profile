control 'MP-04b.' do
  impact 0.5
  title "system media types (defined in MP-04_ODP[01], MP-04_ODP[02], MP-04_ODP[03], MP-04_ODP[04]) are protected until the media are destroyed or sanitized using approved equipment, techniques, and procedures."
  desc <<~DESC
  ...
  tag odp: %w{mp_4_prm_1 mp_4_prm_2}

  describe 'NIST SP 800-53A Rev 5 objective MP-04b.' do
