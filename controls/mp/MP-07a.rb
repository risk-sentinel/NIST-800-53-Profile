control 'MP-07a.' do
  impact 0.5
  title "the use of #{input('mp_07_odp_01')} is #{input('mp_07_odp_02')} on #{input('mp_07_odp_03')} using #{input('mp_07_odp_04')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the use of #{input('mp_07_odp_01')} is #{input('mp_07_odp_02')} on #{input('mp_07_odp_03')} using #{input('mp_07_odp_04')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective MP-07a.' do
