control 'MP-01a.01(a)[02]' do
  impact 0.5
  title "the #{input('mp_01_odp_03')} media protection policy addresses scope;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the #{input('mp_01_odp_03')} media protection policy addresses scope;
  ...
  describe 'NIST SP 800-53A Rev 5 objective MP-01a.01(a)[02]' do
