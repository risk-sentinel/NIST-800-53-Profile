control 'MP-08(04)[02]' do
  impact 0.5
  title "system media containing classified information is downgraded prior to release to individuals without required access authorizations."
  desc <<~DESC
  ...
  tag nist: ['MP-8 (4)']
  tag control: 'MP-8 (4)'
  tag objective: 'MP-08(04)[02]'
  tag rev: 'Rev_5'
  tag family: 'Media Protection'
  tag baseline: %w{}
  tag control_mp_8_4: true

  describe 'NIST SP 800-53A Rev 5 objective MP-08(04)[02]' do
