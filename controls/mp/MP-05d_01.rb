control 'MP-05d.[01]' do
  impact 0.5
  title "personnel authorized to conduct media transport activities is/are identified;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective MP-05d.[01]' do
