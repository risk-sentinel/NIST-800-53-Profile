control 'MP-06a.[02]' do
  impact 0.5
  title "#{input('mp_06_odp_02')} is sanitized using #{input('mp_06_odp_05')} prior to release from organizational control;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('mp_06_odp_02')} is sanitized using #{input('mp_06_odp_05')} prior to release from organizational control;
  ...
  tag control_mp_6: true
  tag odp: %w{mp_06_odp_02 mp_06_odp_05 mp_6_prm_1 mp_6_prm_2}

  describe 'NIST SP 800-53A Rev 5 objective MP-06a.[02]' do
