control 'MP-4 (2)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      MP-04(02)[01] access to media storage areas is restricted using #{input('mp_04_02_odp_01')};
      MP-04(02)[02] access attempts to media storage areas are logged using #{input('mp_04_02_odp_02')};
      MP-04(02)[03] access granted to media storage areas is logged using #{input('mp_04_02_odp_03')}.
  ...
  tag baseline: %w{}
  tag odp: %w{mp_04_02_odp_01 mp_04_02_odp_02 mp_04_02_odp_03 mp_4_2_prm_1}

  describe 'NIST SP 800-53 Rev 5 control MP-4 (2)' do
