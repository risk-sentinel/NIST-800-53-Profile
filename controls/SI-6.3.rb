control 'SI-6 (3)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SI-06(03)[01] the results of security function verification are reported to #{input('si_06_03_odp')};
      SI-06(03)[02] the results of privacy function verification are reported to #{input('si_06_03_odp')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control SI-6 (3)' do
