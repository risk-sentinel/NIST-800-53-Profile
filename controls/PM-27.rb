control 'PM-27' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      PM-27a. #{input('pm_27_odp_01')} are developed;
        PM-27a.01 the privacy reports are disseminated to #{input('pm_27_odp_02')} to demonstrate accountability with statutory, regulatory, and policy privacy mandates;
        PM-27a.02
          PM-27a.02[01] the privacy reports are disseminated to #{input('pm_27_odp_03')};
      ...
      PM-27b. the privacy reports are reviewed and updated #{input('pm_27_odp_04')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control PM-27' do
