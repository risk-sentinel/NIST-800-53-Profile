control 'SI-19(05)[03]' do
  impact 0.5
  title "statistical findings are manipulated so that no individual or organization is identifiable in the results of the analysis."
  desc <<~DESC
  ...
  tag nist: ['SI-19 (5)']
  tag control: 'SI-19 (5)'
  tag objective: 'SI-19(05)[03]'
  tag rev: 'Rev_5'
  tag family: 'System and Information Integrity'
  tag baseline: %w{}
  tag control_si_19_5: true

  describe 'NIST SP 800-53A Rev 5 objective SI-19(05)[03]' do
