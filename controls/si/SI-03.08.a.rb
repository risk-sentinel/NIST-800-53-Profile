control 'SI-03(08)(a)' do
  impact 0.5
  title "#{input('si_03_08_odp_01')} are detected through the kernel application programming interface on #{input('si_03_08_odp_02')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('si_03_08_odp_01')} are detected through the kernel application programming interface on #{input('si_03_08_odp_02')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective SI-03(08)(a)' do
