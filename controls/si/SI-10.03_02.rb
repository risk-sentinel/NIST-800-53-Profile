control 'SI-10(03)[02]' do
  impact 0.5
  title "the system behaves in a documented manner when invalid inputs are received."
  desc <<~DESC
  ...
  tag nist: ['SI-10 (3)']
  tag control: 'SI-10 (3)'
  tag objective: 'SI-10(03)[02]'
  tag rev: 'Rev_5'
  tag family: 'System and Information Integrity'
  tag baseline: %w{}
  tag control_si_10_3: true

  describe 'NIST SP 800-53A Rev 5 objective SI-10(03)[02]' do
