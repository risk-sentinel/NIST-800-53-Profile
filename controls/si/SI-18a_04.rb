control 'SI-18a.[04]' do
  impact 0.5
  title "the completeness of personally identifiable information across the information life cycle is checked #{input('si_18_odp_04')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the completeness of personally identifiable information across the information life cycle is checked #{input('si_18_odp_04')};
  ...
  tag nist: ['SI-18']
  tag control: 'SI-18'
  tag objective: 'SI-18a.[04]'
  tag rev: 'Rev_5'
  tag family: 'System and Information Integrity'
  tag baseline: %w{PRIVACY}
  tag baseline_privacy: true
  tag control_si_18: true
  tag odp: %w{si_18_odp_04 si_18_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective SI-18a.[04]' do
