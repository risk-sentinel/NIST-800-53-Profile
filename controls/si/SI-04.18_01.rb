control 'SI-04(18)[01]' do
  impact 0.5
  title "outbound communications traffic is analyzed at interfaces external to the system to detect covert exfiltration of information;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SI-04(18)[01]' do
