control 'SI-04(15)' do
  impact 0.5
  title "an intrusion detection system is employed to monitor wireless communications traffic as the traffic passes from wireless to wireline networks."
  desc <<~DESC
  ...
  tag nist: ['SI-4 (15)']
  tag control: 'SI-4 (15)'
  tag objective: 'SI-04(15)'
  tag rev: 'Rev_5'
  tag family: 'System and Information Integrity'
  tag baseline: %w{}
  tag control_si_4_15: true

  describe 'NIST SP 800-53A Rev 5 objective SI-04(15)' do
