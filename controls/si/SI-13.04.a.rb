control 'SI-13(04)(a)' do
  impact 0.5
  title "the standby components are successfully and transparently installed within #{input('si_13_04_odp_01')} if system component failures are detected;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the standby components are successfully and transparently installed within #{input('si_13_04_odp_01')} if system component failures are detected;
  ...
  tag nist: ['SI-13 (4)']
  tag control: 'SI-13 (4)'
  tag objective: 'SI-13(04)(a)'
  tag rev: 'Rev_5'
  tag family: 'System and Information Integrity'
  tag baseline: %w{}
  tag control_si_13_4: true
  tag odp: %w{si_13_04_odp_01 si_13_04_odp_02}

  describe 'NIST SP 800-53A Rev 5 objective SI-13(04)(a)' do
