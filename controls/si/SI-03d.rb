control 'SI-03d.' do
  impact 0.5
  title "the receipt of false positives during malicious code detection and eradication and the resulting potential impact on the availability of the system are addressed."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SI-03d.' do
