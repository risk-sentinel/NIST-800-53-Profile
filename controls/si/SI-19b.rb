control 'SI-19b.' do
  impact 0.5
  title "the effectiveness of de-identification is evaluated #{input('si_19_odp_02')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the effectiveness of de-identification is evaluated #{input('si_19_odp_02')}.
  ...
  describe 'NIST SP 800-53A Rev 5 objective SI-19b.' do
