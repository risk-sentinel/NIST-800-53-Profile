control 'SI-14(03)[01]' do
  impact 0.5
  title "connections to the system are established on demand;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SI-14(03)[01]' do
