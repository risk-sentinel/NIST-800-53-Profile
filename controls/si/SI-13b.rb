control 'SI-13b.' do
  impact 0.5
  title "substitute system components and a means to exchange active and standby components are provided in accordance with #{input('si_13_odp_02')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      substitute system components and a means to exchange active and standby components are provided in accordance with #{input('si_13_odp_02')}.
  ...
  tag nist: ['SI-13']
  tag control: 'SI-13'
  tag objective: 'SI-13b.'
  tag rev: 'Rev_5'
  tag family: 'System and Information Integrity'
  tag baseline: %w{}
  tag control_si_13: true
  tag odp: %w{si_13_odp_01 si_13_odp_02}

  describe 'NIST SP 800-53A Rev 5 objective SI-13b.' do
