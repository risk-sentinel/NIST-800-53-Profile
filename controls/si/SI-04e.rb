control 'SI-04e.' do
  impact 0.5
  title "the level of system monitoring activity is adjusted when there is a change in risk to organizational operations and assets, individuals, other organizations, or the Nation;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SI-04e.' do
