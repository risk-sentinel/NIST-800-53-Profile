control 'SI-02b.[01]' do
  impact 0.5
  title "software updates related to flaw remediation are tested for effectiveness before installation;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SI-02b.[01]' do
