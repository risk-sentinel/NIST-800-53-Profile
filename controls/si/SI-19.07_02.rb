control 'SI-19(07)[02]' do
  impact 0.5
  title "de-identification is performed using software that is validated to implement the algorithms."
  desc <<~DESC
  ...
  tag nist: ['SI-19 (7)']
  tag control: 'SI-19 (7)'
  tag objective: 'SI-19(07)[02]'
  tag rev: 'Rev_5'
  tag family: 'System and Information Integrity'
  tag baseline: %w{}
  tag control_si_19_7: true

  describe 'NIST SP 800-53A Rev 5 objective SI-19(07)[02]' do
