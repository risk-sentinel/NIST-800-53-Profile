control 'SI-07(15)' do
  impact 0.5
  title "cryptographic mechanisms are implemented to authenticate #{input('si_07_15_odp')} prior to installation."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      cryptographic mechanisms are implemented to authenticate #{input('si_07_15_odp')} prior to installation.
  ...
  tag nist: ['SI-7 (15)']
  tag control: 'SI-7 (15)'
  tag objective: 'SI-07(15)'
  tag rev: 'Rev_5'
  tag family: 'System and Information Integrity'
  tag baseline: %w{HIGH}
  tag baseline_high: true
  tag control_si_7_15: true
  tag odp: %w{si_07_15_odp}

  describe 'NIST SP 800-53A Rev 5 objective SI-07(15)' do
