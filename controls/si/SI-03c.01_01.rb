control 'SI-03c.01[01]' do
  impact 0.5
  title "malicious code protection mechanisms are configured to perform periodic scans of the system #{input('si_03_odp_02')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      malicious code protection mechanisms are configured to perform periodic scans of the system #{input('si_03_odp_02')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective SI-03c.01[01]' do
