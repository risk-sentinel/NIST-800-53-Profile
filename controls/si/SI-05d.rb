control 'SI-05d.' do
  impact 0.5
  title "security directives are implemented in accordance with established time frames or if the issuing organization is notified of the degree of noncompliance."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SI-05d.' do
