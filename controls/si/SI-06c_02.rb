control 'SI-06c.[02]' do
  impact 0.5
  title "#{input('si_06_odp_06')} is/are alerted to failed privacy verification tests;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('si_06_odp_06')} is/are alerted to failed privacy verification tests;
  ...
  describe 'NIST SP 800-53A Rev 5 objective SI-06c.[02]' do
