control 'SI-10(01)(c)' do
  impact 0.5
  title "the use of the manual override capability is audited."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SI-10(01)(c)' do
