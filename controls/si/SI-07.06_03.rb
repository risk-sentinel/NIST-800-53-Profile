control 'SI-07(06)[03]' do
  impact 0.5
  title "cryptographic mechanisms are implemented to detect unauthorized changes to information."
  desc <<~DESC
  ...
  tag nist: ['SI-7 (6)']
  tag control: 'SI-7 (6)'
  tag objective: 'SI-07(06)[03]'
  tag rev: 'Rev_5'
  tag family: 'System and Information Integrity'
  tag baseline: %w{}
  tag control_si_7_6: true

  describe 'NIST SP 800-53A Rev 5 objective SI-07(06)[03]' do
