control 'SI-04g.' do
  impact 0.5
  title "#{input('si_04_odp_03')} is provided to #{input('si_04_odp_04')} #{input('si_04_odp_05')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('si_04_odp_03')} is provided to #{input('si_04_odp_04')} #{input('si_04_odp_05')}.
  ...
  describe 'NIST SP 800-53A Rev 5 objective SI-04g.' do
