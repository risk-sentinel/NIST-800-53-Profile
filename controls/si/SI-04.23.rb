control 'SI-04(23)' do
  impact 0.5
  title "#{input('si_04_23_odp_01')} are implemented on #{input('si_04_23_odp_02')}."
  desc <<~DESC
    Implement the following host-based monitoring mechanisms at #{input('si_04_23_odp_02')}: #{input('si_04_23_odp_01')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      #{input('si_04_23_odp_01')} are implemented on #{input('si_04_23_odp_02')}.
  ...
  tag nist: ['SI-4 (23)']
  tag control: 'SI-4 (23)'
  tag objective: 'SI-04(23)'
  tag rev: 'Rev_5'
  tag family: 'System and Information Integrity'
  tag baseline: %w{}
  tag control_si_4_23: true
  tag odp: %w{si_04_23_odp_01 si_04_23_odp_02}

  describe 'NIST SP 800-53A Rev 5 objective SI-04(23)' do
