control 'SI-04(02)' do
  impact 0.5
  title "automated tools and mechanisms are employed to support a near real-time analysis of events."
  desc <<~DESC
  ...
  tag nist: ['SI-4 (2)']
  tag control: 'SI-4 (2)'
  tag objective: 'SI-04(02)'
  tag rev: 'Rev_5'
  tag family: 'System and Information Integrity'
  tag baseline: %w{MODERATE HIGH}
  tag baseline_moderate: true
  tag baseline_high: true
  tag control_si_4_2: true

  describe 'NIST SP 800-53A Rev 5 objective SI-04(02)' do
