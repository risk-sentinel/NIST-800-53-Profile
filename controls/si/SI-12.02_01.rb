control 'SI-12(02)[01]' do
  impact 0.5
  title "#{input('si_12_02_odp_01')} are used to minimize the use of personally identifiable information for research;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('si_12_02_odp_01')} are used to minimize the use of personally identifiable information for research;
  ...
  tag nist: ['SI-12 (2)']
  tag control: 'SI-12 (2)'
  tag objective: 'SI-12(02)[01]'
  tag rev: 'Rev_5'
  tag family: 'System and Information Integrity'
  tag baseline: %w{PRIVACY}
  tag baseline_privacy: true
  tag control_si_12_2: true
  tag odp: %w{si_12_02_odp_01 si_12_2_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective SI-12(02)[01]' do
