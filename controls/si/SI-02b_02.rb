control 'SI-02b.[02]' do
  impact 0.5
  title "software updates related to flaw remediation are tested for potential side effects before installation;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SI-02b.[02]' do
