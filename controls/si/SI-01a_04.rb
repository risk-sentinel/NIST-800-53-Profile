control 'SI-01a.[04]' do
  impact 0.5
  title "the system and information integrity procedures are disseminated to #{input('si_01_odp_02')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the system and information integrity procedures are disseminated to #{input('si_01_odp_02')};
  ...
  tag odp: %w{si_01_odp_02 si_01_odp_03 si_01_odp_04 si_01_odp_05 si_01_odp_06 si_01_odp_07 si_01_odp_08 si_1_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective SI-01a.[04]' do
