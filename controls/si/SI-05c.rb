control 'SI-05c.' do
  impact 0.5
  title "security alerts, advisories, and directives are disseminated to #{input('si_05_odp_02')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      security alerts, advisories, and directives are disseminated to #{input('si_05_odp_02')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective SI-05c.' do
