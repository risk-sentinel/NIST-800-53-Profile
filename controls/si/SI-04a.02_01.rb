control 'SI-04a.02[01]' do
  impact 0.5
  title "the system is monitored to detect unauthorized local connections;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SI-04a.02[01]' do
