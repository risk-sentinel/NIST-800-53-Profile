control 'SI-03(10)(a)' do
  impact 0.5
  title "#{input('si_03_10_odp')} are employed to analyze the characteristics and behavior of malicious code;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('si_03_10_odp')} are employed to analyze the characteristics and behavior of malicious code;
  ...
  describe 'NIST SP 800-53A Rev 5 objective SI-03(10)(a)' do
