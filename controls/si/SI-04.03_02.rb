control 'SI-04(03)[02]' do
  impact 0.5
  title "automated tools and mechanisms are employed to integrate intrusion detection tools and mechanisms into flow control mechanisms."
  desc <<~DESC
  ...
  tag nist: ['SI-4 (3)']
  tag control: 'SI-4 (3)'
  tag objective: 'SI-04(03)[02]'
  tag rev: 'Rev_5'
  tag family: 'System and Information Integrity'
  tag baseline: %w{}
  tag control_si_4_3: true

  describe 'NIST SP 800-53A Rev 5 objective SI-04(03)[02]' do
