control 'SI-03(10)(b)[01]' do
  impact 0.5
  title "the results from malicious code analysis are incorporated into organizational incident response processes;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SI-03(10)(b)[01]' do
