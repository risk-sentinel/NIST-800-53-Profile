control 'SI-10(02)[01]' do
  impact 0.5
  title "input validation errors are reviewed within #{input('si_10_02_odp_01')};"
  desc <<~DESC
    Review and resolve input validation errors within #{input('si_10_2_prm_1')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      input validation errors are reviewed within #{input('si_10_02_odp_01')};
  ...
  tag nist: ['SI-10 (2)']
  tag control: 'SI-10 (2)'
  tag objective: 'SI-10(02)[01]'
  tag rev: 'Rev_5'
  tag family: 'System and Information Integrity'
  tag baseline: %w{}
  tag control_si_10_2: true
  tag odp: %w{si_10_02_odp_01 si_10_2_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective SI-10(02)[01]' do
