control 'SI-06d.' do
  impact 0.5
  title "#{input('si_06_odp_07')} is/are initiated when anomalies are discovered."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('si_06_odp_07')} is/are initiated when anomalies are discovered.
  ...
  describe 'NIST SP 800-53A Rev 5 objective SI-06d.' do
