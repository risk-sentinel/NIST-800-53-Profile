control 'SI-04(24)[03]' do
  impact 0.5
  title "indicators of compromise provided by #{input('si_04_24_odp_01')} are distributed to #{input('si_04_24_odp_02')}."
  desc <<~DESC
    Discover, collect, and distribute to #{input('si_04_24_odp_02')} , indicators of compromise provided by #{input('si_04_24_odp_01')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      indicators of compromise provided by #{input('si_04_24_odp_01')} are distributed to #{input('si_04_24_odp_02')}.
  ...
  tag nist: ['SI-4 (24)']
  tag control: 'SI-4 (24)'
  tag objective: 'SI-04(24)[03]'
  tag rev: 'Rev_5'
  tag family: 'System and Information Integrity'
  tag baseline: %w{}
  tag control_si_4_24: true
  tag odp: %w{si_04_24_odp_01 si_04_24_odp_02}

  describe 'NIST SP 800-53A Rev 5 objective SI-04(24)[03]' do
