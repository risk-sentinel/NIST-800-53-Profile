control 'SI-04(13)(b)[01]' do
  impact 0.5
  title "profiles representing common traffic are developed;"
  desc <<~DESC
  ...
  tag nist: ['SI-4 (13)']
  tag control: 'SI-4 (13)'
  tag objective: 'SI-04(13)(b)[01]'
  tag rev: 'Rev_5'
  tag family: 'System and Information Integrity'
  tag baseline: %w{}
  tag control_si_4_13: true

  describe 'NIST SP 800-53A Rev 5 objective SI-04(13)(b)[01]' do
