control 'SI-04a.02[03]' do
  impact 0.5
  title "the system is monitored to detect unauthorized remote connections;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SI-04a.02[03]' do
