control 'SI-10(05)' do
  impact 0.5
  title "the use of information inputs is restricted to #{input('si_10_05_odp_01')} and/or #{input('si_10_05_odp_02')}."
  desc <<~DESC
    Restrict the use of information inputs to #{input('si_10_05_odp_01')} and/or #{input('si_10_05_odp_02')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      the use of information inputs is restricted to #{input('si_10_05_odp_01')} and/or #{input('si_10_05_odp_02')}.
    ...
    Assessment methods and objects:
      ...
      TEST: Organizational processes for restricting information inputs; automated mechanisms supporting and/or implementing restriction of information inputs
  CHECK
  desc 'fix', <<~FIX
  ...
  tag nist: ['SI-10 (5)']
  tag control: 'SI-10 (5)'
  tag objective: 'SI-10(05)'
  tag rev: 'Rev_5'
  tag family: 'System and Information Integrity'
  tag baseline: %w{}
  tag control_si_10_5: true
  tag odp: %w{si_10_05_odp_01 si_10_05_odp_02}

  describe 'NIST SP 800-53A Rev 5 objective SI-10(05)' do
