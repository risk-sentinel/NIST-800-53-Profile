control 'SI-05b.' do
  impact 0.5
  title "internal security alerts, advisories, and directives are generated as deemed necessary;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SI-05b.' do
