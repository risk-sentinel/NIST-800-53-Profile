control 'SI-02(07)c.[02]' do
  impact 0.5
  title "The implementation of actions is monitored for effectiveness."
  desc <<~DESC
  ...
  tag nist: ['SI-2 (7)']
  tag control: 'SI-2 (7)'
  tag objective: 'SI-02(07)c.[02]'
  tag rev: 'Rev_5'
  tag family: 'System and Information Integrity'
  tag baseline: %w{}
  tag control_si_2_7: true

  describe 'NIST SP 800-53A Rev 5 objective SI-02(07)c.[02]' do
