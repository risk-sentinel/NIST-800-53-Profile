control 'SI-04c.02' do
  impact 0.5
  title "internal monitoring capabilities are invoked or monitoring devices are deployed at ad hoc locations within the system to track specific types of transactions of interest to the organization;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SI-04c.02' do
