control 'SI-03a.[02]' do
  impact 0.5
  title "#{input('si_03_odp_01')} malicious code protection mechanisms are implemented at system entry and exit points to eradicate malicious code;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('si_03_odp_01')} malicious code protection mechanisms are implemented at system entry and exit points to eradicate malicious code;
  ...
  describe 'NIST SP 800-53A Rev 5 objective SI-03a.[02]' do
