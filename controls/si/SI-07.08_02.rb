control 'SI-07(08)[02]' do
  impact 0.5
  title "#{input('si_07_08_odp_01')} is/are initiated upon the detection of a potential integrity violation."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('si_07_08_odp_01')} is/are initiated upon the detection of a potential integrity violation.
  ...
  describe 'NIST SP 800-53A Rev 5 objective SI-07(08)[02]' do
