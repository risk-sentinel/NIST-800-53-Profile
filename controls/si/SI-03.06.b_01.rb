control 'SI-03(06)(b)[01]' do
  impact 0.5
  title "the detection of (benign test) code occurs;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SI-03(06)(b)[01]' do
