control 'SI-02(07)b.' do
  impact 0.5
  title "Actions to address the root cause of the issue of failure are developed"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      Actions to address the root cause of the issue of failure are developed
  ...
  tag nist: ['SI-2 (7)']
  tag control: 'SI-2 (7)'
  tag objective: 'SI-02(07)b.'
  tag rev: 'Rev_5'
  tag family: 'System and Information Integrity'
  tag baseline: %w{}
  tag control_si_2_7: true

  describe 'NIST SP 800-53A Rev 5 objective SI-02(07)b.' do
