control 'SI-07(12)' do
  impact 0.5
  title "the integrity of #{input('si_07_12_odp')} is verified prior to execution."
  desc <<~DESC
    Require that the integrity of the following user-installed software be verified prior to execution: #{input('si_07_12_odp')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      the integrity of #{input('si_07_12_odp')} is verified prior to execution.
  ...
  tag nist: ['SI-7 (12)']
  tag control: 'SI-7 (12)'
  tag objective: 'SI-07(12)'
  tag rev: 'Rev_5'
  tag family: 'System and Information Integrity'
  tag baseline: %w{}
  tag control_si_7_12: true
  tag odp: %w{si_07_12_odp}

  describe 'NIST SP 800-53A Rev 5 objective SI-07(12)' do
