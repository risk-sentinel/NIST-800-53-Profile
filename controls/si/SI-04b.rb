control 'SI-04b.' do
  impact 0.5
  title "unauthorized use of the system is identified through #{input('si_04_odp_02')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      unauthorized use of the system is identified through #{input('si_04_odp_02')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective SI-04b.' do
