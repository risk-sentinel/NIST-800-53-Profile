control 'SI-07a.[01]' do
  impact 0.5
  title "integrity verification tools are employed to detect unauthorized changes to #{input('si_07_odp_01')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      integrity verification tools are employed to detect unauthorized changes to #{input('si_07_odp_01')};
  ...
  tag odp: %w{si_07_odp_01 si_7_prm_1 si_7_prm_2}

  describe 'NIST SP 800-53A Rev 5 objective SI-07a.[01]' do
