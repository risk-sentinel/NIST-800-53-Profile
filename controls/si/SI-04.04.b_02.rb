control 'SI-04(04)(b)[02]' do
  impact 0.5
  title "outbound communications traffic is monitored #{input('si_04_04_odp_03')} for #{input('si_04_04_odp_04')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      outbound communications traffic is monitored #{input('si_04_04_odp_03')} for #{input('si_04_04_odp_04')}.
  ...
  tag odp: %w{si_04_04_odp_03 si_04_04_odp_04 si_4_4_prm_1 si_4_4_prm_2}

  describe 'NIST SP 800-53A Rev 5 objective SI-04(04)(b)[02]' do
