control 'SI-02c.[02]' do
  impact 0.5
  title "security-relevant firmware updates are installed within #{input('si_02_odp')} of the release of the updates;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      security-relevant firmware updates are installed within #{input('si_02_odp')} of the release of the updates;
  ...
  tag control_si_2: true
  tag odp: %w{si_02_odp}

  describe 'NIST SP 800-53A Rev 5 objective SI-02c.[02]' do
