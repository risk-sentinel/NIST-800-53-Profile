control 'SI-04(20)' do
  impact 0.5
  title "#{input('si_04_20_odp')} of privileged users is implemented."
  desc <<~DESC
    Implement the following additional monitoring of privileged users: #{input('si_04_20_odp')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      #{input('si_04_20_odp')} of privileged users is implemented.
  ...
  tag nist: ['SI-4 (20)']
  tag control: 'SI-4 (20)'
  tag objective: 'SI-04(20)'
  tag rev: 'Rev_5'
  tag family: 'System and Information Integrity'
  tag baseline: %w{HIGH}
  tag baseline_high: true
  tag control_si_4_20: true
  tag odp: %w{si_04_20_odp}

  describe 'NIST SP 800-53A Rev 5 objective SI-04(20)' do
