control 'SI-04(24)[01]' do
  impact 0.5
  title "indicators of compromise provided by #{input('si_04_24_odp_01')} are discovered;"
  desc <<~DESC
    Discover, collect, and distribute to #{input('si_04_24_odp_02')} , indicators of compromise provided by #{input('si_04_24_odp_01')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      indicators of compromise provided by #{input('si_04_24_odp_01')} are discovered;
  ...
  describe 'NIST SP 800-53A Rev 5 objective SI-04(24)[01]' do
