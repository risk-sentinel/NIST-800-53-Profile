control 'SI-12(03)[01]' do
  impact 0.5
  title "#{input('si_12_03_odp_01')} are used to dispose of information following the retention period;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('si_12_03_odp_01')} are used to dispose of information following the retention period;
  ...
  tag nist: ['SI-12 (3)']
  tag control: 'SI-12 (3)'
  tag objective: 'SI-12(03)[01]'
  tag rev: 'Rev_5'
  tag family: 'System and Information Integrity'
  tag baseline: %w{PRIVACY}
  tag baseline_privacy: true
  tag control_si_12_3: true
  tag odp: %w{si_12_03_odp_01 si_12_3_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective SI-12(03)[01]' do
