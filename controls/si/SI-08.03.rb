control 'SI-08(03)' do
  impact 0.5
  title "spam protection mechanisms with a learning capability are implemented to more effectively identify legitimate communications traffic."
  desc <<~DESC
  ...
  tag nist: ['SI-8 (3)']
  tag control: 'SI-8 (3)'
  tag objective: 'SI-08(03)'
  tag rev: 'Rev_5'
  tag family: 'System and Information Integrity'
  tag baseline: %w{}
  tag control_si_8_3: true

  describe 'NIST SP 800-53A Rev 5 objective SI-08(03)' do
