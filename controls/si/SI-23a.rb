control 'SI-23a.' do
  impact 0.5
  title "under #{input('si_23_odp_01')}, #{input('si_23_odp_02')} is fragmented;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      under #{input('si_23_odp_01')}, #{input('si_23_odp_02')} is fragmented;
  ...
  describe 'NIST SP 800-53A Rev 5 objective SI-23a.' do
