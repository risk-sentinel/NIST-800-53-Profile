control 'SI-02c.[01]' do
  impact 0.5
  title "security-relevant software updates are installed within #{input('si_02_odp')} of the release of the updates;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      security-relevant software updates are installed within #{input('si_02_odp')} of the release of the updates;
  ...
  describe 'NIST SP 800-53A Rev 5 objective SI-02c.[01]' do
