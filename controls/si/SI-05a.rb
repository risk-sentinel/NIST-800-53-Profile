control 'SI-05a.' do
  impact 0.5
  title "system security alerts, advisories, and directives are received from #{input('si_05_odp_01')} on an ongoing basis;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      system security alerts, advisories, and directives are received from #{input('si_05_odp_01')} on an ongoing basis;
  ...
  tag control_si_5: true
  tag odp: %w{si_05_odp_01 si_05_odp_02}

  describe 'NIST SP 800-53A Rev 5 objective SI-05a.' do
