control 'SI-06c.[01]' do
  impact 0.5
  title "#{input('si_06_odp_06')} is/are alerted to failed security verification tests;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('si_06_odp_06')} is/are alerted to failed security verification tests;
  ...
  tag nist: ['SI-6']
  tag control: 'SI-6'
  tag objective: 'SI-06c.[01]'
  tag rev: 'Rev_5'
  tag family: 'System and Information Integrity'
  tag baseline: %w{HIGH}
  tag baseline_high: true
  tag control_si_6: true
  tag odp: %w{si_06_odp_03 si_06_odp_06 si_06_odp_07 si_6_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective SI-06c.[01]' do
