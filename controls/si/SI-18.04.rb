control 'SI-18(04)' do
  impact 0.5
  title "personally identifiable information is corrected or deleted upon request by individuals or their designated representatives."
  desc <<~DESC
  ...
  tag nist: ['SI-18 (4)']
  tag control: 'SI-18 (4)'
  tag objective: 'SI-18(04)'
  tag rev: 'Rev_5'
  tag family: 'System and Information Integrity'
  tag baseline: %w{PRIVACY}
  tag baseline_privacy: true
  tag control_si_18_4: true

  describe 'NIST SP 800-53A Rev 5 objective SI-18(04)' do
