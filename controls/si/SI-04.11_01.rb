control 'SI-04(11)[01]' do
  impact 0.5
  title "outbound communications traffic at the external interfaces to the system is analyzed to discover anomalies;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SI-04(11)[01]' do
