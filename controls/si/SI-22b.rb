control 'SI-22b.' do
  impact 0.5
  title "an alternative information source is used for the execution of essential functions or services on #{input('si_22_odp_03')} when the primary source of information is corrupted or unavailable."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      an alternative information source is used for the execution of essential functions or services on #{input('si_22_odp_03')} when the primary source of information is corrupted or unavailable.
  ...
  describe 'NIST SP 800-53A Rev 5 objective SI-22b.' do
