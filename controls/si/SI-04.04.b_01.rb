control 'SI-04(04)(b)[01]' do
  impact 0.5
  title "inbound communications traffic is monitored #{input('si_04_04_odp_01')} for #{input('si_04_04_odp_02')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      inbound communications traffic is monitored #{input('si_04_04_odp_01')} for #{input('si_04_04_odp_02')};
  ...
  tag odp: %w{si_04_04_odp_01 si_04_04_odp_02 si_4_4_prm_1 si_4_4_prm_2}

  describe 'NIST SP 800-53A Rev 5 objective SI-04(04)(b)[01]' do
