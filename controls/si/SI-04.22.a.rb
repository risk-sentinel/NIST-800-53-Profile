control 'SI-04(22)(a)' do
  impact 0.5
  title "network services that have not been authorized or approved by #{input('si_04_22_odp_01')} are detected;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      network services that have not been authorized or approved by #{input('si_04_22_odp_01')} are detected;
  ...
  describe 'NIST SP 800-53A Rev 5 objective SI-04(22)(a)' do
