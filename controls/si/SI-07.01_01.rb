control 'SI-07(01)[01]' do
  impact 0.5
  title "an integrity check of #{input('si_07_01_odp_01')} is performed #{input('si_07_01_odp_02')};"
  desc <<~DESC
    Perform an integrity check of #{input('si_7_1_prm_1')} #{input('si_7_1_prm_2')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      an integrity check of #{input('si_07_01_odp_01')} is performed #{input('si_07_01_odp_02')};
  ...
  tag odp: %w{si_07_01_odp_01 si_07_01_odp_02 si_7_1_prm_1 si_7_1_prm_2}

  describe 'NIST SP 800-53A Rev 5 objective SI-07(01)[01]' do
