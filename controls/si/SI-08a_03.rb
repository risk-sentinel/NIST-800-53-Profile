control 'SI-08a.[03]' do
  impact 0.5
  title "spam protection mechanisms are employed at system entry points to act on unsolicited messages;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SI-08a.[03]' do
