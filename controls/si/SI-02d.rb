control 'SI-02d.' do
  impact 0.5
  title "flaw remediation is incorporated into the organizational configuration management process."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SI-02d.' do
