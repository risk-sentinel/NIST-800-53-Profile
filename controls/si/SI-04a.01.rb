control 'SI-04a.01' do
  impact 0.5
  title "the system is monitored to detect attacks and indicators of potential attacks in accordance with #{input('si_04_odp_01')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the system is monitored to detect attacks and indicators of potential attacks in accordance with #{input('si_04_odp_01')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective SI-04a.01' do
