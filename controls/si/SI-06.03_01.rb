control 'SI-06(03)[01]' do
  impact 0.5
  title "the results of security function verification are reported to #{input('si_06_03_odp')};"
  desc <<~DESC
    Report the results of security and privacy function verification to #{input('si_06_03_odp')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      the results of security function verification are reported to #{input('si_06_03_odp')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective SI-06(03)[01]' do
