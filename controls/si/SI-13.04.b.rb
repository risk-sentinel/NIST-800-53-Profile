control 'SI-13(04)(b)' do
  impact 0.5
  title "#{input('si_13_04_odp_02')} are performed if system component failures are detected."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('si_13_04_odp_02')} are performed if system component failures are detected.
  ...
  describe 'NIST SP 800-53A Rev 5 objective SI-13(04)(b)' do
