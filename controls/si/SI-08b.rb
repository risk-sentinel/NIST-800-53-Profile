control 'SI-08b.' do
  impact 0.5
  title "spam protection mechanisms are updated when new releases are available in accordance with organizational configuration management policies and procedures."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SI-08b.' do
