control 'SI-02(03)(b)' do
  impact 0.5
  title "#{input('si_02_03_odp')} for taking corrective actions have been established."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('si_02_03_odp')} for taking corrective actions have been established.
  ...
  describe 'NIST SP 800-53A Rev 5 objective SI-02(03)(b)' do
