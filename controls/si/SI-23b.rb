control 'SI-23b.' do
  impact 0.5
  title "under #{input('si_23_odp_01')} , the fragmented information is distributed across #{input('si_23_odp_03')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      under #{input('si_23_odp_01')} , the fragmented information is distributed across #{input('si_23_odp_03')}.
  ...
  tag nist: ['SI-23']
  tag control: 'SI-23'
  tag objective: 'SI-23b.'
  tag rev: 'Rev_5'
  tag family: 'System and Information Integrity'
  tag baseline: %w{}
  tag control_si_23: true
  tag odp: %w{si_23_odp_01 si_23_odp_02 si_23_odp_03}

  describe 'NIST SP 800-53A Rev 5 objective SI-23b.' do
