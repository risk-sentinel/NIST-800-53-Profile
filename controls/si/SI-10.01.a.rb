control 'SI-10(01)(a)' do
  impact 0.5
  title "a manual override capability for the validation of #{input('si_10_odp')} is provided;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      a manual override capability for the validation of #{input('si_10_odp')} is provided;
  ...
  describe 'NIST SP 800-53A Rev 5 objective SI-10(01)(a)' do
