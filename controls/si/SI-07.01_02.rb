control 'SI-07(01)[02]' do
  impact 0.5
  title "an integrity check of #{input('si_07_01_odp_05')} is performed #{input('si_07_01_odp_06')};"
  desc <<~DESC
    Perform an integrity check of #{input('si_7_1_prm_1')} #{input('si_7_1_prm_2')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      an integrity check of #{input('si_07_01_odp_05')} is performed #{input('si_07_01_odp_06')};
  ...
  tag odp: %w{si_07_01_odp_05 si_07_01_odp_06 si_7_1_prm_1 si_7_1_prm_2}

  describe 'NIST SP 800-53A Rev 5 objective SI-07(01)[02]' do
