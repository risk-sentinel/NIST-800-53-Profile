control 'SI-04(01)[01]' do
  impact 0.5
  title "individual intrusion detection tools are connected to a system-wide intrusion detection system;"
  desc <<~DESC
  ...
  tag nist: ['SI-4 (1)']
  tag control: 'SI-4 (1)'
  tag objective: 'SI-04(01)[01]'
  tag rev: 'Rev_5'
  tag family: 'System and Information Integrity'
  tag baseline: %w{}
  tag control_si_4_1: true

  describe 'NIST SP 800-53A Rev 5 objective SI-04(01)[01]' do
