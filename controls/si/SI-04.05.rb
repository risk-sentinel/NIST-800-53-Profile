control 'SI-04(05)' do
  impact 0.5
  title "#{input('si_04_05_odp_01')} are alerted when system-generated #{input('si_04_05_odp_02')} occur."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('si_04_05_odp_01')} are alerted when system-generated #{input('si_04_05_odp_02')} occur.
  ...
  tag nist: ['SI-4 (5)']
  tag control: 'SI-4 (5)'
  tag objective: 'SI-04(05)'
  tag rev: 'Rev_5'
  tag family: 'System and Information Integrity'
  tag baseline: %w{MODERATE HIGH}
  tag baseline_moderate: true
  tag baseline_high: true
  tag control_si_4_5: true
  tag odp: %w{si_04_05_odp_01 si_04_05_odp_02}

  describe 'NIST SP 800-53A Rev 5 objective SI-04(05)' do
