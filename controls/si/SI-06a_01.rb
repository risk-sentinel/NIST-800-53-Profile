control 'SI-06a.[01]' do
  impact 0.5
  title "#{input('si_06_odp_01')} are verified to be operating correctly;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('si_06_odp_01')} are verified to be operating correctly;
  ...
  describe 'NIST SP 800-53A Rev 5 objective SI-06a.[01]' do
