control 'SI-02b.[03]' do
  impact 0.5
  title "firmware updates related to flaw remediation are tested for effectiveness before installation;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SI-02b.[03]' do
