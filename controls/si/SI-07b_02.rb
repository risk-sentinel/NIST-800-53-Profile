control 'SI-07b.[02]' do
  impact 0.5
  title "#{input('si_07_odp_05')} are taken when unauthorized changes to the firmware are detected;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('si_07_odp_05')} are taken when unauthorized changes to the firmware are detected;
  ...
  tag odp: %w{si_07_odp_05 si_7_prm_1 si_7_prm_2}

  describe 'NIST SP 800-53A Rev 5 objective SI-07b.[02]' do
