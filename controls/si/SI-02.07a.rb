control 'SI-02(07)a.' do
  impact 0.5
  title "Root cause analysis is conducted to identify underlying causes of issues or failures"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      Root cause analysis is conducted to identify underlying causes of issues or failures
  ...
  tag nist: ['SI-2 (7)']
  tag control: 'SI-2 (7)'
  tag objective: 'SI-02(07)a.'
  tag rev: 'Rev_5'
  tag family: 'System and Information Integrity'
  tag baseline: %w{}
  tag control_si_2_7: true

  describe 'NIST SP 800-53A Rev 5 objective SI-02(07)a.' do
