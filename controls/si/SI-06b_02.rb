control 'SI-06b.[02]' do
  impact 0.5
  title "#{input('si_06_odp_02')} are verified #{input('si_06_odp_03')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('si_06_odp_02')} are verified #{input('si_06_odp_03')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective SI-06b.[02]' do
