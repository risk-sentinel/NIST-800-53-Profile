control 'SI-04(11)[02]' do
  impact 0.5
  title "outbound communications traffic at #{input('si_04_11_odp')} is analyzed to discover anomalies."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      outbound communications traffic at #{input('si_04_11_odp')} is analyzed to discover anomalies.
  ...
  tag nist: ['SI-4 (11)']
  tag control: 'SI-4 (11)'
  tag objective: 'SI-04(11)[02]'
  tag rev: 'Rev_5'
  tag family: 'System and Information Integrity'
  tag baseline: %w{}
  tag control_si_4_11: true
  tag odp: %w{si_04_11_odp}

  describe 'NIST SP 800-53A Rev 5 objective SI-04(11)[02]' do
