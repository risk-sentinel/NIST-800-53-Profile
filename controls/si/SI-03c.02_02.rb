control 'SI-03c.02[02]' do
  impact 0.5
  title "malicious code protection mechanisms are configured to send alerts to #{input('si_03_odp_06')} in response to malicious code detection;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      malicious code protection mechanisms are configured to send alerts to #{input('si_03_odp_06')} in response to malicious code detection;
  ...
  describe 'NIST SP 800-53A Rev 5 objective SI-03c.02[02]' do
