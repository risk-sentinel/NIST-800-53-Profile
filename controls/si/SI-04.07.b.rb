control 'SI-04(07)(b)' do
  impact 0.5
  title "#{input('si_04_07_odp_02')} are taken upon the detection of suspicious events."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('si_04_07_odp_02')} are taken upon the detection of suspicious events.
  ...
  describe 'NIST SP 800-53A Rev 5 objective SI-04(07)(b)' do
