control 'SI-04(16)' do
  impact 0.5
  title "information from monitoring tools and mechanisms employed throughout the system is correlated."
  desc <<~DESC
  ...
  tag nist: ['SI-4 (16)']
  tag control: 'SI-4 (16)'
  tag objective: 'SI-04(16)'
  tag rev: 'Rev_5'
  tag family: 'System and Information Integrity'
  tag baseline: %w{}
  tag control_si_4_16: true

  describe 'NIST SP 800-53A Rev 5 objective SI-04(16)' do
