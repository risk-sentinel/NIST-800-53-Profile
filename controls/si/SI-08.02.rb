control 'SI-08(02)' do
  impact 0.5
  title "spam protection mechanisms are automatically updated #{input('si_08_02_odp')}."
  desc <<~DESC
    Automatically update spam protection mechanisms #{input('si_08_02_odp')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      spam protection mechanisms are automatically updated #{input('si_08_02_odp')}.
  ...
  tag nist: ['SI-8 (2)']
  tag control: 'SI-8 (2)'
  tag objective: 'SI-08(02)'
  tag rev: 'Rev_5'
  tag family: 'System and Information Integrity'
  tag baseline: %w{MODERATE HIGH}
  tag baseline_moderate: true
  tag baseline_high: true
  tag control_si_8_2: true
  tag odp: %w{si_08_02_odp}

  describe 'NIST SP 800-53A Rev 5 objective SI-08(02)' do
