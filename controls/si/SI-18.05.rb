control 'SI-18(05)' do
  impact 0.5
  title "#{input('si_18_05_odp')} and individuals are notified when the personally identifiable information has been corrected or deleted."
  desc <<~DESC
    Notify #{input('si_18_05_odp')} and individuals that the personally identifiable information has been corrected or deleted.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      #{input('si_18_05_odp')} and individuals are notified when the personally identifiable information has been corrected or deleted.
  ...
  tag nist: ['SI-18 (5)']
  tag control: 'SI-18 (5)'
  tag objective: 'SI-18(05)'
  tag rev: 'Rev_5'
  tag family: 'System and Information Integrity'
  tag baseline: %w{}
  tag control_si_18_5: true
  tag odp: %w{si_18_05_odp}

  describe 'NIST SP 800-53A Rev 5 objective SI-18(05)' do
