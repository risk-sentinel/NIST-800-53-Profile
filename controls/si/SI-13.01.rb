control 'SI-13(01)' do
  impact 0.5
  title "system components are taken out of service by transferring component responsibilities to substitute components no later than #{input('si_13_01_odp')} of mean time to failure."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      system components are taken out of service by transferring component responsibilities to substitute components no later than #{input('si_13_01_odp')} of mean time to failure.
  ...
  tag nist: ['SI-13 (1)']
  tag control: 'SI-13 (1)'
  tag objective: 'SI-13(01)'
  tag rev: 'Rev_5'
  tag family: 'System and Information Integrity'
  tag baseline: %w{}
  tag control_si_13_1: true
  tag odp: %w{si_13_01_odp}

  describe 'NIST SP 800-53A Rev 5 objective SI-13(01)' do
