control 'SI-04(25)[02]' do
  impact 0.5
  title "visibility into network traffic at key internal system interfaces is provided to optimize the effectiveness of monitoring devices."
  desc <<~DESC
  ...
  tag nist: ['SI-4 (25)']
  tag control: 'SI-4 (25)'
  tag objective: 'SI-04(25)[02]'
  tag rev: 'Rev_5'
  tag family: 'System and Information Integrity'
  tag baseline: %w{}
  tag control_si_4_25: true

  describe 'NIST SP 800-53A Rev 5 objective SI-04(25)[02]' do
