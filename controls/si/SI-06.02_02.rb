control 'SI-06(02)[02]' do
  impact 0.5
  title "automated mechanisms are implemented to support the management of distributed privacy function testing."
  desc <<~DESC
  ...
  tag nist: ['SI-6 (2)']
  tag control: 'SI-6 (2)'
  tag objective: 'SI-06(02)[02]'
  tag rev: 'Rev_5'
  tag family: 'System and Information Integrity'
  tag baseline: %w{}
  tag control_si_6_2: true

  describe 'NIST SP 800-53A Rev 5 objective SI-06(02)[02]' do
