control 'SI-18(03)' do
  impact 0.5
  title "personally identifiable information is collected directly from the individual."
  desc <<~DESC
  ...
  tag nist: ['SI-18 (3)']
  tag control: 'SI-18 (3)'
  tag objective: 'SI-18(03)'
  tag rev: 'Rev_5'
  tag family: 'System and Information Integrity'
  tag baseline: %w{}
  tag control_si_18_3: true

  describe 'NIST SP 800-53A Rev 5 objective SI-18(03)' do
