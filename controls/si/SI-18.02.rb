control 'SI-18(02)' do
  impact 0.5
  title "data tags are employed to automate the correction or deletion of personally identifiable information across the information life cycle within organizational systems."
  desc <<~DESC
  ...
  tag nist: ['SI-18 (2)']
  tag control: 'SI-18 (2)'
  tag objective: 'SI-18(02)'
  tag rev: 'Rev_5'
  tag family: 'System and Information Integrity'
  tag baseline: %w{}
  tag control_si_18_2: true

  describe 'NIST SP 800-53A Rev 5 objective SI-18(02)' do
