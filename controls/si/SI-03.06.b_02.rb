control 'SI-03(06)(b)[02]' do
  impact 0.5
  title "the associated incident reporting occurs."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SI-03(06)(b)[02]' do
