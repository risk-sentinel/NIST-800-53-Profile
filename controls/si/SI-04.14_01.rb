control 'SI-04(14)[01]' do
  impact 0.5
  title "a wireless intrusion detection system is employed to identify rogue wireless devices;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective SI-04(14)[01]' do
