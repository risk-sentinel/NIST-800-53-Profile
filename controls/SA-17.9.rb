control 'SA-17 (9)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SA-17(09) different designs are used for #{input('sa_17_09_odp')} to satisfy a common set of requirements or to provide equivalent functionality.
  ...
  describe 'NIST SP 800-53 Rev 5 control SA-17 (9)' do
