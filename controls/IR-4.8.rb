control 'IR-4 (8)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      IR-04(08) there is coordination with #{input('ir_04_08_odp_01')} to correlate and share #{input('ir_04_08_odp_02')} to achieve a cross-organization perspective on incident awareness and more effective incident responses.
  ...
  describe 'NIST SP 800-53 Rev 5 control IR-4 (8)' do
