control 'CA-8 (3)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      CA-08(03) the penetration testing process includes #{input('ca_08_03_odp_01')} #{input('ca_08_03_odp_02')} attempts to bypass or circumvent controls associated with physical access points to facility.
  ...
  describe 'NIST SP 800-53 Rev 5 control CA-8 (3)' do
