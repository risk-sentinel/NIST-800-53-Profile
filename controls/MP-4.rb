control 'MP-4' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      MP-04a.
        MP-04a.[01] #{input('mp_04_odp_01')} are physically controlled;
        MP-04a.[02] #{input('mp_04_odp_02')} are physically controlled;
        MP-04a.[03] #{input('mp_04_odp_03')} are securely stored within #{input('mp_04_odp_05')};
        MP-04a.[04] #{input('mp_04_odp_04')} are securely stored within #{input('mp_04_odp_06')};
  ...
  tag odp: %w{mp_04_odp_01 mp_04_odp_02 mp_04_odp_03 mp_04_odp_04 mp_04_odp_05 mp_04_odp_06 mp_4_prm_1 mp_4_prm_2}

  describe 'NIST SP 800-53 Rev 5 control MP-4' do
