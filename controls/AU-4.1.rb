control 'AU-4 (1)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      AU-04(01) audit logs are transferred #{input('au_04_01_odp')} to a different system, system component, or media other than the system or system component conducting the logging.
  ...
  describe 'NIST SP 800-53 Rev 5 control AU-4 (1)' do
