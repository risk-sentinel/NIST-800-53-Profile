control 'PE-20' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      PE-20 #{input('pe_20_odp_01')} are employed to track and monitor the location and movement of #{input('pe_20_odp_02')} within #{input('pe_20_odp_03')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control PE-20' do
