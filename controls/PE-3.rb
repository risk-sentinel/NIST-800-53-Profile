control 'PE-3' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      PE-03a.
        PE-03a.01 physical access authorizations are enforced at #{input('pe_03_odp_01')} by verifying individual access authorizations before granting access to the facility;
        PE-03a.02 physical access authorizations are enforced at #{input('pe_03_odp_01')} by controlling ingress and egress to the facility using #{input('pe_03_odp_02')};
      PE-03b. physical access audit logs are maintained for #{input('pe_03_odp_04')};
      PE-03c. access to areas within the facility designated as publicly accessible are maintained by implementing #{input('pe_03_odp_05')};
      PE-03d.
        PE-03d.[01] visitors are escorted;
        PE-03d.[02] visitor activity is controlled #{input('pe_03_odp_06')};
      PE-03e.
        PE-03e.[01] keys are secured;
        PE-03e.[02] combinations are secured;
        PE-03e.[03] other physical access devices are secured;
      PE-03f. #{input('pe_03_odp_07')} are inventoried #{input('pe_03_odp_08')};
      PE-03g.
        PE-03g.[01] combinations are changed #{input('pe_03_odp_09')} , when combinations are compromised, or when individuals possessing the combinations are transferred or terminated;
        PE-03g.[02] keys are changed #{input('pe_03_odp_10')} , when keys are lost, or when individuals possessing the keys are transferred or terminated.
  ...
  tag odp: %w{pe_03_odp_01 pe_03_odp_02 pe_03_odp_04 pe_03_odp_05 pe_03_odp_06 pe_03_odp_07 pe_03_odp_08 pe_03_odp_09 pe_03_odp_10 pe_3_prm_9}

  describe 'NIST SP 800-53 Rev 5 control PE-3' do
