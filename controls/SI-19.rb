control 'SI-19' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SI-19a. #{input('si_19_odp_01')} are removed from datasets;
      SI-19b. the effectiveness of de-identification is evaluated #{input('si_19_odp_02')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control SI-19' do
