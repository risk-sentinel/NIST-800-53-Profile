control 'SC-32' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SC-32 the system is partitioned into #{input('sc_32_odp_01')} residing in separate #{input('sc_32_odp_02')} domains or environments based on #{input('sc_32_odp_03')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control SC-32' do
