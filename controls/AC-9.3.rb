control 'AC-9 (3)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      AC-09(03) the user is notified, upon successful logon, of changes to #{input('ac_09_03_odp_01')} during #{input('ac_09_03_odp_02')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control AC-9 (3)' do
