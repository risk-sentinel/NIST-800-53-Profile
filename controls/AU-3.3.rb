control 'AU-3 (3)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      AU-03(03) personally identifiable information contained in audit records is limited to #{input('au_03_03_odp')} identified in the privacy risk assessment.
  ...
  describe 'NIST SP 800-53 Rev 5 control AU-3 (3)' do
