control 'CA-7' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      ...
      CA-07a. system-level continuous monitoring includes establishment of the following system-level metrics to be monitored: #{input('ca_07_odp_01')};
      CA-07b.
        CA-07b.[01] system-level continuous monitoring includes established #{input('ca_07_odp_02')} for monitoring;
        CA-07b.[02] system-level continuous monitoring includes established #{input('ca_07_odp_03')} for assessment of control effectiveness;
      ...
      CA-07g.
        CA-07g.[01] system-level continuous monitoring includes reporting the security status of the system to #{input('ca_07_odp_04')} #{input('ca_07_odp_05')};
        CA-07g.[02] system-level continuous monitoring includes reporting the privacy status of the system to #{input('ca_07_odp_06')} #{input('ca_07_odp_07')}.
  ...
  tag odp: %w{ca_07_odp_01 ca_07_odp_02 ca_07_odp_03 ca_07_odp_04 ca_07_odp_05 ca_07_odp_06 ca_07_odp_07 ca_7_prm_4 ca_7_prm_5}

  describe 'NIST SP 800-53 Rev 5 control CA-7' do
