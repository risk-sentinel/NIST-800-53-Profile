control 'CP-9 (3)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      CP-09(03) backup copies of #{input('cp_09_03_odp')} are stored in a separate facility or in a fire rated container that is not collocated with the operational system.
  ...
  describe 'NIST SP 800-53 Rev 5 control CP-9 (3)' do
