control 'SI-2 (6)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SI-02(06) previous versions of #{input('si_02_06_odp')} are removed after updated versions have been installed.
  ...
  describe 'NIST SP 800-53 Rev 5 control SI-2 (6)' do
