control 'SC-11' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SC-11a. a #{input('sc_11_odp_01')} isolated trusted communication path is provided for communications between the user and the trusted components of the system;
      SC-11b. users are permitted to invoke the trusted communication path for communications between the user and the #{input('sc_11_odp_02')} of the system, including authentication and re-authentication, at a minimum.
  ...
  describe 'NIST SP 800-53 Rev 5 control SC-11' do
