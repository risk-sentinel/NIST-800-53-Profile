control 'IA-5 (16)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      IA-05(16) the issuance of #{input('ia_05_16_odp_01')} is required to be conducted #{input('ia_05_16_odp_02')} before #{input('ia_05_16_odp_03')} with authorization by #{input('ia_05_16_odp_04')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control IA-5 (16)' do
