control 'PE-6 (3)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      PE-06(03)(a) video surveillance of #{input('pe_06_03_odp_01')} is employed;
      PE-06(03)(b) video recordings are reviewed #{input('pe_06_03_odp_02')};
      PE-06(03)(c) video recordings are retained for #{input('pe_06_03_odp_03')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control PE-6 (3)' do
