control 'AC-3 (10)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      AC-03(10) an audited override of automated access control mechanisms is employed under #{input('ac_03_10_odp_01')} by #{input('ac_03_10_odp_02')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control AC-3 (10)' do
