control 'PE-14a.' do
  impact 0.5
  title "#{input('pe_14_odp_01')} levels are maintained at #{input('pe_14_odp_03')} within the facility where the system resides;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('pe_14_odp_01')} levels are maintained at #{input('pe_14_odp_03')} within the facility where the system resides;
  ...
  describe 'NIST SP 800-53A Rev 5 objective PE-14a.' do
