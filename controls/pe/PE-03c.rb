control 'PE-03c.' do
  impact 0.5
  title "access to areas within the facility designated as publicly accessible are maintained by implementing #{input('pe_03_odp_05')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      access to areas within the facility designated as publicly accessible are maintained by implementing #{input('pe_03_odp_05')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective PE-03c.' do
