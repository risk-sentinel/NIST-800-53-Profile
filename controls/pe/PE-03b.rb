control 'PE-03b.' do
  impact 0.5
  title "physical access audit logs are maintained for #{input('pe_03_odp_04')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      physical access audit logs are maintained for #{input('pe_03_odp_04')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective PE-03b.' do
