control 'PE-10c.' do
  impact 0.5
  title "the emergency power shutoff capability is protected from unauthorized activation."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PE-10c.' do
