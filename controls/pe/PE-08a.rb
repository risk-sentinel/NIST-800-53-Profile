control 'PE-08a.' do
  impact 0.5
  title "visitor access records for the facility where the system resides are maintained for #{input('pe_08_odp_01')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      visitor access records for the facility where the system resides are maintained for #{input('pe_08_odp_01')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective PE-08a.' do
