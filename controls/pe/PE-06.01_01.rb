control 'PE-06(01)[01]' do
  impact 0.5
  title "physical access to the facility where the system resides is monitored using physical intrusion alarms;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PE-06(01)[01]' do
