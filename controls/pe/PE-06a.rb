control 'PE-06a.' do
  impact 0.5
  title "physical access to the facility where the system resides is monitored to detect and respond to physical security incidents;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PE-06a.' do
