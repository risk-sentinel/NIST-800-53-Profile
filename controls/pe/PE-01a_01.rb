control 'PE-01a.[01]' do
  impact 0.5
  title "a physical and environmental protection policy is developed and documented;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PE-01a.[01]' do
