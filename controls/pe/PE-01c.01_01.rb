control 'PE-01c.01[01]' do
  impact 0.5
  title "the current physical and environmental protection policy is reviewed and updated #{input('pe_01_odp_05')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the current physical and environmental protection policy is reviewed and updated #{input('pe_01_odp_05')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective PE-01c.01[01]' do
