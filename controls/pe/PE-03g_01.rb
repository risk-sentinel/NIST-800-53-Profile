control 'PE-03g.[01]' do
  impact 0.5
  title "combinations are changed #{input('pe_03_odp_09')} , when combinations are compromised, or when individuals possessing the combinations are transferred or terminated;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      combinations are changed #{input('pe_03_odp_09')} , when combinations are compromised, or when individuals possessing the combinations are transferred or terminated;
  ...
  tag odp: %w{pe_03_odp_01 pe_03_odp_02 pe_03_odp_04 pe_03_odp_05 pe_03_odp_06 pe_03_odp_07 pe_03_odp_08 pe_03_odp_09 pe_3_prm_9}

  describe 'NIST SP 800-53A Rev 5 objective PE-03g.[01]' do
