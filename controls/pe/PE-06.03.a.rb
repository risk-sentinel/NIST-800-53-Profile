control 'PE-06(03)(a)' do
  impact 0.5
  title "video surveillance of #{input('pe_06_03_odp_01')} is employed;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      video surveillance of #{input('pe_06_03_odp_01')} is employed;
  ...
  describe 'NIST SP 800-53A Rev 5 objective PE-06(03)(a)' do
