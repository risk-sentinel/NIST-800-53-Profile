control 'PE-13(04)[02]' do
  impact 0.5
  title "the identified deficiencies from fire protection inspections are resolved within #{input('pe_13_04_odp_02')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the identified deficiencies from fire protection inspections are resolved within #{input('pe_13_04_odp_02')}.
  ...
  describe 'NIST SP 800-53A Rev 5 objective PE-13(04)[02]' do
