control 'PE-17b.' do
  impact 0.5
  title "#{input('pe_17_odp_02')} are employed at alternate work sites;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('pe_17_odp_02')} are employed at alternate work sites;
  ...
  describe 'NIST SP 800-53A Rev 5 objective PE-17b.' do
