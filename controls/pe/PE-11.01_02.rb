control 'PE-11(01)[02]' do
  impact 0.5
  title "the alternate power supply provided for the system can maintain minimally required operational capability in the event of an extended loss of the primary power source."
  desc <<~DESC
  ...
  tag nist: ['PE-11 (1)']
  tag control: 'PE-11 (1)'
  tag objective: 'PE-11(01)[02]'
  tag rev: 'Rev_5'
  tag family: 'Physical and Environmental Protection'
  tag baseline: %w{HIGH}
  tag baseline_high: true
  tag control_pe_11_1: true
  tag odp: %w{pe_11_01_odp}

  describe 'NIST SP 800-53A Rev 5 objective PE-11(01)[02]' do
