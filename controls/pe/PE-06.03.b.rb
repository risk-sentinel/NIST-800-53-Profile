control 'PE-06(03)(b)' do
  impact 0.5
  title "video recordings are reviewed #{input('pe_06_03_odp_02')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      video recordings are reviewed #{input('pe_06_03_odp_02')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective PE-06(03)(b)' do
