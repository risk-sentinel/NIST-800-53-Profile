control 'PE-02a.[01]' do
  impact 0.5
  title "a list of individuals with authorized access to the facility where the system resides has been developed;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PE-02a.[01]' do
