control 'PE-01a.01(b)' do
  impact 0.5
  title "the #{input('pe_01_odp_03')} physical and environmental protection policy is consistent with applicable laws, Executive Orders, directives, regulations, policies, standards, and guidelines;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the #{input('pe_01_odp_03')} physical and environmental protection policy is consistent with applicable laws, Executive Orders, directives, regulations, policies, standards, and guidelines;
  ...
  describe 'NIST SP 800-53A Rev 5 objective PE-01a.01(b)' do
