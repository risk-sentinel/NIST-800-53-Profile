control 'PE-03(01)[01]' do
  impact 0.5
  title "physical access authorizations to the system are enforced;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PE-03(01)[01]' do
