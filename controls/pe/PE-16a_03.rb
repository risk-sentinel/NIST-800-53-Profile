control 'PE-16a.[03]' do
  impact 0.5
  title "#{input('pe_16_odp_02')} are authorized when exiting the facility;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('pe_16_odp_02')} are authorized when exiting the facility;
  ...
  describe 'NIST SP 800-53A Rev 5 objective PE-16a.[03]' do
