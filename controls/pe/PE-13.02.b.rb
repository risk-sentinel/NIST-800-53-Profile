control 'PE-13(02)(b)' do
  impact 0.5
  title "an automatic fire suppression capability is employed when the facility is not staffed on a continuous basis."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PE-13(02)(b)' do
