control 'PE-02c.' do
  impact 0.5
  title "the access list detailing authorized facility access by individuals is reviewed #{input('pe_02_odp')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the access list detailing authorized facility access by individuals is reviewed #{input('pe_02_odp')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective PE-02c.' do
