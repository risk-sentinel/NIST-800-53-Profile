control 'PE-06b.[02]' do
  impact 0.5
  title "physical access logs are reviewed upon occurrence of #{input('pe_06_odp_02')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      physical access logs are reviewed upon occurrence of #{input('pe_06_odp_02')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective PE-06b.[02]' do
