control 'PE-10a.' do
  impact 0.5
  title "the capability to shut off power to #{input('pe_10_odp_01')} in emergency situations is provided;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the capability to shut off power to #{input('pe_10_odp_01')} in emergency situations is provided;
  ...
  describe 'NIST SP 800-53A Rev 5 objective PE-10a.' do
