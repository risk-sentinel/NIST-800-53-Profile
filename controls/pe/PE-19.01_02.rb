control 'PE-19(01)[02]' do
  impact 0.5
  title "associated data communications are protected in accordance with national emissions security policies and procedures based on the security category or classification of the information;"
  desc <<~DESC
  ...
  tag nist: ['PE-19 (1)']
  tag control: 'PE-19 (1)'
  tag objective: 'PE-19(01)[02]'
  tag rev: 'Rev_5'
  tag family: 'Physical and Environmental Protection'
  tag baseline: %w{}
  tag control_pe_19_1: true

  describe 'NIST SP 800-53A Rev 5 objective PE-19(01)[02]' do
