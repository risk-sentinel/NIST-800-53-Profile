control 'PE-13(01)[02]' do
  impact 0.5
  title "fire detection systems that notify #{input('pe_13_01_odp_01')} automatically are employed in the event of a fire;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      fire detection systems that notify #{input('pe_13_01_odp_01')} automatically are employed in the event of a fire;
  ...
  describe 'NIST SP 800-53A Rev 5 objective PE-13(01)[02]' do
