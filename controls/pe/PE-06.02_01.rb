control 'PE-06(02)[01]' do
  impact 0.5
  title "#{input('pe_06_02_odp_01')} are recognized;"
  desc <<~DESC
    Recognize #{input('pe_06_02_odp_01')} and initiate #{input('pe_06_02_odp_02')} using #{input('pe_06_02_odp_03')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      #{input('pe_06_02_odp_01')} are recognized;
  ...
  describe 'NIST SP 800-53A Rev 5 objective PE-06(02)[01]' do
