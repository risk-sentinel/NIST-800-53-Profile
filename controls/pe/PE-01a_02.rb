control 'PE-01a.[02]' do
  impact 0.5
  title "the physical and environmental protection policy is disseminated to #{input('pe_01_odp_01')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the physical and environmental protection policy is disseminated to #{input('pe_01_odp_01')};
  ...
  tag odp: %w{pe_01_odp_01 pe_01_odp_03 pe_01_odp_04 pe_01_odp_05 pe_01_odp_06 pe_01_odp_07 pe_01_odp_08 pe_1_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective PE-01a.[02]' do
