control 'PE-12[02]' do
  impact 0.5
  title "automatic emergency lighting that activates in the event of a power outage or disruption is maintained for the system;"
  desc <<~DESC
  ...
  tag control_pe_12: true

  describe 'NIST SP 800-53A Rev 5 objective PE-12[02]' do
