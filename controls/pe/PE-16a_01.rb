control 'PE-16a.[01]' do
  impact 0.5
  title "#{input('pe_16_odp_01')} are authorized when entering the facility;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('pe_16_odp_01')} are authorized when entering the facility;
  ...
  tag odp: %w{pe_16_odp_01 pe_16_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective PE-16a.[01]' do
