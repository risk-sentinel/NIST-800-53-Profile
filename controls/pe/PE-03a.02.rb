control 'PE-03a.02' do
  impact 0.5
  title "physical access authorizations are enforced at #{input('pe_03_odp_01')} by controlling ingress and egress to the facility using #{input('pe_03_odp_02')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      physical access authorizations are enforced at #{input('pe_03_odp_01')} by controlling ingress and egress to the facility using #{input('pe_03_odp_02')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective PE-03a.02' do
