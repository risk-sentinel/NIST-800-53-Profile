control 'PE-06c.[01]' do
  impact 0.5
  title "results of reviews are coordinated with organizational incident response capabilities;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PE-06c.[01]' do
