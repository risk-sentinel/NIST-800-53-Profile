control 'PE-13(02)(a)[02]' do
  impact 0.5
  title "fire suppression systems that notify #{input('pe_13_02_odp_01')} automatically are employed;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      fire suppression systems that notify #{input('pe_13_02_odp_01')} automatically are employed;
  ...
  describe 'NIST SP 800-53A Rev 5 objective PE-13(02)(a)[02]' do
