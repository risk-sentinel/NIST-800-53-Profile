control 'PE-12(01)' do
  impact 0.5
  title "emergency lighting is provided for all areas within the facility supporting essential mission and business functions."
  desc <<~DESC
  ...
  tag nist: ['PE-12 (1)']
  tag control: 'PE-12 (1)'
  tag objective: 'PE-12(01)'
  tag rev: 'Rev_5'
  tag family: 'Physical and Environmental Protection'
  tag baseline: %w{}
  tag control_pe_12_1: true

  describe 'NIST SP 800-53A Rev 5 objective PE-12(01)' do
