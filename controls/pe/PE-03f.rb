control 'PE-03f.' do
  impact 0.5
  title "#{input('pe_03_odp_07')} are inventoried #{input('pe_03_odp_08')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('pe_03_odp_07')} are inventoried #{input('pe_03_odp_08')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective PE-03f.' do
