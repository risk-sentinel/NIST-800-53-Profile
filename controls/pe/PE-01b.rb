control 'PE-01b.' do
  impact 0.5
  title "the #{input('pe_01_odp_04')} is designated to manage the development, documentation, and dissemination of the physical and environmental protection policy and procedures;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the #{input('pe_01_odp_04')} is designated to manage the development, documentation, and dissemination of the physical and environmental protection policy and procedures;
  ...
  describe 'NIST SP 800-53A Rev 5 objective PE-01b.' do
