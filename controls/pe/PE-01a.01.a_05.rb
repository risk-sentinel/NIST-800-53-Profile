control 'PE-01a.01(a)[05]' do
  impact 0.5
  title "the #{input('pe_01_odp_03')} physical and environmental protection policy addresses management commitment;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the #{input('pe_01_odp_03')} physical and environmental protection policy addresses management commitment;
  ...
  describe 'NIST SP 800-53A Rev 5 objective PE-01a.01(a)[05]' do
