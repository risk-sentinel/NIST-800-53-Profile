control 'PE-15(01)[02]' do
  impact 0.5
  title "#{input('pe_15_01_odp_01')} is/are alerted using #{input('pe_15_01_odp_02')}."
  desc <<~DESC
    Detect the presence of water near the system and alert #{input('pe_15_01_odp_01')} using #{input('pe_15_01_odp_02')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      #{input('pe_15_01_odp_01')} is/are alerted using #{input('pe_15_01_odp_02')}.
  ...
  describe 'NIST SP 800-53A Rev 5 objective PE-15(01)[02]' do
