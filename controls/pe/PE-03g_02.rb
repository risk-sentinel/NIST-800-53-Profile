control 'PE-03g.[02]' do
  impact 0.5
  title "keys are changed #{input('pe_03_odp_10')} , when keys are lost, or when individuals possessing the keys are transferred or terminated."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      keys are changed #{input('pe_03_odp_10')} , when keys are lost, or when individuals possessing the keys are transferred or terminated.
  ...
  tag odp: %w{pe_03_odp_01 pe_03_odp_02 pe_03_odp_04 pe_03_odp_05 pe_03_odp_06 pe_03_odp_07 pe_03_odp_08 pe_03_odp_10 pe_3_prm_9}

  describe 'NIST SP 800-53A Rev 5 objective PE-03g.[02]' do
