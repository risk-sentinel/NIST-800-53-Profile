control 'PE-11(02)(a)' do
  impact 0.5
  title "the alternate power supply provided for the system is self-contained;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PE-11(02)(a)' do
