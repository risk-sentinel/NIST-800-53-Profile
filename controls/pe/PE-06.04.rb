control 'PE-06(04)' do
  impact 0.5
  title "physical access to the system is monitored in addition to the physical access monitoring of the facility at #{input('pe_06_04_odp')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      physical access to the system is monitored in addition to the physical access monitoring of the facility at #{input('pe_06_04_odp')}.
  ...
  tag nist: ['PE-6 (4)']
  tag control: 'PE-6 (4)'
  tag objective: 'PE-06(04)'
  tag rev: 'Rev_5'
  tag family: 'Physical and Environmental Protection'
  tag baseline: %w{HIGH}
  tag baseline_high: true
  tag control_pe_6_4: true
  tag odp: %w{pe_06_04_odp}

  describe 'NIST SP 800-53A Rev 5 objective PE-06(04)' do
