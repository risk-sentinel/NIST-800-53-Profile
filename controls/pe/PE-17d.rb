control 'PE-17d.' do
  impact 0.5
  title "a means for employees to communicate with information security and privacy personnel in case of incidents is provided."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PE-17d.' do
