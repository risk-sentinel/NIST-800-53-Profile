control 'PE-23a.' do
  impact 0.5
  title "the location or site of the facility where the system resides is planned considering physical and environmental hazards;"
  desc <<~DESC
  ...
  tag nist: ['PE-23']
  tag control: 'PE-23'
  tag objective: 'PE-23a.'
  tag rev: 'Rev_5'
  tag family: 'Physical and Environmental Protection'
  tag baseline: %w{}
  tag control_pe_23: true

  describe 'NIST SP 800-53A Rev 5 objective PE-23a.' do
