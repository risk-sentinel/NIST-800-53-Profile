control 'PE-12[03]' do
  impact 0.5
  title "automatic emergency lighting for the system covers emergency exits within the facility;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PE-12[03]' do
