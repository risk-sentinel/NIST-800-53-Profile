control 'PE-14(02)[01]' do
  impact 0.5
  title "environmental control monitoring is employed;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PE-14(02)[01]' do
