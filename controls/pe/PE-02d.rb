control 'PE-02d.' do
  impact 0.5
  title "individuals are removed from the facility access list when access is no longer required."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PE-02d.' do
