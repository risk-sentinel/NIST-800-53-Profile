control 'PE-15[01]' do
  impact 0.5
  title "the system is protected from damage resulting from water leakage by providing master shutoff or isolation valves;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PE-15[01]' do
