control 'PE-11(02)(b)' do
  impact 0.5
  title "the alternate power supply provided for the system is not reliant on external power generation;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PE-11(02)(b)' do
