control 'PE-03a.01' do
  impact 0.5
  title "physical access authorizations are enforced at #{input('pe_03_odp_01')} by verifying individual access authorizations before granting access to the facility;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      physical access authorizations are enforced at #{input('pe_03_odp_01')} by verifying individual access authorizations before granting access to the facility;
  ...
  describe 'NIST SP 800-53A Rev 5 objective PE-03a.01' do
