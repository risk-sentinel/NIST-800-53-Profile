control 'PE-13(04)[01]' do
  impact 0.5
  title "the facility undergoes fire protection inspections #{input('pe_13_04_odp_01')} by authorized and qualified inspectors;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the facility undergoes fire protection inspections #{input('pe_13_04_odp_01')} by authorized and qualified inspectors;
  ...
  tag nist: ['PE-13 (4)']
  tag control: 'PE-13 (4)'
  tag objective: 'PE-13(04)[01]'
  tag rev: 'Rev_5'
  tag family: 'Physical and Environmental Protection'
  tag baseline: %w{}
  tag control_pe_13_4: true
  tag odp: %w{pe_13_04_odp_01 pe_13_04_odp_02}

  describe 'NIST SP 800-53A Rev 5 objective PE-13(04)[01]' do
