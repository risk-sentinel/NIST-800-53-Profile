control 'PE-01c.02[02]' do
  impact 0.5
  title "the current physical and environmental protection procedures are reviewed and updated following #{input('pe_01_odp_08')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the current physical and environmental protection procedures are reviewed and updated following #{input('pe_01_odp_08')}.
  ...
  describe 'NIST SP 800-53A Rev 5 objective PE-01c.02[02]' do
