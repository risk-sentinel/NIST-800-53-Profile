control 'PE-16a.[04]' do
  impact 0.5
  title "#{input('pe_16_odp_02')} are controlled when exiting the facility;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('pe_16_odp_02')} are controlled when exiting the facility;
  ...
  tag odp: %w{pe_16_odp_02 pe_16_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective PE-16a.[04]' do
