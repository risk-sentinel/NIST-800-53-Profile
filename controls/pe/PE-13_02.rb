control 'PE-13[02]' do
  impact 0.5
  title "employed fire detection systems are supported by an independent energy source;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PE-13[02]' do
