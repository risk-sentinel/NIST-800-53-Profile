control 'PE-03d.[02]' do
  impact 0.5
  title "visitor activity is controlled #{input('pe_03_odp_06')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      visitor activity is controlled #{input('pe_03_odp_06')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective PE-03d.[02]' do
