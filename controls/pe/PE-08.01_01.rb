control 'PE-08(01)[01]' do
  impact 0.5
  title "visitor access records are maintained using #{input('pe_08_01_odp_01')};"
  desc <<~DESC
    Maintain and review visitor access records using #{input('pe_8_1_prm_1')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      visitor access records are maintained using #{input('pe_08_01_odp_01')};
  ...
  tag nist: ['PE-8 (1)']
  tag control: 'PE-8 (1)'
  tag objective: 'PE-08(01)[01]'
  tag rev: 'Rev_5'
  tag family: 'Physical and Environmental Protection'
  tag baseline: %w{HIGH}
  tag baseline_high: true
  tag control_pe_8_1: true
  tag odp: %w{pe_08_01_odp_01 pe_8_1_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective PE-08(01)[01]' do
