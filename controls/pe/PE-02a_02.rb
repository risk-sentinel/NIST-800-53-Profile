control 'PE-02a.[02]' do
  impact 0.5
  title "the list of individuals with authorized access to the facility where the system resides has been approved;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PE-02a.[02]' do
