control 'PE-11(01)[01]' do
  impact 0.5
  title "an alternate power supply provided for the system is activated #{input('pe_11_01_odp')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      an alternate power supply provided for the system is activated #{input('pe_11_01_odp')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective PE-11(01)[01]' do
