control 'PE-08b.' do
  impact 0.5
  title "visitor access records are reviewed #{input('pe_08_odp_02')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      visitor access records are reviewed #{input('pe_08_odp_02')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective PE-08b.' do
