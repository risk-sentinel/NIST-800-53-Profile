control 'MP-8' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      MP-08a.
        MP-08a.[01] a #{input('mp_08_odp_01')} is established;
        MP-08a.[02] the #{input('mp_08_odp_01')} includes employing downgrading mechanisms with strength and integrity commensurate with the security category or classification of the information;
      MP-08b.
      ...
      MP-08c. #{input('mp_08_odp_02')} is identified;
      MP-08d. the identified system media is downgraded using the #{input('mp_08_odp_01')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control MP-8' do
