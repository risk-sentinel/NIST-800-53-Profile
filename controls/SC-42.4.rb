control 'SC-42 (4)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SC-42(04) #{input('sc_42_04_odp_01')} are employed to facilitate an individual’s awareness that personally identifiable information is being collected by #{input('sc_42_04_odp_02')}
  ...
  describe 'NIST SP 800-53 Rev 5 control SC-42 (4)' do
