control 'CM-2' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      ...
      CM-02b.
        CM-02b.01 the baseline configuration of the system is reviewed and updated #{input('cm_02_odp_01')};
        CM-02b.02 the baseline configuration of the system is reviewed and updated when required due to #{input('cm_02_odp_02')};
  ...
  describe 'NIST SP 800-53 Rev 5 control CM-2' do
