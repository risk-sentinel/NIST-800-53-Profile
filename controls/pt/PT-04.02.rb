control 'PT-04(02)' do
  impact 0.5
  title "#{input('pt_04_02_odp_01')} are presented to individuals #{input('pt_04_02_odp_02')} and in conjunction with #{input('pt_04_02_odp_03')}."
  desc <<~DESC
    Present #{input('pt_04_02_odp_01')} to individuals at #{input('pt_04_02_odp_02')} and in conjunction with #{input('pt_04_02_odp_03')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      #{input('pt_04_02_odp_01')} are presented to individuals #{input('pt_04_02_odp_02')} and in conjunction with #{input('pt_04_02_odp_03')}.
