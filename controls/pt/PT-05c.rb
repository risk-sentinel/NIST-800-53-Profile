control 'PT-05c.' do
  impact 0.5
  title "a notice to individuals about the processing of personally identifiable information that identifies the authority that authorizes the processing of personally identifiable information is provided;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PT-05c.' do
