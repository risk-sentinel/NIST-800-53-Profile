control 'PT-06(02)[02]' do
  impact 0.5
  title "all Privacy Act exemptions claimed for the system of records are reviewed #{input('pt_06_02_odp')} to ensure that they have been promulgated as regulations;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      all Privacy Act exemptions claimed for the system of records are reviewed #{input('pt_06_02_odp')} to ensure that they have been promulgated as regulations;
  ...
  describe 'NIST SP 800-53A Rev 5 objective PT-06(02)[02]' do
