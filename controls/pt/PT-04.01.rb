control 'PT-04(01)' do
  impact 0.5
  title "#{input('pt_04_01_odp')} are provided to allow individuals to tailor processing permissions to selected elements of personally identifiable information."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('pt_04_01_odp')} are provided to allow individuals to tailor processing permissions to selected elements of personally identifiable information.
  ...
  tag nist: ['PT-4 (1)']
  tag control: 'PT-4 (1)'
  tag objective: 'PT-04(01)'
  tag rev: 'Rev_5'
  tag family: 'Personally Identifiable Information Processing and Transparency'
  tag baseline: %w{}
  tag control_pt_4_1: true
  tag odp: %w{pt_04_01_odp}

  describe 'NIST SP 800-53A Rev 5 objective PT-04(01)' do
