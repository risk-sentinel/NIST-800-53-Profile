control 'PT-01a.01(a)[07]' do
  impact 0.5
  title "the #{input('pt_01_odp_03')} personally identifiable information processing and transparency policy addresses compliance;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the #{input('pt_01_odp_03')} personally identifiable information processing and transparency policy addresses compliance;
  ...
  describe 'NIST SP 800-53A Rev 5 objective PT-01a.01(a)[07]' do
