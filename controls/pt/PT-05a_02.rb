control 'PT-05a.[02]' do
  impact 0.5
  title "a notice to individuals about the processing of personally identifiable information is provided such that the notice is subsequently available to individuals #{input('pt_05_odp_01')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      a notice to individuals about the processing of personally identifiable information is provided such that the notice is subsequently available to individuals #{input('pt_05_odp_01')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective PT-05a.[02]' do
