control 'PT-02(02)' do
  impact 0.5
  title "enforcement of the authorized processing of personally identifiable information is managed using #{input('pt_02_02_odp')}."
  desc <<~DESC
    Manage enforcement of the authorized processing of personally identifiable information using #{input('pt_02_02_odp')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      enforcement of the authorized processing of personally identifiable information is managed using #{input('pt_02_02_odp')}.
  ...
  tag nist: ['PT-2 (2)']
  tag control: 'PT-2 (2)'
  tag objective: 'PT-02(02)'
  tag rev: 'Rev_5'
  tag family: 'Personally Identifiable Information Processing and Transparency'
  tag baseline: %w{}
  tag control_pt_2_2: true
  tag odp: %w{pt_02_02_odp}

  describe 'NIST SP 800-53A Rev 5 objective PT-02(02)' do
