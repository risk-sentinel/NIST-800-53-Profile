control 'PT-03d.[01]' do
  impact 0.5
  title "changes in the processing of personally identifiable information are monitored;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PT-03d.[01]' do
