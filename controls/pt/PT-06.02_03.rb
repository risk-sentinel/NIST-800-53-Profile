control 'PT-06(02)[03]' do
  impact 0.5
  title "all Privacy Act exemptions claimed for the system of records are reviewed #{input('pt_06_02_odp')} to ensure that they are accurately described in the system of records notice."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      all Privacy Act exemptions claimed for the system of records are reviewed #{input('pt_06_02_odp')} to ensure that they are accurately described in the system of records notice.
  ...
  describe 'NIST SP 800-53A Rev 5 objective PT-06(02)[03]' do
