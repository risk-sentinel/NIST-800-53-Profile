control 'PT-07(01)(c)[01]' do
  impact 0.5
  title "when a system processes Social Security numbers, any individual who is asked to disclose their Social Security number is informed whether that disclosure is mandatory or voluntary, by what statutory or other authority such number is solicited, and what uses will be made of it;"
  desc <<~DESC
  ...
  tag nist: ['PT-7 (1)']
  tag control: 'PT-7 (1)'
  tag objective: 'PT-07(01)(c)[01]'
  tag rev: 'Rev_5'
  tag family: 'Personally Identifiable Information Processing and Transparency'
  tag baseline: %w{PRIVACY}
  tag baseline_privacy: true
  tag control_pt_7_1: true

  describe 'NIST SP 800-53A Rev 5 objective PT-07(01)(c)[01]' do
