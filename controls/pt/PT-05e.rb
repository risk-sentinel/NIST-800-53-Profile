control 'PT-05e.' do
  impact 0.5
  title "a notice to individuals about the processing of personally identifiable information which includes #{input('pt_05_odp_02')} is provided."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      a notice to individuals about the processing of personally identifiable information which includes #{input('pt_05_odp_02')} is provided.
  ...
  describe 'NIST SP 800-53A Rev 5 objective PT-05e.' do
