control 'PT-01a.[01]' do
  impact 0.5
  title "a personally identifiable information processing and transparency policy is developed and documented;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PT-01a.[01]' do
