control 'PT-06c.' do
  impact 0.5
  title "system of records notices are kept accurate, up-to-date, and scoped in accordance with policy for systems that process information that will be maintained in a Privacy Act system of records."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PT-06c.' do
