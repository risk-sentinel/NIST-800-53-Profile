control 'PT-01a.01(a)[01]' do
  impact 0.5
  title "the #{input('pt_01_odp_03')} personally identifiable information processing and transparency policy addresses purpose;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the #{input('pt_01_odp_03')} personally identifiable information processing and transparency policy addresses purpose;
  ...
  describe 'NIST SP 800-53A Rev 5 objective PT-01a.01(a)[01]' do
