control 'PT-08b.[01]' do
  impact 0.5
  title "a computer matching agreement is developed when a system or organization processes information for the purpose of conducting a matching program;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PT-08b.[01]' do
