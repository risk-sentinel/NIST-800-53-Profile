control 'PT-08d.' do
  impact 0.5
  title "the information produced by the matching program is independently verified before taking adverse action against an individual, if required, when a system or organization processes information for the purpose of conducting a matching program;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PT-08d.' do
