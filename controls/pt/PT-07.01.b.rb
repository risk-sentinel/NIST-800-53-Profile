control 'PT-07(01)(b)' do
  impact 0.5
  title "when a system processes Social Security numbers, individual rights, benefits, or privileges provided by law are not denied because of an individual’s refusal to disclose their Social Security number;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PT-07(01)(b)' do
