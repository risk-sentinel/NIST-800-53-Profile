control 'PT-01c.01[02]' do
  impact 0.5
  title "the current personally identifiable information processing and transparency policy is reviewed and updated following #{input('pt_01_odp_06')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the current personally identifiable information processing and transparency policy is reviewed and updated following #{input('pt_01_odp_06')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective PT-01c.01[02]' do
