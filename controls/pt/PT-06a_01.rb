control 'PT-06a.[01]' do
  impact 0.5
  title "system of records notices are drafted in accordance with OMB guidance for systems that process information that will be maintained in a Privacy Act system of records;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PT-06a.[01]' do
