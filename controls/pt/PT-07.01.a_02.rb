control 'PT-07(01)(a)[02]' do
  impact 0.5
  title "when a system processes Social Security numbers, alternatives to the use of Social Security Numbers as a personal identifier are explored;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PT-07(01)(a)[02]' do
