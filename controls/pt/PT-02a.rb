control 'PT-02a.' do
  impact 0.5
  title "the #{input('pt_02_odp_01')} that permits the #{input('pt_02_odp_02')} of personally identifiable information is determined and documented;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the #{input('pt_02_odp_01')} that permits the #{input('pt_02_odp_02')} of personally identifiable information is determined and documented;
