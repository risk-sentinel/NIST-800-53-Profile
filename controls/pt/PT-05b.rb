control 'PT-05b.' do
  impact 0.5
  title "a notice to individuals about the processing of personally identifiable information is provided that is clear, easy-to-understand, and expresses information about personally identifiable information processing in plain language;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PT-05b.' do
