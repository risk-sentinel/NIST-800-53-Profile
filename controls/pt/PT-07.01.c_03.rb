control 'PT-07(01)(c)[03]' do
  impact 0.5
  title "when a system processes Social Security numbers, any individual who is asked to disclose their Social Security number is informed what uses will be made of it."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PT-07(01)(c)[03]' do
