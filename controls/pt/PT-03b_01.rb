control 'PT-03b.[01]' do
  impact 0.5
  title "the purpose(s) is/are described in the public privacy notices of the organization;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PT-03b.[01]' do
