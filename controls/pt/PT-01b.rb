control 'PT-01b.' do
  impact 0.5
  title "the #{input('pt_01_odp_04')} is designated to manage the development, documentation, and dissemination of the personally identifiable information processing and transparency policy and procedures;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the #{input('pt_01_odp_04')} is designated to manage the development, documentation, and dissemination of the personally identifiable information processing and transparency policy and procedures;
  ...
  describe 'NIST SP 800-53A Rev 5 objective PT-01b.' do
