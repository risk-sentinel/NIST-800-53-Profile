control 'PT-01a.[04]' do
  impact 0.5
  title "the personally identifiable information processing and transparency procedures are disseminated to #{input('pt_01_odp_02')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the personally identifiable information processing and transparency procedures are disseminated to #{input('pt_01_odp_02')};
  ...
  tag odp: %w{pt_01_odp_02 pt_01_odp_03 pt_01_odp_04 pt_01_odp_05 pt_01_odp_06 pt_01_odp_07 pt_01_odp_08 pt_1_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective PT-01a.[04]' do
