control 'PT-03d.[02]' do
  impact 0.5
  title "#{input('pt_03_odp_03')} are implemented to ensure that any changes are made in accordance with #{input('pt_03_odp_04')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('pt_03_odp_03')} are implemented to ensure that any changes are made in accordance with #{input('pt_03_odp_04')}.
  ...
  describe 'NIST SP 800-53A Rev 5 objective PT-03d.[02]' do
