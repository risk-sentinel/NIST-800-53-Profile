control 'PT-07(01)(a)[01]' do
  impact 0.5
  title "when a system processes Social Security numbers, the unnecessary collection, maintenance, and use of Social Security numbers are eliminated;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PT-07(01)(a)[01]' do
