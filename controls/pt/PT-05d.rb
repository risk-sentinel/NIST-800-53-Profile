control 'PT-05d.' do
  impact 0.5
  title "a notice to individuals about the processing of personally identifiable information that identifies the purpose for which personally identifiable information is to be processed is provided;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PT-05d.' do
