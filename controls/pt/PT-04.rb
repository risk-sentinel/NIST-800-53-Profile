control 'PT-04' do
  impact 0.5
  title "the #{input('pt_04_odp')} are implemented for individuals to consent to the processing of their personally identifiable information prior to its collection that facilitate individuals’ informed decision-making."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the #{input('pt_04_odp')} are implemented for individuals to consent to the processing of their personally identifiable information prior to its collection that facilitate individuals’ informed decision-making.
  ...
  tag control_pt_4: true
  tag odp: %w{pt_04_odp}

  describe 'NIST SP 800-53A Rev 5 objective PT-04' do
