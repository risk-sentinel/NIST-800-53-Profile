control 'PT-02b.' do
  impact 0.5
  title "the #{input('pt_02_odp_03')} of personally identifiable information is restricted to only that which is authorized."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the #{input('pt_02_odp_03')} of personally identifiable information is restricted to only that which is authorized.
  ...
  describe 'NIST SP 800-53A Rev 5 objective PT-02b.' do
