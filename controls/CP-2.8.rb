control 'CP-2 (8)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      CP-02(08) critical system assets supporting #{input('cp_02_08_odp')} mission and business functions are identified.
  ...
  describe 'NIST SP 800-53 Rev 5 control CP-2 (8)' do
