control 'AT-3' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      AT-03a.
        AT-03a.01
          AT-03a.01[01] role-based security training is provided to #{input('at_03_odp_01')} before authorizing access to the system, information, or performing assigned duties;
          AT-03a.01[02] role-based privacy training is provided to #{input('at_03_odp_02')} before authorizing access to the system, information, or performing assigned duties;
          AT-03a.01[03] role-based security training is provided to #{input('at_03_odp_01')} #{input('at_03_odp_03')} thereafter;
          AT-03a.01[04] role-based privacy training is provided to #{input('at_03_odp_02')} #{input('at_03_odp_03')} thereafter;
        AT-03a.02
      ...
      AT-03b.
        AT-03b.[01] role-based training content is updated #{input('at_03_odp_04')};
        AT-03b.[02] role-based training content is updated following #{input('at_03_odp_05')};
  ...
  tag odp: %w{at_03_odp_01 at_03_odp_02 at_03_odp_03 at_03_odp_04 at_03_odp_05 at_3_prm_1}

  describe 'NIST SP 800-53 Rev 5 control AT-3' do
