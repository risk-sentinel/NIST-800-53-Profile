control 'MA-4 (6)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      MA-04(06)[01] #{input('ma_04_06_odp')} are implemented to protect the integrity of nonlocal maintenance and diagnostic communications;
      MA-04(06)[02] #{input('ma_04_06_odp')} are implemented to protect the confidentiality of nonlocal maintenance and diagnostic communications.
  ...
  describe 'NIST SP 800-53 Rev 5 control MA-4 (6)' do
