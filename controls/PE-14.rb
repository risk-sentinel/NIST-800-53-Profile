control 'PE-14' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      PE-14a. #{input('pe_14_odp_01')} levels are maintained at #{input('pe_14_odp_03')} within the facility where the system resides;
      PE-14b. environmental control levels are monitored #{input('pe_14_odp_04')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control PE-14' do
