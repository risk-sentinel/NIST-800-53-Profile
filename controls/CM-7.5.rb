control 'CM-7 (5)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      CM-07(05)(a) #{input('cm_07_05_odp_01')} are identified;
      ...
      CM-07(05)(c) the list of authorized software programs is reviewed and updated #{input('cm_07_05_odp_02')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control CM-7 (5)' do
