control 'SR-3' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SR-03a.
        SR-03a.[01] a process or processes is/are established to identify and address weaknesses or deficiencies in the supply chain elements and processes of #{input('sr_03_odp_01')};
        SR-03a.[02] the process or processes to identify and address weaknesses or deficiencies in the supply chain elements and processes of #{input('sr_03_odp_01')} is/are coordinated with #{input('sr_03_odp_02')};
      SR-03b. #{input('sr_03_odp_03')} are employed to protect against supply chain risks to the system, system component, or system service and to limit the harm or consequences from supply chain-related events;
      SR-03c. the selected and implemented supply chain processes and controls are documented in #{input('sr_03_odp_04')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control SR-3' do
