control 'MA-5 (1)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      ...
      MA-05(01)(b) #{input('ma_05_01_odp')} are developed and implemented in the event that a system cannot be sanitized, removed, or disconnected from the system.
  ...
  describe 'NIST SP 800-53 Rev 5 control MA-5 (1)' do
