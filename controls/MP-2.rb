control 'MP-2' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      MP-02[01] access to #{input('mp_02_odp_01')} is restricted to #{input('mp_02_odp_02')};
      MP-02[02] access to #{input('mp_02_odp_03')} is restricted to #{input('mp_02_odp_04')}.
  ...
  tag odp: %w{mp_02_odp_01 mp_02_odp_02 mp_02_odp_03 mp_02_odp_04 mp_2_prm_1 mp_2_prm_2}

  describe 'NIST SP 800-53 Rev 5 control MP-2' do
