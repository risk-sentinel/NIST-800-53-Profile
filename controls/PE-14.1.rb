control 'PE-14 (1)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      PE-14(01) #{input('pe_14_01_odp')} are employed in the facility to prevent fluctuations that are potentially harmful to the system.
  ...
  describe 'NIST SP 800-53 Rev 5 control PE-14 (1)' do
