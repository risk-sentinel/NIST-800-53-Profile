control 'PL-8' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      ...
      PL-08b. changes in the enterprise architecture are reviewed and updated #{input('pl_08_odp')} to reflect changes in the enterprise architecture;
      PL-08c.
  ...
  describe 'NIST SP 800-53 Rev 5 control PL-8' do
