control 'PS-3' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      ...
      PS-03b.
        PS-03b.[01] individuals are rescreened in accordance with #{input('ps_03_odp_01')};
        PS-03b.[02] where rescreening is so indicated, individuals are rescreened #{input('ps_03_odp_02')}.
  ...
  tag odp: %w{ps_03_odp_01 ps_03_odp_02 ps_3_prm_1}

  describe 'NIST SP 800-53 Rev 5 control PS-3' do
