control 'SR-6 (1)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SR-06(01) #{input('sr_06_01_odp_01')} is/are employed on #{input('sr_06_01_odp_02')} associated with the system, system component, or system service.
  ...
  describe 'NIST SP 800-53 Rev 5 control SR-6 (1)' do
