control 'SC-42' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SC-42a. #{input('sc_42_odp_01')} is/are prohibited;
      SC-42b. an explicit indication of sensor use is provided to #{input('sc_42_odp_05')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control SC-42' do
