control 'SI-22' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SI-22a. #{input('si_22_odp_01')} for #{input('si_22_odp_02')} are identified;
      SI-22b. an alternative information source is used for the execution of essential functions or services on #{input('si_22_odp_03')} when the primary source of information is corrupted or unavailable.
  ...
  describe 'NIST SP 800-53 Rev 5 control SI-22' do
