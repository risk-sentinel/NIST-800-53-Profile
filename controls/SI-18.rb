control 'SI-18' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SI-18a.
        SI-18a.[01] the accuracy of personally identifiable information across the information life cycle is checked #{input('si_18_odp_01')};
        SI-18a.[02] the relevance of personally identifiable information across the information life cycle is checked #{input('si_18_odp_02')};
        SI-18a.[03] the timeliness of personally identifiable information across the information life cycle is checked #{input('si_18_odp_03')};
        SI-18a.[04] the completeness of personally identifiable information across the information life cycle is checked #{input('si_18_odp_04')};
  ...
  tag odp: %w{si_18_odp_01 si_18_odp_02 si_18_odp_03 si_18_odp_04 si_18_prm_1}

  describe 'NIST SP 800-53 Rev 5 control SI-18' do
