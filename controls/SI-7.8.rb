control 'SI-7 (8)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      ...
      SI-07(08)[02] #{input('si_07_08_odp_01')} is/are initiated upon the detection of a potential integrity violation.
  ...
  describe 'NIST SP 800-53 Rev 5 control SI-7 (8)' do
