control 'AC-17 (9)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      AC-17(09) the capability to disconnect or disable remote access to the system within #{input('ac_17_09_odp')} is provided.
  ...
  describe 'NIST SP 800-53 Rev 5 control AC-17 (9)' do
