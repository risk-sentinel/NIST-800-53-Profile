control 'AC-21 (1)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      AC-21(01) #{input('ac_21_01_odp')} are employed to enforce information-sharing decisions by authorized users based on access authorizations of sharing partners and access restrictions on information to be shared.
  ...
  describe 'NIST SP 800-53 Rev 5 control AC-21 (1)' do
