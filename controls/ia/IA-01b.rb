control 'IA-01b.' do
  impact 0.5
  title "the #{input('ia_01_odp_04')} is designated to manage the development, documentation, and dissemination of the identification and authentication policy and procedures;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the #{input('ia_01_odp_04')} is designated to manage the development, documentation, and dissemination of the identification and authentication policy and procedures;
  ...
  describe 'NIST SP 800-53A Rev 5 objective IA-01b.' do
