control 'IA-08(01)[02]' do
  impact 0.5
  title "Personal Identity Verification-compliant credentials from other federal agencies are electronically verified."
  desc <<~DESC
  ...
  tag control_ia_8_1: true

  describe 'NIST SP 800-53A Rev 5 objective IA-08(01)[02]' do
