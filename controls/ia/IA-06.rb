control 'IA-06' do
  impact 0.5
  title "the feedback of authentication information is obscured during the authentication process to protect the information from possible exploitation and use by unauthorized individuals."
  desc <<~DESC
  ...
  tag control_ia_6: true

  describe 'NIST SP 800-53A Rev 5 objective IA-06' do
