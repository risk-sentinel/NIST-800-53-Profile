control 'IA-04(06)' do
  impact 0.5
  title "cross-organization management of identifiers is coordinated with #{input('ia_04_06_odp')}."
  desc <<~DESC
    Coordinate with the following external organizations for cross-organization management of identifiers: #{input('ia_04_06_odp')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      cross-organization management of identifiers is coordinated with #{input('ia_04_06_odp')}.
  ...
  tag nist: ['IA-4 (6)']
  tag control: 'IA-4 (6)'
  tag objective: 'IA-04(06)'
  tag rev: 'Rev_5'
  tag family: 'Identification and Authentication'
  tag baseline: %w{}
  tag control_ia_4_6: true
  tag odp: %w{ia_04_06_odp}

  describe 'NIST SP 800-53A Rev 5 objective IA-04(06)' do
