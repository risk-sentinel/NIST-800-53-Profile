control 'IA-01a.01(a)[04]' do
  impact 0.5
  title "the #{input('ia_01_odp_03')} identification and authentication policy addresses responsibilities;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the #{input('ia_01_odp_03')} identification and authentication policy addresses responsibilities;
  ...
  describe 'NIST SP 800-53A Rev 5 objective IA-01a.01(a)[04]' do
