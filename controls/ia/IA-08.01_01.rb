control 'IA-08(01)[01]' do
  impact 0.5
  title "Personal Identity Verification-compliant credentials from other federal agencies are accepted;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective IA-08(01)[01]' do
