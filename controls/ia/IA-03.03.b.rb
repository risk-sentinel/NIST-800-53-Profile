control 'IA-03(03)(b)' do
  impact 0.5
  title "lease information is audited when assigned to a device."
  desc <<~DESC
  ...
  tag nist: ['IA-3 (3)']
  tag control: 'IA-3 (3)'
  tag objective: 'IA-03(03)(b)'
  tag rev: 'Rev_5'
  tag family: 'Identification and Authentication'
  tag baseline: %w{}
  tag control_ia_3_3: true
  tag odp: %w{ia_3_3_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective IA-03(03)(b)' do
