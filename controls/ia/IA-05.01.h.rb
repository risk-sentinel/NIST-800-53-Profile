control 'IA-05(01)(h)' do
  impact 0.5
  title "for password-based authentication, #{input('ia_05_01_odp_02')} are enforced."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      for password-based authentication, #{input('ia_05_01_odp_02')} are enforced.
  ...
  describe 'NIST SP 800-53A Rev 5 objective IA-05(01)(h)' do
