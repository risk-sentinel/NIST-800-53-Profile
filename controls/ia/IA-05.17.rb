control 'IA-05(17)' do
  impact 0.5
  title "presentation attack detection mechanisms are employed for biometric-based authentication."
  desc <<~DESC
  ...
  tag nist: ['IA-5 (17)']
  tag control: 'IA-5 (17)'
  tag objective: 'IA-05(17)'
  tag rev: 'Rev_5'
  tag family: 'Identification and Authentication'
  tag baseline: %w{}
  tag control_ia_5_17: true

  describe 'NIST SP 800-53A Rev 5 objective IA-05(17)' do
