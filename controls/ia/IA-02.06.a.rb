control 'IA-02(06)(a)' do
  impact 0.5
  title "multi-factor authentication is implemented for #{input('ia_02_06_odp_01')} access to #{input('ia_02_06_odp_02')} such that one of the factors is provided by a device separate from the system gaining access;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      multi-factor authentication is implemented for #{input('ia_02_06_odp_01')} access to #{input('ia_02_06_odp_02')} such that one of the factors is provided by a device separate from the system gaining access;
  ...
  describe 'NIST SP 800-53A Rev 5 objective IA-02(06)(a)' do
