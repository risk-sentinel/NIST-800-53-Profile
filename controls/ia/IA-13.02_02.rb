control 'IA-13(02)[02]' do
  impact 0.5
  title "the source of access tokens is verified before granting access to system and information resources;"
  desc <<~DESC
  ...
  tag nist: ['IA-13 (2)']
  tag control: 'IA-13 (2)'
  tag objective: 'IA-13(02)[02]'
  tag rev: 'Rev_5'
  tag family: 'Identification and Authentication'
  tag baseline: %w{}
  tag control_ia_13_2: true

  describe 'NIST SP 800-53A Rev 5 objective IA-13(02)[02]' do
