control 'IA-05(14)' do
  impact 0.5
  title "an organization-wide methodology for managing the content of PKI trust stores is employed across all platforms, including networks, operating systems, browsers, and applications for PKI-based authentication."
  desc <<~DESC
  ...
  tag nist: ['IA-5 (14)']
  tag control: 'IA-5 (14)'
  tag objective: 'IA-05(14)'
  tag rev: 'Rev_5'
  tag family: 'Identification and Authentication'
  tag baseline: %w{}
  tag control_ia_5_14: true

  describe 'NIST SP 800-53A Rev 5 objective IA-05(14)' do
