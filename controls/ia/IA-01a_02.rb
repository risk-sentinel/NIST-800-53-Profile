control 'IA-01a.[02]' do
  impact 0.5
  title "the identification and authentication policy is disseminated to #{input('ia_01_odp_01')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the identification and authentication policy is disseminated to #{input('ia_01_odp_01')};
  ...
  tag odp: %w{ia_01_odp_01 ia_01_odp_03 ia_01_odp_04 ia_01_odp_05 ia_01_odp_06 ia_01_odp_07 ia_01_odp_08 ia_1_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective IA-01a.[02]' do
