control 'IA-05h.[02]' do
  impact 0.5
  title "system authenticators are managed through the requirement for devices to implement specific controls to protect authenticators;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective IA-05h.[02]' do
