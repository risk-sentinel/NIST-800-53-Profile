control 'IA-05(01)(e)' do
  impact 0.5
  title "for password-based authentication, immediate selection of a new password is required upon account recovery;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective IA-05(01)(e)' do
