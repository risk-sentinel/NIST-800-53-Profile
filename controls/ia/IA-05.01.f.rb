control 'IA-05(01)(f)' do
  impact 0.5
  title "for password-based authentication, user selection of long passwords and passphrases is allowed, including spaces and all printable characters;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective IA-05(01)(f)' do
