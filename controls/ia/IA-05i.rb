control 'IA-05i.' do
  impact 0.5
  title "system authenticators are managed through the change of authenticators for group or role accounts when membership to those accounts changes."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective IA-05i.' do
