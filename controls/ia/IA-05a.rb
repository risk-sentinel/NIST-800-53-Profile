control 'IA-05a.' do
  impact 0.5
  title "system authenticators are managed through the verification of the identity of the individual, group, role, service, or device receiving the authenticator as part of the initial authenticator distribution;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective IA-05a.' do
