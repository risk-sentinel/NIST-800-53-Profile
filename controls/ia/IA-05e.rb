control 'IA-05e.' do
  impact 0.5
  title "system authenticators are managed through the change of default authenticators prior to first use;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective IA-05e.' do
