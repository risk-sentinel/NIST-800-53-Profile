control 'IA-05f.' do
  impact 0.5
  title "system authenticators are managed through the change or refreshment of authenticators #{input('ia_05_odp_01')} or when #{input('ia_05_odp_02')} occur;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      system authenticators are managed through the change or refreshment of authenticators #{input('ia_05_odp_01')} or when #{input('ia_05_odp_02')} occur;
  ...
  describe 'NIST SP 800-53A Rev 5 objective IA-05f.' do
