control 'IA-12(02)' do
  impact 0.5
  title "evidence of individual identification is presented to the registration authority."
  desc <<~DESC
  ...
  tag nist: ['IA-12 (2)']
  tag control: 'IA-12 (2)'
  tag objective: 'IA-12(02)'
  tag rev: 'Rev_5'
  tag family: 'Identification and Authentication'
  tag baseline: %w{MODERATE HIGH}
  tag baseline_moderate: true
  tag baseline_high: true
  tag control_ia_12_2: true

  describe 'NIST SP 800-53A Rev 5 objective IA-12(02)' do
