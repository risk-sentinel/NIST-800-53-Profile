control 'IA-13(01)[02]' do
  impact 0.5
  title "cryptographic keys that protect access tokens are managed;"
  desc <<~DESC
  ...
  tag nist: ['IA-13 (1)']
  tag control: 'IA-13 (1)'
  tag objective: 'IA-13(01)[02]'
  tag rev: 'Rev_5'
  tag family: 'Identification and Authentication'
  tag baseline: %w{}
  tag control_ia_13_1: true

  describe 'NIST SP 800-53A Rev 5 objective IA-13(01)[02]' do
