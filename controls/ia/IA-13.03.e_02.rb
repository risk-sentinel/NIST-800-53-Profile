control 'IA-13(03)(e)[02]' do
  impact 0.5
  title "access tokens are time-restricted in accordance with #{input('ia_13_odp_01')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      access tokens are time-restricted in accordance with #{input('ia_13_odp_01')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective IA-13(03)(e)[02]' do
