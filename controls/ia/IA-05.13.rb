control 'IA-05(13)' do
  impact 0.5
  title "the use of cached authenticators is prohibited after #{input('ia_05_13_odp')}."
  desc <<~DESC
    Prohibit the use of cached authenticators after #{input('ia_05_13_odp')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      the use of cached authenticators is prohibited after #{input('ia_05_13_odp')}.
  ...
  tag nist: ['IA-5 (13)']
  tag control: 'IA-5 (13)'
  tag objective: 'IA-05(13)'
  tag rev: 'Rev_5'
  tag family: 'Identification and Authentication'
  tag baseline: %w{}
  tag control_ia_5_13: true
  tag odp: %w{ia_05_13_odp}

  describe 'NIST SP 800-53A Rev 5 objective IA-05(13)' do
