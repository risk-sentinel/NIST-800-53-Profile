control 'IA-13[04]' do
  impact 0.5
  title "authorization servers are employed to manage user, device, and non-person entity (NPE) identities, attributes and access rights supporting authorization decisions in accordance with #{input('ia_13_odp_02')} using #{input('ia_13_odp_02')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      authorization servers are employed to manage user, device, and non-person entity (NPE) identities, attributes and access rights supporting authorization decisions in accordance with #{input('ia_13_odp_02')} using #{input('ia_13_odp_02')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective IA-13[04]' do
