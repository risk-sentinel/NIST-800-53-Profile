control 'IA-05(18)(a)' do
  impact 0.5
  title "#{input('ia_05_18_odp_01')} are employed to generate and manage passwords;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('ia_05_18_odp_01')} are employed to generate and manage passwords;
  ...
  tag nist: ['IA-5 (18)']
  tag control: 'IA-5 (18)'
  tag objective: 'IA-05(18)(a)'
  tag rev: 'Rev_5'
  tag family: 'Identification and Authentication'
  tag baseline: %w{}
  tag control_ia_5_18: true
  tag odp: %w{ia_05_18_odp_01 ia_05_18_odp_02}

  describe 'NIST SP 800-53A Rev 5 objective IA-05(18)(a)' do
