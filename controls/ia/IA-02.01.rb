control 'IA-02(01)' do
  impact 0.5
  title "multi-factor authentication is implemented for access to privileged accounts."
  desc <<~DESC
  ...
  tag control_ia_2_1: true

  describe 'NIST SP 800-53A Rev 5 objective IA-02(01)' do
