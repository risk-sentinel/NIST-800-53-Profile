control 'IA-08(05)[02]' do
  impact 0.5
  title "federated or PKI credentials that meet #{input('ia_08_05_odp')} are verified."
  desc <<~DESC
    Accept and verify federated or PKI credentials that meet #{input('ia_08_05_odp')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      federated or PKI credentials that meet #{input('ia_08_05_odp')} are verified.
  ...
  describe 'NIST SP 800-53A Rev 5 objective IA-08(05)[02]' do
