control 'IA-05(18)(b)' do
  impact 0.5
  title "the passwords are protected using #{input('ia_05_18_odp_02')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the passwords are protected using #{input('ia_05_18_odp_02')}.
  ...
  describe 'NIST SP 800-53A Rev 5 objective IA-05(18)(b)' do
