control 'IA-01a.[01]' do
  impact 0.5
  title "an identification and authentication policy is developed and documented;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective IA-01a.[01]' do
