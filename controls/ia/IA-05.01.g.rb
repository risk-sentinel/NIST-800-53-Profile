control 'IA-05(01)(g)' do
  impact 0.5
  title "for password-based authentication, automated tools are employed to assist the user in selecting strong password authenticators;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective IA-05(01)(g)' do
