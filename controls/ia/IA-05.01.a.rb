control 'IA-05(01)(a)' do
  impact 0.5
  title "for password-based authentication, a list of commonly used, expected, or compromised passwords is maintained and updated #{input('ia_05_01_odp_01')} and when organizational passwords are suspected to have been compromised directly or indirectly;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      for password-based authentication, a list of commonly used, expected, or compromised passwords is maintained and updated #{input('ia_05_01_odp_01')} and when organizational passwords are suspected to have been compromised directly or indirectly;
  ...
  describe 'NIST SP 800-53A Rev 5 objective IA-05(01)(a)' do
