control 'IA-05(12)' do
  impact 0.5
  title "mechanisms that satisfy #{input('ia_05_12_odp')} are employed for biometric-based authentication."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      mechanisms that satisfy #{input('ia_05_12_odp')} are employed for biometric-based authentication.
  ...
  tag nist: ['IA-5 (12)']
  tag control: 'IA-5 (12)'
  tag objective: 'IA-05(12)'
  tag rev: 'Rev_5'
  tag family: 'Identification and Authentication'
  tag baseline: %w{}
  tag control_ia_5_12: true
  tag odp: %w{ia_05_12_odp}

  describe 'NIST SP 800-53A Rev 5 objective IA-05(12)' do
