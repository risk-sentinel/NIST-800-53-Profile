control 'IA-04d.' do
  impact 0.5
  title "system identifiers are managed by preventing reuse of identifiers for #{input('ia_04_odp_02')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      system identifiers are managed by preventing reuse of identifiers for #{input('ia_04_odp_02')}.
  ...
  describe 'NIST SP 800-53A Rev 5 objective IA-04d.' do
