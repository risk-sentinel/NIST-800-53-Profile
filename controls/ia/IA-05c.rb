control 'IA-05c.' do
  impact 0.5
  title "system authenticators are managed to ensure that authenticators have sufficient strength of mechanism for their intended use;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective IA-05c.' do
