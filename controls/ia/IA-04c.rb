control 'IA-04c.' do
  impact 0.5
  title "system identifiers are managed by assigning the identifier to the intended individual, group, role, service, or device;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective IA-04c.' do
