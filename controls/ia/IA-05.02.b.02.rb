control 'IA-05(02)(b)(02)' do
  impact 0.5
  title "when public key infrastructure (PKI) is used, a local cache of revocation data is implemented to support path discovery and validation."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective IA-05(02)(b)(02)' do
