control 'IA-02(13)' do
  impact 0.5
  title "#{input('ia_02_13_odp_01')} mechanisms are implemented under #{input('ia_02_13_odp_02')}."
  desc <<~DESC
    Implement the following out-of-band authentication mechanisms under #{input('ia_02_13_odp_02')}: #{input('ia_02_13_odp_01')}.
  DESC
  desc 'check', <<~CHECK
    Determine if:
      #{input('ia_02_13_odp_01')} mechanisms are implemented under #{input('ia_02_13_odp_02')}.
  ...
  tag nist: ['IA-2 (13)']
  tag control: 'IA-2 (13)'
  tag objective: 'IA-02(13)'
  tag rev: 'Rev_5'
  tag family: 'Identification and Authentication'
  tag baseline: %w{}
  tag control_ia_2_13: true
  tag odp: %w{ia_02_13_odp_01 ia_02_13_odp_02}

  describe 'NIST SP 800-53A Rev 5 objective IA-02(13)' do
