control 'IA-05(02)(b)(01)' do
  impact 0.5
  title "when public key infrastructure (PKI) is used, certificates are validated by constructing and verifying a certification path to an accepted trust anchor, including checking certificate status information;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective IA-05(02)(b)(01)' do
