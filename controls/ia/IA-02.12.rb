control 'IA-02(12)' do
  impact 0.5
  title "Personal Identity Verification-compliant credentials are accepted and electronically verified."
  desc <<~DESC
  ...
  tag control_ia_2_12: true

  describe 'NIST SP 800-53A Rev 5 objective IA-02(12)' do
