control 'IA-08(02)(b)[02]' do
  impact 0.5
  title "a list of accepted external authenticators is maintained."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective IA-08(02)(b)[02]' do
