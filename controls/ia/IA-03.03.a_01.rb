control 'IA-03(03)(a)[01]' do
  impact 0.5
  title "dynamic address allocation lease information assigned to devices where addresses are allocated dynamically are standardized in accordance with #{input('ia_03_03_odp_01')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      dynamic address allocation lease information assigned to devices where addresses are allocated dynamically are standardized in accordance with #{input('ia_03_03_odp_01')};
  ...
  tag nist: ['IA-3 (3)']
  tag control: 'IA-3 (3)'
  tag objective: 'IA-03(03)(a)[01]'
  tag rev: 'Rev_5'
  tag family: 'Identification and Authentication'
  tag baseline: %w{}
  tag control_ia_3_3: true
  tag odp: %w{ia_03_03_odp_01 ia_3_3_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective IA-03(03)(a)[01]' do
