control 'IA-08(06)' do
  impact 0.5
  title "#{input('ia_08_06_odp')} to disassociate user attributes or identifier assertion relationships among individuals, credential service providers, and relying parties are implemented."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      #{input('ia_08_06_odp')} to disassociate user attributes or identifier assertion relationships among individuals, credential service providers, and relying parties are implemented.
  ...
  tag nist: ['IA-8 (6)']
  tag control: 'IA-8 (6)'
  tag objective: 'IA-08(06)'
  tag rev: 'Rev_5'
  tag family: 'Identification and Authentication'
  tag baseline: %w{}
  tag control_ia_8_6: true
  tag odp: %w{ia_08_06_odp}

  describe 'NIST SP 800-53A Rev 5 objective IA-08(06)' do
