control 'IA-05(01)(b)' do
  impact 0.5
  title "for password-based authentication when passwords are created or updated by users, the passwords are verified not to be found on the list of commonly used, expected, or compromised passwords in IA-05(01)(a);"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective IA-05(01)(b)' do
