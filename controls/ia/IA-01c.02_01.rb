control 'IA-01c.02[01]' do
  impact 0.5
  title "the current identification and authentication procedures are reviewed and updated #{input('ia_01_odp_07')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the current identification and authentication procedures are reviewed and updated #{input('ia_01_odp_07')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective IA-01c.02[01]' do
