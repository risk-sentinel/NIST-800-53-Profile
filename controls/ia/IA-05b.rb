control 'IA-05b.' do
  impact 0.5
  title "system authenticators are managed through the establishment of initial authenticator content for any authenticators issued by the organization;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective IA-05b.' do
