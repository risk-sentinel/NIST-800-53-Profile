control 'IA-05(01)(c)' do
  impact 0.5
  title "for password-based authentication, passwords are only transmitted over cryptographically protected channels;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective IA-05(01)(c)' do
