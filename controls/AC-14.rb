control 'AC-14' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      AC-14a. #{input('ac_14_odp')} that can be performed on the system without identification or authentication consistent with organizational mission and business functions are identified;
      AC-14b.
  ...
  describe 'NIST SP 800-53 Rev 5 control AC-14' do
