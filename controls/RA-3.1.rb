control 'RA-3 (1)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      RA-03(01)(a) supply chain risks associated with #{input('ra_03_01_odp_01')} are assessed;
      RA-03(01)(b) the supply chain risk assessment is updated #{input('ra_03_01_odp_02')} , when there are significant changes to the relevant supply chain, or when changes to the system, environments of operation, or other conditions may necessitate a change in the supply chain.
  ...
  describe 'NIST SP 800-53 Rev 5 control RA-3 (1)' do
