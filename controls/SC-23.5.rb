control 'SC-23 (5)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SC-23(05) only the use of #{input('sc_23_05_odp')} for verification of the establishment of protected sessions is allowed.
  ...
  describe 'NIST SP 800-53 Rev 5 control SC-23 (5)' do
