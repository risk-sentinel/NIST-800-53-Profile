control 'PE-8 (1)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      PE-08(01)[01] visitor access records are maintained using #{input('pe_08_01_odp_01')};
      PE-08(01)[02] visitor access records are reviewed using #{input('pe_08_01_odp_02')}.
  ...
  tag odp: %w{pe_08_01_odp_01 pe_08_01_odp_02 pe_8_1_prm_1}

  describe 'NIST SP 800-53 Rev 5 control PE-8 (1)' do
