control 'PE-2 (3)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      PE-02(03) unescorted access to the facility where the system resides is restricted to personnel with #{input('pe_02_03_odp_01')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control PE-2 (3)' do
