control 'SA-11 (7)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SA-11(07)[01] the developer of the system, system component, or system service is required to verify that the scope of testing and evaluation provides complete coverage of the required controls at #{input('sa_11_07_odp_01')};
      SA-11(07)[02] the developer of the system, system component, or system service is required to verify that the scope of testing and evaluation provides complete coverage of the required controls at #{input('sa_11_07_odp_02')}.
  ...
  tag baseline: %w{}
  tag odp: %w{sa_11_07_odp_01 sa_11_07_odp_02 sa_11_7_prm_1}

  describe 'NIST SP 800-53 Rev 5 control SA-11 (7)' do
