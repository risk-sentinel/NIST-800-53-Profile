control 'SR-5' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SR-05[01] #{input('sr_05_odp')} are employed to protect against supply chain risks;
      SR-05[02] #{input('sr_05_odp')} are employed to identify supply chain risks;
      SR-05[03] #{input('sr_05_odp')} are employed to mitigate supply chain risks.
  ...
  describe 'NIST SP 800-53 Rev 5 control SR-5' do
