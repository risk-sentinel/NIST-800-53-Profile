control 'IA-13 (3)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      IA-13(03)(a)[01] assertions are generated in accordance with #{input('ia_13_odp_01')};
      IA-13(03)(a)[02] access tokens are generated in accordance with #{input('ia_13_odp_01')};
      IA-13(03)(b)[01] assertions are issued in accordance with #{input('ia_13_odp_01')};
      IA-13(03)(b)[02] access tokens are issued in accordance with #{input('ia_13_odp_01')};
      IA-13(03)(c)[01] assertions are refreshed in accordance with #{input('ia_13_odp_01')};
      IA-13(03)(c)[02] access tokens are refreshed in accordance with #{input('ia_13_odp_01')};
      IA-13(03)(d)[01] assertions are revoked in accordance with #{input('ia_13_odp_01')};
      IA-13(03)(d)[02] access tokens are revoked in accordance with #{input('ia_13_odp_01')};
      IA-13(03)(e)[01] assertions are time-restricted in accordance with #{input('ia_13_odp_01')};
      IA-13(03)(e)[02] access tokens are time-restricted in accordance with #{input('ia_13_odp_01')};
      IA-13(03)(f)[01] assertions are audience-restricted in accordance with #{input('ia_13_odp_01')};
      IA-13(03)(f)[02] access tokens are audience-restricted in accordance with #{input('ia_13_odp_01')};
  ...
  describe 'NIST SP 800-53 Rev 5 control IA-13 (3)' do
