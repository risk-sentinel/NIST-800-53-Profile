control 'RA-5' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      RA-05a.
        RA-05a.[01] systems and hosted applications are monitored for vulnerabilities #{input('ra_05_odp_01')} and when new vulnerabilities potentially affecting the system are identified and reported;
        RA-05a.[02] systems and hosted applications are scanned for vulnerabilities #{input('ra_05_odp_02')} and when new vulnerabilities potentially affecting the system are identified and reported;
      ...
      RA-05d. legitimate vulnerabilities are remediated #{input('ra_05_odp_03')} in accordance with an organizational assessment of risk;
      RA-05e. information obtained from the vulnerability monitoring process and control assessments is shared with #{input('ra_05_odp_04')} to help eliminate similar vulnerabilities in other systems;
  ...
  tag odp: %w{ra_05_odp_01 ra_05_odp_02 ra_05_odp_03 ra_05_odp_04 ra_5_prm_1}

  describe 'NIST SP 800-53 Rev 5 control RA-5' do
