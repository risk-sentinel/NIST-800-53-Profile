control 'AC-4 (15)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      AC-04(15)[01] when transferring information between different security domains, information is examined for the presence of #{input('ac_04_15_odp_01')};
      AC-04(15)[02] when transferring information between different security domains, transfer of #{input('ac_04_15_odp_01')} is prohibited in accordance with the #{input('ac_04_15_odp_02')};
      AC-04(15)[03] when transferring information between different security domains, transfer of #{input('ac_04_15_odp_01')} is prohibited in accordance with the #{input('ac_04_15_odp_03')}.
  ...
  tag baseline: %w{}
  tag odp: %w{ac_04_15_odp_01 ac_04_15_odp_02 ac_04_15_odp_03 ac_4_15_prm_2}

  describe 'NIST SP 800-53 Rev 5 control AC-4 (15)' do
