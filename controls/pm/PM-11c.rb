control 'PM-11c.' do
  impact 0.5
  title "the mission and business processes are reviewed and revised #{input('pm_11_odp')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the mission and business processes are reviewed and revised #{input('pm_11_odp')}.
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-11c.' do
