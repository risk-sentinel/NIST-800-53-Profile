control 'PM-18a.02[03]' do
  impact 0.5
  title "the privacy program plan provides a description of common controls in place or planned for meeting the requirements of the privacy program;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-18a.02[03]' do
