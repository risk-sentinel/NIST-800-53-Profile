control 'PM-18a.03[01]' do
  impact 0.5
  title "the privacy program plan includes the role of the senior agency official for privacy;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-18a.03[01]' do
