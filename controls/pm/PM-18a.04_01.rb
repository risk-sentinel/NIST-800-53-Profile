control 'PM-18a.04[01]' do
  impact 0.5
  title "the privacy program plan describes management commitment;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-18a.04[01]' do
