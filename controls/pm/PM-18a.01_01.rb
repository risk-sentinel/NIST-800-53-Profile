control 'PM-18a.01[01]' do
  impact 0.5
  title "the privacy program plan includes a description of the structure of the privacy program;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-18a.01[01]' do
