control 'PM-19[01]' do
  impact 0.5
  title "a senior agency official for privacy with authority, mission, accountability, and resources is appointed;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-19[01]' do
