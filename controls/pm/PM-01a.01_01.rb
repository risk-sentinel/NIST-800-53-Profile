control 'PM-01a.01[01]' do
  impact 0.5
  title "the information security program plan provides an overview of the requirements for the security program;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-01a.01[01]' do
