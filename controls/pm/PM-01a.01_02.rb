control 'PM-01a.01[02]' do
  impact 0.5
  title "the information security program plan provides a description of the security program management controls in place or planned for meeting those requirements;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-01a.01[02]' do
