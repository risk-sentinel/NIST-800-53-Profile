control 'PM-27a.02[01]' do
  impact 0.5
  title "the privacy reports are disseminated to #{input('pm_27_odp_03')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the privacy reports are disseminated to #{input('pm_27_odp_03')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-27a.02[01]' do
