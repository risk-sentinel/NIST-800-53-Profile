control 'PM-27a.01' do
  impact 0.5
  title "the privacy reports are disseminated to #{input('pm_27_odp_02')} to demonstrate accountability with statutory, regulatory, and policy privacy mandates;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the privacy reports are disseminated to #{input('pm_27_odp_02')} to demonstrate accountability with statutory, regulatory, and policy privacy mandates;
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-27a.01' do
