control 'PM-04b.[02]' do
  impact 0.5
  title "plans of action and milestones are reviewed for consistency with organization-wide priorities for risk response actions."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-04b.[02]' do
