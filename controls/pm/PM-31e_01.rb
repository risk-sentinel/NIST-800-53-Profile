control 'PM-31e.[01]' do
  impact 0.5
  title "continuous monitoring programs are implemented that include response actions to address the analysis of control assessment information;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-31e.[01]' do
