control 'PM-20(01)(b)[01]' do
  impact 0.5
  title "the privacy policies provide the information needed by the public to make an informed decision about whether to interact with the organization;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-20(01)(b)[01]' do
