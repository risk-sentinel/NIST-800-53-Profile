control 'PM-28c.' do
  impact 0.5
  title "risk framing considerations are reviewed and updated #{input('pm_28_odp_02')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      risk framing considerations are reviewed and updated #{input('pm_28_odp_02')}.
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-28c.' do
