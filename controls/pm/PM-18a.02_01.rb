control 'PM-18a.02[01]' do
  impact 0.5
  title "the privacy program plan provides an overview of the requirements for the privacy program;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-18a.02[01]' do
