control 'PM-18a.03[02]' do
  impact 0.5
  title "the privacy program plan includes the identification and assignment of the roles of other privacy officials and staff and their responsibilities;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-18a.03[02]' do
