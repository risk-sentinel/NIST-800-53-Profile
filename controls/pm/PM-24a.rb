control 'PM-24a.' do
  impact 0.5
  title "the Data Integrity Board reviews proposals to conduct or participate in a matching program;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-24a.' do
