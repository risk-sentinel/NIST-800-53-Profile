control 'PM-18a.04[03]' do
  impact 0.5
  title "the privacy program plan describes the strategic goals and objectives of the privacy program;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-18a.04[03]' do
