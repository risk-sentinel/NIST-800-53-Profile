control 'PM-26b.' do
  impact 0.5
  title "the complaint management process includes all information necessary for successfully filing complaints;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-26b.' do
