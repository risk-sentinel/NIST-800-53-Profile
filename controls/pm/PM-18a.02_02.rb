control 'PM-18a.02[02]' do
  impact 0.5
  title "the privacy program plan provides a description of the privacy program management controls in place or planned for meeting the requirements of the privacy program;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-18a.02[02]' do
