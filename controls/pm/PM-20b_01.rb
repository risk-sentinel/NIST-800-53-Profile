control 'PM-20b.[01]' do
  impact 0.5
  title "the webpage ensures that organizational privacy practices are publicly available;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-20b.[01]' do
