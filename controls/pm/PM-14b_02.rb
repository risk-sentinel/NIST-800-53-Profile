control 'PM-14b.[02]' do
  impact 0.5
  title "training plans are reviewed for consistency with the organizational risk management strategy;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-14b.[02]' do
