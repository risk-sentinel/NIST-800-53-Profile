control 'PM-31d.[01]' do
  impact 0.5
  title "continuous monitoring programs are implemented that include correlating information generated by control assessments and monitoring;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-31d.[01]' do
