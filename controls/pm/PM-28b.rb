control 'PM-28b.' do
  impact 0.5
  title "the results of risk framing activities are distributed to #{input('pm_28_odp_01')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the results of risk framing activities are distributed to #{input('pm_28_odp_01')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-28b.' do
