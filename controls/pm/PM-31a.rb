control 'PM-31a.' do
  impact 0.5
  title "continuous monitoring programs are implemented that include establishing #{input('pm_31_odp_01')} to be monitored;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      continuous monitoring programs are implemented that include establishing #{input('pm_31_odp_01')} to be monitored;
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-31a.' do
