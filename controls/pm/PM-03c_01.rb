control 'PM-03c.[01]' do
  impact 0.5
  title "information security resources are made available for expenditure as planned;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-03c.[01]' do
