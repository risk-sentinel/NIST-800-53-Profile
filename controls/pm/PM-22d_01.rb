control 'PM-22d.[01]' do
  impact 0.5
  title "the policies address appeals of adverse decisions on correction or deletion requests;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-22d.[01]' do
