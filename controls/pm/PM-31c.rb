control 'PM-31c.' do
  impact 0.5
  title "continuous monitoring programs are implemented that include monitoring #{input('pm_31_odp_01')} on an ongoing basis in accordance with the continuous monitoring strategy;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      continuous monitoring programs are implemented that include monitoring #{input('pm_31_odp_01')} on an ongoing basis in accordance with the continuous monitoring strategy;
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-31c.' do
