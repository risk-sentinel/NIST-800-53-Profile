control 'PM-14b.[05]' do
  impact 0.5
  title "training plans are reviewed for consistency with organization-wide priorities for risk response actions;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-14b.[05]' do
