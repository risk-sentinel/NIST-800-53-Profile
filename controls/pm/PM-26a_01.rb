control 'PM-26a.[01]' do
  impact 0.5
  title "the complaint management process includes mechanisms that are easy to use by the public;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-26a.[01]' do
