control 'PM-11a.[02]' do
  impact 0.5
  title "organizational mission and business processes are defined with consideration for privacy;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-11a.[02]' do
