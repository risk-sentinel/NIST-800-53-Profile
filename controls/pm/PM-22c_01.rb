control 'PM-22c.[01]' do
  impact 0.5
  title "the policies address disseminating notice of corrected or deleted personally identifiable information to individuals or other appropriate entities;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-22c.[01]' do
