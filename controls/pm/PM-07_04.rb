control 'PM-07[04]' do
  impact 0.5
  title "an enterprise architecture is maintained with consideration for privacy;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-07[04]' do
