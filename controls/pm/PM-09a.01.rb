control 'PM-09a.01' do
  impact 0.5
  title "a comprehensive strategy is developed to manage security risk to organizational operations and assets, individuals, other organizations, and the Nation associated with the operation and use of organizational systems;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-09a.01' do
