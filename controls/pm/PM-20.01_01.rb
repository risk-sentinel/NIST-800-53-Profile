control 'PM-20(01)[01]' do
  impact 0.5
  title "privacy policies are developed and posted on all external-facing websites;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-20(01)[01]' do
