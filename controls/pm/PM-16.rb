control 'PM-16' do
  impact 0.5
  title "a threat awareness program that includes a cross-organization information-sharing capability for threat intelligence is implemented."
  desc <<~DESC
  ...
  tag baseline: %w{}
  tag control_pm_16: true

  describe 'NIST SP 800-53A Rev 5 objective PM-16' do
