control 'PM-29a.[01]' do
  impact 0.5
  title "a Senior Accountable Official for Risk Management is appointed;"
  desc <<~DESC
  ...
  tag nist: ['PM-29']
  tag control: 'PM-29'
  tag objective: 'PM-29a.[01]'
  tag rev: 'Rev_5'
  tag family: 'Program Management'
  tag baseline: %w{}
  tag control_pm_29: true

  describe 'NIST SP 800-53A Rev 5 objective PM-29a.[01]' do
