control 'PM-22a.[04]' do
  impact 0.5
  title "the policies address reviewing the completeness of personally identifiable information across the information life cycle;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-22a.[04]' do
