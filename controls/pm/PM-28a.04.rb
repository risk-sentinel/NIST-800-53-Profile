control 'PM-28a.04' do
  impact 0.5
  title "organizational risk tolerance is identified and documented;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-28a.04' do
