control 'PM-25a.[11]' do
  impact 0.5
  title "procedures that address the use of personally identifiable information for training are implemented;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-25a.[11]' do
