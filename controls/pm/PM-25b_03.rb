control 'PM-25b.[03]' do
  impact 0.5
  title "the amount of personally identifiable information used for internal research purposes is limited or minimized;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-25b.[03]' do
