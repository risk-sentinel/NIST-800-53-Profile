control 'PM-25a.[06]' do
  impact 0.5
  title "procedures that address the use of personally identifiable information for internal research are developed and documented;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-25a.[06]' do
