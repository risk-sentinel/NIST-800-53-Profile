control 'PM-31b.[02]' do
  impact 0.5
  title "continuous monitoring programs are implemented that establish #{input('pm_31_odp_03')} for assessment of control effectiveness;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      continuous monitoring programs are implemented that establish #{input('pm_31_odp_03')} for assessment of control effectiveness;
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-31b.[02]' do
