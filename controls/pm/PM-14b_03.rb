control 'PM-14b.[03]' do
  impact 0.5
  title "monitoring plans are reviewed for consistency with the organizational risk management strategy;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-14b.[03]' do
