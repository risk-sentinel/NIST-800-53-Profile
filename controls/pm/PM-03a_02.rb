control 'PM-03a.[02]' do
  impact 0.5
  title "the resources needed to implement the privacy program are included in capital planning and investment requests, and all exceptions are documented;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-03a.[02]' do
