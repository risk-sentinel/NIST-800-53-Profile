control 'PM-01b.[02]' do
  impact 0.5
  title "the information security program plan is reviewed and updated following #{input('pm_01_odp_02')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the information security program plan is reviewed and updated following #{input('pm_01_odp_02')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-01b.[02]' do
