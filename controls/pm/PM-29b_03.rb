control 'PM-29b.[03]' do
  impact 0.5
  title "a Risk Executive (function) ensures that the management of risk is consistent across the organization."
  desc <<~DESC
  ...
  tag nist: ['PM-29']
  tag control: 'PM-29'
  tag objective: 'PM-29b.[03]'
  tag rev: 'Rev_5'
  tag family: 'Program Management'
  tag baseline: %w{}
  tag control_pm_29: true

  describe 'NIST SP 800-53A Rev 5 objective PM-29b.[03]' do
