control 'PM-25a.[01]' do
  impact 0.5
  title "policies that address the use of personally identifiable information for internal testing are developed and documented;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-25a.[01]' do
