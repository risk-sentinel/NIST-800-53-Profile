control 'PM-03c.[02]' do
  impact 0.5
  title "privacy resources are made available for expenditure as planned."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-03c.[02]' do
