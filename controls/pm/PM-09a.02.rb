control 'PM-09a.02' do
  impact 0.5
  title "a comprehensive strategy is developed to manage privacy risk to individuals resulting from the authorized processing of personally identifiable information;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-09a.02' do
