control 'PM-15c.[01]' do
  impact 0.5
  title "contact is established and institutionalized with selected groups and associations within the security community to share current security information, including threats, vulnerabilities, and incidents;"
  desc <<~DESC
  ...
  tag nist: ['PM-15']
  tag control: 'PM-15'
  tag objective: 'PM-15c.[01]'
  tag rev: 'Rev_5'
  tag family: 'Program Management'
  tag baseline: %w{}
  tag control_pm_15: true

  describe 'NIST SP 800-53A Rev 5 objective PM-15c.[01]' do
