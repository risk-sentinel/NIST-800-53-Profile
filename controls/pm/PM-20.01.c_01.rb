control 'PM-20(01)(c)[01]' do
  impact 0.5
  title "the privacy policies are updated whenever the organization makes a substantive change to the practices it describes;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-20(01)(c)[01]' do
