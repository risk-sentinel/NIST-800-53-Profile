control 'PM-03b.[01]' do
  impact 0.5
  title "the documentation required for addressing the information security program in capital planning and investment requests is prepared in accordance with applicable laws, executive orders, directives, policies, regulations, standards;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-03b.[01]' do
