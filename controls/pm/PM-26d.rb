control 'PM-26d.' do
  impact 0.5
  title "the complaint management process includes acknowledging the receipt of complaints, concerns, or questions from individuals within #{input('pm_26_odp_03')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the complaint management process includes acknowledging the receipt of complaints, concerns, or questions from individuals within #{input('pm_26_odp_03')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-26d.' do
