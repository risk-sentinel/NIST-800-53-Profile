control 'PM-22a.[03]' do
  impact 0.5
  title "the policies address reviewing the timeliness of personally identifiable information across the information life cycle;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-22a.[03]' do
