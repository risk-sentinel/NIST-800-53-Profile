control 'PM-25c.[01]' do
  impact 0.5
  title "the required use of personally identifiable information for internal testing is authorized;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-25c.[01]' do
