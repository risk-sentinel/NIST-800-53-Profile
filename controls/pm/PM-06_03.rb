control 'PM-06[03]' do
  impact 0.5
  title "the results of information security measures of performance are reported;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-06[03]' do
