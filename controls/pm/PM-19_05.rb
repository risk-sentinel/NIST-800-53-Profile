control 'PM-19[05]' do
  impact 0.5
  title "the senior agency official for privacy manages privacy risks through the organization-wide privacy program."
  desc <<~DESC
  ...
  tag nist: ['PM-19']
  tag control: 'PM-19'
  tag objective: 'PM-19[05]'
  tag rev: 'Rev_5'
  tag family: 'Program Management'
  tag baseline: %w{PRIVACY}
  tag baseline_privacy: true
  tag control_pm_19: true

  describe 'NIST SP 800-53A Rev 5 objective PM-19[05]' do
