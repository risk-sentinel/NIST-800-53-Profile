control 'PM-18b.[01]' do
  impact 0.5
  title "the privacy program plan is updated #{input('pm_18_odp')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the privacy program plan is updated #{input('pm_18_odp')};
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-18b.[01]' do
