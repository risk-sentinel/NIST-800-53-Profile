control 'PM-22b.[01]' do
  impact 0.5
  title "the policies address correcting or deleting inaccurate or outdated personally identifiable information;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-22b.[01]' do
