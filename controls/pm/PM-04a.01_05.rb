control 'PM-04a.01[05]' do
  impact 0.5
  title "a process to ensure that plans of action and milestones for the supply chain risk management program and associated organizational systems are developed;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-04a.01[05]' do
