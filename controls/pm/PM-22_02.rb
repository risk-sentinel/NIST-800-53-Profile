control 'PM-22[02]' do
  impact 0.5
  title "organization-wide procedures for personally identifiable information quality management are developed and documented;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-22[02]' do
