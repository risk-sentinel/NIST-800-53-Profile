control 'PM-14a.01[03]' do
  impact 0.5
  title "a process is implemented for ensuring that organizational plans for conducting privacy testing, training, and monitoring activities associated with organizational systems are developed;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-14a.01[03]' do
