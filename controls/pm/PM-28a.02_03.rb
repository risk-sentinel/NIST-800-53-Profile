control 'PM-28a.02[03]' do
  impact 0.5
  title "constraints affecting risk monitoring are identified and documented;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-28a.02[03]' do
