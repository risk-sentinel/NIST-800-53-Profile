control 'PM-02[03]' do
  impact 0.5
  title "the senior agency information security officer is provided with the mission and resources to develop an organization-wide information security program;"
  desc <<~DESC
  ...
  tag nist: ['PM-2']
  tag control: 'PM-2'
  tag objective: 'PM-02[03]'
  tag rev: 'Rev_5'
  tag family: 'Program Management'
  tag baseline: %w{}
  tag control_pm_2: true

  describe 'NIST SP 800-53A Rev 5 objective PM-02[03]' do
