control 'PM-25d.[04]' do
  impact 0.5
  title "procedures are updated #{input('pm_25_odp_04')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      procedures are updated #{input('pm_25_odp_04')}.
  ...
  tag nist: ['PM-25']
  tag control: 'PM-25'
  tag objective: 'PM-25d.[04]'
  tag rev: 'Rev_5'
  tag family: 'Program Management'
  tag baseline: %w{PRIVACY}
  tag baseline_privacy: true
  tag control_pm_25: true
  tag odp: %w{pm_25_odp_04 pm_25_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective PM-25d.[04]' do
