control 'PM-12' do
  impact 0.5
  title "an insider threat program that includes a cross-discipline insider threat incident handling team is implemented."
  desc <<~DESC
  ...
  tag baseline: %w{}
  tag control_pm_12: true

  describe 'NIST SP 800-53A Rev 5 objective PM-12' do
