control 'PM-11b.[01]' do
  impact 0.5
  title "information protection needs arising from the defined mission and business processes are determined;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-11b.[01]' do
