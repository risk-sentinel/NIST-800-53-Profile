control 'PM-07[05]' do
  impact 0.5
  title "an enterprise architecture is developed with consideration for the resulting risk to organizational operations and assets, individuals, other organizations, and the Nation;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-07[05]' do
