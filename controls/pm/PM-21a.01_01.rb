control 'PM-21a.01[01]' do
  impact 0.5
  title "the accounting includes the date of each disclosure;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-21a.01[01]' do
