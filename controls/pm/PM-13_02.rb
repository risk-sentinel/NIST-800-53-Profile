control 'PM-13[02]' do
  impact 0.5
  title "a privacy workforce development and improvement program is established."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-13[02]' do
