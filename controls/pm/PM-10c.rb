control 'PM-10c.' do
  impact 0.5
  title "the authorization processes are integrated into an organization-wide risk management program."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-10c.' do
