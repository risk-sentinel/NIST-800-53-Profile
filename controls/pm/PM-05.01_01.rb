control 'PM-05(01)[01]' do
  impact 0.5
  title "an inventory of all systems, applications, and projects that process personally identifiable information is established;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-05(01)[01]' do
