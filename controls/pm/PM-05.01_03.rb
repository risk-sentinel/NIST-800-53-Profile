control 'PM-05(01)[03]' do
  impact 0.5
  title "an inventory of all systems, applications, and projects that process personally identifiable information is updated #{input('pm_05_01_odp')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      an inventory of all systems, applications, and projects that process personally identifiable information is updated #{input('pm_05_01_odp')}.
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-05(01)[03]' do
