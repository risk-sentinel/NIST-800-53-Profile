control 'PM-21c.' do
  impact 0.5
  title "the accounting of disclosures is made available to the individual to whom the personally identifiable information relates upon request."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-21c.' do
