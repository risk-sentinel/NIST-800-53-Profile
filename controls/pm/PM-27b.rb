control 'PM-27b.' do
  impact 0.5
  title "the privacy reports are reviewed and updated #{input('pm_27_odp_04')}."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the privacy reports are reviewed and updated #{input('pm_27_odp_04')}.
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-27b.' do
