control 'PM-01a.03' do
  impact 0.5
  title "the information security program plan reflects the coordination among the organizational entities responsible for information security;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-01a.03' do
