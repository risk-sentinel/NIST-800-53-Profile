control 'PM-04b.[01]' do
  impact 0.5
  title "plans of action and milestones are reviewed for consistency with the organizational risk management strategy;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-04b.[01]' do
