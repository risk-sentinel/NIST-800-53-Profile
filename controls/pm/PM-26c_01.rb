control 'PM-26c.[01]' do
  impact 0.5
  title "the complaint management process includes tracking mechanisms to ensure that all complaints are reviewed within #{input('pm_26_odp_01')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the complaint management process includes tracking mechanisms to ensure that all complaints are reviewed within #{input('pm_26_odp_01')};
  ...
  tag nist: ['PM-26']
  tag control: 'PM-26'
  tag objective: 'PM-26c.[01]'
  tag rev: 'Rev_5'
  tag family: 'Program Management'
  tag baseline: %w{PRIVACY}
  tag baseline_privacy: true
  tag control_pm_26: true
  tag odp: %w{pm_26_odp_01 pm_26_odp_03 pm_26_odp_04 pm_26_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective PM-26c.[01]' do
