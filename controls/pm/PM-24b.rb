control 'PM-24b.' do
  impact 0.5
  title "the Data Integrity Board conducts an annual review of all matching programs in which the agency has participated."
  desc <<~DESC
  ...
  tag nist: ['PM-24']
  tag control: 'PM-24'
  tag objective: 'PM-24b.'
  tag rev: 'Rev_5'
  tag family: 'Program Management'
  tag baseline: %w{PRIVACY}
  tag baseline_privacy: true
  tag control_pm_24: true

  describe 'NIST SP 800-53A Rev 5 objective PM-24b.' do
