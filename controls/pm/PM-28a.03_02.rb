control 'PM-28a.03[02]' do
  impact 0.5
  title "trade-offs considered by the organization for managing risk are identified and documented;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-28a.03[02]' do
