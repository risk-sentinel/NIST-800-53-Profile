control 'PM-18b.[03]' do
  impact 0.5
  title "the privacy program plan is updated to address organizational changes;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-18b.[03]' do
