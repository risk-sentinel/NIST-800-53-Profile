control 'PM-31b.[01]' do
  impact 0.5
  title "continuous monitoring programs are implemented that establish #{input('pm_31_odp_02')} for monitoring;"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      continuous monitoring programs are implemented that establish #{input('pm_31_odp_02')} for monitoring;
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-31b.[01]' do
