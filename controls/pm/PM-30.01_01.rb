control 'PM-30(01)[01]' do
  impact 0.5
  title "suppliers of critical or mission-essential technologies, products, and services are identified;"
  desc <<~DESC
  ...
  tag nist: ['PM-30 (1)']
  tag control: 'PM-30 (1)'
  tag objective: 'PM-30(01)[01]'
  tag rev: 'Rev_5'
  tag family: 'Program Management'
  tag baseline: %w{}
  tag control_pm_30_1: true

  describe 'NIST SP 800-53A Rev 5 objective PM-30(01)[01]' do
