control 'PM-20(01)(c)[02]' do
  impact 0.5
  title "the privacy policies include a time/date stamp to inform the public of the date of the most recent changes."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-20(01)(c)[02]' do
