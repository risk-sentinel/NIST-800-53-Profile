control 'PM-30a.[01]' do
  impact 0.5
  title "an organization-wide strategy for managing supply chain risks is developed;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-30a.[01]' do
