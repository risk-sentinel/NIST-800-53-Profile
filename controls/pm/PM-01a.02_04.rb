control 'PM-01a.02[04]' do
  impact 0.5
  title "the information security program plan addresses coordination among organizational entities;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-01a.02[04]' do
