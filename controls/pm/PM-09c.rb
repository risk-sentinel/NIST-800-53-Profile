control 'PM-09c.' do
  impact 0.5
  title "the risk management strategy is reviewed and updated #{input('pm_09_odp')} or as required to address organizational changes."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the risk management strategy is reviewed and updated #{input('pm_09_odp')} or as required to address organizational changes.
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-09c.' do
