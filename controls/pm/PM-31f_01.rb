control 'PM-31f.[01]' do
  impact 0.5
  title "continuous monitoring programs are implemented that include reporting the security status of organizational systems to #{input('pm_31_odp_04')} #{input('pm_31_odp_06')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      continuous monitoring programs are implemented that include reporting the security status of organizational systems to #{input('pm_31_odp_04')} #{input('pm_31_odp_06')};
  ...
  tag nist: ['PM-31']
  tag control: 'PM-31'
  tag objective: 'PM-31f.[01]'
  tag rev: 'Rev_5'
  tag family: 'Program Management'
  tag baseline: %w{PRIVACY}
  tag baseline_privacy: true
  tag control_pm_31: true
  tag odp: %w{pm_31_odp_01 pm_31_odp_02 pm_31_odp_03 pm_31_odp_04 pm_31_odp_06 pm_31_prm_4 pm_31_prm_5}

  describe 'NIST SP 800-53A Rev 5 objective PM-31f.[01]' do
