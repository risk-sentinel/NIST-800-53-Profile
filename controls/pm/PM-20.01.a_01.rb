control 'PM-20(01)(a)[01]' do
  impact 0.5
  title "the privacy policies are written in plain language;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-20(01)(a)[01]' do
