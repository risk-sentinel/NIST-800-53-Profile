control 'PM-20[01]' do
  impact 0.5
  title "a central resource webpage is maintained on the organization’s principal public website;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-20[01]' do
