control 'PM-01c.[02]' do
  impact 0.5
  title "the information security program plan is protected from unauthorized modification."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-01c.[02]' do
