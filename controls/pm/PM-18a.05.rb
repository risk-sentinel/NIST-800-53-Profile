control 'PM-18a.05' do
  impact 0.5
  title "the privacy program plan reflects coordination among organizational entities responsible for the different aspects of privacy;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-18a.05' do
