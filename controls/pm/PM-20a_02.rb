control 'PM-20a.[02]' do
  impact 0.5
  title "the webpage ensures that the public can communicate with its senior agency official for privacy;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-20a.[02]' do
