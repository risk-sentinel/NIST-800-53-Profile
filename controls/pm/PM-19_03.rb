control 'PM-19[03]' do
  impact 0.5
  title "the senior agency official for privacy develops applicable privacy requirements;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-19[03]' do
