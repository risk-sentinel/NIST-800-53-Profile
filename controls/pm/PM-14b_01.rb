control 'PM-14b.[01]' do
  impact 0.5
  title "testing plans are reviewed for consistency with the organizational risk management strategy;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-14b.[01]' do
