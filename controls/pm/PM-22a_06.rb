control 'PM-22a.[06]' do
  impact 0.5
  title "the procedures address reviewing the relevance of personally identifiable information across the information life cycle;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-22a.[06]' do
