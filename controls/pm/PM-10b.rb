control 'PM-10b.' do
  impact 0.5
  title "individuals are designated to fulfill specific roles and responsibilities within the organizational risk management process;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-10b.' do
