control 'PM-26[01]' do
  impact 0.5
  title "a process for receiving complaints, concerns, or questions from individuals about organizational security and privacy practices is implemented;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-26[01]' do
