control 'PM-30a.[13]' do
  impact 0.5
  title "the supply chain risk management strategy addresses risks associated with the disposal of system services;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-30a.[13]' do
