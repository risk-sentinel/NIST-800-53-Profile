control 'PM-21b.' do
  impact 0.5
  title "the accounting of disclosures is retained for the length of time that the personally identifiable information is maintained or five years after the disclosure is made, whichever is longer;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-21b.' do
