control 'PM-01a.02[01]' do
  impact 0.5
  title "the information security program plan includes the identification and assignment of roles;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-01a.02[01]' do
