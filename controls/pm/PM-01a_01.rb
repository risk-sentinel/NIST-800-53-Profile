control 'PM-01a.[01]' do
  impact 0.5
  title "an organization-wide information security program plan is developed;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-01a.[01]' do
