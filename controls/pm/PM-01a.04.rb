control 'PM-01a.04' do
  impact 0.5
  title "the information security program plan is approved by a senior official with responsibility and accountability for the risk being incurred to organizational operations (including mission, functions, image, and reputation), organizational assets, individuals, other organizations, and the Nation;"
  desc <<~DESC
    ...
    b. Review and update the organization-wide information security program plan #{input('pm_01_odp_01')} and following #{input('pm_01_odp_02')} ; and
  ...
  tag nist: ['PM-1']
  tag control: 'PM-1'
  tag objective: 'PM-01a.04'
  tag rev: 'Rev_5'
  tag family: 'Program Management'
  tag baseline: %w{}
  tag control_pm_1: true
  tag odp: %w{pm_01_odp_01 pm_01_odp_02}

  describe 'NIST SP 800-53A Rev 5 objective PM-01a.04' do
