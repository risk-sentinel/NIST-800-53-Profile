control 'PM-20c.' do
  impact 0.5
  title "the webpage employs publicly facing email addresses and/or phone numbers to enable the public to provide feedback and/or direct questions to privacy offices regarding privacy practices."
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-20c.' do
