control 'PM-30b.' do
  impact 0.5
  title "the supply chain risk management strategy is implemented consistently across the organization;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-30b.' do
