control 'PM-17b.[01]' do
  impact 0.5
  title "policy is reviewed and updated #{input('pm_17_odp_01')};"
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      policy is reviewed and updated #{input('pm_17_odp_01')};
  ...
  tag nist: ['PM-17']
  tag control: 'PM-17'
  tag objective: 'PM-17b.[01]'
  tag rev: 'Rev_5'
  tag family: 'Program Management'
  tag baseline: %w{PRIVACY}
  tag baseline_privacy: true
  tag control_pm_17: true
  tag odp: %w{pm_17_odp_01 pm_17_prm_1}

  describe 'NIST SP 800-53A Rev 5 objective PM-17b.[01]' do
