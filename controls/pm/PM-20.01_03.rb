control 'PM-20(01)[03]' do
  impact 0.5
  title "privacy policies are developed and posted on all other digital services;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-20(01)[03]' do
