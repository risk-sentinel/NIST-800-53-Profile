control 'PM-08[05]' do
  impact 0.5
  title "privacy issues are addressed in the documentation of a critical infrastructure and key resources protection plan;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-08[05]' do
