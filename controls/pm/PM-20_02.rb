control 'PM-20[02]' do
  impact 0.5
  title "the webpage serves as a central source of information about the organization’s privacy program;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-20[02]' do
