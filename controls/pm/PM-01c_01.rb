control 'PM-01c.[01]' do
  impact 0.5
  title "the information security program plan is protected from unauthorized disclosure;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-01c.[01]' do
