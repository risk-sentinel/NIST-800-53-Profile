control 'PM-30c.' do
  impact 0.5
  title "the supply chain risk management strategy is reviewed and updated #{input('pm_30_odp')} or as required to address organizational changes."
  desc <<~DESC
  ...
  desc 'check', <<~CHECK
    Determine if:
      the supply chain risk management strategy is reviewed and updated #{input('pm_30_odp')} or as required to address organizational changes.
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-30c.' do
