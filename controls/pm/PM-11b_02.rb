control 'PM-11b.[02]' do
  impact 0.5
  title "personally identifiable information processing needs arising from the defined mission and business processes are determined;"
  desc <<~DESC
  ...
  describe 'NIST SP 800-53A Rev 5 objective PM-11b.[02]' do
