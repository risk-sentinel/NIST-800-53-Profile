control 'AC-2' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      ...
      AC-02c. #{input('ac_02_odp_01')} for group and role membership are required;
      AC-02d.
        ...
        AC-02d.03
          ...
          AC-02d.03[02] #{input('ac_02_odp_02')} are specified for each account;
      AC-02e. approvals are required by #{input('ac_02_odp_03')} for requests to create accounts;
      AC-02f.
        AC-02f.[01] accounts are created in accordance with #{input('ac_02_odp_04')};
        AC-02f.[02] accounts are enabled in accordance with #{input('ac_02_odp_04')};
        AC-02f.[03] accounts are modified in accordance with #{input('ac_02_odp_04')};
        AC-02f.[04] accounts are disabled in accordance with #{input('ac_02_odp_04')};
        AC-02f.[05] accounts are removed in accordance with #{input('ac_02_odp_04')};
      AC-02g. the use of accounts is monitored;
      AC-02h.
        AC-02h.01 account managers and #{input('ac_02_odp_05')} are notified within #{input('ac_02_odp_06')} when accounts are no longer required;
        AC-02h.02 account managers and #{input('ac_02_odp_05')} are notified within #{input('ac_02_odp_07')} when users are terminated or transferred;
        AC-02h.03 account managers and #{input('ac_02_odp_05')} are notified within #{input('ac_02_odp_08')} when system usage or the need to know changes for an individual;
      AC-02i.
        ...
        AC-02i.03 access to the system is authorized based on #{input('ac_02_odp_09')};
      AC-02j. accounts are reviewed for compliance with account management requirements #{input('ac_02_odp_10')};
      AC-02k.
  ...
  describe 'NIST SP 800-53 Rev 5 control AC-2' do
