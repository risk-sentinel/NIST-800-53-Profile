control 'RA-3 (3)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      RA-03(03) the current cyber threat environment is determined on an ongoing basis using #{input('ra_03_03_odp')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control RA-3 (3)' do
