control 'SC-8 (4)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SC-08(04) cryptographic mechanisms are implemented to conceal or randomize communication patterns unless otherwise protected by #{input('sc_08_04_odp')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control SC-8 (4)' do
