control 'SC-18 (2)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SC-18(02)[01] the acquisition of mobile code to be deployed in the system meets #{input('sc_18_02_odp')};
      SC-18(02)[02] the development of mobile code to be deployed in the system meets #{input('sc_18_02_odp')};
      SC-18(02)[03] the use of mobile code to be deployed in the system meets #{input('sc_18_02_odp')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control SC-18 (2)' do
