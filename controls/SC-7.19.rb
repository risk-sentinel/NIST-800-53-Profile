control 'SC-7 (19)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SC-07(19)[01] inbound communications traffic is blocked between #{input('sc_07_19_odp')} that are independently configured by end users and external service providers;
      SC-07(19)[02] outbound communications traffic is blocked between #{input('sc_07_19_odp')} that are independently configured by end users and external service providers.
  ...
  describe 'NIST SP 800-53 Rev 5 control SC-7 (19)' do
