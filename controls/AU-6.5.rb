control 'AU-6 (5)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      AU-06(05) analysis of audit records is integrated with analysis of #{input('au_06_05_odp_01')} to further enhance the ability to identify inappropriate or unusual activity.
  ...
  describe 'NIST SP 800-53 Rev 5 control AU-6 (5)' do
