control 'SI-3 (6)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SI-03(06)(a) malicious code protection mechanisms are tested #{input('si_03_06_odp')} by introducing known benign code into the system;
      SI-03(06)(b)
  ...
  describe 'NIST SP 800-53 Rev 5 control SI-3 (6)' do
