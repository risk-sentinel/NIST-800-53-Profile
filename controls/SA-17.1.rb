control 'SA-17 (1)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SA-17(01)(a)
        SA-17(01)(a)[01] as an integral part of the development process, the developer of the system, system component, or system service is required to produce a formal policy model describing the #{input('sa_17_01_odp_01')} to be enforced;
        SA-17(01)(a)[02] as an integral part of the development process, the developer of the system, system component, or system service is required to produce a formal policy model describing the #{input('sa_17_01_odp_02')} to be enforced;
      SA-17(01)(b)
  ...
  tag baseline: %w{}
  tag odp: %w{sa_17_01_odp_01 sa_17_01_odp_02 sa_17_1_prm_1}

  describe 'NIST SP 800-53 Rev 5 control SA-17 (1)' do
