control 'AC-16 (9)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      AC-16(09)[01] security attributes associated with information are changed only via regrading mechanisms validated using #{input('ac_16_09_odp_01')};
      AC-16(09)[02] privacy attributes associated with information are changed only via regrading mechanisms validated using #{input('ac_16_09_odp_02')}.
  ...
  tag baseline: %w{}
  tag odp: %w{ac_16_09_odp_01 ac_16_09_odp_02 ac_16_9_prm_1}

  describe 'NIST SP 800-53 Rev 5 control AC-16 (9)' do
