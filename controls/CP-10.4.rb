control 'CP-10 (4)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      CP-10(04) the capability to restore system components within #{input('cp_10_04_odp')} from configuration-controlled and integrity-protected information representing a known, operational state for the components is provided.
  ...
  describe 'NIST SP 800-53 Rev 5 control CP-10 (4)' do
