control 'IA-12 (5)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      IA-12(05) a #{input('ia_12_05_odp')} is delivered through an out-of-band channel to verify the user’s address (physical or digital) of record.
  ...
  describe 'NIST SP 800-53 Rev 5 control IA-12 (5)' do
