control 'SI-7 (10)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SI-07(10) #{input('si_07_10_odp_01')} are implemented to protect the integrity of boot firmware in #{input('si_07_10_odp_02')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control SI-7 (10)' do
