control 'SC-49' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SC-49 hardware-enforced separation and policy enforcement mechanisms are implemented between #{input('sc_49_odp')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control SC-49' do
