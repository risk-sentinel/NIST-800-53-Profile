control 'AU-6 (7)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      AU-06(07) the permitted actions for each #{input('au_06_07_odp')} associated with the review, analysis, and reporting of audit record information are specified.
  ...
  describe 'NIST SP 800-53 Rev 5 control AU-6 (7)' do
