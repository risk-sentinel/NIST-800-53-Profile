control 'SC-7 (13)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SC-07(13) #{input('sc_07_13_odp')} are isolated from other internal system components by implementing physically separate subnetworks with managed interfaces to other components of the system.
  ...
  describe 'NIST SP 800-53 Rev 5 control SC-7 (13)' do
