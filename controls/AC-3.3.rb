control 'AC-3 (3)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      AC-03(03)[01] #{input('ac_03_03_odp_01')} is enforced over the set of covered subjects specified in the policy;
      AC-03(03)[02] #{input('ac_03_03_odp_02')} is enforced over the set of covered objects specified in the policy;
      AC-03(03)(a)
        AC-03(03)(a)[01] #{input('ac_03_03_odp_01')} is uniformly enforced across the covered subjects within the system;
        AC-03(03)(a)[02] #{input('ac_03_03_odp_02')} is uniformly enforced across the covered objects within the system;
      AC-03(03)(b)
        AC-03(03)(b)(01) #{input('ac_03_03_odp_01')} and #{input('ac_03_03_odp_02')} specifying that a subject that has been granted access to information is constrained from passing the information to unauthorized subjects or objects are enforced;
        AC-03(03)(b)(02) #{input('ac_03_03_odp_01')} and #{input('ac_03_03_odp_02')} specifying that a subject that has been granted access to information is constrained from granting its privileges to other subjects are enforced;
        AC-03(03)(b)(03) #{input('ac_03_03_odp_01')} and #{input('ac_03_03_odp_02')} specifying that a subject that has been granted access to information is constrained from changing one of more security attributes (specified by the policy) on subjects, objects, the system, or system components are enforced;
        AC-03(03)(b)(04) #{input('ac_03_03_odp_01')} and #{input('ac_03_03_odp_02')} specifying that a subject that has been granted access to information is constrained from choosing the security attributes and attribute values (specified by the policy) to be associated with newly created or modified objects are enforced;
        AC-03(03)(b)(05) #{input('ac_03_03_odp_01')} and #{input('ac_03_03_odp_02')} specifying that a subject that has been granted access to information is constrained from changing the rules governing access control are enforced;
      AC-03(03)(c) #{input('ac_03_03_odp_01')} and #{input('ac_03_03_odp_02')} specifying that #{input('ac_03_03_odp_03')} may explicitly be granted #{input('ac_03_03_odp_04')} such that they are not limited by any defined subset (or all) of the above constraints are enforced.
  ...
  tag baseline: %w{}
  tag odp: %w{ac_03_03_odp_01 ac_03_03_odp_02 ac_03_03_odp_03 ac_03_03_odp_04 ac_3_3_prm_1}

  describe 'NIST SP 800-53 Rev 5 control AC-3 (3)' do
