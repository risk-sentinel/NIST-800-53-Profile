control 'SC-7 (21)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      SC-07(21) boundary protection mechanisms are employed to isolate #{input('sc_07_21_odp_01')} supporting #{input('sc_07_21_odp_02')}.
  ...
  describe 'NIST SP 800-53 Rev 5 control SC-7 (21)' do
