control 'CP-9 (5)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      CP-09(05)[01] system backup information is transferred to the alternate storage site for #{input('cp_09_05_odp_01')};
      CP-09(05)[02] system backup information is transferred to the alternate storage site #{input('cp_09_05_odp_02')}.
  ...
  tag odp: %w{cp_09_05_odp_01 cp_09_05_odp_02 cp_9_5_prm_1}

  describe 'NIST SP 800-53 Rev 5 control CP-9 (5)' do
