control 'PE-3 (5)' do
  ...
  desc 'check', <<~CHECK
    Determine if:
      PE-03(05) #{input('pe_03_05_odp_01')} are employed to #{input('pe_03_05_odp_02')} physical tampering or alteration of #{input('pe_03_05_odp_03')} within the system.
  ...
  describe 'NIST SP 800-53 Rev 5 control PE-3 (5)' do
